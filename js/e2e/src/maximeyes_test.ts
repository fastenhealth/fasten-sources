...
// Sandbox failed to start - 500 error
test.skip("MaximEyes Login Flow", async ({page}, testInfo) => {
    try {
        ...
        let authorizeData = await generateFastenConnectAuthorizeUrl(
            '5e3839ed-6ae1-472b-b4b8-b5df098443c7',
            'd26f0b1c-82e7-4cb5-a4c4-55e73d48c016',
            'f4ea79fc-9a1b-43f0-be95-24247d666514',
        )
