...
import { generateSourceAuthorizeUrl, generateFastenConnectAuthorizeUrl } from '@shared-library';
...
test("Cerner Login Flow", async ({ page }, testInfo) => {
    try {
        ...
        let authorizeData = await generateFastenConnectAuthorizeUrl(
            'a9da9380-0510-4026-9161-8ec238695c49',
            '00a83214-7b14-4a12-ad95-5198b70dbb63',
            '3290e5d7-978e-42ad-b661-1cf8a01a989c',
        )
