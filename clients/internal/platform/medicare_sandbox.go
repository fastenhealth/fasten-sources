...
type sourceClientMedicareSandbox struct {
	models.SourceClient
}
...
*/
func GetSourceClientMedicareSandbox(env pkg.FastenLighthouseEnvType, ctx context.Context, globalLogger logrus.FieldLogger, sourceCreds models.SourceCredential, testHttpClient ...*http.Client) (models.SourceClient, error) {
	baseClient, err := base.GetSourceClientFHIR401(env, ctx, globalLogger, sourceCreds, testHttpClient...)
	if err != nil {
		return nil, err
	}

	return sourceClientMedicareSandbox{baseClient}, err
}
...
func (c sourceClientMedicareSandbox) SyncAll(db models.DatabaseRepository) (models.UpsertSummary, error) {
