...
type SourceClientUnicare struct {
	models.SourceClient
}
...
func GetSourceClientUnicare(env pkg.FastenEnvType, ctx context.Context, globalLogger logrus.FieldLogger, sourceCreds models.SourceCredential, testHttpClient ...*http.Client) (models.SourceClient, *models.SourceCredential, error) {
	baseClient, updatedSourceCred, err := GetSourceClientAnthem(env, ctx, globalLogger, sourceCreds, testHttpClient...)

	return SourceClientUnicare{baseClient}, updatedSourceCred, err
}
