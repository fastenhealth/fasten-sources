...
func (m *MockSourceCredential) RefreshTokens(accessToken, refreshTokens string, expiresAt int64) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "RefreshTokens", accessToken, refreshTokens, expiresAt)
}

// RefreshTokens indicates an expected call of RefreshTokens.
func (mr *MockSourceCredentialMockRecorder) RefreshTokens(accessToken, refreshTokens, expiresAt interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RefreshTokens", reflect.TypeOf((*MockSourceCredential)(nil).RefreshTokens), accessToken, refreshTokens, expiresAt)
}
