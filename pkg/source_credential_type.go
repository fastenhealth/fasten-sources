...
const (
	...
	SourceCredentialTypeTefcaFacilitated SourceCredentialType = "tefca_facilitated" // TEFCA Facilitated FHIR authorization (SMART on FHIR under the hood, but initally populated by TEFCA RLS response)
