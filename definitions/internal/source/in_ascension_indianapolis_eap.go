...
func GetSourceInAscensionIndianapolisEap(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeInAscensionIndianapolisEap]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "IN  Ascension  Indianapolis EAP"
	sourceDef.SourceType = pkg.SourceTypeInAscensionIndianapolisEap
