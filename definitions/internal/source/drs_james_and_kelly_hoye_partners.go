...
func GetSourceDrsJamesAndKellyHoyePartners(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrsJamesAndKellyHoyePartners]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Drs James and Kelly Hoye Partners"
	sourceDef.SourceType = pkg.SourceTypeDrsJamesAndKellyHoyePartners
