...
func GetSourceAbcPediatrics1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAbcPediatrics1]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ABC Pediatrics"
	sourceDef.SourceType = pkg.SourceTypeAbcPediatrics1
	...
	sourceDef.BrandLogo = "abc-pediatrics.png"
