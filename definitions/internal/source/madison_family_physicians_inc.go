...
func GetSourceMadisonFamilyPhysiciansInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMadisonFamilyPhysiciansInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Madison Family Physicians Inc"
	sourceDef.SourceType = pkg.SourceTypeMadisonFamilyPhysiciansInc
