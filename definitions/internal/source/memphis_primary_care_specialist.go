...
func GetSourceMemphisPrimaryCareSpecialist(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMemphisPrimaryCareSpecialist]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Memphis Primary Care Specialist"
	sourceDef.SourceType = pkg.SourceTypeMemphisPrimaryCareSpecialist
	sourceDef.BrandLogo = "memphis-primary-care-specialist.jpg"
	sourceDef.PatientAccessUrl = "https://www.primarycarememphis.com/"
