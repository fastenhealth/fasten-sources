...
func GetSourceOhioEarInstituteLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOhioEarInstituteLlc]; clientIdOk {
	...
	sourceDef.Category = []string{"261QA1903X", "207YX0901X"}
