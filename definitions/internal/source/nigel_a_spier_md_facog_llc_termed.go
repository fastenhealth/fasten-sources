...
func GetSourceNigelASpierMdFacogLlcTermed(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNigelASpierMdFacogLlcTermed]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "NIGEL A SPIER MD FACOG LLC TERMED"
	sourceDef.SourceType = pkg.SourceTypeNigelASpierMdFacogLlcTermed
