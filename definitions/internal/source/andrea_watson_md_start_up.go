...
func GetSourceAndreaWatsonMdStartUp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAndreaWatsonMdStartUp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Andrea Watson MD start up"
	sourceDef.SourceType = pkg.SourceTypeAndreaWatsonMdStartUp
