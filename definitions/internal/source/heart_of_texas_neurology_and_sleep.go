...
func GetSourceHeartOfTexasNeurologyAndSleep(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHeartOfTexasNeurologyAndSleep]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Heart of Texas Neurology and Sleep"
	sourceDef.SourceType = pkg.SourceTypeHeartOfTexasNeurologyAndSleep
