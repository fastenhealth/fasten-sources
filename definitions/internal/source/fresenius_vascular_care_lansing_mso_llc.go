...
func GetSourceFreseniusVascularCareLansingMsoLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFreseniusVascularCareLansingMsoLlc]; clientIdOk {
	...
	sourceDef.Aliases = []string{"FRESENIUS VASCULAR CARE LANSING MSO LLC"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1255603767"}}
	sourceDef.BrandLogo = "fresenius-medical-care-north-america.png"
