...
func GetSourceErdeySearcyEyeGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeErdeySearcyEyeGroup]; clientIdOk {
	...
	sourceDef.BrandLogo = "erdey-searcy-eye-group.jpg"
