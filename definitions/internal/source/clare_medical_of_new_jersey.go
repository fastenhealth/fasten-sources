...
func GetSourceClareMedicalOfNewJersey(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeClareMedicalOfNewJersey]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Clare Medical of New Jersey"
	sourceDef.SourceType = pkg.SourceTypeClareMedicalOfNewJersey
