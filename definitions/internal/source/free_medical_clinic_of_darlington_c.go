...
func GetSourceFreeMedicalClinicOfDarlingtonC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFreeMedicalClinicOfDarlingtonC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Free Medical Clinic of Darlington C"
	sourceDef.SourceType = pkg.SourceTypeFreeMedicalClinicOfDarlingtonC
