...
func GetSourceDrKuruchiSrinivasanMdpc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrKuruchiSrinivasanMdpc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dr Kuruchi Srinivasan MDPC"
	sourceDef.SourceType = pkg.SourceTypeDrKuruchiSrinivasanMdpc
