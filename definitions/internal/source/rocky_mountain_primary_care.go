...
func GetSourceRockyMountainPrimaryCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRockyMountainPrimaryCare]; clientIdOk {
	...
	sourceDef.Aliases = []string{"RMPC - WESTMINSTER", "ROCKY MOUNTAIN PRIMARY CARE"}
