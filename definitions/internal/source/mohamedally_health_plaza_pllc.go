...
func GetSourceMohamedallyHealthPlazaPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMohamedallyHealthPlazaPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Mohamedally Health Plaza PLLC"
	sourceDef.SourceType = pkg.SourceTypeMohamedallyHealthPlazaPllc
