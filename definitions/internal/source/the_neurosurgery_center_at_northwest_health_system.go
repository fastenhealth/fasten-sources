...
func GetSourceTheNeurosurgeryCenterAtNorthwestHealthSystem(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheNeurosurgeryCenterAtNorthwestHealthSystem]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Neurosurgery Center at Northwest Health System"
	sourceDef.SourceType = pkg.SourceTypeTheNeurosurgeryCenterAtNorthwestHealthSystem
