...
func GetSourceTheChildrensClinicAtHarberMeadows(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheChildrensClinicAtHarberMeadows]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Childrens Clinic at HarBer Meadows"
	sourceDef.SourceType = pkg.SourceTypeTheChildrensClinicAtHarberMeadows
