...
func GetSourceEconciergeOfEfficientWeightLoss(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEconciergeOfEfficientWeightLoss]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "EConcierge of Efficient Weight Loss"
	sourceDef.SourceType = pkg.SourceTypeEconciergeOfEfficientWeightLoss
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://econciergeofefficienthealthcare.com"
