...
func GetSourceARolandSpedaleJrMdFacp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeARolandSpedaleJrMdFacp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "A Roland Spedale Jr MD FACP"
	sourceDef.SourceType = pkg.SourceTypeARolandSpedaleJrMdFacp
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.mdvip.com/ARolandSpedaleMD"
