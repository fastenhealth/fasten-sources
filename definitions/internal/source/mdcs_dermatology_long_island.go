...
func GetSourceMdcsDermatologyLongIsland(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMdcsDermatologyLongIsland]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MDCS Dermatology Long Island"
	sourceDef.SourceType = pkg.SourceTypeMdcsDermatologyLongIsland
