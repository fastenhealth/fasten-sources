...
func GetSourceTheImageOfEveRestoredInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheImageOfEveRestoredInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Image of Eve Restored Inc"
	sourceDef.SourceType = pkg.SourceTypeTheImageOfEveRestoredInc
