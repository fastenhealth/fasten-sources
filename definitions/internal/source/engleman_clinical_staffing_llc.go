...
func GetSourceEnglemanClinicalStaffingLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEnglemanClinicalStaffingLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Engleman Clinical Staffing LLC"
	sourceDef.SourceType = pkg.SourceTypeEnglemanClinicalStaffingLlc
