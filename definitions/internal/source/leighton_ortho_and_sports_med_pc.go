...
func GetSourceLeightonOrthoAndSportsMedPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLeightonOrthoAndSportsMedPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Leighton Ortho and Sports Med PC"
	sourceDef.SourceType = pkg.SourceTypeLeightonOrthoAndSportsMedPc
