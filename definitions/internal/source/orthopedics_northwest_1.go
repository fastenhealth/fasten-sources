...
func GetSourceOrthopedicsNorthwest1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthopedicsNorthwest1]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Orthopedics Northwest"
	sourceDef.SourceType = pkg.SourceTypeOrthopedicsNorthwest1
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "orthopedics-northwest.png"
	sourceDef.PatientAccessUrl = "https://www.orthnw.com/"
