...
func GetSourcePediatricPartnersOfHamptonRoads(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatricPartnersOfHamptonRoads]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pediatric Partners of Hampton Roads"
	sourceDef.SourceType = pkg.SourceTypePediatricPartnersOfHamptonRoads
