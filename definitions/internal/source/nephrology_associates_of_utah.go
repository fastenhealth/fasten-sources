...
func GetSourceNephrologyAssociatesOfUtah(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNephrologyAssociatesOfUtah]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "NEPHROLOGY ASSOCIATES OF UTAH"
	sourceDef.SourceType = pkg.SourceTypeNephrologyAssociatesOfUtah
