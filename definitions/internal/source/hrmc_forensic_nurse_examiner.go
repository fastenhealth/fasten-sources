...
func GetSourceHrmcForensicNurseExaminer(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHrmcForensicNurseExaminer]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "HRMC Forensic Nurse Examiner"
	sourceDef.SourceType = pkg.SourceTypeHrmcForensicNurseExaminer
