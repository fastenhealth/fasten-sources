...
func GetSourceAndersonFootAndAnkleInstituteI(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAndersonFootAndAnkleInstituteI]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Anderson Foot and Ankle Institute I"
	sourceDef.SourceType = pkg.SourceTypeAndersonFootAndAnkleInstituteI
