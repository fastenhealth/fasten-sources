...
func GetSourceDevelopmentalPediatricsHealthWel(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDevelopmentalPediatricsHealthWel]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Developmental Pediatrics Health Wel"
	sourceDef.SourceType = pkg.SourceTypeDevelopmentalPediatricsHealthWel
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.asmajsadiq.com"
