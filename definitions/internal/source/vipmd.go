...
func GetSourceVipmd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVipmd]; clientIdOk {
	...
	sourceDef.Category = []string{"207Q00000X", "207R00000X", "207RI0011X", "261QM1300X"}
