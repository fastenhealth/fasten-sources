...
func GetSourceFulshearFootAndAnklePllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFulshearFootAndAnklePllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Fulshear Foot and Ankle PLLC"
	sourceDef.SourceType = pkg.SourceTypeFulshearFootAndAnklePllc
	sourceDef.Category = []string{"213E00000X", "213ES0103X"}
	sourceDef.Aliases = []string{}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1346628161", "1811369341"}}
	sourceDef.PatientAccessUrl = "http://www.fulshearfootandankle.com"
