...
func GetSourceWayfinderWellnessPhysicalThera(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWayfinderWellnessPhysicalThera]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Wayfinder Wellness  Physical Thera"
	sourceDef.SourceType = pkg.SourceTypeWayfinderWellnessPhysicalThera
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.wayfindervt.com"
