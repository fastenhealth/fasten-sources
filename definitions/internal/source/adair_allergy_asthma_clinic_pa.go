...
func GetSourceAdairAllergyAsthmaClinicPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdairAllergyAsthmaClinicPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Adair Allergy  Asthma Clinic PA"
	sourceDef.SourceType = pkg.SourceTypeAdairAllergyAsthmaClinicPa
