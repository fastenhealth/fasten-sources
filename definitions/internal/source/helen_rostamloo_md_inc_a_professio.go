...
func GetSourceHelenRostamlooMdIncAProfessio(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHelenRostamlooMdIncAProfessio]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Helen Rostamloo MD Inc A Professio"
	sourceDef.SourceType = pkg.SourceTypeHelenRostamlooMdIncAProfessio
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.gimclinic.com"
