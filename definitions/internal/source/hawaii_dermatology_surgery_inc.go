...
func GetSourceHawaiiDermatologySurgeryInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHawaiiDermatologySurgeryInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Hawaii Dermatology  Surgery Inc"
	sourceDef.SourceType = pkg.SourceTypeHawaiiDermatologySurgeryInc
