...
func GetSourceHospitalistServicesOfOkaloosaCounty(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHospitalistServicesOfOkaloosaCounty]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Hospitalist Services of Okaloosa County"
	sourceDef.SourceType = pkg.SourceTypeHospitalistServicesOfOkaloosaCounty
