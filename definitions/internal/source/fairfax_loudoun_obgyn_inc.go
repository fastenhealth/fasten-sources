...
func GetSourceFairfaxLoudounObgynInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFairfaxLoudounObgynInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Fairfax Loudoun OBGYN INC"
	sourceDef.SourceType = pkg.SourceTypeFairfaxLoudounObgynInc
