...
func GetSourceLedesmaFootAnkleInstitute(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLedesmaFootAnkleInstitute]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Ledesma Foot  Ankle Institute"
	sourceDef.SourceType = pkg.SourceTypeLedesmaFootAnkleInstitute
