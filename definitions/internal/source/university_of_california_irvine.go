...
func GetSourceUniversityOfCaliforniaIrvine(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Aliases = []string{"OUTPATIENT PHARMACY - UC IRVINE HEALTH", "UCI MEDICAL CENTER", "UCI FAMILY HEALTH CENTER PHARMACY", "UCI HEALTH-SUSAN SAMUELI INTEGRATED HEALTH INSTITUTE PHARMACY", "UCI FAMILY HEALTH CENTER - ANAHEIM", "UCI FAMILY HEALTH CENTER - SANTA ANA"}
