...
func GetSourceSleepMedicineSpclstsSFl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSleepMedicineSpclstsSFl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sleep Medicine Spclsts S FL"
	sourceDef.SourceType = pkg.SourceTypeSleepMedicineSpclstsSFl
