...
func GetSourceNashobaValleyHealthcareGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNashobaValleyHealthcareGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Nashoba Valley Healthcare Group"
	sourceDef.SourceType = pkg.SourceTypeNashobaValleyHealthcareGroup
