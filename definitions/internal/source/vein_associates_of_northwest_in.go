...
func GetSourceVeinAssociatesOfNorthwestIn(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVeinAssociatesOfNorthwestIn]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Vein Associates of Northwest IN"
	sourceDef.SourceType = pkg.SourceTypeVeinAssociatesOfNorthwestIn
