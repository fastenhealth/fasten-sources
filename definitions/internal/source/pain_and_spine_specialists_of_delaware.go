...
func GetSourcePainAndSpineSpecialistsOfDelaware(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePainAndSpineSpecialistsOfDelaware]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pain and Spine Specialists of Delaware"
	sourceDef.SourceType = pkg.SourceTypePainAndSpineSpecialistsOfDelaware
