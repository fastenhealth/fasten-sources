...
func GetSourceJenaMRoyFnpLlcDbaBasileFami(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJenaMRoyFnpLlcDbaBasileFami]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Jena M Roy FNP LLC dba Basile Fami"
	sourceDef.SourceType = pkg.SourceTypeJenaMRoyFnpLlcDbaBasileFami
