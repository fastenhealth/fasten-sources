...
func GetSourceSouthernCalOrofacialPainMgmt(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthernCalOrofacialPainMgmt]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Southern Cal Orofacial Pain Mgmt"
	sourceDef.SourceType = pkg.SourceTypeSouthernCalOrofacialPainMgmt
