...
func GetSourceClaimsPractice1Gateway(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeClaimsPractice1Gateway]; clientIdOk {
