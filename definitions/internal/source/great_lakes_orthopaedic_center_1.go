...
func GetSourceGreatLakesOrthopaedicCenter1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGreatLakesOrthopaedicCenter1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeGreatLakesOrthopaedicCenter1
	...
	sourceDef.BrandLogo = "great-lakes-orthopaedic-center.png"
