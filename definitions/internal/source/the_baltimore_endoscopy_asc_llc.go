...
func GetSourceTheBaltimoreEndoscopyAscLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheBaltimoreEndoscopyAscLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "The Baltimore Endoscopy ASC LLC"
	sourceDef.SourceType = pkg.SourceTypeTheBaltimoreEndoscopyAscLlc
