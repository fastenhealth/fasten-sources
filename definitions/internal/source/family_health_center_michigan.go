...
func GetSourceFamilyHealthCenterMichigan(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeFamilyHealthCenterMichigan
