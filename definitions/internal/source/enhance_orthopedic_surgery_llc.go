...
func GetSourceEnhanceOrthopedicSurgeryLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEnhanceOrthopedicSurgeryLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Enhance Orthopedic Surgery LLC"
	sourceDef.SourceType = pkg.SourceTypeEnhanceOrthopedicSurgeryLlc
