...
func GetSourceColoradoCenterOfMedicalExcelle(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeColoradoCenterOfMedicalExcelle]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Colorado Center of Medical Excelle"
	sourceDef.SourceType = pkg.SourceTypeColoradoCenterOfMedicalExcelle
