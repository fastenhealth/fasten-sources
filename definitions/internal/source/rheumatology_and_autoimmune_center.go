...
func GetSourceRheumatologyAndAutoimmuneCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRheumatologyAndAutoimmuneCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Rheumatology and Autoimmune Center"
	sourceDef.SourceType = pkg.SourceTypeRheumatologyAndAutoimmuneCenter
