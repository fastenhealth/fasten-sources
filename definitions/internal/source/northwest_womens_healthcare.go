...
func GetSourceNorthwestWomensHealthcare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthwestWomensHealthcare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Northwest Womens Healthcare"
	sourceDef.SourceType = pkg.SourceTypeNorthwestWomensHealthcare
	sourceDef.BrandLogo = "northwest-womens-healthcare.jpg"
	sourceDef.PatientAccessUrl = "https://www.nwwomenshealth.com/"
