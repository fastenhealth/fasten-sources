...
func GetSourceAdultPediatricOrthopaedicSpeci(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdultPediatricOrthopaedicSpeci]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Adult  Pediatric Orthopaedic Speci"
	sourceDef.SourceType = pkg.SourceTypeAdultPediatricOrthopaedicSpeci
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.posocortho.com/"
