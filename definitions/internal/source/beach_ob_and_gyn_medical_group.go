...
func GetSourceBeachObAndGynMedicalGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBeachObAndGynMedicalGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Beach OB & Gyn Medical Group"
	sourceDef.SourceType = pkg.SourceTypeBeachObAndGynMedicalGroup
	sourceDef.PatientAccessUrl = "https://www.beachobgyn.com/"
