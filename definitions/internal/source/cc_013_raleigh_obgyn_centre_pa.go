...
func GetSourceCc013RaleighObgynCentrePa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc013RaleighObgynCentrePa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC013RALEIGH OBGYN CENTRE PA"
	sourceDef.SourceType = pkg.SourceTypeCc013RaleighObgynCentrePa
