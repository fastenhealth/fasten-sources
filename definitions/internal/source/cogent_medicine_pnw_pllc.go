...
func GetSourceCogentMedicinePnwPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCogentMedicinePnwPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "COGENT MEDICINE PNW PLLC"
	sourceDef.SourceType = pkg.SourceTypeCogentMedicinePnwPllc
