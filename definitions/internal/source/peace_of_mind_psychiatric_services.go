...
func GetSourcePeaceOfMindPsychiatricServices(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePeaceOfMindPsychiatricServices]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Peace of Mind Psychiatric Services"
	sourceDef.SourceType = pkg.SourceTypePeaceOfMindPsychiatricServices
