...
func GetSourceKidneyDiseaseAndHypertensionAssociatesInc8948(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKidneyDiseaseAndHypertensionAssociatesInc8948]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Kidney Disease and Hypertension Associates INC8948"
	sourceDef.SourceType = pkg.SourceTypeKidneyDiseaseAndHypertensionAssociatesInc8948
