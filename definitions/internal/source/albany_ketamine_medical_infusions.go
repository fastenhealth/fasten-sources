...
func GetSourceAlbanyKetamineMedicalInfusions(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlbanyKetamineMedicalInfusions]; clientIdOk {
	...
	sourceDef.Category = []string{"261QI0500X"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1861065856"}}
