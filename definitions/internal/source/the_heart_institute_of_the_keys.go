...
func GetSourceTheHeartInstituteOfTheKeys(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheHeartInstituteOfTheKeys]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Heart Institute of the Keys"
	sourceDef.SourceType = pkg.SourceTypeTheHeartInstituteOfTheKeys
