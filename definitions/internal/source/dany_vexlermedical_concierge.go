...
func GetSourceDanyVexlermedicalConcierge(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDanyVexlermedicalConcierge]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dany VexlerMedical Concierge"
	sourceDef.SourceType = pkg.SourceTypeDanyVexlermedicalConcierge
