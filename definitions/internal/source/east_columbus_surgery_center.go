...
func GetSourceEastColumbusSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEastColumbusSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "East Columbus Surgery Center"
	sourceDef.SourceType = pkg.SourceTypeEastColumbusSurgeryCenter
	sourceDef.PatientAccessUrl = "http://www.ecsc.md/"
