...
func GetSourceBaptistHealthMedicalGroup1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBaptistHealthMedicalGroup1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeBaptistHealthMedicalGroup1
