...
func GetSourceCc017MidatlanticWomensCareImagingCenters(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc017MidatlanticWomensCareImagingCenters]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC017MIDATLANTIC WOMENS CARE IMAGING CENTERS"
	sourceDef.SourceType = pkg.SourceTypeCc017MidatlanticWomensCareImagingCenters
