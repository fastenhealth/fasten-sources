...
func GetSourceTheSouthBendClinicLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Category = []string{"261Q00000X", "261QM1300X", "261QU0200X", "291U00000X", "3336C0002X"}
	sourceDef.Aliases = []string{"THE SOUTH BEND CLINIC LABORATORY", "THE SOUTH BEND CLINIC PHARMACY AT DAY RD"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1174187553", "1528659216", "1538257167"}}
