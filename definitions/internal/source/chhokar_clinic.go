...
func GetSourceChhokarClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeChhokarClinic]; clientIdOk {
	...
	sourceDef.Aliases = []string{"CHHOKAR & CHHOKAR MD'S PC"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1619079100"}}
	sourceDef.PatientAccessUrl = "http://www.chhokarclinic.com/"
