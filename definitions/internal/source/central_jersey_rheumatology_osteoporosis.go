...
func GetSourceCentralJerseyRheumatologyOsteoporosis(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCentralJerseyRheumatologyOsteoporosis]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Central Jersey Rheumatology Osteoporosis"
	sourceDef.SourceType = pkg.SourceTypeCentralJerseyRheumatologyOsteoporosis
