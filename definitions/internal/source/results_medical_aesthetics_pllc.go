...
func GetSourceResultsMedicalAestheticsPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeResultsMedicalAestheticsPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "RESULTS MEDICAL AESTHETICS PLLC"
	sourceDef.SourceType = pkg.SourceTypeResultsMedicalAestheticsPllc
