...
func GetSourceBreatheEasyAllergyAsthma(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBreatheEasyAllergyAsthma]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Breathe Easy Allergy  Asthma"
	sourceDef.SourceType = pkg.SourceTypeBreatheEasyAllergyAsthma
