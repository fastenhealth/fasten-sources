...
func GetSourceCc009NorthwestAssociatesForWomensHealthcare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc009NorthwestAssociatesForWomensHealthcare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC009NORTHWEST ASSOCIATES FOR WOMENS HEALTHCARE"
	sourceDef.SourceType = pkg.SourceTypeCc009NorthwestAssociatesForWomensHealthcare
