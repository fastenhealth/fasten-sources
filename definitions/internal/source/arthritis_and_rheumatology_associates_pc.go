...
func GetSourceArthritisAndRheumatologyAssociatesPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeArthritisAndRheumatologyAssociatesPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Arthritis & Rheumatology Associates PC"
	sourceDef.SourceType = pkg.SourceTypeArthritisAndRheumatologyAssociatesPc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.yelp.com/biz/arthritis-and-rheumatology-pc-east-stroudsburg"
