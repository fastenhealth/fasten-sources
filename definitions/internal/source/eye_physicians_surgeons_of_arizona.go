...
func GetSourceEyePhysiciansSurgeonsOfArizona(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyePhysiciansSurgeonsOfArizona]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Eye Physicians Surgeons of Arizona"
	sourceDef.SourceType = pkg.SourceTypeEyePhysiciansSurgeonsOfArizona
