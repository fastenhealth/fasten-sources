...
func GetSourceElRioHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.RegistrationEndpoint = "https://epicproxy.et1240.epichosted.com/FHIRProxy/oauth2/register"
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeElRioHealth]; clientIdOk {
