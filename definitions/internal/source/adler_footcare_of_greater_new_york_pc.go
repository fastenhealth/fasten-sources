...
func GetSourceAdlerFootcareOfGreaterNewYorkPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdlerFootcareOfGreaterNewYorkPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Adler Footcare of Greater New York PC"
	sourceDef.SourceType = pkg.SourceTypeAdlerFootcareOfGreaterNewYorkPc
