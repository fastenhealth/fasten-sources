...
func GetSourceWesternCommunityHealthResources(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Category = []string{"251K00000X", "251S00000X"}
	sourceDef.Aliases = []string{"WESTERN COMMUNITY HEALTH RESOURCES"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1134342306", "1215352679", "1720145188", "1972055036"}}
