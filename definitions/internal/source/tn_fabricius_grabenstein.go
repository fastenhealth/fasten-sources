...
func GetSourceTnFabriciusGrabenstein(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTnFabriciusGrabenstein]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TN  Fabricius  Grabenstein"
	sourceDef.SourceType = pkg.SourceTypeTnFabriciusGrabenstein
