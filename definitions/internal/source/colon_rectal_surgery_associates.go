...
func GetSourceColonRectalSurgeryAssociates(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeColonRectalSurgeryAssociates]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "http://www.aikencolonandrectalsurgery.com"
