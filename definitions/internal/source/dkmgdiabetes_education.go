...
func GetSourceDkmgdiabetesEducation(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDkmgdiabetesEducation]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "DKMGDIABETES EDUCATION"
	sourceDef.SourceType = pkg.SourceTypeDkmgdiabetesEducation
