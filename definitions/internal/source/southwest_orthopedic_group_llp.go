...
func GetSourceSouthwestOrthopedicGroupLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthwestOrthopedicGroupLlp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Southwest Orthopedic Group LLP"
	sourceDef.SourceType = pkg.SourceTypeSouthwestOrthopedicGroupLlp
