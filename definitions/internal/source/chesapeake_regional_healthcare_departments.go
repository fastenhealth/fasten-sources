...
func GetSourceChesapeakeRegionalHealthcareDepartments(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeChesapeakeRegionalHealthcareDepartments]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Chesapeake Regional Healthcare Departments"
	sourceDef.SourceType = pkg.SourceTypeChesapeakeRegionalHealthcareDepartments
