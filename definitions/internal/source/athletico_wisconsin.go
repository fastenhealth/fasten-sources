...
func GetSourceAthleticoWisconsin(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAthleticoWisconsin]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Athletico Wisconsin"
	sourceDef.SourceType = pkg.SourceTypeAthleticoWisconsin
	sourceDef.BrandLogo = "athletico-wisconsin.svg"
	sourceDef.PatientAccessUrl = "https://www.athletico.com/regions/wisconsin/"
