...
func GetSourceCenterForAdvancedPainManagement1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCenterForAdvancedPainManagement1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeCenterForAdvancedPainManagement1
