...
func GetSourceQuantumPersonalHomeCarePc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeQuantumPersonalHomeCarePc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "QUANTUM PERSONAL HOME CARE PC"
	sourceDef.SourceType = pkg.SourceTypeQuantumPersonalHomeCarePc
