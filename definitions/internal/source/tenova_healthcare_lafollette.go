...
func GetSourceTenovaHealthcareLafollette(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTenovaHealthcareLafollette]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tenova Healthcare  LaFollette"
	sourceDef.SourceType = pkg.SourceTypeTenovaHealthcareLafollette
