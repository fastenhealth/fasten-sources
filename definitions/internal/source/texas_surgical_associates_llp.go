...
func GetSourceTexasSurgicalAssociatesLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTexasSurgicalAssociatesLlp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Texas Surgical Associates LLP"
	sourceDef.SourceType = pkg.SourceTypeTexasSurgicalAssociatesLlp
	sourceDef.PatientAccessUrl = "http://www.swtsa.com/"
