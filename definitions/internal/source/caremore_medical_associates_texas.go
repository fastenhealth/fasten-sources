...
func GetSourceCaremoreMedicalAssociatesTexas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaremoreMedicalAssociatesTexas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "CareMore Medical Associates - Texas"
	sourceDef.SourceType = pkg.SourceTypeCaremoreMedicalAssociatesTexas
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "caremore-medical-associates-texas.svg"
