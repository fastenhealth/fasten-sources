...
func GetSourceSacredHeartPediatricsDetroit(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSacredHeartPediatricsDetroit]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sacred Heart Pediatrics Detroit"
	sourceDef.SourceType = pkg.SourceTypeSacredHeartPediatricsDetroit
