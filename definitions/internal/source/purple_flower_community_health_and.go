...
func GetSourcePurpleFlowerCommunityHealthAnd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePurpleFlowerCommunityHealthAnd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Purple Flower Community Health and"
	sourceDef.SourceType = pkg.SourceTypePurpleFlowerCommunityHealthAnd
