...
func GetSourceFortWorthInfectiousDisease(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFortWorthInfectiousDisease]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FORT WORTH INFECTIOUS DISEASE"
	sourceDef.SourceType = pkg.SourceTypeFortWorthInfectiousDisease
