...
func GetSourceUsaDoctorsOnWheelsPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUsaDoctorsOnWheelsPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "USA DOCTORS ON WHEELS PLLC"
	sourceDef.SourceType = pkg.SourceTypeUsaDoctorsOnWheelsPllc
