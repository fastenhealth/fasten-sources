...
func GetSourceCc004PhysiciansForWomenOfGreensboro(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc004PhysiciansForWomenOfGreensboro]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC004Physicians for Women of Greensboro"
	sourceDef.SourceType = pkg.SourceTypeCc004PhysiciansForWomenOfGreensboro
