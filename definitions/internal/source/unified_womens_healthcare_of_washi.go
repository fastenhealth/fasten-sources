...
func GetSourceUnifiedWomensHealthcareOfWashi(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUnifiedWomensHealthcareOfWashi]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Unified Womens Healthcare of Washi"
	sourceDef.SourceType = pkg.SourceTypeUnifiedWomensHealthcareOfWashi
