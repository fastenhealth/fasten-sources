...
func GetSourceWaianaeCoastCompHealthCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWaianaeCoastCompHealthCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Waianae Coast Comp Health Center"
	sourceDef.SourceType = pkg.SourceTypeWaianaeCoastCompHealthCenter
	sourceDef.BrandLogo = "waianae-coast-comp-health-center.jpeg"
