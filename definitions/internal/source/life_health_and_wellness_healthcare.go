...
func GetSourceLifeHealthAndWellnessHealthcare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLifeHealthAndWellnessHealthcare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Life Health and Wellness HealthCare"
	sourceDef.SourceType = pkg.SourceTypeLifeHealthAndWellnessHealthcare
