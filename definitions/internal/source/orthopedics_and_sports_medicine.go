...
func GetSourceOrthopedicsAndSportsMedicine(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthopedicsAndSportsMedicine]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Orthopedics and Sports Medicine"
	sourceDef.SourceType = pkg.SourceTypeOrthopedicsAndSportsMedicine
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.frederickhealth.org/services/orthopedics-sports-medicine/"
