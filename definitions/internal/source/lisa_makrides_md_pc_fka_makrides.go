...
func GetSourceLisaMakridesMdPcFkaMakrides(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLisaMakridesMdPcFkaMakrides]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lisa Makrides MD PC FKA Makrides"
	sourceDef.SourceType = pkg.SourceTypeLisaMakridesMdPcFkaMakrides
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.lisamakridesmdpc.com"
