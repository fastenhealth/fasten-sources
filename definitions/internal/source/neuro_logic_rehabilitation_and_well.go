...
func GetSourceNeuroLogicRehabilitationAndWell(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNeuroLogicRehabilitationAndWell]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Neuro Logic Rehabilitation And Well"
	sourceDef.SourceType = pkg.SourceTypeNeuroLogicRehabilitationAndWell
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://neurologicrehab.com"
