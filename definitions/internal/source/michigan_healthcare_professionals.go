...
func GetSourceMichiganHealthcareProfessionals(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMichiganHealthcareProfessionals]; clientIdOk {
	...
	sourceDef.Category = []string{"332B00000X", "332S00000X", "261QU0200X", "261QS1200X"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1821464348", "1497178867", "1720369358", "1093107682"}}
