...
func GetSourceDonaldCassadayMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDonaldCassadayMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Donald Cassaday MD"
	sourceDef.SourceType = pkg.SourceTypeDonaldCassadayMd
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://drcassaday.health/"
