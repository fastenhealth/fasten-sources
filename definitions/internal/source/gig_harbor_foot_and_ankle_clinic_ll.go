...
func GetSourceGigHarborFootAndAnkleClinicLl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGigHarborFootAndAnkleClinicLl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Gig Harbor Foot and Ankle Clinic LL"
	sourceDef.SourceType = pkg.SourceTypeGigHarborFootAndAnkleClinicLl
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://gigharborfootandankleclinic.com"
