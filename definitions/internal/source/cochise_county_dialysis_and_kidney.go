...
func GetSourceCochiseCountyDialysisAndKidney(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCochiseCountyDialysisAndKidney]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Cochise County Dialysis and Kidney"
	sourceDef.SourceType = pkg.SourceTypeCochiseCountyDialysisAndKidney
