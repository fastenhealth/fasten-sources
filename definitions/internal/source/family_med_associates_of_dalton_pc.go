...
func GetSourceFamilyMedAssociatesOfDaltonPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyMedAssociatesOfDaltonPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Family Med Associates of Dalton PC"
	sourceDef.SourceType = pkg.SourceTypeFamilyMedAssociatesOfDaltonPc
