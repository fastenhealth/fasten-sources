...
func GetSourceAimsOutpatientSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAimsOutpatientSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "AIMS OUTPATIENT SURGERY CENTER"
	sourceDef.SourceType = pkg.SourceTypeAimsOutpatientSurgeryCenter
