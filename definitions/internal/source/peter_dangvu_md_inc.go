...
func GetSourcePeterDangvuMdInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePeterDangvuMdInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Peter Dangvu MD Inc"
	sourceDef.SourceType = pkg.SourceTypePeterDangvuMdInc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://hoagmedicalgroup.com/"
