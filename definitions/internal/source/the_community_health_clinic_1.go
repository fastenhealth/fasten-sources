...
func GetSourceTheCommunityHealthClinic1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheCommunityHealthClinic1]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Community Health Clinic"
	sourceDef.SourceType = pkg.SourceTypeTheCommunityHealthClinic1
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "the-community-health-clinic.png"
	sourceDef.PatientAccessUrl = "https://www.facebook.com/CommunityHealthProviderAlliance/"
