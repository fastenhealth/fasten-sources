...
func GetSourceCc209WomensHealthSpecialistsIiLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc209WomensHealthSpecialistsIiLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC209WOMENS HEALTH SPECIALISTS II LLC"
	sourceDef.SourceType = pkg.SourceTypeCc209WomensHealthSpecialistsIiLlc
