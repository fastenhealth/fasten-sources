...
func GetSourceDetroitWayneCtyHlthAuthrty(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDetroitWayneCtyHlthAuthrty]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Detroit Wayne Cty Hlth Authrty"
	sourceDef.SourceType = pkg.SourceTypeDetroitWayneCtyHlthAuthrty
