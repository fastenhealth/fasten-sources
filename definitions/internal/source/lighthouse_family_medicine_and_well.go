...
func GetSourceLighthouseFamilyMedicineAndWell(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLighthouseFamilyMedicineAndWell]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lighthouse Family Medicine and Well"
	sourceDef.SourceType = pkg.SourceTypeLighthouseFamilyMedicineAndWell
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.lighthousefamilydoctors.com"
