...
func GetSourceMinnesotaEndoscopyCenterLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMinnesotaEndoscopyCenterLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Minnesota Endoscopy Center LLC"
	sourceDef.SourceType = pkg.SourceTypeMinnesotaEndoscopyCenterLlc
