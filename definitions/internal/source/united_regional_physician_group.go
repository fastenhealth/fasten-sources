...
func GetSourceUnitedRegionalPhysicianGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUnitedRegionalPhysicianGroup]; clientIdOk {
	...
	sourceDef.Category = []string{"207R00000X", "207T00000X", "207X00000X", "208600000X", "208G00000X", "207Q00000X"}
