...
func GetSourceGuadalupeRegionalMedicalGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGuadalupeRegionalMedicalGroup]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "http://www.grmedgroup.com"
