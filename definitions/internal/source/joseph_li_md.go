...
func GetSourceJosephLiMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJosephLiMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Joseph Li MD"
	sourceDef.SourceType = pkg.SourceTypeJosephLiMd
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "joseph-li-md.svg"
	sourceDef.PatientAccessUrl = "https://www.huntingtonhealth.org/physicians/joseph-y-li-md/"
