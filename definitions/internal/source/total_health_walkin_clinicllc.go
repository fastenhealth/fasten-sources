...
func GetSourceTotalHealthWalkinClinicllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTotalHealthWalkinClinicllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Total Health Walkin ClinicLLC"
	sourceDef.SourceType = pkg.SourceTypeTotalHealthWalkinClinicllc
