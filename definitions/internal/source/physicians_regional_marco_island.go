...
func GetSourcePhysiciansRegionalMarcoIsland(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePhysiciansRegionalMarcoIsland]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Physicians Regional Marco Island"
	sourceDef.SourceType = pkg.SourceTypePhysiciansRegionalMarcoIsland
