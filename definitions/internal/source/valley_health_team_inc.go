...
func GetSourceValleyHealthTeamInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeValleyHealthTeamInc]; clientIdOk {
	...
	sourceDef.Aliases = []string{"BISHOP COMMUNITY HEALTH CENTER", "KERMAN DENTAL CENTER", "KERMAN UNIFIED SCHOOL DISTRICT COMMUNITY HEALTH CENTER", "KINGSBURG COMMUNITY HEALTH CENTER", "VHT PHARMACY", "CLOVIS COMMUNITY HEALTH CENTER"}
