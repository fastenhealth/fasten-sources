...
func GetSourceTheBirthPlaceeasyAccessWomensClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheBirthPlaceeasyAccessWomensClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Birth PlaceEasy Access Womens Clinic"
	sourceDef.SourceType = pkg.SourceTypeTheBirthPlaceeasyAccessWomensClinic
