...
func GetSourceBicityMedicalMinistriesInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBicityMedicalMinistriesInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BiCity Medical Ministries Inc"
	sourceDef.SourceType = pkg.SourceTypeBicityMedicalMinistriesInc
