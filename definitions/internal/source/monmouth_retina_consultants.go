...
func GetSourceMonmouthRetinaConsultants(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMonmouthRetinaConsultants]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Monmouth Retina Consultants"
	sourceDef.SourceType = pkg.SourceTypeMonmouthRetinaConsultants
	sourceDef.PatientAccessUrl = "https://www.monmouthretina.com/"
