...
func GetSourceCarlosHernandezMdPaDbaSo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCarlosHernandezMdPaDbaSo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CARLOS HERNANDEZ MD PA DBA SO"
	sourceDef.SourceType = pkg.SourceTypeCarlosHernandezMdPaDbaSo
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://southwesternwomensclinic.com"
