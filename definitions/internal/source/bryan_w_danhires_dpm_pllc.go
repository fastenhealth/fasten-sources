...
func GetSourceBryanWDanhiresDpmPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBryanWDanhiresDpmPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Bryan W Danhires DPM PLLC"
	sourceDef.SourceType = pkg.SourceTypeBryanWDanhiresDpmPllc
