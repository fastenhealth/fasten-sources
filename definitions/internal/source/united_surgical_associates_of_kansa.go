...
func GetSourceUnitedSurgicalAssociatesOfKansa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUnitedSurgicalAssociatesOfKansa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "United Surgical Associates of Kansa"
	sourceDef.SourceType = pkg.SourceTypeUnitedSurgicalAssociatesOfKansa
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://usa-kc.com"
