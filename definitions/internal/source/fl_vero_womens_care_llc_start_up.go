...
func GetSourceFlVeroWomensCareLlcStartUp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFlVeroWomensCareLlcStartUp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FL  VERO WOMENS CARE LLC  Start Up"
	sourceDef.SourceType = pkg.SourceTypeFlVeroWomensCareLlcStartUp
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.verowomencare.com"
