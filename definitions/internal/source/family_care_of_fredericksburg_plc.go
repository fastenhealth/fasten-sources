...
func GetSourceFamilyCareOfFredericksburgPlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyCareOfFredericksburgPlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Family Care of Fredericksburg PLC"
	sourceDef.SourceType = pkg.SourceTypeFamilyCareOfFredericksburgPlc
