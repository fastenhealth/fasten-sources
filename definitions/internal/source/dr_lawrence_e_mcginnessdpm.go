...
func GetSourceDrLawrenceEMcginnessdpm(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrLawrenceEMcginnessdpm]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dr Lawrence E McGinnessDPM"
	sourceDef.SourceType = pkg.SourceTypeDrLawrenceEMcginnessdpm
