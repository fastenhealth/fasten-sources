...
func GetSourceTheEyeCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheEyeCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "THE EYE CENTER"
	sourceDef.SourceType = pkg.SourceTypeTheEyeCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "http://www.lauramullermd.com/"
