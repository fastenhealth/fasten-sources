...
func GetSourceGynecologicAndReconstructiveSurgery(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGynecologicAndReconstructiveSurgery]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Gynecologic And Reconstructive Surgery"
	sourceDef.SourceType = pkg.SourceTypeGynecologicAndReconstructiveSurgery
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "gynecologic-and-reconstructive-surgery.jpg"
	sourceDef.PatientAccessUrl = "https://gynecologicsurgery.com/"
