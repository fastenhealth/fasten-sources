...
func GetSourceChristusHealthClinicIrving(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeChristusHealthClinicIrving]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CHRISTUS Health Clinic Irving"
	sourceDef.SourceType = pkg.SourceTypeChristusHealthClinicIrving
