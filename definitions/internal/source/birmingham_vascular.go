...
func GetSourceBirminghamVascular(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBirminghamVascular]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://birminghamvascularassociatespc.com/"
