...
func GetSourceUzimaRejuvenationStationLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUzimaRejuvenationStationLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "UZIMA REJUVENATION STATION LLC"
	sourceDef.SourceType = pkg.SourceTypeUzimaRejuvenationStationLlc
