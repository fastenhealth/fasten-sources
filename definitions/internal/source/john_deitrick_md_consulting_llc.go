...
func GetSourceJohnDeitrickMdConsultingLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJohnDeitrickMdConsultingLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "John Deitrick MD Consulting LLC"
	sourceDef.SourceType = pkg.SourceTypeJohnDeitrickMdConsultingLlc
