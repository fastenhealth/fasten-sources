...
func GetSourceAntonioPizarroMdApmc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAntonioPizarroMdApmc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Antonio Pizarro MD APMC"
	sourceDef.SourceType = pkg.SourceTypeAntonioPizarroMdApmc
