...
func GetSourceRushUniversityMedicalCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Category = []string{"174400000X", "207R00000X", "207V00000X", "207VM0101X", "208000000X", "2085N0700X", "2085R0202X", "2085R0204X", "261Q00000X", "281P00000X", "282N00000X", "282NC0060X", "282NC2000X", "363L00000X"}
	sourceDef.Aliases = []string{"RADIOLOGY SERVICES", "RUSH COLLEGE OF NURSING SUE GIN HEALTH CENTER AT OAKLEY SQUARE"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1093036980", "1154382893", "1184269425", "1316067994", "1356891618", "1396184669", "1396906103", "1699921007", "1790116176", "1902873003"}}
