...
func GetSourceRushUniversityMedicalCenter(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeRushUniversityMedicalCenter
