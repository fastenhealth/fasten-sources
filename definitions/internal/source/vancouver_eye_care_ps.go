...
func GetSourceVancouverEyeCarePs(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVancouverEyeCarePs]; clientIdOk {
	...
	sourceDef.Category = []string{"261QA1903X", "332H00000X", "207W00000X"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1669427043", "1356375042"}}
