...
func GetSourceVirginiaSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVirginiaSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Virginia Surgery Center"
	sourceDef.SourceType = pkg.SourceTypeVirginiaSurgeryCenter
	sourceDef.PatientAccessUrl = "https://www.virginiaeyeconsultants.com/"
