...
func GetSourceEastsideHealthcareOfChicagoHeig(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEastsideHealthcareOfChicagoHeig]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Eastside Healthcare of Chicago Heig"
	sourceDef.SourceType = pkg.SourceTypeEastsideHealthcareOfChicagoHeig
