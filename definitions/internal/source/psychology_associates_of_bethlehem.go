...
func GetSourcePsychologyAssociatesOfBethlehem(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePsychologyAssociatesOfBethlehem]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Psychology Associates of Bethlehem"
	sourceDef.SourceType = pkg.SourceTypePsychologyAssociatesOfBethlehem
