...
func GetSourceMinneapolisEndoscopyAscLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMinneapolisEndoscopyAscLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Minneapolis Endoscopy ASC LLC"
	sourceDef.SourceType = pkg.SourceTypeMinneapolisEndoscopyAscLlc
