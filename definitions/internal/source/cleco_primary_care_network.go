...
func GetSourceClecoPrimaryCareNetwork(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeClecoPrimaryCareNetwork]; clientIdOk {
	...
	sourceDef.Aliases = []string{"KINGS MOUNTAIN MEDICAL CENTER", "UPPER CLEVELAND MEDICAL CENTER", "CLECO PRIMARY CARE NETWORK", "CLECO MEDICAL CENTER"}
