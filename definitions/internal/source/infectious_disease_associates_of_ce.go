...
func GetSourceInfectiousDiseaseAssociatesOfCe(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeInfectiousDiseaseAssociatesOfCe]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Infectious Disease Associates of Ce"
	sourceDef.SourceType = pkg.SourceTypeInfectiousDiseaseAssociatesOfCe
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.idvirginia.com"
