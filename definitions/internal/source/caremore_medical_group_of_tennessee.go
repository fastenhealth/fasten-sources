...
func GetSourceCaremoreMedicalGroupOfTennessee(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaremoreMedicalGroupOfTennessee]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "CareMore Medical Group Of Tennessee"
	sourceDef.SourceType = pkg.SourceTypeCaremoreMedicalGroupOfTennessee
	sourceDef.BrandLogo = "caremore-medical-group-of-tennessee.svg"
