...
func GetSourceLakeNormanMedicalGroupHeartAndVascularMooresville(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLakeNormanMedicalGroupHeartAndVascularMooresville]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lake Norman Medical Group Heart and Vascular Mooresville"
	sourceDef.SourceType = pkg.SourceTypeLakeNormanMedicalGroupHeartAndVascularMooresville
