...
func GetSourceMedicalCareCoordination(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMedicalCareCoordination]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://hsvsnyc.org/"
