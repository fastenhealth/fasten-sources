...
func GetSourceDeanzaObstetricsAndGynecologyMedGrp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDeanzaObstetricsAndGynecologyMedGrp]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.arrowheadregional.org/services/maternity-services/"
