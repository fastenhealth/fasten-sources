...
func GetSourceCardiovascularInstituteOfGeorgia(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCardiovascularInstituteOfGeorgia]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Cardiovascular Institute of Georgia"
	sourceDef.SourceType = pkg.SourceTypeCardiovascularInstituteOfGeorgia
