...
func GetSourceCherryHillsMidwiferyObstetricsGynecology(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCherryHillsMidwiferyObstetricsGynecology]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Cherry Hills Midwifery Obstetrics  Gynecology"
	sourceDef.SourceType = pkg.SourceTypeCherryHillsMidwiferyObstetricsGynecology
