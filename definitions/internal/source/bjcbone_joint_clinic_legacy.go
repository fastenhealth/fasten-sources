...
func GetSourceBjcboneJointClinicLegacy(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBjcboneJointClinicLegacy]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BJCBone  Joint Clinic Legacy"
	sourceDef.SourceType = pkg.SourceTypeBjcboneJointClinicLegacy
