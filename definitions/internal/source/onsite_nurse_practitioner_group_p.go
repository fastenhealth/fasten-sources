...
func GetSourceOnsiteNursePractitionerGroupP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOnsiteNursePractitionerGroupP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ONSITE NURSE PRACTITIONER GROUP P"
	sourceDef.SourceType = pkg.SourceTypeOnsiteNursePractitionerGroupP
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.accessmedhealthcare.com"
