...
func GetSourceVigoCountyCommunityCorrections(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVigoCountyCommunityCorrections]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Vigo County Community Corrections"
	sourceDef.SourceType = pkg.SourceTypeVigoCountyCommunityCorrections
