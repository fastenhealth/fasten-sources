...
func GetSourceHunterdonPelvicHealthProgram(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHunterdonPelvicHealthProgram]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Hunterdon Pelvic Health Program"
	sourceDef.SourceType = pkg.SourceTypeHunterdonPelvicHealthProgram
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "hunterdon-behavioral-health.svg"
	sourceDef.PatientAccessUrl = "https://www.hunterdonhealthcarepartners.org/"
