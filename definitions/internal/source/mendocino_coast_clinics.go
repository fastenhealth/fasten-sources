...
func GetSourceMendocinoCoastClinics(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMendocinoCoastClinics]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Mendocino Coast Clinics"
	sourceDef.SourceType = pkg.SourceTypeMendocinoCoastClinics
	sourceDef.PatientAccessUrl = "https://mendocinocoastclinics.org/"
