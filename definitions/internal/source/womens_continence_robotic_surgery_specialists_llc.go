...
func GetSourceWomensContinenceRoboticSurgerySpecialistsLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomensContinenceRoboticSurgerySpecialistsLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "WOMENS CONTINENCE  ROBOTIC SURGERY SPECIALISTS LLC"
	sourceDef.SourceType = pkg.SourceTypeWomensContinenceRoboticSurgerySpecialistsLlc
