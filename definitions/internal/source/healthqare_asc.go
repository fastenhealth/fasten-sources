...
func GetSourceHealthqareAsc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHealthqareAsc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "HealthQare ASC"
	sourceDef.SourceType = pkg.SourceTypeHealthqareAsc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.azuravascularcare.com/center/healthqare-associates/"
