...
func GetSourceUrologySpecialistsOfNevada(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUrologySpecialistsOfNevada]; clientIdOk {
	...
	sourceDef.Aliases = []string{"UROLOGY SPECIALISTS OF NEVADA"}
