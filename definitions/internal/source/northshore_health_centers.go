...
func GetSourceNorthshoreHealthCenters(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthshoreHealthCenters]; clientIdOk {
	...
	sourceDef.Category = []string{"1041C0700X", "207V00000X", "208000000X", "207Q00000X"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1497996839"}}
