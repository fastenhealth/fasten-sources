...
func GetSourceMichaelJLemmersMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMichaelJLemmersMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Michael J Lemmers MD"
	sourceDef.SourceType = pkg.SourceTypeMichaelJLemmersMd
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.legacyhealth.org/providers/michael-lemmers"
