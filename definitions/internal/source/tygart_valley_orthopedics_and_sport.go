...
func GetSourceTygartValleyOrthopedicsAndSport(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTygartValleyOrthopedicsAndSport]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tygart Valley Orthopedics and Sport"
	sourceDef.SourceType = pkg.SourceTypeTygartValleyOrthopedicsAndSport
