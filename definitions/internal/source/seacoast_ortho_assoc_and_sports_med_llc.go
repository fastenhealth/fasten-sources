...
func GetSourceSeacoastOrthoAssocAndSportsMedLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSeacoastOrthoAssocAndSportsMedLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Seacoast Ortho Assoc & Sports Med LLC"
	sourceDef.SourceType = pkg.SourceTypeSeacoastOrthoAssocAndSportsMedLlc
	sourceDef.BrandLogo = "seacoast-ortho-assoc-and-sports-med-llc.jpg"
	sourceDef.PatientAccessUrl = "https://www.seacoastorthopedics.com/"
