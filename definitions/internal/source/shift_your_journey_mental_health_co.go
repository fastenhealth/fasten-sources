...
func GetSourceShiftYourJourneyMentalHealthCo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeShiftYourJourneyMentalHealthCo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SHIFT YOUR JOURNEY MENTAL HEALTH CO"
	sourceDef.SourceType = pkg.SourceTypeShiftYourJourneyMentalHealthCo
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.shiftyourjourney.com"
