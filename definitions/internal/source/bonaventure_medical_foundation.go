...
func GetSourceBonaventureMedicalFoundation(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBonaventureMedicalFoundation]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BONAVENTURE MEDICAL FOUNDATION"
	sourceDef.SourceType = pkg.SourceTypeBonaventureMedicalFoundation
