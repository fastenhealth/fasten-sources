...
func GetSourceHeadacheSpecialistsOfOklahomaP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHeadacheSpecialistsOfOklahomaP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "HEADACHE SPECIALISTS OF OKLAHOMA P"
	sourceDef.SourceType = pkg.SourceTypeHeadacheSpecialistsOfOklahomaP
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://headachespecialistsofoklahoma.com/"
