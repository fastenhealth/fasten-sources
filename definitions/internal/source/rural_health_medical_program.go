...
func GetSourceRuralHealthMedicalProgram(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRuralHealthMedicalProgram]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Rural Health Medical Program"
	sourceDef.SourceType = pkg.SourceTypeRuralHealthMedicalProgram
