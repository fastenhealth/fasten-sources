...
func GetSourceMumtazMumtazIncDbaAlpharett(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMumtazMumtazIncDbaAlpharett]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MUMTAZ  MUMTAZ INC DBA Alpharett"
	sourceDef.SourceType = pkg.SourceTypeMumtazMumtazIncDbaAlpharett
