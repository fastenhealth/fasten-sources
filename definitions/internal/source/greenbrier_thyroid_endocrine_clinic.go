...
func GetSourceGreenbrierThyroidEndocrineClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGreenbrierThyroidEndocrineClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Greenbrier Thyroid  Endocrine Clinic"
	sourceDef.SourceType = pkg.SourceTypeGreenbrierThyroidEndocrineClinic
