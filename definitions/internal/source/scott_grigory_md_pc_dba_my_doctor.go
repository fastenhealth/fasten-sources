...
func GetSourceScottGrigoryMdPcDbaMyDoctor(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeScottGrigoryMdPcDbaMyDoctor]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Scott Grigory MD PC dba My Doctor"
	sourceDef.SourceType = pkg.SourceTypeScottGrigoryMdPcDbaMyDoctor
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.mydoctorpediatrics.com"
