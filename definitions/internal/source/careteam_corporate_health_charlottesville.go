...
func GetSourceCareteamCorporateHealthCharlottesville(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCareteamCorporateHealthCharlottesville]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CareTeam Corporate Health Charlottesville"
	sourceDef.SourceType = pkg.SourceTypeCareteamCorporateHealthCharlottesville
