...
func GetSourceAdvancedEndoscopyAndSurgicalCenterLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdvancedEndoscopyAndSurgicalCenterLlc]; clientIdOk {
	...
	sourceDef.Aliases = []string{"ADVANCED ENDOSCOPY & SURGICAL CENTER"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1114965803"}}
