...
func GetSourceNcpLakeCharlesAsc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNcpLakeCharlesAsc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "NCP Lake Charles ASC"
	sourceDef.SourceType = pkg.SourceTypeNcpLakeCharlesAsc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.lakecharlescathlab.com/"
