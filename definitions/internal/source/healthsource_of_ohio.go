...
func GetSourceHealthsourceOfOhio(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHealthsourceOfOhio]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "HealthSource Of Ohio"
	sourceDef.SourceType = pkg.SourceTypeHealthsourceOfOhio
	sourceDef.PatientAccessUrl = "https://www.healthsourceofohio.org/"
