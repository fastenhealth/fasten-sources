...
func GetSourceYoungHeartsOfYumaInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeYoungHeartsOfYumaInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Young Hearts of Yuma Inc"
	sourceDef.SourceType = pkg.SourceTypeYoungHeartsOfYumaInc
