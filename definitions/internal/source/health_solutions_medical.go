...
func GetSourceHealthSolutionsMedical(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHealthSolutionsMedical]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Health Solutions Medical"
	sourceDef.SourceType = pkg.SourceTypeHealthSolutionsMedical
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "health-solutions-medical.jpg"
	sourceDef.PatientAccessUrl = "https://www.health.solutions"
