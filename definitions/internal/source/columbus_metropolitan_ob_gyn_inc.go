...
func GetSourceColumbusMetropolitanObGynInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeColumbusMetropolitanObGynInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Columbus Metropolitan OB/GYN Inc"
	sourceDef.SourceType = pkg.SourceTypeColumbusMetropolitanObGynInc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "http://columbusmetroobgyn.com"
