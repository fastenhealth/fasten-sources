...
func GetSourceValerieAHiveleyBlatzGnp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeValerieAHiveleyBlatzGnp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Valerie A Hiveley Blatz GNP"
	sourceDef.SourceType = pkg.SourceTypeValerieAHiveleyBlatzGnp
