...
func GetSourceMusickDermatologyAdvancedClinicalSpaLlc(env pkg.FastenLighthouseEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = pkg.SourceTypeMusickDermatologyAdvancedClinicalSpaLlc
