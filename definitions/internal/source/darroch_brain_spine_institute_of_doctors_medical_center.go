...
func GetSourceDarrochBrainSpineInstituteOfDoctorsMedicalCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDarrochBrainSpineInstituteOfDoctorsMedicalCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Darroch Brain  Spine Institute of Doctors Medical Center"
	sourceDef.SourceType = pkg.SourceTypeDarrochBrainSpineInstituteOfDoctorsMedicalCenter
