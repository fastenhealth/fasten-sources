...
func GetSourceZarineTerpoghosyanMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeZarineTerpoghosyanMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ZARINE TERPOGHOSYAN MD"
	sourceDef.SourceType = pkg.SourceTypeZarineTerpoghosyanMd
