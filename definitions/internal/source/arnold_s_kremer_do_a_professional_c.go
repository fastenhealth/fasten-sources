...
func GetSourceArnoldSKremerDoAProfessionalC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeArnoldSKremerDoAProfessionalC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Arnold S Kremer DO A Professional C"
	sourceDef.SourceType = pkg.SourceTypeArnoldSKremerDoAProfessionalC
