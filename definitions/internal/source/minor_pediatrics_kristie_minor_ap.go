...
func GetSourceMinorPediatricsKristieMinorAp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMinorPediatricsKristieMinorAp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Minor Pediatrics Kristie Minor AP"
	sourceDef.SourceType = pkg.SourceTypeMinorPediatricsKristieMinorAp
