...
func GetSourceWomensCareOfBoyntonBeachLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomensCareOfBoyntonBeachLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "WOMENS CARE OF BOYNTON BEACH LLC"
	sourceDef.SourceType = pkg.SourceTypeWomensCareOfBoyntonBeachLlc
