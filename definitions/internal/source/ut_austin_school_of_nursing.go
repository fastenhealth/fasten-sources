...
func GetSourceUtAustinSchoolOfNursing(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUtAustinSchoolOfNursing]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "UT Austin School of Nursing"
	sourceDef.SourceType = pkg.SourceTypeUtAustinSchoolOfNursing
