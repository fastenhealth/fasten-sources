...
func GetSourceSouthCoastEyeCareCenters(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthCoastEyeCareCenters]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "South Coast Eye Care Centers"
	sourceDef.SourceType = pkg.SourceTypeSouthCoastEyeCareCenters
	sourceDef.Category = []string{"332H00000X"}
	sourceDef.Aliases = []string{}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1518935725", "1942473889"}}
	sourceDef.PatientAccessUrl = "https://www.southcoasteye.com/"
