...
func GetSourceMolaniMedicalGroupAProfessiona(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMolaniMedicalGroupAProfessiona]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MOLANI MEDICAL GROUP A PROFESSIONA"
	sourceDef.SourceType = pkg.SourceTypeMolaniMedicalGroupAProfessiona
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.molanimedicalgroup.com"
