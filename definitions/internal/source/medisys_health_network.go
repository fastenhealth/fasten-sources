...
func GetSourceMedisysHealthNetwork(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeMedisysHealthNetwork
