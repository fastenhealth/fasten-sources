...
func GetSourceMadisonStreetSurgeryCenterLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMadisonStreetSurgeryCenterLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Madison Street Surgery Center LLC"
	sourceDef.SourceType = pkg.SourceTypeMadisonStreetSurgeryCenterLlc
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "madison-street-surgery-center-llc.svg"
