...
func GetSourceMedicalAssociatesOfCambridgeInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMedicalAssociatesOfCambridgeInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Medical Associates Of Cambridge Inc"
	sourceDef.SourceType = pkg.SourceTypeMedicalAssociatesOfCambridgeInc
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "medical-associates-of-cambridge-inc.jpg"
	sourceDef.PatientAccessUrl = "https://www.medicalassociatescare.com/"
