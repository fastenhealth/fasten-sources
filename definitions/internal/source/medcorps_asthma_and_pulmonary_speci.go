...
func GetSourceMedcorpsAsthmaAndPulmonarySpeci(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMedcorpsAsthmaAndPulmonarySpeci]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Medcorps Asthma and Pulmonary Speci"
	sourceDef.SourceType = pkg.SourceTypeMedcorpsAsthmaAndPulmonarySpeci
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.MedCorpsUSA.com"
