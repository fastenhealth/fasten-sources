...
func GetSourceTnChristieCarrFnpSoleProp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTnChristieCarrFnpSoleProp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TN  Christie Carr FNP  SOLE PROP"
	sourceDef.SourceType = pkg.SourceTypeTnChristieCarrFnpSoleProp
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http:// www.carrhealthclinic.com"
