...
func GetSourceLongBeachSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLongBeachSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Long Beach Surgery Center"
	sourceDef.SourceType = pkg.SourceTypeLongBeachSurgeryCenter
	sourceDef.PatientAccessUrl = "https://surgerycenteroflongbeach.com/contact-us/"
