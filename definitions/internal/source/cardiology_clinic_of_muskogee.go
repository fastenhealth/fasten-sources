...
func GetSourceCardiologyClinicOfMuskogee(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCardiologyClinicOfMuskogee]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Cardiology Clinic of Muskogee"
	sourceDef.SourceType = pkg.SourceTypeCardiologyClinicOfMuskogee
