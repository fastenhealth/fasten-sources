...
func GetSourceEyeCareAssociatesInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeCareAssociatesInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Care Associates Inc"
	sourceDef.SourceType = pkg.SourceTypeEyeCareAssociatesInc
	sourceDef.BrandLogo = "eye-care-associates-inc.webp"
	sourceDef.PatientAccessUrl = "https://www.eyecareassociates.com/"
