...
func GetSourceConnecticutKidneyCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeConnecticutKidneyCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Connecticut Kidney Center"
	sourceDef.SourceType = pkg.SourceTypeConnecticutKidneyCenter
	sourceDef.PatientAccessUrl = "https://weikidneyinstitute.org/"
