...
func GetSourceAlamoRanchIntegrativeMedicineP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlamoRanchIntegrativeMedicineP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Alamo Ranch Integrative Medicine P"
	sourceDef.SourceType = pkg.SourceTypeAlamoRanchIntegrativeMedicineP
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.arim-sa.com"
