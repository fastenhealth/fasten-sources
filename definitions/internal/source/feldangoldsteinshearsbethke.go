...
func GetSourceFeldangoldsteinshearsbethke(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFeldangoldsteinshearsbethke]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FeldanGoldsteinShearsBethke"
	sourceDef.SourceType = pkg.SourceTypeFeldangoldsteinshearsbethke
