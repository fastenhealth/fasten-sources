...
func GetSourceNorthShoreEndoscopyCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthShoreEndoscopyCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "North Shore Endoscopy Center"
	sourceDef.SourceType = pkg.SourceTypeNorthShoreEndoscopyCenter
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://doctor.webmd.com/practice/north-shore-endoscopy-center-09be68c8-4703-e211-a42b-001f29e3eb44"
