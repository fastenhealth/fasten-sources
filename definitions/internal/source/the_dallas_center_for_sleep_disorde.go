...
func GetSourceTheDallasCenterForSleepDisorde(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheDallasCenterForSleepDisorde]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "THE DALLAS CENTER FOR SLEEP DISORDE"
	sourceDef.SourceType = pkg.SourceTypeTheDallasCenterForSleepDisorde
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.DallasSleep.com"
