...
func GetSourceFamilyMedicalCareOfBayShoreP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyMedicalCareOfBayShoreP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Family Medical Care of Bay Shore P"
	sourceDef.SourceType = pkg.SourceTypeFamilyMedicalCareOfBayShoreP
