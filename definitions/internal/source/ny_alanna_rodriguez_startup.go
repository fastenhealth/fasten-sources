...
func GetSourceNyAlannaRodriguezStartup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNyAlannaRodriguezStartup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "NY  Alanna Rodriguez  Startup"
	sourceDef.SourceType = pkg.SourceTypeNyAlannaRodriguezStartup
