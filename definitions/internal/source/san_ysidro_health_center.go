...
func GetSourceSanYsidroHealthCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSanYsidroHealthCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "San Ysidro Health Center"
	sourceDef.SourceType = pkg.SourceTypeSanYsidroHealthCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.syhealth.org/"
