...
func GetSourceSwiftcareOfMarylandPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSwiftcareOfMarylandPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SWIFTCARE OF MARYLAND PC"
	sourceDef.SourceType = pkg.SourceTypeSwiftcareOfMarylandPc
