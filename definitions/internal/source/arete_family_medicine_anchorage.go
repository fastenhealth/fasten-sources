...
func GetSourceAreteFamilyMedicineAnchorage(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAreteFamilyMedicineAnchorage]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Arete Family Medicine  Anchorage"
	sourceDef.SourceType = pkg.SourceTypeAreteFamilyMedicineAnchorage
