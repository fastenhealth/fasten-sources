...
func GetSourceGraybillMedicalGroupInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGraybillMedicalGroupInc]; clientIdOk {
	...
	sourceDef.Category = []string{"207Q00000X", "207QS0010X", "207R00000X", "207RC0000X", "207X00000X", "207Y00000X", "208000000X", "208600000X"}
