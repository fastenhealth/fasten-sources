...
func GetSourceMaculaAndRetinaSpecialistsOfHo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMaculaAndRetinaSpecialistsOfHo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Macula and Retina Specialists of Ho"
	sourceDef.SourceType = pkg.SourceTypeMaculaAndRetinaSpecialistsOfHo
