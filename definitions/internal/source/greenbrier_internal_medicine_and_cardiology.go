...
func GetSourceGreenbrierInternalMedicineAndCardiology(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGreenbrierInternalMedicineAndCardiology]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Greenbrier Internal Medicine and Cardiology"
	sourceDef.SourceType = pkg.SourceTypeGreenbrierInternalMedicineAndCardiology
