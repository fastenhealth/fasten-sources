...
func GetSourceColumbiaGastrointestinalEndoscopyCtr(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeColumbiaGastrointestinalEndoscopyCtr]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Columbia Gastrointestinal Endoscopy Ctr"
	sourceDef.SourceType = pkg.SourceTypeColumbiaGastrointestinalEndoscopyCtr
