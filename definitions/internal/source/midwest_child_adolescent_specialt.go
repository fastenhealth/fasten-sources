...
func GetSourceMidwestChildAdolescentSpecialt(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMidwestChildAdolescentSpecialt]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MIDWEST CHILD  ADOLESCENT SPECIALT"
	sourceDef.SourceType = pkg.SourceTypeMidwestChildAdolescentSpecialt
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.terrehautepediatricians.com"
