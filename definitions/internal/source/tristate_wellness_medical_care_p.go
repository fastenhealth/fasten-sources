...
func GetSourceTristateWellnessMedicalCareP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTristateWellnessMedicalCareP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TRISTATE WELLNESS  MEDICAL CARE P"
	sourceDef.SourceType = pkg.SourceTypeTristateWellnessMedicalCareP
