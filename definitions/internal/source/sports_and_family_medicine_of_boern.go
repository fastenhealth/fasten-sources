...
func GetSourceSportsAndFamilyMedicineOfBoern(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSportsAndFamilyMedicineOfBoern]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sports and Family Medicine of Boern"
	sourceDef.SourceType = pkg.SourceTypeSportsAndFamilyMedicineOfBoern
