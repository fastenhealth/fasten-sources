...
func GetSourceGlennvilleEyeSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGlennvilleEyeSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Glennville Eye Surgery Center"
	sourceDef.SourceType = pkg.SourceTypeGlennvilleEyeSurgeryCenter
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "glennville-eye-surgery-center.jpg"
	sourceDef.PatientAccessUrl = "https://www.gaeyeinstitute.com/"
