...
func GetSourceMilwaukeeCardiacCareInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMilwaukeeCardiacCareInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MILWAUKEE CARDIAC CARE INC"
	sourceDef.SourceType = pkg.SourceTypeMilwaukeeCardiacCareInc
