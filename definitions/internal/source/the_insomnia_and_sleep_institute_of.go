...
func GetSourceTheInsomniaAndSleepInstituteOf(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheInsomniaAndSleepInstituteOf]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Insomnia And Sleep Institute of"
	sourceDef.SourceType = pkg.SourceTypeTheInsomniaAndSleepInstituteOf
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.sleeplessinarizona.com"
