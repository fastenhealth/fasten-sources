...
func GetSourceGarzaMedicalGroupSouthAlamo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGarzaMedicalGroupSouthAlamo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Garza Medical Group  South Alamo"
	sourceDef.SourceType = pkg.SourceTypeGarzaMedicalGroupSouthAlamo
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://Http://Garzamedical.com"
