...
func GetSourceOptumMedicalCareOfNjPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOptumMedicalCareOfNjPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Optum Medical Care of NJ PC"
	sourceDef.SourceType = pkg.SourceTypeOptumMedicalCareOfNjPc
