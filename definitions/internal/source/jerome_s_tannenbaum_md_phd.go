...
func GetSourceJeromeSTannenbaumMdPhd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJeromeSTannenbaumMdPhd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Jerome S Tannenbaum MD PHD"
	sourceDef.SourceType = pkg.SourceTypeJeromeSTannenbaumMdPhd
