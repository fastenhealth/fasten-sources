...
func GetSourceSurgicareArtsAesthetics(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSurgicareArtsAesthetics]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SurgiCare Arts  Aesthetics"
	sourceDef.SourceType = pkg.SourceTypeSurgicareArtsAesthetics
