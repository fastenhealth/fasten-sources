...
func GetSourceClearwaterFamilyMedicineAndAllergyPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeClearwaterFamilyMedicineAndAllergyPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Clearwater Family Medicine and Allergy PLLC"
	sourceDef.SourceType = pkg.SourceTypeClearwaterFamilyMedicineAndAllergyPllc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.cfma.health"
