...
func GetSourceCharlesSGrahamDoPcDbaC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCharlesSGrahamDoPcDbaC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CHARLES S GRAHAM DO PC dba C"
	sourceDef.SourceType = pkg.SourceTypeCharlesSGrahamDoPcDbaC
