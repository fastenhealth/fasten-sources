...
func GetSourceChiMemorialHospitalGeorgia(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeChiMemorialHospitalGeorgia]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CHI MEMORIAL HOSPITAL  GEORGIA"
	sourceDef.SourceType = pkg.SourceTypeChiMemorialHospitalGeorgia
