...
func GetSourceBluegrassEyeAndLaser(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBluegrassEyeAndLaser]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Bluegrass Eye and Laser"
	sourceDef.SourceType = pkg.SourceTypeBluegrassEyeAndLaser
