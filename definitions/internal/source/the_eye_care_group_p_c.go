...
func GetSourceTheEyeCareGroupPC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheEyeCareGroupPC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "The Eye Care Group P C"
	sourceDef.SourceType = pkg.SourceTypeTheEyeCareGroupPC
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://theeyecaregroup.com/"
