...
func GetSourcePottstownMedicialPhysicians(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePottstownMedicialPhysicians]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "POTTSTOWN MEDICIAL PHYSICIANS"
	sourceDef.SourceType = pkg.SourceTypePottstownMedicialPhysicians
