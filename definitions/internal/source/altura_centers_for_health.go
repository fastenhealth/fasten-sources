...
func GetSourceAlturaCentersForHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlturaCentersForHealth]; clientIdOk {
	...
	sourceDef.Category = []string{"261QA0005X", "261QD0000X", "261QM1300X", "261QF0400X", "261Q00000X", "261QC1500X"}
