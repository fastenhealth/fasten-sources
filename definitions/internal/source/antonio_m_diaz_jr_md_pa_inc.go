...
func GetSourceAntonioMDiazJrMdPaInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAntonioMDiazJrMdPaInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Antonio M Diaz Jr MD PA Inc"
	sourceDef.SourceType = pkg.SourceTypeAntonioMDiazJrMdPaInc
