...
func GetSourceVolunteerFamilyMedicineUrgent(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVolunteerFamilyMedicineUrgent]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "VOLUNTEER FAMILY MEDICINE  URGENT"
	sourceDef.SourceType = pkg.SourceTypeVolunteerFamilyMedicineUrgent
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.volunteerfamilymedicine.com"
