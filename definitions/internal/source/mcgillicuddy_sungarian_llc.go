...
func GetSourceMcgillicuddySungarianLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMcgillicuddySungarianLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "McGillicuddy Sungarian LLC"
	sourceDef.SourceType = pkg.SourceTypeMcgillicuddySungarianLlc
