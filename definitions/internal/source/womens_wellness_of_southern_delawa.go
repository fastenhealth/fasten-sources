...
func GetSourceWomensWellnessOfSouthernDelawa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomensWellnessOfSouthernDelawa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Womens Wellness of Southern Delawa"
	sourceDef.SourceType = pkg.SourceTypeWomensWellnessOfSouthernDelawa
