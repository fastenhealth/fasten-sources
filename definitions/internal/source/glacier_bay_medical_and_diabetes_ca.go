...
func GetSourceGlacierBayMedicalAndDiabetesCa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGlacierBayMedicalAndDiabetesCa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Glacier Bay Medical and Diabetes Ca"
	sourceDef.SourceType = pkg.SourceTypeGlacierBayMedicalAndDiabetesCa
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://Glacierbaymed.com"
