...
func GetSourceVirginiaObstetricsGynecologyP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVirginiaObstetricsGynecologyP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Virginia Obstetrics  Gynecology P"
	sourceDef.SourceType = pkg.SourceTypeVirginiaObstetricsGynecologyP
