...
func GetSourceSureshKSachdevaMdProfessio(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSureshKSachdevaMdProfessio]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Suresh K Sachdeva MD Professio"
	sourceDef.SourceType = pkg.SourceTypeSureshKSachdevaMdProfessio
