...
func GetSourceTxLonestarFamilyMedicalClinicSt(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTxLonestarFamilyMedicalClinicSt]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TX  LoneStar Family Medical Clinic  St"
	sourceDef.SourceType = pkg.SourceTypeTxLonestarFamilyMedicalClinicSt
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.lonestarfamilyclinic.com"
