...
func GetSourceStillnessCounselingAndConsulting(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeStillnessCounselingAndConsulting]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Stillness Counseling and Consulting"
	sourceDef.SourceType = pkg.SourceTypeStillnessCounselingAndConsulting
