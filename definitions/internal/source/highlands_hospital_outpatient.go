...
func GetSourceHighlandsHospitalOutpatient(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHighlandsHospitalOutpatient]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Highlands Hospital Outpatient"
	sourceDef.SourceType = pkg.SourceTypeHighlandsHospitalOutpatient
