...
func GetSourceAlonsoAndBarrosoMdLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlonsoAndBarrosoMdLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Alonso and Barroso MD LLC"
	sourceDef.SourceType = pkg.SourceTypeAlonsoAndBarrosoMdLlc
