...
func GetSourceObstetrixMedicalGroupOfNebraska(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeObstetrixMedicalGroupOfNebraska]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Obstetrix Medical Group Of Nebraska"
	sourceDef.SourceType = pkg.SourceTypeObstetrixMedicalGroupOfNebraska
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.mednax.com/practice/obstetrix-medical-group-of-nebraska/"
