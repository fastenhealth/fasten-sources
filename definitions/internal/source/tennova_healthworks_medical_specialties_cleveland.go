...
func GetSourceTennovaHealthworksMedicalSpecialtiesCleveland(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTennovaHealthworksMedicalSpecialtiesCleveland]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tennova Healthworks Medical Specialties  Cleveland"
	sourceDef.SourceType = pkg.SourceTypeTennovaHealthworksMedicalSpecialtiesCleveland
