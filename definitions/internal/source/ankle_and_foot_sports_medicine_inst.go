...
func GetSourceAnkleAndFootSportsMedicineInst(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnkleAndFootSportsMedicineInst]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ANKLE AND FOOT SPORTS MEDICINE INST"
	sourceDef.SourceType = pkg.SourceTypeAnkleAndFootSportsMedicineInst
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://ramdathsportsmedicine.com"
