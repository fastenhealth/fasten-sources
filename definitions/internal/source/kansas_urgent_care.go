...
func GetSourceKansasUrgentCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKansasUrgentCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Kansas Urgent Care"
	sourceDef.SourceType = pkg.SourceTypeKansasUrgentCare
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "kansas-urgent-care.jpg"
