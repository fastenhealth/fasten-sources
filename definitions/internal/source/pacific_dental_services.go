...
func GetSourcePacificDentalServices(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.ApiEndpointBaseUrl = "https://epicproxy.et1079.epichosted.com/FHIRProxy/api/FHIR/R4"
	...
	sourceDef.SourceType = definitions.SourceTypePacificDentalServices
