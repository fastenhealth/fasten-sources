...
func GetSourceCPSammaroneJrDOInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCPSammaroneJrDOInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "C.P. Sammarone Jr. D.O. Inc."
	sourceDef.SourceType = pkg.SourceTypeCPSammaroneJrDOInc
