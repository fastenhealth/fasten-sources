...
func GetSourceAnthonyAMcfarlaneMdPcInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnthonyAMcfarlaneMdPcInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Anthony A McFarlane MD PC INC"
	sourceDef.SourceType = pkg.SourceTypeAnthonyAMcfarlaneMdPcInc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.anthonymcfarlane.com"
