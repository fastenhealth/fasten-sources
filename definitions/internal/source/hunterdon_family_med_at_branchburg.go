...
func GetSourceHunterdonFamilyMedAtBranchburg(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHunterdonFamilyMedAtBranchburg]; clientIdOk {
	...
	sourceDef.BrandLogo = "hunterdon-family-med-at-branchburg.svg"
	sourceDef.PatientAccessUrl = "https://www.hunterdonhealth.org/services/hunterdon-family-medicine-bridgewater"
