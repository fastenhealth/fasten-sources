...
func GetSourceFamilyCarePlusClinicOhio(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyCarePlusClinicOhio]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FAMILY CARE PLUS CLINIC Ohio"
	sourceDef.SourceType = pkg.SourceTypeFamilyCarePlusClinicOhio
