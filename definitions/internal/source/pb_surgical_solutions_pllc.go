...
func GetSourcePbSurgicalSolutionsPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePbSurgicalSolutionsPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "PB Surgical Solutions PLLC"
	sourceDef.SourceType = pkg.SourceTypePbSurgicalSolutionsPllc
