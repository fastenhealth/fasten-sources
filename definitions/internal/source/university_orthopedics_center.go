...
func GetSourceUniversityOrthopedicsCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUniversityOrthopedicsCenter]; clientIdOk {
	...
	sourceDef.Category = []string{"207X00000X", "332BC3200X", "332B00000X"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1750673133", "1730383852"}}
