...
func GetSourceGriffinPopulationAnalyticPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGriffinPopulationAnalyticPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Griffin Population Analytic PC"
	sourceDef.SourceType = pkg.SourceTypeGriffinPopulationAnalyticPc
