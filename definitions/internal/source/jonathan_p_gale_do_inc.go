...
func GetSourceJonathanPGaleDoInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJonathanPGaleDoInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Jonathan P Gale DO Inc"
	sourceDef.SourceType = pkg.SourceTypeJonathanPGaleDoInc
	sourceDef.PatientAccessUrl = "https://healthy.kaiserpermanente.org/southern-california/physicians/jonathan-gale-3709265"
