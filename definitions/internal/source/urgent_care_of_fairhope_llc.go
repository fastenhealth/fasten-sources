...
func GetSourceUrgentCareOfFairhopeLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUrgentCareOfFairhopeLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Urgent Care of Fairhope LLC"
	sourceDef.SourceType = pkg.SourceTypeUrgentCareOfFairhopeLlc
	sourceDef.Category = []string{"207Q00000X", "261QU0200X"}
	sourceDef.Aliases = []string{}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1336800010"}}
	sourceDef.PatientAccessUrl = "https://www.urgentcareoffairhope.com/"
