...
func GetSourceAltheaLTurkMdPcDbaComprehen(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAltheaLTurkMdPcDbaComprehen]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Althea L Turk MD PC dba Comprehen"
	sourceDef.SourceType = pkg.SourceTypeAltheaLTurkMdPcDbaComprehen
