...
func GetSourceBoazAndAlbertvilleFamilyCareLl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBoazAndAlbertvilleFamilyCareLl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Boaz and Albertville Family Care LL"
	sourceDef.SourceType = pkg.SourceTypeBoazAndAlbertvilleFamilyCareLl
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://bafamilycare.com"
