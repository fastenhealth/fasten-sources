...
func GetSourceARayOfHopeTheGreatLakesInst(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeARayOfHopeTheGreatLakesInst]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "A Ray of Hope The Great Lakes Inst"
	sourceDef.SourceType = pkg.SourceTypeARayOfHopeTheGreatLakesInst
