...
func GetSourceOrthopaedicSurgerySportsMedicineOfDallas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthopaedicSurgerySportsMedicineOfDallas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Orthopaedic Surgery  Sports Medicine of Dallas"
	sourceDef.SourceType = pkg.SourceTypeOrthopaedicSurgerySportsMedicineOfDallas
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.ossmdallas.com"
