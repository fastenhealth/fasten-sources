...
func GetSourceSpotlyteBehavioralHealthOfPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSpotlyteBehavioralHealthOfPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SpotLyte Behavioral Health of PA"
	sourceDef.SourceType = pkg.SourceTypeSpotlyteBehavioralHealthOfPa
