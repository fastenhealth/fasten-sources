...
func GetSourceFinchFamilyMedicalCarePllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFinchFamilyMedicalCarePllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Finch Family Medical Care PLLC"
	sourceDef.SourceType = pkg.SourceTypeFinchFamilyMedicalCarePllc
