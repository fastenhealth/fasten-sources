...
func GetSourceMobileUrgentSpecializedTreatment(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMobileUrgentSpecializedTreatment]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Mobile Urgent Specialized Treatment"
	sourceDef.SourceType = pkg.SourceTypeMobileUrgentSpecializedTreatment
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://WWW.MUSTCLINIC.HEALTH"
