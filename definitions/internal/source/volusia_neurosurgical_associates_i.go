...
func GetSourceVolusiaNeurosurgicalAssociatesI(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVolusiaNeurosurgicalAssociatesI]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "VOLUSIA NEUROSURGICAL ASSOCIATES I"
	sourceDef.SourceType = pkg.SourceTypeVolusiaNeurosurgicalAssociatesI
