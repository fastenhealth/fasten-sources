...
func GetSourcePrincetonEntAndSleepLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePrincetonEntAndSleepLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "PRINCETON ENT AND SLEEP LLC"
	sourceDef.SourceType = pkg.SourceTypePrincetonEntAndSleepLlc
