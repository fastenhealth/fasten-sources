...
func GetSourceCommonwealthHospitalistGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCommonwealthHospitalistGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "COMMONWEALTH HOSPITALIST GROUP"
	sourceDef.SourceType = pkg.SourceTypeCommonwealthHospitalistGroup
