...
func GetSourceVbPhysiciansNetworkInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVbPhysiciansNetworkInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "VB Physicians Network INC"
	sourceDef.SourceType = pkg.SourceTypeVbPhysiciansNetworkInc
