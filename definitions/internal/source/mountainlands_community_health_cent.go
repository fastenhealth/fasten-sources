...
func GetSourceMountainlandsCommunityHealthCent(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMountainlandsCommunityHealthCent]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Mountainlands Community Health Cent"
	sourceDef.SourceType = pkg.SourceTypeMountainlandsCommunityHealthCent
