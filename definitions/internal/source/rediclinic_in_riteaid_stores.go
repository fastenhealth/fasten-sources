...
func GetSourceRediclinicInRiteaidStores(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRediclinicInRiteaidStores]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "RediClinic in RiteAid Stores"
	sourceDef.SourceType = pkg.SourceTypeRediclinicInRiteaidStores
