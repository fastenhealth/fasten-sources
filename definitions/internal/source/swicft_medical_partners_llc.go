...
func GetSourceSwicftMedicalPartnersLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSwicftMedicalPartnersLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SWICFT MEDICAL PARTNERS LLC"
	sourceDef.SourceType = pkg.SourceTypeSwicftMedicalPartnersLlc
