...
func GetSourceKidsUrgentCareAndPediatrics(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKidsUrgentCareAndPediatrics]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "KIDS Urgent Care and Pediatrics"
	sourceDef.SourceType = pkg.SourceTypeKidsUrgentCareAndPediatrics
