...
func GetSourcePhysicianAdvisoryGroupLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePhysicianAdvisoryGroupLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "PHYSICIAN ADVISORY GROUP LLC"
	sourceDef.SourceType = pkg.SourceTypePhysicianAdvisoryGroupLlc
