...
func GetSourceFavorFootAndAnklePodiatryPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFavorFootAndAnklePodiatryPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FAVOR FOOT AND ANKLE PODIATRY PC"
	sourceDef.SourceType = pkg.SourceTypeFavorFootAndAnklePodiatryPc
