...
func GetSourceClinicalNephrologyAssociates(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeClinicalNephrologyAssociates]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Clinical Nephrology Associates"
	sourceDef.SourceType = pkg.SourceTypeClinicalNephrologyAssociates
	sourceDef.BrandLogo = "clinical-nephrology-associates.jpg"
