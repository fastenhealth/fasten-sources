...
func GetSourceVenturaCountyUrologyMedicalGrou(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVenturaCountyUrologyMedicalGrou]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Ventura County Urology Medical Grou"
	sourceDef.SourceType = pkg.SourceTypeVenturaCountyUrologyMedicalGrou
