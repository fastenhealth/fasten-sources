...
func GetSourceSundanceMedicalCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSundanceMedicalCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Sundance Medical Center"
	sourceDef.SourceType = pkg.SourceTypeSundanceMedicalCenter
	sourceDef.PatientAccessUrl = "https://sundancemedicalcenter.com/"
