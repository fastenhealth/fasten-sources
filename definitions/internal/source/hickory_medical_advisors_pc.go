...
func GetSourceHickoryMedicalAdvisorsPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHickoryMedicalAdvisorsPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Hickory Medical Advisors PC"
	sourceDef.SourceType = pkg.SourceTypeHickoryMedicalAdvisorsPc
