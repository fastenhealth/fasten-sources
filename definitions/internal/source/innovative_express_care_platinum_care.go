...
func GetSourceInnovativeExpressCarePlatinumCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeInnovativeExpressCarePlatinumCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Innovative Express Care  Platinum Care"
	sourceDef.SourceType = pkg.SourceTypeInnovativeExpressCarePlatinumCare
