...
func GetSourceMercyHealthServicesMd(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeMercyHealthServicesMd
