...
func GetSourceSunshineUrgentCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSunshineUrgentCare]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "http://www.sunshineUC.com"
