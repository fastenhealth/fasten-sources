...
func GetSourceNcpCollegeStationCathLab(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNcpCollegeStationCathLab]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "NCP College Station Cath Lab"
	sourceDef.SourceType = pkg.SourceTypeNcpCollegeStationCathLab
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "http://bcshvc.com/contact.php"
