...
func GetSourceOrthopaedicInstituteWesternKentucky(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthopaedicInstituteWesternKentucky]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Orthopaedic Institute Western Kentucky"
	sourceDef.SourceType = pkg.SourceTypeOrthopaedicInstituteWesternKentucky
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://oiwky.com/"
