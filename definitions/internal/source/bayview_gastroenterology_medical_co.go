...
func GetSourceBayviewGastroenterologyMedicalCo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBayviewGastroenterologyMedicalCo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Bayview Gastroenterology Medical Co"
	sourceDef.SourceType = pkg.SourceTypeBayviewGastroenterologyMedicalCo
