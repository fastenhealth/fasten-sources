...
func GetSourceSibteKazmiMdLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSibteKazmiMdLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Sibte Kazmi MD LLC"
	sourceDef.SourceType = pkg.SourceTypeSibteKazmiMdLlc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.sharecare.com/doctor/dr-sibte-a-kazmi"
