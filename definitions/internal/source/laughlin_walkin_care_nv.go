...
func GetSourceLaughlinWalkinCareNv(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLaughlinWalkinCareNv]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Laughlin WalkIn Care NV"
	sourceDef.SourceType = pkg.SourceTypeLaughlinWalkinCareNv
