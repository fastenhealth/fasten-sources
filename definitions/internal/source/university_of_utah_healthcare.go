...
func GetSourceUniversityOfUtahHealthcare(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeUniversityOfUtahHealthcare
