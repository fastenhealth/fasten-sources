...
func GetSourceAnnapolisColonRectalSurgeons(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnnapolisColonRectalSurgeons]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Annapolis Colon  Rectal Surgeons"
	sourceDef.SourceType = pkg.SourceTypeAnnapolisColonRectalSurgeons
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://STEVENPROSHANMD.COM"
