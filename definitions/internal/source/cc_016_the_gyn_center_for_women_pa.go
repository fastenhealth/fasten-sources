...
func GetSourceCc016TheGynCenterForWomenPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc016TheGynCenterForWomenPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC016THE GYN CENTER FOR WOMEN PA"
	sourceDef.SourceType = pkg.SourceTypeCc016TheGynCenterForWomenPa
