...
func GetSourceCaliforniaPrimaryHealthCareCorp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaliforniaPrimaryHealthCareCorp]; clientIdOk {
	...
	sourceDef.Category = []string{"261QP2300X", "207R00000X"}
