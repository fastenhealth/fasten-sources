...
func GetSourceTcmcDbaRadianceObgyn(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTcmcDbaRadianceObgyn]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TCMC dba Radiance OBGYN"
	sourceDef.SourceType = pkg.SourceTypeTcmcDbaRadianceObgyn
