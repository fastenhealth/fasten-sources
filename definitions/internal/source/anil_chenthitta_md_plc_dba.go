...
func GetSourceAnilChenthittaMdPlcDba(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnilChenthittaMdPlcDba]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Anil Chenthitta MD PLC DBA"
	sourceDef.SourceType = pkg.SourceTypeAnilChenthittaMdPlcDba
