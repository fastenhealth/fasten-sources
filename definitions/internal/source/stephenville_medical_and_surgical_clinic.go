...
func GetSourceStephenvilleMedicalAndSurgicalClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeStephenvilleMedicalAndSurgicalClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Stephenville Medical And Surgical Clinic"
	sourceDef.SourceType = pkg.SourceTypeStephenvilleMedicalAndSurgicalClinic
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "stephenville-medical-and-surgical-clinic.jpg"
	sourceDef.PatientAccessUrl = "https://www.smsc.org/"
