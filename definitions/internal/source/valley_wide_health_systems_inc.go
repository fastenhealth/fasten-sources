...
func GetSourceValleyWideHealthSystemsInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeValleyWideHealthSystemsInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Valley Wide Health Systems Inc"
	sourceDef.SourceType = pkg.SourceTypeValleyWideHealthSystemsInc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://valley-widehealth.org/"
