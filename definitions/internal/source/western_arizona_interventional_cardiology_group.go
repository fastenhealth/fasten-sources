...
func GetSourceWesternArizonaInterventionalCardiologyGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWesternArizonaInterventionalCardiologyGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Western Arizona Interventional Cardiology Group"
	sourceDef.SourceType = pkg.SourceTypeWesternArizonaInterventionalCardiologyGroup
