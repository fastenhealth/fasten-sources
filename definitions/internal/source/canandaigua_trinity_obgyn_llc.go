...
func GetSourceCanandaiguaTrinityObgynLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCanandaiguaTrinityObgynLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Canandaigua Trinity OBGYN LLC"
	sourceDef.SourceType = pkg.SourceTypeCanandaiguaTrinityObgynLlc
