...
func GetSourceFamilyHealthCareCenterOfEdina(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyHealthCareCenterOfEdina]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Family Health Care Center of Edina"
	sourceDef.SourceType = pkg.SourceTypeFamilyHealthCareCenterOfEdina
