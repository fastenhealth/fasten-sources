...
func GetSourceFreeMedicalClinicOfOakRidge(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFreeMedicalClinicOfOakRidge]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Free Medical Clinic of Oak Ridge"
	sourceDef.SourceType = pkg.SourceTypeFreeMedicalClinicOfOakRidge
