...
func GetSourceWestTexasDiabetesAndEndocrineCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWestTexasDiabetesAndEndocrineCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "West Texas Diabetes and Endocrine Center"
	sourceDef.SourceType = pkg.SourceTypeWestTexasDiabetesAndEndocrineCenter
