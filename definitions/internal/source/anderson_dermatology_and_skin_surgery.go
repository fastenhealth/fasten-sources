...
func GetSourceAndersonDermatologyAndSkinSurgery(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAndersonDermatologyAndSkinSurgery]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://andersondermatologysc.com/"
