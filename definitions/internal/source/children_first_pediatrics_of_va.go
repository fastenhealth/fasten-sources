...
func GetSourceChildrenFirstPediatricsOfVa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeChildrenFirstPediatricsOfVa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Children First Pediatrics of VA"
	sourceDef.SourceType = pkg.SourceTypeChildrenFirstPediatricsOfVa
