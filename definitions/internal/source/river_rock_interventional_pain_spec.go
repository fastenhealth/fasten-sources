...
func GetSourceRiverRockInterventionalPainSpec(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRiverRockInterventionalPainSpec]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "RIVER ROCK INTERVENTIONAL PAIN SPEC"
	sourceDef.SourceType = pkg.SourceTypeRiverRockInterventionalPainSpec
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.riverrockpain.com/"
