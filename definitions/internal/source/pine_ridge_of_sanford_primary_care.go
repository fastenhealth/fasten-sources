...
func GetSourcePineRidgeOfSanfordPrimaryCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePineRidgeOfSanfordPrimaryCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pine Ridge of Sanford Primary Care"
	sourceDef.SourceType = pkg.SourceTypePineRidgeOfSanfordPrimaryCare
