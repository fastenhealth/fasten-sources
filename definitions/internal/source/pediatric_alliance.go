...
func GetSourcePediatricAlliance(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatricAlliance]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pediatric Alliance"
	sourceDef.SourceType = pkg.SourceTypePediatricAlliance
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.pediatricalliancetexas.com/"
