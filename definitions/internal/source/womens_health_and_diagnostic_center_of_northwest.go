...
func GetSourceWomensHealthAndDiagnosticCenterOfNorthwest(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomensHealthAndDiagnosticCenterOfNorthwest]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Womens Health and Diagnostic Center of Northwest"
	sourceDef.SourceType = pkg.SourceTypeWomensHealthAndDiagnosticCenterOfNorthwest
