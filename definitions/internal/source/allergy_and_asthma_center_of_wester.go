...
func GetSourceAllergyAndAsthmaCenterOfWester(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAllergyAndAsthmaCenterOfWester]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Allergy and Asthma Center of Wester"
	sourceDef.SourceType = pkg.SourceTypeAllergyAndAsthmaCenterOfWester
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://allergywesterncolorado.com"
