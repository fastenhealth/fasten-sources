...
func GetSourceSalemRheumatologyAndInfusionsLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSalemRheumatologyAndInfusionsLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Salem Rheumatology and Infusions LLC"
	sourceDef.SourceType = pkg.SourceTypeSalemRheumatologyAndInfusionsLlc
