...
func GetSourcePacificPulmonaryMedicalGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePacificPulmonaryMedicalGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pacific Pulmonary Medical Group"
	sourceDef.SourceType = pkg.SourceTypePacificPulmonaryMedicalGroup
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "http://pacificpulm.com/"
