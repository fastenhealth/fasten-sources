...
func GetSourceWomancareCentersPlcPcn(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomancareCentersPlcPcn]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "WomanCare Centers PLC  PCN"
	sourceDef.SourceType = pkg.SourceTypeWomancareCentersPlcPcn
