...
func GetSourceEyecareAndSurgerycenterftlauderdale(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyecareAndSurgerycenterftlauderdale]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "EyeCare & SurgeryCenterFtLauderdale"
	sourceDef.SourceType = pkg.SourceTypeEyecareAndSurgerycenterftlauderdale
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.araneye.com/surgery-centers/eye-care-and-surgery-center-of-ft-lauderdale/"
