...
func GetSourceFareedaNAdeebMdPediatrics(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFareedaNAdeebMdPediatrics]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Fareeda N Adeeb MD Pediatrics"
	sourceDef.SourceType = pkg.SourceTypeFareedaNAdeebMdPediatrics
