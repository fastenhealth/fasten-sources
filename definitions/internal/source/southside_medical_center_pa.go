...
func GetSourceSouthsideMedicalCenterPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthsideMedicalCenterPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Southside Medical Center PA"
	sourceDef.SourceType = pkg.SourceTypeSouthsideMedicalCenterPa
	sourceDef.Category = []string{"207Q00000X", "261Q00000X"}
	sourceDef.Aliases = []string{}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1003099409", "1972782019"}}
	sourceDef.PatientAccessUrl = "http://www.hollyridgehealthcare.com"
