...
func GetSourceRegionViiAreaAgencyOnAging(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRegionViiAreaAgencyOnAging]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Region VII Area Agency on Aging"
	sourceDef.SourceType = pkg.SourceTypeRegionViiAreaAgencyOnAging
