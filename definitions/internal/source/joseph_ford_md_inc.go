...
func GetSourceJosephFordMdInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJosephFordMdInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Joseph Ford MD Inc"
	sourceDef.SourceType = pkg.SourceTypeJosephFordMdInc
	sourceDef.PatientAccessUrl = "https://doctor.webmd.com/doctor/joseph-ford-f17c1073-45b9-4e5e-a1dd-e473dc9d3edb-overview"
