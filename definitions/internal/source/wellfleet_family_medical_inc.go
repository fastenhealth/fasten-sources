...
func GetSourceWellfleetFamilyMedicalInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWellfleetFamilyMedicalInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Wellfleet Family Medical Inc"
	sourceDef.SourceType = pkg.SourceTypeWellfleetFamilyMedicalInc
