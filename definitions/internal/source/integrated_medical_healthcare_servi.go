...
func GetSourceIntegratedMedicalHealthcareServi(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeIntegratedMedicalHealthcareServi]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "INTEGRATED MEDICAL HEALTHCARE SERVI"
	sourceDef.SourceType = pkg.SourceTypeIntegratedMedicalHealthcareServi
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.imhcares.com"
