...
func GetSourceOccupationalMedicineAtMcch(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOccupationalMedicineAtMcch]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Occupational Medicine at MCCH"
	sourceDef.SourceType = pkg.SourceTypeOccupationalMedicineAtMcch
