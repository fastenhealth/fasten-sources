...
func GetSourceDrYenShipleyAndDrMesnier(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrYenShipleyAndDrMesnier]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dr Yen Shipley and Dr Mesnier"
	sourceDef.SourceType = pkg.SourceTypeDrYenShipleyAndDrMesnier
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.multnomahortho.com/"
