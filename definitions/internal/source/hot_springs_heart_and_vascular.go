...
func GetSourceHotSpringsHeartAndVascular(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHotSpringsHeartAndVascular]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Hot Springs Heart and Vascular"
	sourceDef.SourceType = pkg.SourceTypeHotSpringsHeartAndVascular
