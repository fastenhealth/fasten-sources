...
func GetSourceTouchstoneNeurodevelopmental(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTouchstoneNeurodevelopmental]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Touchstone Neurodevelopmental"
	sourceDef.SourceType = pkg.SourceTypeTouchstoneNeurodevelopmental
