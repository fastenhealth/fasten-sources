...
func GetSourcePajaroValleyCommunityHealthTrus(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePajaroValleyCommunityHealthTrus]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pajaro Valley Community Health Trus"
	sourceDef.SourceType = pkg.SourceTypePajaroValleyCommunityHealthTrus
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.pvhealthtrust.org"
