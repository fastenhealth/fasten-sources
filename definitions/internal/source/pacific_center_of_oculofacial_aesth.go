...
func GetSourcePacificCenterOfOculofacialAesth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePacificCenterOfOculofacialAesth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pacific Center of Oculofacial Aesth"
	sourceDef.SourceType = pkg.SourceTypePacificCenterOfOculofacialAesth
