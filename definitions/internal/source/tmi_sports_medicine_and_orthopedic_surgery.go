...
func GetSourceTmiSportsMedicineAndOrthopedicSurgery(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTmiSportsMedicineAndOrthopedicSurgery]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TMI SPORTS MEDICINE AND ORTHOPEDIC SURGERY"
	sourceDef.SourceType = pkg.SourceTypeTmiSportsMedicineAndOrthopedicSurgery
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.tmisportsmed.com/"
