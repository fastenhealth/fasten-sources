...
func GetSourceCaJrJohnsonMdIncAthenaone(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaJrJohnsonMdIncAthenaone]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CA  JR Johnson MD Inc  athenaOne"
	sourceDef.SourceType = pkg.SourceTypeCaJrJohnsonMdIncAthenaone
