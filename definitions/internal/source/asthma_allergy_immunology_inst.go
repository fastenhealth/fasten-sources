...
func GetSourceAsthmaAllergyImmunologyInst(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAsthmaAllergyImmunologyInst]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Asthma Allergy Immunology Inst"
	sourceDef.SourceType = pkg.SourceTypeAsthmaAllergyImmunologyInst
