...
func GetSourcePartnersInWomensHealthIiLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePartnersInWomensHealthIiLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Partners in Womens Health II LLC"
	sourceDef.SourceType = pkg.SourceTypePartnersInWomensHealthIiLlc
