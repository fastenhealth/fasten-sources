...
func GetSourceNjAdvanceHealthcareAssociatesSta(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNjAdvanceHealthcareAssociatesSta]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "NJ  Advance Healthcare Associates  Sta"
	sourceDef.SourceType = pkg.SourceTypeNjAdvanceHealthcareAssociatesSta
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.ahawellnessfirst.org"
