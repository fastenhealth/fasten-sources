...
func GetSourceLufkinAdultMedicineClinicPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLufkinAdultMedicineClinicPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lufkin Adult Medicine Clinic PA"
	sourceDef.SourceType = pkg.SourceTypeLufkinAdultMedicineClinicPa
