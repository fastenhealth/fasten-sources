...
func GetSourceSurgicalSpecialtyCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSurgicalSpecialtyCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Surgical Specialty Center"
	sourceDef.SourceType = pkg.SourceTypeSurgicalSpecialtyCenter
	sourceDef.PatientAccessUrl = "https://m.yelp.com/biz/surgical-specialty-center-shreveport"
