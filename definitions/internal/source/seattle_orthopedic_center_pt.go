...
func GetSourceSeattleOrthopedicCenterPt(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSeattleOrthopedicCenterPt]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Seattle Orthopedic Center PT"
	sourceDef.SourceType = pkg.SourceTypeSeattleOrthopedicCenterPt
