...
func GetSourceBeatAidsCoalitionTrust(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Category = []string{"261Q00000X", "101Y00000X", "101YA0400X", "101YM0800X", "171M00000X", "172A00000X", "172V00000X", "174H00000X", "251B00000X", "291U00000X", "343900000X", "344600000X", "347C00000X", "251S00000X"}
