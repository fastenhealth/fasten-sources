...
func GetSourceInnovativeGynecologyObstetrics(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeInnovativeGynecologyObstetrics]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Innovative Gynecology  Obstetrics"
	sourceDef.SourceType = pkg.SourceTypeInnovativeGynecologyObstetrics
