...
func GetSourceBiospineOrlando(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBiospineOrlando]; clientIdOk {
	...
	sourceDef.BrandLogo = "biospine-orlando.svg"
