...
func GetSourcePeterJacksonMD(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePeterJacksonMD]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Peter Jackson M D"
	sourceDef.SourceType = pkg.SourceTypePeterJacksonMD
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.yelp.com/biz/peter-j-jackson-md-pasadena"
