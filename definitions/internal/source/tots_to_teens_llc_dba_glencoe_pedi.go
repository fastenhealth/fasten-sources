...
func GetSourceTotsToTeensLlcDbaGlencoePedi(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTotsToTeensLlcDbaGlencoePedi]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tots To Teens LLC DBA Glencoe Pedi"
	sourceDef.SourceType = pkg.SourceTypeTotsToTeensLlcDbaGlencoePedi
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.glencoepediatrics.org/"
