...
func GetSourceDoctorsEmergencyRoomCorpLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDoctorsEmergencyRoomCorpLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "DOCTORS EMERGENCY ROOM CORP LLC"
	sourceDef.SourceType = pkg.SourceTypeDoctorsEmergencyRoomCorpLlc
