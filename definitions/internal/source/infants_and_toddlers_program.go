...
func GetSourceInfantsAndToddlersProgram(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeInfantsAndToddlersProgram]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://marylandpublicschools.org"
