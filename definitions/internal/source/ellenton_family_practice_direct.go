...
func GetSourceEllentonFamilyPracticeDirect(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEllentonFamilyPracticeDirect]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Ellenton Family Practice Direct"
	sourceDef.SourceType = pkg.SourceTypeEllentonFamilyPracticeDirect
