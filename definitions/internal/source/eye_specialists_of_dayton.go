...
func GetSourceEyeSpecialistsOfDayton(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeSpecialistsOfDayton]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Eye Specialists of Dayton"
	sourceDef.SourceType = pkg.SourceTypeEyeSpecialistsOfDayton
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://eyedoctorjoshi.wix.com/eyecarestation"
