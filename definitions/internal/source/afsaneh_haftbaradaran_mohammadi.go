...
func GetSourceAfsanehHaftbaradaranMohammadi(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAfsanehHaftbaradaranMohammadi]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "AFSANEH HAFTBARADARAN MOHAMMADI"
	sourceDef.SourceType = pkg.SourceTypeAfsanehHaftbaradaranMohammadi
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://mykidneyspecialist.com"
