...
func GetSourceEntPhysiciansOfKearneyPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEntPhysiciansOfKearneyPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ENT Physicians Of Kearney PC"
	sourceDef.SourceType = pkg.SourceTypeEntPhysiciansOfKearneyPc
