...
func GetSourceMooreHealthcareGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMooreHealthcareGroup]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "http://moorehealthcaregroup.org"
