...
func GetSourceEpHealthAndWellnessPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEpHealthAndWellnessPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "EP Health and Wellness PLLC"
	sourceDef.SourceType = pkg.SourceTypeEpHealthAndWellnessPllc
