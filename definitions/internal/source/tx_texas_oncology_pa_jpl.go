...
func GetSourceTxTexasOncologyPaJpl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTxTexasOncologyPaJpl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TX  Texas Oncology PA  JPL"
	sourceDef.SourceType = pkg.SourceTypeTxTexasOncologyPaJpl
