...
func GetSourceOcalaAnesthesiaServices(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOcalaAnesthesiaServices]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Ocala Anesthesia Services"
	sourceDef.SourceType = pkg.SourceTypeOcalaAnesthesiaServices
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://surgerycenterofocala.com/"
