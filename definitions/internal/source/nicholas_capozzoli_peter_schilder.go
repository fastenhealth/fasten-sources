...
func GetSourceNicholasCapozzoliPeterSchilder(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNicholasCapozzoliPeterSchilder]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Nicholas Capozzoli  Peter Schilder"
	sourceDef.SourceType = pkg.SourceTypeNicholasCapozzoliPeterSchilder
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.drnicholascapozzoli.com"
