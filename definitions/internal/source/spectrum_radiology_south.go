...
func GetSourceSpectrumRadiologySouth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSpectrumRadiologySouth]; clientIdOk {
	...
	sourceDef.Category = []string{"2085R0001X", "2085R0202X", "2085R0204X", "363A00000X", "363L00000X"}
