...
func GetSourceLakePflugervillePediatricHouseC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLakePflugervillePediatricHouseC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lake Pflugerville Pediatric House C"
	sourceDef.SourceType = pkg.SourceTypeLakePflugervillePediatricHouseC
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.lakepflugervillepediatrichousecalls.com"
