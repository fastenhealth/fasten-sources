...
func GetSourceOrthopedicSpineCentersOfWisconsin(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthopedicSpineCentersOfWisconsin]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Orthopedic  Spine Centers of Wisconsin"
	sourceDef.SourceType = pkg.SourceTypeOrthopedicSpineCentersOfWisconsin
