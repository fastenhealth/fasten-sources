...
func GetSourcePrairieClinicSc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePrairieClinicSc]; clientIdOk {
	...
	sourceDef.Category = []string{"207Q00000X", "207R00000X", "207V00000X", "208000000X", "332B00000X"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1235163494", "1407060791"}}
