...
func GetSourceMusculoskeletalInstituteOfAmerica(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMusculoskeletalInstituteOfAmerica]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MusculoSkeletal Institute of America"
	sourceDef.SourceType = pkg.SourceTypeMusculoskeletalInstituteOfAmerica
