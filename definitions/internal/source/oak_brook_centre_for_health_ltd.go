...
func GetSourceOakBrookCentreForHealthLtd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOakBrookCentreForHealthLtd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Oak Brook Centre For Health Ltd"
	sourceDef.SourceType = pkg.SourceTypeOakBrookCentreForHealthLtd
