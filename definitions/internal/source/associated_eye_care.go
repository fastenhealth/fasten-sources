...
func GetSourceAssociatedEyeCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAssociatedEyeCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Associated Eye Care"
	sourceDef.SourceType = pkg.SourceTypeAssociatedEyeCare
	sourceDef.PatientAccessUrl = "https://www.associatedeyecare.net/"
