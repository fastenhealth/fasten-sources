...
func GetSourceCc015WomensExecutiveHealthcare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc015WomensExecutiveHealthcare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC015WOMENS EXECUTIVE HEALTHCARE"
	sourceDef.SourceType = pkg.SourceTypeCc015WomensExecutiveHealthcare
