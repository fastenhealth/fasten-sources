...
func GetSourcePowderRiverPhysicalMedicineReha(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePowderRiverPhysicalMedicineReha]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Powder River Physical Medicine Reha"
	sourceDef.SourceType = pkg.SourceTypePowderRiverPhysicalMedicineReha
