...
func GetSourceMentalHealthAmericaOfRoanokeVa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMentalHealthAmericaOfRoanokeVa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Mental Health America of Roanoke Va"
	sourceDef.SourceType = pkg.SourceTypeMentalHealthAmericaOfRoanokeVa
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.mharv.org"
