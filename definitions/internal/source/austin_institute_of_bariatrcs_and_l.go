...
func GetSourceAustinInstituteOfBariatrcsAndL(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAustinInstituteOfBariatrcsAndL]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Austin Institute of Bariatrcs and L"
	sourceDef.SourceType = pkg.SourceTypeAustinInstituteOfBariatrcsAndL
