...
func GetSourceLakesideFamilyPhysiciansPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLakesideFamilyPhysiciansPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lakeside Family Physicians PLLC"
	sourceDef.SourceType = pkg.SourceTypeLakesideFamilyPhysiciansPllc
