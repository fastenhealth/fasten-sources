...
func GetSourceAlexDenesMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlexDenesMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Alex Denes MD"
	sourceDef.SourceType = pkg.SourceTypeAlexDenesMd
	sourceDef.BrandLogo = "alex-denes-md.jpg"
	sourceDef.PatientAccessUrl = "https://physicians.wustl.edu/"
