...
func GetSourceWilmingtonMaternalFetalMedicine1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWilmingtonMaternalFetalMedicine1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeWilmingtonMaternalFetalMedicine1
	...
	sourceDef.BrandLogo = "wilmington-maternal-fetal-medicine.png"
