...
func GetSourceAmericanAccessCarePhysiciansBk(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAmericanAccessCarePhysiciansBk]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "American Access Care Physicians Bk"
	sourceDef.SourceType = pkg.SourceTypeAmericanAccessCarePhysiciansBk
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.azuravascularcare.com/center/american-access-care-brooklyn/"
