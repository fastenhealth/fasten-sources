...
func GetSourceWomensHealthCenterOfClrksvlle(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomensHealthCenterOfClrksvlle]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Womens Health Center Of Clrksvlle"
	sourceDef.SourceType = pkg.SourceTypeWomensHealthCenterOfClrksvlle
