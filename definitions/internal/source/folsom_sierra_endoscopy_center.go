...
func GetSourceFolsomSierraEndoscopyCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFolsomSierraEndoscopyCenter]; clientIdOk {
	...
	sourceDef.Aliases = []string{"FOLSOM SIERRA ENDOSCOPY CENTER"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1538664339"}}
	sourceDef.PatientAccessUrl = "https://folsomsierraendoscopycenter.com/"
