...
func GetSourceUrogynecologySpecialistsOfFloridaLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUrogynecologySpecialistsOfFloridaLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Urogynecology Specialists of Florida LLC"
	sourceDef.SourceType = pkg.SourceTypeUrogynecologySpecialistsOfFloridaLlc
