...
func GetSourceCardiologyInternalMedicineGrou(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCardiologyInternalMedicineGrou]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Cardiology  Internal Medicine Grou"
	sourceDef.SourceType = pkg.SourceTypeCardiologyInternalMedicineGrou
