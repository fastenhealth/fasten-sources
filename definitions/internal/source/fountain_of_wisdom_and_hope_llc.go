...
func GetSourceFountainOfWisdomAndHopeLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFountainOfWisdomAndHopeLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FOUNTAIN OF WISDOM AND HOPE LLC"
	sourceDef.SourceType = pkg.SourceTypeFountainOfWisdomAndHopeLlc
