...
func GetSourceWomenCenterLaObgynPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomenCenterLaObgynPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "WOMEN CENTER LA OBGYN PC"
	sourceDef.SourceType = pkg.SourceTypeWomenCenterLaObgynPc
