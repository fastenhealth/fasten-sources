...
func GetSourceGreaterLaPainSpecialistsInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGreaterLaPainSpecialistsInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Greater LA Pain Specialists Inc"
	sourceDef.SourceType = pkg.SourceTypeGreaterLaPainSpecialistsInc
