...
func GetSourceLeChangFamilyUrgentCarePc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLeChangFamilyUrgentCarePc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "LE  CHANG FAMILY URGENT CARE PC"
	sourceDef.SourceType = pkg.SourceTypeLeChangFamilyUrgentCarePc
