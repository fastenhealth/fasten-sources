...
func GetSourceDrPareshNVaru(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrPareshNVaru]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Dr Paresh N Varu"
	sourceDef.SourceType = pkg.SourceTypeDrPareshNVaru
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.providence.org/doctors/internal-medicine/ca/burbank/paresh-varu-1215041397"
