...
func GetSourceNePhiladelphiaVascular(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNePhiladelphiaVascular]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "NE Philadelphia Vascular"
	sourceDef.SourceType = pkg.SourceTypeNePhiladelphiaVascular
	sourceDef.PatientAccessUrl = "https://vascularhealthllc.com"
