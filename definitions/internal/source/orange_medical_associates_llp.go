...
func GetSourceOrangeMedicalAssociatesLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrangeMedicalAssociatesLlp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ORANGE MEDICAL ASSOCIATES LLP"
	sourceDef.SourceType = pkg.SourceTypeOrangeMedicalAssociatesLlp
