...
func GetSourcePremierFamilyHealthcare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePremierFamilyHealthcare]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypePremierFamilyHealthcare
