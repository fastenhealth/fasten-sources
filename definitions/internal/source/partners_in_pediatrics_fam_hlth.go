...
func GetSourcePartnersInPediatricsFamHlth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePartnersInPediatricsFamHlth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Partners In Pediatrics  Fam Hlth"
	sourceDef.SourceType = pkg.SourceTypePartnersInPediatricsFamHlth
