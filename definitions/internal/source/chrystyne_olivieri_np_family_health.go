...
func GetSourceChrystyneOlivieriNpFamilyHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeChrystyneOlivieriNpFamilyHealth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CHRYSTYNE OLIVIERI NP FAMILY HEALTH"
	sourceDef.SourceType = pkg.SourceTypeChrystyneOlivieriNpFamilyHealth
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.yourpaleopractitioner.com"
