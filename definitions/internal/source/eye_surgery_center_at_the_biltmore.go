...
func GetSourceEyeSurgeryCenterAtTheBiltmore(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeSurgeryCenterAtTheBiltmore]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Surgery Center At The Biltmore"
	sourceDef.SourceType = pkg.SourceTypeEyeSurgeryCenterAtTheBiltmore
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "eye-surgery-center-at-the-biltmore.jpg"
	sourceDef.PatientAccessUrl = "https://eyesurgeryaz.com/"
