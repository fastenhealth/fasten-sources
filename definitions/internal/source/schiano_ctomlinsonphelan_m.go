...
func GetSourceSchianoCtomlinsonphelanM(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSchianoCtomlinsonphelanM]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Schiano CTomlinsonPhelan M"
	sourceDef.SourceType = pkg.SourceTypeSchianoCtomlinsonphelanM
