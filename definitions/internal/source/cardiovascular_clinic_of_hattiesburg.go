...
func GetSourceCardiovascularClinicOfHattiesburg(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCardiovascularClinicOfHattiesburg]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Cardiovascular Clinic of Hattiesburg"
	sourceDef.SourceType = pkg.SourceTypeCardiovascularClinicOfHattiesburg
