...
func GetSourceErSpecialistsUrgencyCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeErSpecialistsUrgencyCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ER Specialists Urgency Center"
	sourceDef.SourceType = pkg.SourceTypeErSpecialistsUrgencyCenter
