...
func GetSourceNorthLaVascularAndEndovascular(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthLaVascularAndEndovascular]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "North LA Vascular and Endovascular"
	sourceDef.SourceType = pkg.SourceTypeNorthLaVascularAndEndovascular
