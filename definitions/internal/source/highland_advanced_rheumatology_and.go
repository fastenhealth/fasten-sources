...
func GetSourceHighlandAdvancedRheumatologyAnd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHighlandAdvancedRheumatologyAnd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Highland Advanced Rheumatology and"
	sourceDef.SourceType = pkg.SourceTypeHighlandAdvancedRheumatologyAnd
