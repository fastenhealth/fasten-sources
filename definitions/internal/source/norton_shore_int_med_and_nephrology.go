...
func GetSourceNortonShoreIntMedAndNephrology(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNortonShoreIntMedAndNephrology]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Norton Shore Int Med and Nephrology"
	sourceDef.SourceType = pkg.SourceTypeNortonShoreIntMedAndNephrology
