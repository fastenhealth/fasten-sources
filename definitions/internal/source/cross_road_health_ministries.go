...
func GetSourceCrossRoadHealthMinistries(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCrossRoadHealthMinistries]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Cross Road Health Ministries"
	sourceDef.SourceType = pkg.SourceTypeCrossRoadHealthMinistries
	sourceDef.PatientAccessUrl = "https://crossroadmc.org/"
