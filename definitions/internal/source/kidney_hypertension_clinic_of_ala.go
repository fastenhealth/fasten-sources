...
func GetSourceKidneyHypertensionClinicOfAla(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKidneyHypertensionClinicOfAla]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Kidney  Hypertension Clinic of Ala"
	sourceDef.SourceType = pkg.SourceTypeKidneyHypertensionClinicOfAla
