...
func GetSourceRosevilleSurgicalAllianceInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRosevilleSurgicalAllianceInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ROSEVILLE SURGICAL ALLIANCE INC"
	sourceDef.SourceType = pkg.SourceTypeRosevilleSurgicalAllianceInc
