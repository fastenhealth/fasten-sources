...
func GetSourceWalkerSurgeryAndEndoscopyPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWalkerSurgeryAndEndoscopyPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "WALKER SURGERY AND ENDOSCOPY PC"
	sourceDef.SourceType = pkg.SourceTypeWalkerSurgeryAndEndoscopyPc
