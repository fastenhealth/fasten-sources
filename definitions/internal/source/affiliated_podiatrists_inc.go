...
func GetSourceAffiliatedPodiatristsInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAffiliatedPodiatristsInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Affiliated Podiatrists Inc"
	sourceDef.SourceType = pkg.SourceTypeAffiliatedPodiatristsInc
