...
func GetSourceCc901SpecialtyServicesCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc901SpecialtyServicesCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC901SPECIALTY SERVICES CENTER"
	sourceDef.SourceType = pkg.SourceTypeCc901SpecialtyServicesCenter
