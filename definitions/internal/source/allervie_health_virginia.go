...
func GetSourceAllervieHealthVirginia(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAllervieHealthVirginia]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "AllerVie Health Virginia"
	sourceDef.SourceType = pkg.SourceTypeAllervieHealthVirginia
	sourceDef.BrandLogo = "allervie-health-virginia.svg"
	sourceDef.PatientAccessUrl = "https://www.allervie.com/"
