...
func GetSourceDiabetesAndEndocrineCareOfVirg(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDiabetesAndEndocrineCareOfVirg]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Diabetes and Endocrine Care of Virg"
	sourceDef.SourceType = pkg.SourceTypeDiabetesAndEndocrineCareOfVirg
