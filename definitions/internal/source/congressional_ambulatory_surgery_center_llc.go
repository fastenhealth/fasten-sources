...
func GetSourceCongressionalAmbulatorySurgeryCenterLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCongressionalAmbulatorySurgeryCenterLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CONGRESSIONAL AMBULATORY SURGERY CENTER LLC"
	sourceDef.SourceType = pkg.SourceTypeCongressionalAmbulatorySurgeryCenterLlc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.congressionalobgyn.com"
