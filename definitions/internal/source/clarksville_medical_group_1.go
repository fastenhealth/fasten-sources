...
func GetSourceClarksvilleMedicalGroup1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeClarksvilleMedicalGroup1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeClarksvilleMedicalGroup1
