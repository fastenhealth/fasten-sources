...
func GetSourceFamilyMedicineOfNorthHamptonL(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyMedicineOfNorthHamptonL]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FAMILY MEDICINE OF NORTH HAMPTON L"
	sourceDef.SourceType = pkg.SourceTypeFamilyMedicineOfNorthHamptonL
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.familymedicineofnorthhampton.com"
