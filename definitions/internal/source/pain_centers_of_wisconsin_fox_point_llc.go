...
func GetSourcePainCentersOfWisconsinFoxPointLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePainCentersOfWisconsinFoxPointLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pain Centers Of Wisconsin Fox Point LLC"
	sourceDef.SourceType = pkg.SourceTypePainCentersOfWisconsinFoxPointLlc
	sourceDef.PatientAccessUrl = "https://npino.com/medical-supplies/1679136584-pain-centers-of-wisconsin---fox-point%2C-llc/"
