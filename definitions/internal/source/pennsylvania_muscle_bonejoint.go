...
func GetSourcePennsylvaniaMuscleBonejoint(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePennsylvaniaMuscleBonejoint]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pennsylvania Muscle BoneJoint"
	sourceDef.SourceType = pkg.SourceTypePennsylvaniaMuscleBonejoint
