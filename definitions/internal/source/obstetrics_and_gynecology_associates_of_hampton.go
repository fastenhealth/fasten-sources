...
func GetSourceObstetricsAndGynecologyAssociatesOfHampton(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeObstetricsAndGynecologyAssociatesOfHampton]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Obstetrics and Gynecology Associates of Hampton"
	sourceDef.SourceType = pkg.SourceTypeObstetricsAndGynecologyAssociatesOfHampton
