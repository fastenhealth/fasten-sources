...
func GetSourceNaplesConciergeCardiologyAndInt(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNaplesConciergeCardiologyAndInt]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Naples Concierge Cardiology and Int"
	sourceDef.SourceType = pkg.SourceTypeNaplesConciergeCardiologyAndInt
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.naplesccim.com"
