...
func GetSourceNephrologyCenterSouthwestMichigan(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeNephrologyCenterSouthwestMichigan
