...
func GetSourceFranklinCountyMedicalCenter1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFranklinCountyMedicalCenter1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeFranklinCountyMedicalCenter1
