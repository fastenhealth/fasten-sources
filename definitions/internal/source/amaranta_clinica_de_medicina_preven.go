...
func GetSourceAmarantaClinicaDeMedicinaPreven(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAmarantaClinicaDeMedicinaPreven]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Amaranta Clinica De Medicina Preven"
	sourceDef.SourceType = pkg.SourceTypeAmarantaClinicaDeMedicinaPreven
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://amarantacmp.com/"
