...
func GetSourceQueenCreekPrimaryCarePc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeQueenCreekPrimaryCarePc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Queen Creek Primary Care PC"
	sourceDef.SourceType = pkg.SourceTypeQueenCreekPrimaryCarePc
