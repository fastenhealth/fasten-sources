...
func GetSourcePrimaryCareOfTennesseeAtTennova(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePrimaryCareOfTennesseeAtTennova]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Primary Care of Tennessee at Tennova"
	sourceDef.SourceType = pkg.SourceTypePrimaryCareOfTennesseeAtTennova
