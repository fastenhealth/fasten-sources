...
func GetSourcePrestigeMedicalClinicAndUrgent(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePrestigeMedicalClinicAndUrgent]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Prestige Medical Clinic and Urgent"
	sourceDef.SourceType = pkg.SourceTypePrestigeMedicalClinicAndUrgent
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.prestigemedicalclinic.com"
