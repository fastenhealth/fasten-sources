...
func GetSourceColorectalHealthNorthwest(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeColorectalHealthNorthwest]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "COLORECTAL HEALTH NORTHWEST"
	sourceDef.SourceType = pkg.SourceTypeColorectalHealthNorthwest
