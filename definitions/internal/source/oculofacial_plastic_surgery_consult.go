...
func GetSourceOculofacialPlasticSurgeryConsult(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOculofacialPlasticSurgeryConsult]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Oculofacial Plastic Surgery Consult"
	sourceDef.SourceType = pkg.SourceTypeOculofacialPlasticSurgeryConsult
