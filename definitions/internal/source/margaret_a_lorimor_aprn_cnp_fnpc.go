...
func GetSourceMargaretALorimorAprnCnpFnpc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMargaretALorimorAprnCnpFnpc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Margaret A  Lorimor APRN CNP FNPC"
	sourceDef.SourceType = pkg.SourceTypeMargaretALorimorAprnCnpFnpc
