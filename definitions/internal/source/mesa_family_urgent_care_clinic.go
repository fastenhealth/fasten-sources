...
func GetSourceMesaFamilyUrgentCareClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMesaFamilyUrgentCareClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Mesa Family  Urgent Care Clinic"
	sourceDef.SourceType = pkg.SourceTypeMesaFamilyUrgentCareClinic
