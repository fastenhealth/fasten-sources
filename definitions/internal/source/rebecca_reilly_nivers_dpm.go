...
func GetSourceRebeccaReillyNiversDpm(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRebeccaReillyNiversDpm]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Rebecca Reilly Nivers DPM"
	sourceDef.SourceType = pkg.SourceTypeRebeccaReillyNiversDpm
