...
func GetSourceAthleticoMissouri(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAthleticoMissouri]; clientIdOk {
	...
	sourceDef.BrandLogo = "athletico-missouri.svg"
