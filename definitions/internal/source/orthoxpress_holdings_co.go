...
func GetSourceOrthoxpressHoldingsCo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthoxpressHoldingsCo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "OrthoXpress Holdings Co"
	sourceDef.SourceType = pkg.SourceTypeOrthoxpressHoldingsCo
