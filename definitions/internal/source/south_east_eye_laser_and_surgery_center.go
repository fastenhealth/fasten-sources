...
func GetSourceSouthEastEyeLaserAndSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthEastEyeLaserAndSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "South East Eye Laser And Surgery Center"
	sourceDef.SourceType = pkg.SourceTypeSouthEastEyeLaserAndSurgeryCenter
	sourceDef.PatientAccessUrl = "https://www.southeast-eye.com/"
