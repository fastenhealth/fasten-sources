...
func GetSourcePrimaryCarePartnersOfHawaii(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePrimaryCarePartnersOfHawaii]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Primary Care Partners of Hawaii"
	sourceDef.SourceType = pkg.SourceTypePrimaryCarePartnersOfHawaii
