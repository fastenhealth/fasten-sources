...
func GetSourceInnovativeUrologyPracticeOfNew(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeInnovativeUrologyPracticeOfNew]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "INNOVATIVE UROLOGY PRACTICE OF NEW"
	sourceDef.SourceType = pkg.SourceTypeInnovativeUrologyPracticeOfNew
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.IUPNY.com"
