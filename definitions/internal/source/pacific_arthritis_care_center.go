...
func GetSourcePacificArthritisCareCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePacificArthritisCareCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pacific Arthritis Care Center"
	sourceDef.SourceType = pkg.SourceTypePacificArthritisCareCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://pacificarthritis.com/"
