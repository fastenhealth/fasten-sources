...
func GetSourceEstrellaEarNoseAndThroatPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEstrellaEarNoseAndThroatPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ESTRELLA EAR NOSE AND THROAT PC"
	sourceDef.SourceType = pkg.SourceTypeEstrellaEarNoseAndThroatPc
