...
func GetSourceEarNoseAndThroatAssociatesOfSouthArkansas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEarNoseAndThroatAssociatesOfSouthArkansas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Ear Nose and Throat Associates of South Arkansas"
	sourceDef.SourceType = pkg.SourceTypeEarNoseAndThroatAssociatesOfSouthArkansas
