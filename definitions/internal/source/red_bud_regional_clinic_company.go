...
func GetSourceRedBudRegionalClinicCompany(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRedBudRegionalClinicCompany]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "RED BUD REGIONAL CLINIC COMPANY"
	sourceDef.SourceType = pkg.SourceTypeRedBudRegionalClinicCompany
