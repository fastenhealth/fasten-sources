...
func GetSourceParadiseValleyFootAnklePllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeParadiseValleyFootAnklePllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Paradise Valley Foot  Ankle PLLC"
	sourceDef.SourceType = pkg.SourceTypeParadiseValleyFootAnklePllc
