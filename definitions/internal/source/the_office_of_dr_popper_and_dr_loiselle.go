...
func GetSourceTheOfficeOfDrPopperAndDrLoiselle(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheOfficeOfDrPopperAndDrLoiselle]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The office of Dr Popper and Dr Loiselle"
	sourceDef.SourceType = pkg.SourceTypeTheOfficeOfDrPopperAndDrLoiselle
