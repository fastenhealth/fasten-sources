...
func GetSourceHandsOfHopeHealthCareCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHandsOfHopeHealthCareCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Hands Of Hope Health Care Center"
	sourceDef.SourceType = pkg.SourceTypeHandsOfHopeHealthCareCenter
