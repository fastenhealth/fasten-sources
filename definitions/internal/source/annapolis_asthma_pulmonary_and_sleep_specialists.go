...
func GetSourceAnnapolisAsthmaPulmonaryAndSleepSpecialists(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnnapolisAsthmaPulmonaryAndSleepSpecialists]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Annapolis Asthma Pulmonary and Sleep Specialists"
	sourceDef.SourceType = pkg.SourceTypeAnnapolisAsthmaPulmonaryAndSleepSpecialists
