...
func GetSourceCc201FrankJamesAndresMdIiLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc201FrankJamesAndresMdIiLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC201FRANK JAMES ANDRES MD II LLC"
	sourceDef.SourceType = pkg.SourceTypeCc201FrankJamesAndresMdIiLlc
