...
func GetSourcePremierSurgicalAndPremierVein(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePremierSurgicalAndPremierVein]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "PREMIER SURGICAL AND PREMIER VEIN"
	sourceDef.SourceType = pkg.SourceTypePremierSurgicalAndPremierVein
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://premiersurgicalnj.com/"
