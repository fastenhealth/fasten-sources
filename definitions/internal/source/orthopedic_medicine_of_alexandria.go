...
func GetSourceOrthopedicMedicineOfAlexandria(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthopedicMedicineOfAlexandria]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Orthopedic Medicine of Alexandria"
	sourceDef.SourceType = pkg.SourceTypeOrthopedicMedicineOfAlexandria
