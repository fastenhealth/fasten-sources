...
func GetSourceCc213OsceolaObgynIiLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc213OsceolaObgynIiLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC213OSCEOLA OBGYN II LLC"
	sourceDef.SourceType = pkg.SourceTypeCc213OsceolaObgynIiLlc
