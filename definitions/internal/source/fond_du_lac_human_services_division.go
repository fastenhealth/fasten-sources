...
func GetSourceFondDuLacHumanServicesDivision(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFondDuLacHumanServicesDivision]; clientIdOk {
	...
	sourceDef.BrandLogo = "fond-du-lac-hsd-purchased-referred-care.png"
