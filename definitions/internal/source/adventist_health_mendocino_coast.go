...
func GetSourceAdventistHealthMendocinoCoast(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdventistHealthMendocinoCoast]; clientIdOk {
	...
	sourceDef.Category = []string{"282NC0060X", "251E00000X", "261QR1300X"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1538113725", "1710932157", "1124220249"}}
