...
func GetSourceSuncoastVascularAndGeneralSurge(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSuncoastVascularAndGeneralSurge]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Suncoast Vascular and General Surge"
	sourceDef.SourceType = pkg.SourceTypeSuncoastVascularAndGeneralSurge
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://suncoastvascular.com"
