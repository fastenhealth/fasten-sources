...
func GetSourceCarolinaHeadacheInstitute1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCarolinaHeadacheInstitute1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeCarolinaHeadacheInstitute1
