...
func GetSourceRochesterRegionalHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.RegistrationEndpoint = "https://epicarr.rochesterregional.org/FHIR/oauth2/register"
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRochesterRegionalHealth]; clientIdOk {
