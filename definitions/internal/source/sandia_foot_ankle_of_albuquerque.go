...
func GetSourceSandiaFootAnkleOfAlbuquerque(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSandiaFootAnkleOfAlbuquerque]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sandia Foot  Ankle of Albuquerque"
	sourceDef.SourceType = pkg.SourceTypeSandiaFootAnkleOfAlbuquerque
