...
func GetSourceTheHealingHouseOfNewMexico(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheHealingHouseOfNewMexico]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Healing House of New Mexico"
	sourceDef.SourceType = pkg.SourceTypeTheHealingHouseOfNewMexico
