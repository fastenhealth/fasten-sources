...
func GetSourceBreckinridgeHealthPainManagementCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBreckinridgeHealthPainManagementCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Breckinridge Health Pain Management Center"
	sourceDef.SourceType = pkg.SourceTypeBreckinridgeHealthPainManagementCenter
