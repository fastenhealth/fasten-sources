...
func GetSourceErickMadrigalMdMbaInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeErickMadrigalMdMbaInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Erick Madrigal MD MBA Inc"
	sourceDef.SourceType = pkg.SourceTypeErickMadrigalMdMbaInc
