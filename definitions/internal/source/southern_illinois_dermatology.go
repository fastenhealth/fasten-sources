...
func GetSourceSouthernIllinoisDermatology(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthernIllinoisDermatology]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Southern Illinois Dermatology"
	sourceDef.SourceType = pkg.SourceTypeSouthernIllinoisDermatology
	sourceDef.PatientAccessUrl = "https://siderm.com/"
