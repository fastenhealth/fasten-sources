...
func GetSourceSchoolBasedClinicsNoPortal(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSchoolBasedClinicsNoPortal]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "School Based Clinics  No Portal"
	sourceDef.SourceType = pkg.SourceTypeSchoolBasedClinicsNoPortal
