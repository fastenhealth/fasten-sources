...
func GetSourceNewHopeGeneralAndOncologicSurg(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNewHopeGeneralAndOncologicSurg]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "New Hope General and Oncologic Surg"
	sourceDef.SourceType = pkg.SourceTypeNewHopeGeneralAndOncologicSurg
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://newhopegos.com\t\t\t\t\t\t\t\t\t\t\t\t"
