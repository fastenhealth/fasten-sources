...
func GetSourceUniversityMedicalCenter1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUniversityMedicalCenter1]; clientIdOk {
	...
	sourceDef.Category = []string{"207Q00000X", "282N00000X"}
	sourceDef.Aliases = []string{"Student Health Center", "UNIVERSITY MEDICAL CENTER"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1740397751", "1962567107"}}
