...
func GetSourceJuliaRiftineMdObstetricsAndGyn(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJuliaRiftineMdObstetricsAndGyn]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Julia Riftine MD Obstetrics and Gyn"
	sourceDef.SourceType = pkg.SourceTypeJuliaRiftineMdObstetricsAndGyn
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://riftine.com"
