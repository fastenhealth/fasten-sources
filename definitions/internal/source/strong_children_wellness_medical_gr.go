...
func GetSourceStrongChildrenWellnessMedicalGr(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeStrongChildrenWellnessMedicalGr]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Strong Children Wellness Medical Gr"
	sourceDef.SourceType = pkg.SourceTypeStrongChildrenWellnessMedicalGr
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.strongchildrenwellness.com"
