...
func GetSourceClinicalGeneticsAssociatesMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeClinicalGeneticsAssociatesMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CLINICAL GENETICS ASSOCIATES MD"
	sourceDef.SourceType = pkg.SourceTypeClinicalGeneticsAssociatesMd
