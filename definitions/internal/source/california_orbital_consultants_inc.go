...
func GetSourceCaliforniaOrbitalConsultantsInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaliforniaOrbitalConsultantsInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CALIFORNIA ORBITAL CONSULTANTS INC"
	sourceDef.SourceType = pkg.SourceTypeCaliforniaOrbitalConsultantsInc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.myeyelidsurgeon.com"
