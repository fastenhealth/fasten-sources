...
func GetSourceFamilyBirthWomensHealthCente(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyBirthWomensHealthCente]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Family Birth  Womens Health Cente"
	sourceDef.SourceType = pkg.SourceTypeFamilyBirthWomensHealthCente
