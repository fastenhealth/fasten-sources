...
func GetSourceSkinAndMohsSurgeryCenterLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSkinAndMohsSurgeryCenterLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Skin And Mohs Surgery Center LLC"
	sourceDef.SourceType = pkg.SourceTypeSkinAndMohsSurgeryCenterLlc
