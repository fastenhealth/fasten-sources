...
func GetSourceRobertCFeldmanMdPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRobertCFeldmanMdPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Robert C Feldman MD PA"
	sourceDef.SourceType = pkg.SourceTypeRobertCFeldmanMdPa
	sourceDef.PatientAccessUrl = "https://theeyecenterinc.com/"
