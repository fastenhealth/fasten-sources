...
func GetSourcePolycliniqueWestPalmBeach(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePolycliniqueWestPalmBeach]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Polyclinique West Palm Beach"
	sourceDef.SourceType = pkg.SourceTypePolycliniqueWestPalmBeach
