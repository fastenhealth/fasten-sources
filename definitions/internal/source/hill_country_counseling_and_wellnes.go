...
func GetSourceHillCountryCounselingAndWellnes(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHillCountryCounselingAndWellnes]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "HILL COUNTRY COUNSELING AND WELLNES"
	sourceDef.SourceType = pkg.SourceTypeHillCountryCounselingAndWellnes
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.hccwtx.org"
