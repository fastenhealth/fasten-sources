...
func GetSourceCc015CentralPhoenixWomensHealthCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc015CentralPhoenixWomensHealthCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC015CENTRAL PHOENIX WOMENS HEALTH CARE"
	sourceDef.SourceType = pkg.SourceTypeCc015CentralPhoenixWomensHealthCare
