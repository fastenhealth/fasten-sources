...
func GetSourceLaClinicaLatinaSpanishFreeClin(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLaClinicaLatinaSpanishFreeClin]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "La Clinica Latina Spanish Free Clin"
	sourceDef.SourceType = pkg.SourceTypeLaClinicaLatinaSpanishFreeClin
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.laclinicalatinaoh.com"
