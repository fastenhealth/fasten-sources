...
func GetSourceFamilyFirstHealthcare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Display = "Family First Healthcare"
	sourceDef.SourceType = pkg.SourceTypeFamilyFirstHealthcare
	sourceDef.Category = []string{"207Q00000X", "251E00000X", "363LF0000X"}
	sourceDef.Aliases = []string{"FAMILY FIRST HEALTHCARE"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1053070698", "1184764276", "1649923707", "1770197618"}}
