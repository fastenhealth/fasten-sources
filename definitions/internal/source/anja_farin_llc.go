...
func GetSourceAnjaFarinLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnjaFarinLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Anja Farin LLC"
	sourceDef.SourceType = pkg.SourceTypeAnjaFarinLlc
	sourceDef.Category = []string{"176B00000X"}
	sourceDef.Aliases = []string{}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1669107033"}}
	sourceDef.PatientAccessUrl = "https://www.anjafarin.com/"
