...
func GetSourceSacredRootsMidwiferyLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSacredRootsMidwiferyLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SACRED ROOTS MIDWIFERY LLC"
	sourceDef.SourceType = pkg.SourceTypeSacredRootsMidwiferyLlc
