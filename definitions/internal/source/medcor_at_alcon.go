...
func GetSourceMedcorAtAlcon(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMedcorAtAlcon]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Medcor At Alcon"
	sourceDef.SourceType = pkg.SourceTypeMedcorAtAlcon
	sourceDef.PatientAccessUrl = "https://www.alcon.com/"
