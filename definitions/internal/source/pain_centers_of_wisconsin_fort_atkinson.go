...
func GetSourcePainCentersOfWisconsinFortAtkinson(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePainCentersOfWisconsinFortAtkinson]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pain Centers Of Wisconsin Fort Atkinson"
	sourceDef.SourceType = pkg.SourceTypePainCentersOfWisconsinFortAtkinson
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.forthealthcare.com/clinic/pain-management-clinic/"
