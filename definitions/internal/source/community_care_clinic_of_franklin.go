...
func GetSourceCommunityCareClinicOfFranklin(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCommunityCareClinicOfFranklin]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Community Care Clinic of Franklin"
	sourceDef.SourceType = pkg.SourceTypeCommunityCareClinicOfFranklin
