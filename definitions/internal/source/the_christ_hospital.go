...
func GetSourceTheChristHospital(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Category = []string{"273R00000X", "273Y00000X", "282N00000X", "333600000X"}
	sourceDef.Aliases = []string{"THE CHRIST HOSPITAL"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1124577705", "1780633289", "1912232794", "1932157385", "1932158466"}}
