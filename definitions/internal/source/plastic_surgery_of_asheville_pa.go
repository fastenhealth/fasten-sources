...
func GetSourcePlasticSurgeryOfAshevillePa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePlasticSurgeryOfAshevillePa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Plastic Surgery of Asheville PA"
	sourceDef.SourceType = pkg.SourceTypePlasticSurgeryOfAshevillePa
