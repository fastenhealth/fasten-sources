...
func GetSourceJamesWassonMdPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJamesWassonMdPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "James Wasson MD PC"
	sourceDef.SourceType = pkg.SourceTypeJamesWassonMdPc
	sourceDef.PatientAccessUrl = "http://www.drwasson.com/"
