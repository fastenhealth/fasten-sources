...
func GetSourceMyChoicesDbaObriaMedicalPnw(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMyChoicesDbaObriaMedicalPnw]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "My Choices DBA Obria Medical PNW"
	sourceDef.SourceType = pkg.SourceTypeMyChoicesDbaObriaMedicalPnw
