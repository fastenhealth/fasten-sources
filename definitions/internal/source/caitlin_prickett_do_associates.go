...
func GetSourceCaitlinPrickettDoAssociates(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaitlinPrickettDoAssociates]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CAITLIN PRICKETT DO  ASSOCIATES"
	sourceDef.SourceType = pkg.SourceTypeCaitlinPrickettDoAssociates
