...
func GetSourceWashingtonCountyMemorialHospital(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Aliases = []string{"AUSTIN PLAZA PRIMARY CARE CLINIC", "HEALTH WAY PRIMARY CARE CLINIC", "POTOSI RURAL HEALTH CLINIC", "BELGRADE RURAL HEALTH CLINIC", "WCMH URGENT CARE CLINIC"}
