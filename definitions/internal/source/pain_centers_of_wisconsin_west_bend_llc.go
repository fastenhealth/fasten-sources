...
func GetSourcePainCentersOfWisconsinWestBendLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePainCentersOfWisconsinWestBendLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pain Centers Of Wisconsin West Bend LLC"
	sourceDef.SourceType = pkg.SourceTypePainCentersOfWisconsinWestBendLlc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.wispineandpain.com/"
