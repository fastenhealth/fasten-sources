...
func GetSourceShoalsOrthopedicsSportsMedicin(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeShoalsOrthopedicsSportsMedicin]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Shoals Orthopedics  Sports Medicin"
	sourceDef.SourceType = pkg.SourceTypeShoalsOrthopedicsSportsMedicin
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.shoalsorthopedics.com"
