...
func GetSourceUrologicalPhysiciansOfSanDiego(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUrologicalPhysiciansOfSanDiego]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Urological Physicians of San Diego"
	sourceDef.SourceType = pkg.SourceTypeUrologicalPhysiciansOfSanDiego
