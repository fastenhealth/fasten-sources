...
func GetSourceMidwestAllergySinusAsthmaSc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMidwestAllergySinusAsthmaSc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Midwest Allergy Sinus Asthma SC"
	sourceDef.SourceType = pkg.SourceTypeMidwestAllergySinusAsthmaSc
