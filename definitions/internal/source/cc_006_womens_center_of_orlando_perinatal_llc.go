...
func GetSourceCc006WomensCenterOfOrlandoPerinatalLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc006WomensCenterOfOrlandoPerinatalLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC006WOMENS CENTER OF ORLANDO PERINATAL LLC"
	sourceDef.SourceType = pkg.SourceTypeCc006WomensCenterOfOrlandoPerinatalLlc
