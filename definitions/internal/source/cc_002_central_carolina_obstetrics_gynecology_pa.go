...
func GetSourceCc002CentralCarolinaObstetricsGynecologyPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc002CentralCarolinaObstetricsGynecologyPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC002Central Carolina Obstetrics Gynecology PA"
	sourceDef.SourceType = pkg.SourceTypeCc002CentralCarolinaObstetricsGynecologyPa
