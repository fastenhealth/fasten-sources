...
func GetSourcePregnancySupportCenterOfStarkC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePregnancySupportCenterOfStarkC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pregnancy Support Center of Stark C"
	sourceDef.SourceType = pkg.SourceTypePregnancySupportCenterOfStarkC
