...
func GetSourceHouseCallDoctorsOfPacificNorth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHouseCallDoctorsOfPacificNorth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "House Call Doctors of Pacific North"
	sourceDef.SourceType = pkg.SourceTypeHouseCallDoctorsOfPacificNorth
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.housecalldoctorspacificnorthwest.com/"
