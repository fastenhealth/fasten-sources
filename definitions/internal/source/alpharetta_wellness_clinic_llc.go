...
func GetSourceAlpharettaWellnessClinicLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlpharettaWellnessClinicLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ALPHARETTA WELLNESS CLINIC LLC"
	sourceDef.SourceType = pkg.SourceTypeAlpharettaWellnessClinicLlc
