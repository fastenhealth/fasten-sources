...
func GetSourceSunshineHealthPartnersLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSunshineHealthPartnersLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SUNSHINE HEALTH PARTNERS LLC"
	sourceDef.SourceType = pkg.SourceTypeSunshineHealthPartnersLlc
