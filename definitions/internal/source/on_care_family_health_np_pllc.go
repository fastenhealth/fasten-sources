...
func GetSourceOnCareFamilyHealthNpPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOnCareFamilyHealthNpPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ON CARE FAMILY HEALTH NP PLLC"
	sourceDef.SourceType = pkg.SourceTypeOnCareFamilyHealthNpPllc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.oncarefamilyhealth.com"
