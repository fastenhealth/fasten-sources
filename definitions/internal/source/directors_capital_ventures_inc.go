...
func GetSourceDirectorsCapitalVenturesInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDirectorsCapitalVenturesInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Directors Capital Ventures Inc"
	sourceDef.SourceType = pkg.SourceTypeDirectorsCapitalVenturesInc
