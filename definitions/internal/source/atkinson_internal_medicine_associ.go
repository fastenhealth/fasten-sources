...
func GetSourceAtkinsonInternalMedicineAssoci(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAtkinsonInternalMedicineAssoci]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Atkinson Internal Medicine  Associ"
	sourceDef.SourceType = pkg.SourceTypeAtkinsonInternalMedicineAssoci
