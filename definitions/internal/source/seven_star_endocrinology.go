...
func GetSourceSevenStarEndocrinology(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSevenStarEndocrinology]; clientIdOk {
	...
	sourceDef.Aliases = []string{"SEVEN STAR ENDOCRINOLOGY"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1073116166"}}
