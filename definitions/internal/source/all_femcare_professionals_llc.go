...
func GetSourceAllFemcareProfessionalsLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAllFemcareProfessionalsLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ALL FEMCARE PROFESSIONALS LLC"
	sourceDef.SourceType = pkg.SourceTypeAllFemcareProfessionalsLlc
