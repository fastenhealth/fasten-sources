...
func GetSourceGlobalPediatricsAndFamMed(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGlobalPediatricsAndFamMed]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Global Pediatrics And Fam Med"
	sourceDef.SourceType = pkg.SourceTypeGlobalPediatricsAndFamMed
