...
func GetSourceFrederickGastroenterologyAssociates(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFrederickGastroenterologyAssociates]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.fgamd.com/"
