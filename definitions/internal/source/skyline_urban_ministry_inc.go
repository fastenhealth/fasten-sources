...
func GetSourceSkylineUrbanMinistryInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSkylineUrbanMinistryInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Skyline Urban Ministry Inc"
	sourceDef.SourceType = pkg.SourceTypeSkylineUrbanMinistryInc
