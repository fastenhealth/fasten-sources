...
func GetSourceBaltimoreSuburbanHealthLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBaltimoreSuburbanHealthLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Baltimore Suburban Health LLC"
	sourceDef.SourceType = pkg.SourceTypeBaltimoreSuburbanHealthLlc
