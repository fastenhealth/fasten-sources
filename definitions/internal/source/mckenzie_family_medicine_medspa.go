...
func GetSourceMckenzieFamilyMedicineMedspa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMckenzieFamilyMedicineMedspa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "McKenzie Family Medicine  Medspa"
	sourceDef.SourceType = pkg.SourceTypeMckenzieFamilyMedicineMedspa
