...
func GetSourceEyeSurgeryCenterOfTheDesertLtd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeSurgeryCenterOfTheDesertLtd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Surgery Center Of The Desert LTD"
	sourceDef.SourceType = pkg.SourceTypeEyeSurgeryCenterOfTheDesertLtd
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.milauskas-eye.com/locations/eye-surgery-center-of-the-desert/"
