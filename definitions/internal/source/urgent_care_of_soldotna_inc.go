...
func GetSourceUrgentCareOfSoldotnaInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUrgentCareOfSoldotnaInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Urgent Care of Soldotna Inc"
	sourceDef.SourceType = pkg.SourceTypeUrgentCareOfSoldotnaInc
