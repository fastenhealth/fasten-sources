...
func GetSourceTexarkanaSeniorCareClininc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTexarkanaSeniorCareClininc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Texarkana Senior Care Clininc"
	sourceDef.SourceType = pkg.SourceTypeTexarkanaSeniorCareClininc
