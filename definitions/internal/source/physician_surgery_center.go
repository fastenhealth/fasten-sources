...
func GetSourcePhysicianSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePhysicianSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Physician Surgery Center"
	sourceDef.SourceType = pkg.SourceTypePhysicianSurgeryCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.facebook.com/physicianssurgerycenter/"
