...
func GetSourcePulmonaryAndCriticalCareSpecialistsOfPrincetonPC1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePulmonaryAndCriticalCareSpecialistsOfPrincetonPC1]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeCerner))

	sourceDef.Display = "Pulmonary and Critical Care Specialists of Princeton, P.C."
	sourceDef.SourceType = pkg.SourceTypePulmonaryAndCriticalCareSpecialistsOfPrincetonPC1
