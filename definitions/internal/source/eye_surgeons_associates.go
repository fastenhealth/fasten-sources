...
func GetSourceEyeSurgeonsAssociates(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeSurgeonsAssociates]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Surgeons Associates"
	sourceDef.SourceType = pkg.SourceTypeEyeSurgeonsAssociates
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.eyesurgeonspc.com/our-locations/bettendorf/"
