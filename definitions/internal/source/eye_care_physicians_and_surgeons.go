...
func GetSourceEyeCarePhysiciansAndSurgeons(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeCarePhysiciansAndSurgeons]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Care Physicians and Surgeons"
	sourceDef.SourceType = pkg.SourceTypeEyeCarePhysiciansAndSurgeons
	sourceDef.BrandLogo = "eye-care-physicians-and-surgeons.jpg"
	sourceDef.PatientAccessUrl = "https://salemeyecare.com/pages/home"
