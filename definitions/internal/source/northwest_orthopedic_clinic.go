...
func GetSourceNorthwestOrthopedicClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthwestOrthopedicClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Northwest Orthopedic Clinic"
	sourceDef.SourceType = pkg.SourceTypeNorthwestOrthopedicClinic
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.nworthopaedicspecialists.com/"
