...
func GetSourceCc007PeninsulaWomensCarePc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc007PeninsulaWomensCarePc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC007PENINSULA WOMENS CARE PC"
	sourceDef.SourceType = pkg.SourceTypeCc007PeninsulaWomensCarePc
