...
func GetSourceLitchfieldLaserSkinCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLitchfieldLaserSkinCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "LITCHFIELD LASER SKIN CARE"
	sourceDef.SourceType = pkg.SourceTypeLitchfieldLaserSkinCare
