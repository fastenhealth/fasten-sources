...
func GetSourceEarNoseThroatAndAllergyCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEarNoseThroatAndAllergyCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Ear Nose Throat and Allergy Center"
	sourceDef.SourceType = pkg.SourceTypeEarNoseThroatAndAllergyCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.entallergycenter.com/"
