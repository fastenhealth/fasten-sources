...
func GetSourcePediatricCareOfLansingPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatricCareOfLansingPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "PEDIATRIC CARE OF LANSING PC"
	sourceDef.SourceType = pkg.SourceTypePediatricCareOfLansingPc
