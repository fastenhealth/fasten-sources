...
func GetSourceMuscogeeHospitalistServices(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMuscogeeHospitalistServices]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MUSCOGEE HOSPITALIST SERVICES"
	sourceDef.SourceType = pkg.SourceTypeMuscogeeHospitalistServices
