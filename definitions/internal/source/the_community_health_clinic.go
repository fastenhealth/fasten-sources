...
func GetSourceTheCommunityHealthClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheCommunityHealthClinic]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeTheCommunityHealthClinic
