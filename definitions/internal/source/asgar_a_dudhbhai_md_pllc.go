...
func GetSourceAsgarADudhbhaiMdPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAsgarADudhbhaiMdPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Asgar A Dudhbhai MD PLLC"
	sourceDef.SourceType = pkg.SourceTypeAsgarADudhbhaiMdPllc
