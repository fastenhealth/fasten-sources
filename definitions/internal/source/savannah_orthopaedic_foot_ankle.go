...
func GetSourceSavannahOrthopaedicFootAnkle(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSavannahOrthopaedicFootAnkle]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Savannah Orthopaedic Foot  Ankle"
	sourceDef.SourceType = pkg.SourceTypeSavannahOrthopaedicFootAnkle
