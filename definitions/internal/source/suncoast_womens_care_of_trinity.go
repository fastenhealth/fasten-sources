...
func GetSourceSuncoastWomensCareOfTrinity(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSuncoastWomensCareOfTrinity]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SUNCOAST WOMENS CARE OF TRINITY"
	sourceDef.SourceType = pkg.SourceTypeSuncoastWomensCareOfTrinity
