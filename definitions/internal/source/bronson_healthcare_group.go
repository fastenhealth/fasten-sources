...
func GetSourceBronsonHealthcareGroup(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeBronsonHealthcareGroup
