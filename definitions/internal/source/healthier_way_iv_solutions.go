...
func GetSourceHealthierWayIvSolutions(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHealthierWayIvSolutions]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Healthier Way IV Solutions"
	sourceDef.SourceType = pkg.SourceTypeHealthierWayIvSolutions
	sourceDef.Category = []string{"261Q00000X", "261QP2300X", "261QU0200X", "363LF0000X"}
