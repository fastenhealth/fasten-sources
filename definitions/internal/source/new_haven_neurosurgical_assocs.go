...
func GetSourceNewHavenNeurosurgicalAssocs(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNewHavenNeurosurgicalAssocs]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "New Haven Neurosurgical Assocs"
	sourceDef.SourceType = pkg.SourceTypeNewHavenNeurosurgicalAssocs
