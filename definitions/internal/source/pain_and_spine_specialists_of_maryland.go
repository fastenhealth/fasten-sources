...
func GetSourcePainAndSpineSpecialistsOfMaryland(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePainAndSpineSpecialistsOfMaryland]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pain and Spine Specialists of Maryland"
	sourceDef.SourceType = pkg.SourceTypePainAndSpineSpecialistsOfMaryland
