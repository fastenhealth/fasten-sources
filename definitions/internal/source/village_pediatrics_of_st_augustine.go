...
func GetSourceVillagePediatricsOfStAugustine(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVillagePediatricsOfStAugustine]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "VILLAGE PEDIATRICS OF ST AUGUSTINE"
	sourceDef.SourceType = pkg.SourceTypeVillagePediatricsOfStAugustine
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.wgvpediatrics.com"
