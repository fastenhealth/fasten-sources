...
func GetSourceCenterGroveFootAnkleCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCenterGroveFootAnkleCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Center Grove Foot  Ankle Care"
	sourceDef.SourceType = pkg.SourceTypeCenterGroveFootAnkleCare
