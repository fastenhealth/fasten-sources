...
func GetSourceKennethJRosenthalMdPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKennethJRosenthalMdPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Kenneth J. Rosenthal MD PC"
	sourceDef.SourceType = pkg.SourceTypeKennethJRosenthalMdPc
	sourceDef.PatientAccessUrl = "https://www.eyesurgery.org/eye-doctors-new-york/kenneth-rosenthal-md/"
