...
func GetSourceTexasInstituteOfDermatologyLaserAndCosmeticSurgery(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTexasInstituteOfDermatologyLaserAndCosmeticSurgery]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Texas Institute of Dermatology Laser and Cosmetic Surgery"
	sourceDef.SourceType = pkg.SourceTypeTexasInstituteOfDermatologyLaserAndCosmeticSurgery
