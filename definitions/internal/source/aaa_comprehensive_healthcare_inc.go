...
func GetSourceAaaComprehensiveHealthcareInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAaaComprehensiveHealthcareInc]; clientIdOk {
	...
	sourceDef.Category = []string{"261QC1500X", "261QD0000X", "261QF0400X"}
