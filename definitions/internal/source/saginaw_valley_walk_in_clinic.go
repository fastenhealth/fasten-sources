...
func GetSourceSaginawValleyWalkInClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSaginawValleyWalkInClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Saginaw Valley Walk In Clinic"
	sourceDef.SourceType = pkg.SourceTypeSaginawValleyWalkInClinic
