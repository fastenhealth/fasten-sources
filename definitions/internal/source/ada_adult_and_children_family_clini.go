...
func GetSourceAdaAdultAndChildrenFamilyClini(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdaAdultAndChildrenFamilyClini]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ADA ADULT AND CHILDREN FAMILY CLINI"
	sourceDef.SourceType = pkg.SourceTypeAdaAdultAndChildrenFamilyClini
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.adafamilyclinic.com/"
