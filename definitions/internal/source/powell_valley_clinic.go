...
func GetSourcePowellValleyClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePowellValleyClinic]; clientIdOk {
	...
	sourceDef.Category = []string{"207L00000X", "207P00000X", "207Q00000X", "207R00000X", "207V00000X", "207X00000X", "207XS0106X", "208000000X", "2085R0202X", "208600000X", "261QU0200X", "332B00000X"}
