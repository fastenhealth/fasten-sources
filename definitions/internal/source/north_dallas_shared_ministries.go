...
func GetSourceNorthDallasSharedMinistries(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthDallasSharedMinistries]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "North Dallas Shared Ministries"
	sourceDef.SourceType = pkg.SourceTypeNorthDallasSharedMinistries
