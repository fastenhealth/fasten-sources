...
func GetSourceFamilyMedicineAndUrgentCareOf(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyMedicineAndUrgentCareOf]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Family Medicine and Urgent Care of"
	sourceDef.SourceType = pkg.SourceTypeFamilyMedicineAndUrgentCareOf
