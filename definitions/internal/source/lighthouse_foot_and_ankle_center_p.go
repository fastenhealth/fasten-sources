...
func GetSourceLighthouseFootAndAnkleCenterP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLighthouseFootAndAnkleCenterP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lighthouse Foot and Ankle Center P"
	sourceDef.SourceType = pkg.SourceTypeLighthouseFootAndAnkleCenterP
