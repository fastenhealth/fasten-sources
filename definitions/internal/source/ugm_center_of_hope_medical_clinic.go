...
func GetSourceUgmCenterOfHopeMedicalClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUgmCenterOfHopeMedicalClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "UGM Center of Hope Medical Clinic"
	sourceDef.SourceType = pkg.SourceTypeUgmCenterOfHopeMedicalClinic
