...
func GetSourceCraniospinalCenterOfLosAngeles(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCraniospinalCenterOfLosAngeles]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Craniospinal Center of Los Angeles"
	sourceDef.SourceType = pkg.SourceTypeCraniospinalCenterOfLosAngeles
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://craniospinalcenter.com/"
