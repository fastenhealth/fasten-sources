...
func GetSourceTotalHealthMedicalOfTheDesert(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTotalHealthMedicalOfTheDesert]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Total Health Medical of the Desert"
	sourceDef.SourceType = pkg.SourceTypeTotalHealthMedicalOfTheDesert
