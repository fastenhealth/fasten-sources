...
func GetSourceSocratesPerezrodriguezMdPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSocratesPerezrodriguezMdPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Socrates PerezRodriguez MD PA"
	sourceDef.SourceType = pkg.SourceTypeSocratesPerezrodriguezMdPa
