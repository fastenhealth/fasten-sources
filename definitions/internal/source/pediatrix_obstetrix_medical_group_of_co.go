...
func GetSourcePediatrixObstetrixMedicalGroupOfCo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatrixObstetrixMedicalGroupOfCo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pediatrix Obstetrix Medical Group Of CO"
	sourceDef.SourceType = pkg.SourceTypePediatrixObstetrixMedicalGroupOfCo
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "pediatrix-obstetrix-medical-group-of-co.jpg"
