...
func GetSourceBestPhysiciansAtHomeInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBestPhysiciansAtHomeInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Best Physicians At Home Inc"
	sourceDef.SourceType = pkg.SourceTypeBestPhysiciansAtHomeInc
