...
func GetSourceArthritisCareSpecialistsOfMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeArthritisCareSpecialistsOfMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Arthritis Care Specialists of MD"
	sourceDef.SourceType = pkg.SourceTypeArthritisCareSpecialistsOfMd
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.arthritiscarespecialists.com"
