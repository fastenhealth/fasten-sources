...
func GetSourceDrCarolynLangfordUrologicSolut(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrCarolynLangfordUrologicSolut]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dr Carolyn Langford Urologic Solut"
	sourceDef.SourceType = pkg.SourceTypeDrCarolynLangfordUrologicSolut
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://drcarolynlangford.com"
