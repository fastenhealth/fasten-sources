...
func GetSourceGulfCoastObgynOfSarasotaLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGulfCoastObgynOfSarasotaLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "GULF COAST OBGYN OF SARASOTA LLC"
	sourceDef.SourceType = pkg.SourceTypeGulfCoastObgynOfSarasotaLlc
