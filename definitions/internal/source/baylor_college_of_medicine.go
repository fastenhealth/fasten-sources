...
func GetSourceBaylorCollegeOfMedicine(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Category = []string{"103K00000X", "170100000X", "207L00000X", "207N00000X", "207Q00000X", "207R00000X", "207RE0101X", "207T00000X", "207V00000X", "207W00000X", "207X00000X", "207Y00000X", "208000000X", "208100000X", "208200000X", "2084N0400X", "2084P0800X", "2085R0202X", "208600000X", "208800000X", "282N00000X", "283Q00000X", "284300000X", "3336C0003X"}
	sourceDef.Aliases = []string{"BCM PHYSICIANS", "BCM PHYSICIANS OF SAN ANTONIO", "TEXAS CHILDREN'S HOSPITAL"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1124413513", "1164463287", "1285079764", "1386691681", "1457556565", "1497843700", "1730132721", "1801177555", "1821548488", "1881026664", "1982778544"}}
