...
func GetSourceValueInPreventionOfVirginia(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeValueInPreventionOfVirginia]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Value in Prevention of Virginia"
	sourceDef.SourceType = pkg.SourceTypeValueInPreventionOfVirginia
