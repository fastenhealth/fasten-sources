...
func GetSourceEmilioJGomezmadrazoMdLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEmilioJGomezmadrazoMdLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "EMILIO J GOMEZMADRAZO MD LLC"
	sourceDef.SourceType = pkg.SourceTypeEmilioJGomezmadrazoMdLlc
