...
func GetSourcePeterAlanKrauseMedicalCorporati(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePeterAlanKrauseMedicalCorporati]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Peter Alan Krause Medical Corporati"
	sourceDef.SourceType = pkg.SourceTypePeterAlanKrauseMedicalCorporati
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.dockrause.net"
