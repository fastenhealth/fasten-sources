...
func GetSourceThomasWBrittDopcDbaGapMedic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeThomasWBrittDopcDbaGapMedic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Thomas W Britt DOPC DBA Gap Medic"
	sourceDef.SourceType = pkg.SourceTypeThomasWBrittDopcDbaGapMedic
