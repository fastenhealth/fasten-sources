...
func GetSourceAkliluAndCobianInfectDiseases(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAkliluAndCobianInfectDiseases]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Aklilu And Cobian Infect Diseases"
	sourceDef.SourceType = pkg.SourceTypeAkliluAndCobianInfectDiseases
