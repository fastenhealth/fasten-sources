...
func GetSourcePulseHealthcareSolutionsPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePulseHealthcareSolutionsPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pulse Healthcare Solutions PLLC"
	sourceDef.SourceType = pkg.SourceTypePulseHealthcareSolutionsPllc
