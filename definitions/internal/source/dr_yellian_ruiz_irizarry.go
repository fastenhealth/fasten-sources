...
func GetSourceDrYellianRuizIrizarry(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrYellianRuizIrizarry]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dr Yellian Ruiz Irizarry"
	sourceDef.SourceType = pkg.SourceTypeDrYellianRuizIrizarry
