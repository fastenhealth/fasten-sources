...
func GetSourceInstituteOfOrthopedicsSpineSp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeInstituteOfOrthopedicsSpineSp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Institute of Orthopedics Spine  Sp"
	sourceDef.SourceType = pkg.SourceTypeInstituteOfOrthopedicsSpineSp
