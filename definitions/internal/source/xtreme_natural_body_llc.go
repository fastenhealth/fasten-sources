...
func GetSourceXtremeNaturalBodyLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeXtremeNaturalBodyLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "XTREME NATURAL BODY LLC"
	sourceDef.SourceType = pkg.SourceTypeXtremeNaturalBodyLlc
