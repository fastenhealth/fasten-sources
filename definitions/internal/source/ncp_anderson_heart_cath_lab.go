...
func GetSourceNcpAndersonHeartCathLab(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNcpAndersonHeartCathLab]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "NCP Anderson Heart Cath Lab"
	sourceDef.SourceType = pkg.SourceTypeNcpAndersonHeartCathLab
	sourceDef.PatientAccessUrl = "https://anmed.org/"
