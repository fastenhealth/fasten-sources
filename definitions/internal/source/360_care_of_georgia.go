...
func GetSource360CareOfGeorgia(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceType360CareOfGeorgia]; clientIdOk {
	...
	sourceDef.Category = []string{"122300000X", "213E00000X", "231H00000X", "152W00000X"}
