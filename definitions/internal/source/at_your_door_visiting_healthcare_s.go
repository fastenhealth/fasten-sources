...
func GetSourceAtYourDoorVisitingHealthcareS(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAtYourDoorVisitingHealthcareS]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "AT YOUR DOOR VISITING HEALTHCARE S"
	sourceDef.SourceType = pkg.SourceTypeAtYourDoorVisitingHealthcareS
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://atyourdoorhealthcare.com/"
