...
func GetSourceSurgicalCareOfTheVirginiasLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSurgicalCareOfTheVirginiasLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Surgical Care of the Virginias LLC"
	sourceDef.SourceType = pkg.SourceTypeSurgicalCareOfTheVirginiasLlc
