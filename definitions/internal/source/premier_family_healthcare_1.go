...
func GetSourcePremierFamilyHealthcare1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePremierFamilyHealthcare1]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Premier Family Healthcare"
	sourceDef.SourceType = pkg.SourceTypePremierFamilyHealthcare1
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "premier-family-healthcare.jpg"
	sourceDef.PatientAccessUrl = "https://www.facebook.com/premierfamilycare/"
