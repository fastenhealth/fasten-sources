...
func GetSourceJenniferLJohnsoncaldwellMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJenniferLJohnsoncaldwellMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Jennifer L JohnsonCaldwell MD"
	sourceDef.SourceType = pkg.SourceTypeJenniferLJohnsoncaldwellMd
