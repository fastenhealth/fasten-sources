...
func GetSourceLindoFamilyHealthAndCarezPeds(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLindoFamilyHealthAndCarezPeds]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lindo Family Health and Carez Peds"
	sourceDef.SourceType = pkg.SourceTypeLindoFamilyHealthAndCarezPeds
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://lindohealthandwellness.com/"
