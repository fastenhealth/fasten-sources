...
func GetSourceAnsuyaKalraMdVipObgynLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnsuyaKalraMdVipObgynLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ANSUYA KALRA MD VIP OBGYN LLC"
	sourceDef.SourceType = pkg.SourceTypeAnsuyaKalraMdVipObgynLlc
