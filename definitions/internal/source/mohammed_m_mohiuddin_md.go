...
func GetSourceMohammedMMohiuddinMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMohammedMMohiuddinMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MOHAMMED M MOHIUDDIN MD"
	sourceDef.SourceType = pkg.SourceTypeMohammedMMohiuddinMd
