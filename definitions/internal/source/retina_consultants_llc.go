...
func GetSourceRetinaConsultantsLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRetinaConsultantsLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Retina Consultants LLC"
	sourceDef.SourceType = pkg.SourceTypeRetinaConsultantsLlc
	sourceDef.PatientAccessUrl = "https://salemretina.com/"
