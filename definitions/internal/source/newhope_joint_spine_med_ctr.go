...
func GetSourceNewhopeJointSpineMedCtr(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNewhopeJointSpineMedCtr]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Newhope Joint  Spine Med Ctr"
	sourceDef.SourceType = pkg.SourceTypeNewhopeJointSpineMedCtr
