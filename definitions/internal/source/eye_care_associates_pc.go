...
func GetSourceEyeCareAssociatesPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeCareAssociatesPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Care Associates PC"
	sourceDef.SourceType = pkg.SourceTypeEyeCareAssociatesPc
	sourceDef.PatientAccessUrl = "https://www.eye-careassociates.com"
