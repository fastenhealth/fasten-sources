...
func GetSourceAnthonyBranzMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnthonyBranzMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Anthony Branz MD"
	sourceDef.SourceType = pkg.SourceTypeAnthonyBranzMd
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.healthgrades.com/physician/dr-anthony-branz-xgjh5"
