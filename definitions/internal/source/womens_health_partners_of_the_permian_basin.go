...
func GetSourceWomensHealthPartnersOfThePermianBasin(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomensHealthPartnersOfThePermianBasin]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Womens Health Partners of the Permian Basin"
	sourceDef.SourceType = pkg.SourceTypeWomensHealthPartnersOfThePermianBasin
