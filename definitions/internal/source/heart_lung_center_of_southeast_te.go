...
func GetSourceHeartLungCenterOfSoutheastTe(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHeartLungCenterOfSoutheastTe]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Heart  Lung Center of Southeast Te"
	sourceDef.SourceType = pkg.SourceTypeHeartLungCenterOfSoutheastTe
