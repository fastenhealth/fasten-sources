...
func GetSourceTreyMedicalEnterprisesInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTreyMedicalEnterprisesInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Trey Medical Enterprises Inc"
	sourceDef.SourceType = pkg.SourceTypeTreyMedicalEnterprisesInc
