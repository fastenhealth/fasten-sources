...
func GetSourceNorthTexasAreaCommunityHealthCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthTexasAreaCommunityHealthCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "North Texas Area Community Health Center"
	sourceDef.SourceType = pkg.SourceTypeNorthTexasAreaCommunityHealthCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://ntachc.org/"
