...
func GetSourceRegullanoAndYuMedicalGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRegullanoAndYuMedicalGroup]; clientIdOk {
	...
	sourceDef.Category = []string{"208000000X", "207Q00000X"}
