...
func GetSourceJerryJTracyIiiPhysicianPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJerryJTracyIiiPhysicianPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Jerry J Tracy III Physician PLLC"
	sourceDef.SourceType = pkg.SourceTypeJerryJTracyIiiPhysicianPllc
