...
func GetSourceArthritisCenterOfLexingtonPSC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeArthritisCenterOfLexingtonPSC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Arthritis Center Of Lexington P.S.C."
	sourceDef.SourceType = pkg.SourceTypeArthritisCenterOfLexingtonPSC
	sourceDef.PatientAccessUrl = "https://www.aclky.com/"
