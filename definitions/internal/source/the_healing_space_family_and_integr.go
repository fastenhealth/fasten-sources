...
func GetSourceTheHealingSpaceFamilyAndIntegr(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheHealingSpaceFamilyAndIntegr]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Healing Space Family and Integr"
	sourceDef.SourceType = pkg.SourceTypeTheHealingSpaceFamilyAndIntegr
