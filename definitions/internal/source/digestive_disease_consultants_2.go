...
func GetSourceDigestiveDiseaseConsultants2(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDigestiveDiseaseConsultants2]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeDigestiveDiseaseConsultants2
