...
func GetSourceChinatownServiceCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Category = []string{"171M00000X", "251S00000X", "261QD0000X", "261QF0400X", "261QH0100X", "261QP2300X"}
	sourceDef.Aliases = []string{"CSC HEALTH"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1013444660", "1134482326", "1134830862", "1265963649", "1306373964", "1427046754", "1427424654"}}
