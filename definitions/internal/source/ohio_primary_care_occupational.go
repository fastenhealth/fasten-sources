...
func GetSourceOhioPrimaryCareOccupational(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOhioPrimaryCareOccupational]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Ohio Primary Care  Occupational"
	sourceDef.SourceType = pkg.SourceTypeOhioPrimaryCareOccupational
