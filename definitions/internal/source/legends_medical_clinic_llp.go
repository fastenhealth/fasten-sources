...
func GetSourceLegendsMedicalClinicLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLegendsMedicalClinicLlp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Legends Medical Clinic LLP"
	sourceDef.SourceType = pkg.SourceTypeLegendsMedicalClinicLlp
