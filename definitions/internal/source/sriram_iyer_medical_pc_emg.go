...
func GetSourceSriramIyerMedicalPcEmg(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSriramIyerMedicalPcEmg]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sriram Iyer Medical PC EMG"
	sourceDef.SourceType = pkg.SourceTypeSriramIyerMedicalPcEmg
