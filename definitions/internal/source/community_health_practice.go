...
func GetSourceCommunityHealthPractice(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCommunityHealthPractice]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Community Health Practice"
	sourceDef.SourceType = pkg.SourceTypeCommunityHealthPractice
	sourceDef.PatientAccessUrl = "https://www.whcg.org.au/community-health"
