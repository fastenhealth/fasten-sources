...
func GetSourceEastCoastRetinaPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEastCoastRetinaPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "East Coast Retina PA"
	sourceDef.SourceType = pkg.SourceTypeEastCoastRetinaPa
	sourceDef.PatientAccessUrl = "https://eastcoastretinasc.com/"
