...
func GetSourceSurvivalTelepsychiatryServicesPl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSurvivalTelepsychiatryServicesPl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SURVIVAL TELEPSYCHIATRY SERVICES PL"
	sourceDef.SourceType = pkg.SourceTypeSurvivalTelepsychiatryServicesPl
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.survivaltelepsych.com"
