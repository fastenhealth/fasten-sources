...
func GetSourceSonrisePediatricsAndWellness(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSonrisePediatricsAndWellness]; clientIdOk {
	...
	sourceDef.Aliases = []string{"SONRISE PEDIATRICS & WELLNESS"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1538739206"}}
