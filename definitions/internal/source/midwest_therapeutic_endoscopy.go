...
func GetSourceMidwestTherapeuticEndoscopy(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMidwestTherapeuticEndoscopy]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Midwest Therapeutic Endoscopy"
	sourceDef.SourceType = pkg.SourceTypeMidwestTherapeuticEndoscopy
