...
func GetSourceLacyCKesslerMdPa(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeLacyCKesslerMdPa
