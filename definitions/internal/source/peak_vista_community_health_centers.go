...
func GetSourcePeakVistaCommunityHealthCenters(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Aliases = []string{"HEALTH CENTER AT WAHSATCH", "DOWNTOWN HEALTH CENTER", "FAMILY HEALTH CENTER AT MITCHELL HIGH SCHOOL", "HEALTH CENTER AT JET WING", "DENTAL HEALTH CENTER", "HEATH CENTER AT ACADEMY SUITE 3500", "PEDIATRIC HEALTH CENTER", "LOGAN HEALTH CENTER AT MYRON STRATTON", "CONVENIENT CARE CENTER AND PEDIATRIC HEALTH CENTER AT ACADEMY", "HEALTH CENTER AT UNION"}
