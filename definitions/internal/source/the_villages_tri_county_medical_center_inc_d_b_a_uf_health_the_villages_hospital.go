...
func GetSourceTheVillagesTriCountyMedicalCenterIncDBAUfHealthTheVillagesHospital(env pkg.FastenLighthouseEnvType) (models.LighthouseSourceDefinition, error) {
