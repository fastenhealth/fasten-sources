...
func GetSourceHunterdonFamilyPhysicians(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHunterdonFamilyPhysicians]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Hunterdon Family Physicians"
	sourceDef.SourceType = pkg.SourceTypeHunterdonFamilyPhysicians
	sourceDef.PatientAccessUrl = "https://www.hunterdonfamilyphysicians.com/"
