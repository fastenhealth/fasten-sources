...
func GetSourcePatriciaModadMdPaDbaPalmCoa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePatriciaModadMdPaDbaPalmCoa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Patricia Modad MD PA dba Palm Coa"
	sourceDef.SourceType = pkg.SourceTypePatriciaModadMdPaDbaPalmCoa
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.palmcoastobgyn.com"
