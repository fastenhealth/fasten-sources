...
func GetSourceSightEyeClinicPC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSightEyeClinicPC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Sight Eye Clinic P.C."
	sourceDef.SourceType = pkg.SourceTypeSightEyeClinicPC
	sourceDef.PatientAccessUrl = "https://sighteyeclinic.com/"
