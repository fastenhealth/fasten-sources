...
func GetSourceAngelicaMartinezFamilyPracticeP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAngelicaMartinezFamilyPracticeP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ANGELICA MARTINEZ FAMILY PRACTICE P"
	sourceDef.SourceType = pkg.SourceTypeAngelicaMartinezFamilyPracticeP
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.martinez-fp.org"
