...
func GetSourceHandCenterOfBocaDelray(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHandCenterOfBocaDelray]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Hand Center of Boca  Delray"
	sourceDef.SourceType = pkg.SourceTypeHandCenterOfBocaDelray
