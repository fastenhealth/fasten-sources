...
func GetSourceEnglenderSperDrasninMdsInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEnglenderSperDrasninMdsInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Englender Sper  Drasnin MDs Inc"
	sourceDef.SourceType = pkg.SourceTypeEnglenderSperDrasninMdsInc
