...
func GetSourceSpringParkSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSpringParkSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Spring Park Surgery Center"
	sourceDef.SourceType = pkg.SourceTypeSpringParkSurgeryCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "http://www.springparksurgery.com/"
