...
func GetSourceHopeFamilyMedicineInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHopeFamilyMedicineInc]; clientIdOk {
	...
	sourceDef.BrandLogo = "hope-family-medicine-inc.jpg"
