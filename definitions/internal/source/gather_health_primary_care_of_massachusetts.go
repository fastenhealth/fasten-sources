...
func GetSourceGatherHealthPrimaryCareOfMassachusetts(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGatherHealthPrimaryCareOfMassachusetts]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "GATHER HEALTH PRIMARY CARE OF MASSACHUSETTS"
	sourceDef.SourceType = pkg.SourceTypeGatherHealthPrimaryCareOfMassachusetts
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.gather-health.com/"
