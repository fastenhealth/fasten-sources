...
func GetSourceDrLuckinoAndDrRaabe(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrLuckinoAndDrRaabe]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dr Luckino and Dr Raabe"
	sourceDef.SourceType = pkg.SourceTypeDrLuckinoAndDrRaabe
