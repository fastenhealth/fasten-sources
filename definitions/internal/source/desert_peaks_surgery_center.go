...
func GetSourceDesertPeaksSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDesertPeaksSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Desert Peaks Surgery Center"
	sourceDef.SourceType = pkg.SourceTypeDesertPeaksSurgeryCenter
	sourceDef.PatientAccessUrl = "https://desertpeakssurgery.com/"
