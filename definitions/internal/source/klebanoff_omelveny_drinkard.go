...
func GetSourceKlebanoffOmelvenyDrinkard(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKlebanoffOmelvenyDrinkard]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Klebanoff OMelveny  Drinkard"
	sourceDef.SourceType = pkg.SourceTypeKlebanoffOmelvenyDrinkard
