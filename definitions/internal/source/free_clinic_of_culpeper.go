...
func GetSourceFreeClinicOfCulpeper(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFreeClinicOfCulpeper]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Free Clinic Of Culpeper"
	sourceDef.SourceType = pkg.SourceTypeFreeClinicOfCulpeper
