...
func GetSourceArthritisAssociatesInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeArthritisAssociatesInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Arthritis Associates Inc."
	sourceDef.SourceType = pkg.SourceTypeArthritisAssociatesInc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://doctor.webmd.com/practice/arthritis-associates-inc-a45d8fc8-4703-e211-a42b-001f29e3eb44"
