...
func GetSourceMidatlanticEpilepsySleepCtr(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMidatlanticEpilepsySleepCtr]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MidAtlantic Epilepsy  Sleep Ctr"
	sourceDef.SourceType = pkg.SourceTypeMidatlanticEpilepsySleepCtr
