...
func GetSourceVicksburgPulmonaryClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVicksburgPulmonaryClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Vicksburg Pulmonary Clinic"
	sourceDef.SourceType = pkg.SourceTypeVicksburgPulmonaryClinic
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://vicksburg-pulmonary.business.site/"
