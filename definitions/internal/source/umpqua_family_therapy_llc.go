...
func GetSourceUmpquaFamilyTherapyLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUmpquaFamilyTherapyLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "UMPQUA FAMILY THERAPY LLC"
	sourceDef.SourceType = pkg.SourceTypeUmpquaFamilyTherapyLlc
