...
func GetSourceColumbusArthritisCenterInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeColumbusArthritisCenterInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Columbus Arthritis Center Inc"
	sourceDef.SourceType = pkg.SourceTypeColumbusArthritisCenterInc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://columbusarthritis.com/"
