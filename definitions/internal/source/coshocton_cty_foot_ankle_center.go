...
func GetSourceCoshoctonCtyFootAnkleCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCoshoctonCtyFootAnkleCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Coshocton Cty Foot  Ankle Center"
	sourceDef.SourceType = pkg.SourceTypeCoshoctonCtyFootAnkleCenter
