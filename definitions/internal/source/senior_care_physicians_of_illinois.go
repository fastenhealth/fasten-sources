...
func GetSourceSeniorCarePhysiciansOfIllinois(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSeniorCarePhysiciansOfIllinois]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Senior Care Physicians of Illinois"
	sourceDef.SourceType = pkg.SourceTypeSeniorCarePhysiciansOfIllinois
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.welcometosedgebrook.com/"
