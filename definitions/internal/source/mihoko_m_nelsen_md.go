...
func GetSourceMihokoMNelsenMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMihokoMNelsenMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Mihoko M Nelsen MD"
	sourceDef.SourceType = pkg.SourceTypeMihokoMNelsenMd
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.saintalphonsus.org/"
