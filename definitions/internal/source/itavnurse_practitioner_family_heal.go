...
func GetSourceItavnursePractitionerFamilyHeal(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeItavnursePractitionerFamilyHeal]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ITAVNURSE PRACTITIONER FAMILY HEAL"
	sourceDef.SourceType = pkg.SourceTypeItavnursePractitionerFamilyHeal
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.itav-npfamilyhealth.com"
