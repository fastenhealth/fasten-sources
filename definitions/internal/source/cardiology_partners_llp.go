...
func GetSourceCardiologyPartnersLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCardiologyPartnersLlp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Cardiology Partners LLP"
	sourceDef.SourceType = pkg.SourceTypeCardiologyPartnersLlp
	sourceDef.PatientAccessUrl = "https://cardiologypartners.com/"
