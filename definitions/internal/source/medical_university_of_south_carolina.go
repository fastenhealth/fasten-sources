...
func GetSourceMedicalUniversityOfSouthCarolina(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeMedicalUniversityOfSouthCarolina
