...
func GetSourceCc024AWomansPlaceInFayettevilleLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc024AWomansPlaceInFayettevilleLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC024A WOMANS PLACE IN FAYETTEVILLE LLC"
	sourceDef.SourceType = pkg.SourceTypeCc024AWomansPlaceInFayettevilleLlc
