...
func GetSourceYooFootAndAnklePodiatryLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeYooFootAndAnklePodiatryLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Yoo Foot and Ankle Podiatry LLC"
	sourceDef.SourceType = pkg.SourceTypeYooFootAndAnklePodiatryLlc
