...
func GetSourceEndureUrgentCareAProfessional(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEndureUrgentCareAProfessional]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ENDURE URGENT CARE A PROFESSIONAL"
	sourceDef.SourceType = pkg.SourceTypeEndureUrgentCareAProfessional
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://Endureurgentcare.com"
