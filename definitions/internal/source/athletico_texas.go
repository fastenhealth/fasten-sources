...
func GetSourceAthleticoTexas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAthleticoTexas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Athletico Texas"
	sourceDef.SourceType = pkg.SourceTypeAthleticoTexas
	sourceDef.BrandLogo = "athletico-texas.svg"
	sourceDef.PatientAccessUrl = "https://www.athletico.com/regions/texas/"
