...
func GetSourceObgynSpecialistsOfThePalmBeaches(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeObgynSpecialistsOfThePalmBeaches]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "OBGYN Specialists of the Palm Beaches"
	sourceDef.SourceType = pkg.SourceTypeObgynSpecialistsOfThePalmBeaches
