...
func GetSourceCc005BayViewObstetricsAndGynecologyPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc005BayViewObstetricsAndGynecologyPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC005BAY VIEW OBSTETRICS AND GYNECOLOGY PC"
	sourceDef.SourceType = pkg.SourceTypeCc005BayViewObstetricsAndGynecologyPc
