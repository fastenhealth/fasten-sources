...
func GetSourceStarmedUrgentFamilyCarePa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeStarmedUrgentFamilyCarePa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "StarMed Urgent  Family Care PA"
	sourceDef.SourceType = pkg.SourceTypeStarmedUrgentFamilyCarePa
