...
func GetSourceCatholicHealthLongIslandNy(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeCatholicHealthLongIslandNy
