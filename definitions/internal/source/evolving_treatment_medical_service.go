...
func GetSourceEvolvingTreatmentMedicalService(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEvolvingTreatmentMedicalService]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "EVOLVING TREATMENT MEDICAL SERVICE"
	sourceDef.SourceType = pkg.SourceTypeEvolvingTreatmentMedicalService
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.drharrylindman.com"
