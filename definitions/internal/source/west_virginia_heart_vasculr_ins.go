...
func GetSourceWestVirginiaHeartVasculrIns(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWestVirginiaHeartVasculrIns]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "West Virginia Heart Vasculr Ins"
	sourceDef.SourceType = pkg.SourceTypeWestVirginiaHeartVasculrIns
