...
func GetSourceTimNguyenMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTimNguyenMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Tim Nguyen MD"
	sourceDef.SourceType = pkg.SourceTypeTimNguyenMd
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://suncitymedicalpartners.com/physicians/"
