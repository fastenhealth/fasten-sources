...
func GetSourceRheumatologyConsultantsLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRheumatologyConsultantsLlp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Rheumatology Consultants LLP"
	sourceDef.SourceType = pkg.SourceTypeRheumatologyConsultantsLlp
	sourceDef.PatientAccessUrl = "http://www.rheumconsultants.com/"
