...
func GetSourceMarylandEyeAssociates(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMarylandEyeAssociates]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Maryland Eye Associates"
	sourceDef.SourceType = pkg.SourceTypeMarylandEyeAssociates
	sourceDef.PatientAccessUrl = "https://www.marylandeyeassociates.com/"
