...
func GetSourceSpringfieldCardiology(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSpringfieldCardiology]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Springfield Cardiology"
	sourceDef.SourceType = pkg.SourceTypeSpringfieldCardiology
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "http://springfieldcardiology.us/"
