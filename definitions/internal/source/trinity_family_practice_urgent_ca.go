...
func GetSourceTrinityFamilyPracticeUrgentCa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTrinityFamilyPracticeUrgentCa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TRINITY FAMILY PRACTICE  URGENT CA"
	sourceDef.SourceType = pkg.SourceTypeTrinityFamilyPracticeUrgentCa
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://trinityhealthodessa.com/"
