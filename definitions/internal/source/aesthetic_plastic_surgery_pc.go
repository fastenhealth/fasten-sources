...
func GetSourceAestheticPlasticSurgeryPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAestheticPlasticSurgeryPc]; clientIdOk {
	...
	sourceDef.Aliases = []string{"NYBRA Plastic Surgery"}
	sourceDef.BrandLogo = "aesthetic-plastic-surgery-pc.svg"
