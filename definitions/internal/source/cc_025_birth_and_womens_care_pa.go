...
func GetSourceCc025BirthAndWomensCarePa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc025BirthAndWomensCarePa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC025BIRTH AND WOMENS CARE PA"
	sourceDef.SourceType = pkg.SourceTypeCc025BirthAndWomensCarePa
