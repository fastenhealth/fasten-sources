...
func GetSourceNcpTylerCathLab(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNcpTylerCathLab]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "NCP Tyler Cath Lab"
	sourceDef.SourceType = pkg.SourceTypeNcpTylerCathLab
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.tylerheart.com/"
