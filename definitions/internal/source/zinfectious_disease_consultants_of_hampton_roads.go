...
func GetSourceZinfectiousDiseaseConsultantsOfHamptonRoads(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeZinfectiousDiseaseConsultantsOfHamptonRoads]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ZInfectious Disease Consultants of Hampton Roads"
	sourceDef.SourceType = pkg.SourceTypeZinfectiousDiseaseConsultantsOfHamptonRoads
