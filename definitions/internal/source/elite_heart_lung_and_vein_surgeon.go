...
func GetSourceEliteHeartLungAndVeinSurgeon(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEliteHeartLungAndVeinSurgeon]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Elite Heart Lung and Vein Surgeon"
	sourceDef.SourceType = pkg.SourceTypeEliteHeartLungAndVeinSurgeon
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://eliteheartsurgeons.com/"
