...
func GetSourceArlingtonDepressionTreatmentCent(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeArlingtonDepressionTreatmentCent]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ARLINGTON DEPRESSION TREATMENT CENT"
	sourceDef.SourceType = pkg.SourceTypeArlingtonDepressionTreatmentCent
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://arlingtondepressiontreatmentcenter.com"
