...
func GetSourceQuickCareClinicFamilyPract(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeQuickCareClinicFamilyPract]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Quick Care Clinic Family Pract"
	sourceDef.SourceType = pkg.SourceTypeQuickCareClinicFamilyPract
