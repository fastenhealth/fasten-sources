...
func GetSourceTexasSpineAndNeurosurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTexasSpineAndNeurosurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Texas Spine And Neurosurgery Center"
	sourceDef.SourceType = pkg.SourceTypeTexasSpineAndNeurosurgeryCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.texasspineandneurosurgerycenter.com/"
