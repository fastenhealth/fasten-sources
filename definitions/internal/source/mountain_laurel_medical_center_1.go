...
func GetSourceMountainLaurelMedicalCenter1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMountainLaurelMedicalCenter1]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Mountain Laurel Medical Center"
	sourceDef.SourceType = pkg.SourceTypeMountainLaurelMedicalCenter1
	...
	sourceDef.BrandLogo = "mountain-laurel-medical-center.png"
