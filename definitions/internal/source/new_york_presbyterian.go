...
func GetSourceNewYorkPresbyterian(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeNewYorkPresbyterian
