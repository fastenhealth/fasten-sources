...
func GetSourceHealthcareNetworkOfSwfl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHealthcareNetworkOfSwfl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Healthcare Network of SWFL"
	sourceDef.SourceType = pkg.SourceTypeHealthcareNetworkOfSwfl
