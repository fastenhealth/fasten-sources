...
func GetSourceJohnPhoenixAprnPllcDbaHun(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJohnPhoenixAprnPllcDbaHun]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "John Phoenix APRN PLLC dba Hun"
	sourceDef.SourceType = pkg.SourceTypeJohnPhoenixAprnPllcDbaHun
