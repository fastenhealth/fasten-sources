...
func GetSourceSmaldoreKellieAndStephen(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSmaldoreKellieAndStephen]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Smaldore Kellie and Stephen"
	sourceDef.SourceType = pkg.SourceTypeSmaldoreKellieAndStephen
