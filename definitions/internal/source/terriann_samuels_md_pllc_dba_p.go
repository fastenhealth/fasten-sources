...
func GetSourceTerriannSamuelsMdPllcDbaP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTerriannSamuelsMdPllcDbaP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TerriAnn Samuels MD PLLC DBA P"
	sourceDef.SourceType = pkg.SourceTypeTerriannSamuelsMdPllcDbaP
