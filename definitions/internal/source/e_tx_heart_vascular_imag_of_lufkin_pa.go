...
func GetSourceETxHeartVascularImagOfLufkinPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeETxHeartVascularImagOfLufkinPa]; clientIdOk {
	...
	sourceDef.BrandLogo = "e-tx-heart-vascular-imag-of-lufkin-pa.webp"
