...
func GetSourceOklahomaCityGynecologyAndObstetricslakeside(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOklahomaCityGynecologyAndObstetricslakeside]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Oklahoma City Gynecology and ObstetricsLakeside"
	sourceDef.SourceType = pkg.SourceTypeOklahomaCityGynecologyAndObstetricslakeside
