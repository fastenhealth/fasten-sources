...
func GetSourcePediatrixCardiologyOfPalmBeach(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatrixCardiologyOfPalmBeach]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pediatrix Cardiology of Palm Beach"
	sourceDef.SourceType = pkg.SourceTypePediatrixCardiologyOfPalmBeach
