...
func GetSourceKidneyClinicOfNorthFlPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKidneyClinicOfNorthFlPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Kidney Clinic of North FL PLLC"
	sourceDef.SourceType = pkg.SourceTypeKidneyClinicOfNorthFlPllc
