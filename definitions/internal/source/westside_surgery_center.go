...
func GetSourceWestsideSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWestsideSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Westside Surgery Center"
	sourceDef.SourceType = pkg.SourceTypeWestsideSurgeryCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://westsidesurgerycenters.com/"
