...
func GetSourceTannerClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTannerClinic]; clientIdOk {
	...
	sourceDef.Category = []string{"207KA0200X", "207Q00000X", "213EP1101X", "261QP2300X"}
	sourceDef.Aliases = []string{"TANNER CLINIC"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1104356013", "1174295562", "1447845730"}}
