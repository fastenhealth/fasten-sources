...
func GetSourceTowerOrthopedicJtReplacement(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTowerOrthopedicJtReplacement]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tower Orthopedic  Jt Replacement"
	sourceDef.SourceType = pkg.SourceTypeTowerOrthopedicJtReplacement
