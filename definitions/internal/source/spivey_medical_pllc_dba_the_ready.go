...
func GetSourceSpiveyMedicalPllcDbaTheReady(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSpiveyMedicalPllcDbaTheReady]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Spivey Medical PLLC dba The Ready"
	sourceDef.SourceType = pkg.SourceTypeSpiveyMedicalPllcDbaTheReady
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.thereadycareclinic.com"
