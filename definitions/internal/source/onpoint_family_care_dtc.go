...
func GetSourceOnpointFamilyCareDtc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOnpointFamilyCareDtc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "OnPoint Family Care  DTC"
	sourceDef.SourceType = pkg.SourceTypeOnpointFamilyCareDtc
