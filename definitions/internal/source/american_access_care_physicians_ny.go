...
func GetSourceAmericanAccessCarePhysiciansNy(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAmericanAccessCarePhysiciansNy]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "American Access Care Physicians Ny"
	sourceDef.SourceType = pkg.SourceTypeAmericanAccessCarePhysiciansNy
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.azuravascularcare.com/center/american-access-care-manhattan/"
