...
func GetSourceAmeliaNgMdPaAndTamVHoMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAmeliaNgMdPaAndTamVHoMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Amelia Ng MD PA and Tam V Ho MD"
	sourceDef.SourceType = pkg.SourceTypeAmeliaNgMdPaAndTamVHoMd
