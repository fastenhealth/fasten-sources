...
func GetSourceFieldsCenterForWomensHealthAndRoboticSurgeryAtTennova(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFieldsCenterForWomensHealthAndRoboticSurgeryAtTennova]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Fields Center for Womens Health and Robotic Surgery at Tennova"
	sourceDef.SourceType = pkg.SourceTypeFieldsCenterForWomensHealthAndRoboticSurgeryAtTennova
