...
func GetSourceRevitalizedNaturalHealthCtrLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRevitalizedNaturalHealthCtrLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Revitalized Natural Health Ctr LLC"
	sourceDef.SourceType = pkg.SourceTypeRevitalizedNaturalHealthCtrLlc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.revitalizednaturalhealth.com/"
