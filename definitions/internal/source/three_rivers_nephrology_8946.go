...
func GetSourceThreeRiversNephrology8946(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeThreeRiversNephrology8946]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Three Rivers Nephrology8946"
	sourceDef.SourceType = pkg.SourceTypeThreeRiversNephrology8946
