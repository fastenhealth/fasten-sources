...
func GetSourceTheSurgicalClinicOfCentralAr(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheSurgicalClinicOfCentralAr]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Surgical Clinic of Central AR"
	sourceDef.SourceType = pkg.SourceTypeTheSurgicalClinicOfCentralAr
