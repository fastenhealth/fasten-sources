...
func GetSourceTheLaserClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheLaserClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "The Laser Clinic"
	sourceDef.SourceType = pkg.SourceTypeTheLaserClinic
	sourceDef.BrandLogo = "the-laser-clinic.jpg"
	sourceDef.PatientAccessUrl = "https://www.facebook.com/TheLaserClinicLebanon/photos/"
