...
func GetSourceHowsdenDermatology(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHowsdenDermatology]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Howsden Dermatology"
	sourceDef.SourceType = pkg.SourceTypeHowsdenDermatology
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://howsdendermatology.com/"
