...
func GetSourceLisaJTriggPhdArnpPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLisaJTriggPhdArnpPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lisa J Trigg PhD ARNP PLLC"
	sourceDef.SourceType = pkg.SourceTypeLisaJTriggPhdArnpPllc
