...
func GetSourcePremierHealthcareAprncnpPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePremierHealthcareAprncnpPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "PREMIER HEALTHCARE APRNCNP PC"
	sourceDef.SourceType = pkg.SourceTypePremierHealthcareAprncnpPc
