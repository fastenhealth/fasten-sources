...
func GetSourceTheodorePWerblinMdPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheodorePWerblinMdPc]; clientIdOk {
	...
	sourceDef.Category = []string{"207W00000X", "261QS0132X"}
