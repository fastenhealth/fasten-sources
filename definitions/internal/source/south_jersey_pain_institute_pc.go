...
func GetSourceSouthJerseyPainInstitutePc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthJerseyPainInstitutePc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "South Jersey Pain Institute PC"
	sourceDef.SourceType = pkg.SourceTypeSouthJerseyPainInstitutePc
