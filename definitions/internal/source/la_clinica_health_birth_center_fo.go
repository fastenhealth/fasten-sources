...
func GetSourceLaClinicaHealthBirthCenterFo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLaClinicaHealthBirthCenterFo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "La Clinica Health  Birth Center fo"
	sourceDef.SourceType = pkg.SourceTypeLaClinicaHealthBirthCenterFo
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://laclinicanm.org"
