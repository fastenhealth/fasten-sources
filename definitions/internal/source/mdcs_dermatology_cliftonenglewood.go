...
func GetSourceMdcsDermatologyCliftonenglewood(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMdcsDermatologyCliftonenglewood]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MDCS Dermatology CliftonEnglewood"
	sourceDef.SourceType = pkg.SourceTypeMdcsDermatologyCliftonenglewood
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://mdcsnyc.com/"
