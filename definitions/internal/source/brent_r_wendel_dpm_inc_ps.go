...
func GetSourceBrentRWendelDpmIncPs(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBrentRWendelDpmIncPs]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Brent R Wendel DPM Inc PS"
	sourceDef.SourceType = pkg.SourceTypeBrentRWendelDpmIncPs
