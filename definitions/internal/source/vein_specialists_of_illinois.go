...
func GetSourceVeinSpecialistsOfIllinois(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVeinSpecialistsOfIllinois]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Vein Specialists of Illinois"
	sourceDef.SourceType = pkg.SourceTypeVeinSpecialistsOfIllinois
