...
func GetSourceBiospineLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBiospineLlc]; clientIdOk {
	...
	sourceDef.Aliases = []string{"BIOSPINE LLC"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1154747566"}}
	sourceDef.BrandLogo = "biospine-llc.svg"
