...
func GetSourceWestKnoxvilleHeartAtTennova(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWestKnoxvilleHeartAtTennova]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "West Knoxville Heart at Tennova"
	sourceDef.SourceType = pkg.SourceTypeWestKnoxvilleHeartAtTennova
