...
func GetSourceParisUnionSchoolDistrict95(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeParisUnionSchoolDistrict95]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Paris Union School District 95"
	sourceDef.SourceType = pkg.SourceTypeParisUnionSchoolDistrict95
