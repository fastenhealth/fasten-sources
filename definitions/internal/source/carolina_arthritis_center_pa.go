...
func GetSourceCarolinaArthritisCenterPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCarolinaArthritisCenterPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Carolina Arthritis Center PA"
	sourceDef.SourceType = pkg.SourceTypeCarolinaArthritisCenterPa
	sourceDef.PatientAccessUrl = "https://www.carolina-arthritis.com/"
