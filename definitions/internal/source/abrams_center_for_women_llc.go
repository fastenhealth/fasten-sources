...
func GetSourceAbramsCenterForWomenLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAbramsCenterForWomenLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ABRAMS CENTER FOR WOMEN LLC"
	sourceDef.SourceType = pkg.SourceTypeAbramsCenterForWomenLlc
