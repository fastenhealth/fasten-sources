...
func GetSourceVascularSurgerySpecialistPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVascularSurgerySpecialistPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Vascular Surgery Specialist PA"
	sourceDef.SourceType = pkg.SourceTypeVascularSurgerySpecialistPa
