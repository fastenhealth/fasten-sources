...
func GetSourceEastwayMedicalClinicAndUrgentC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEastwayMedicalClinicAndUrgentC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Eastway Medical Clinic and Urgent C"
	sourceDef.SourceType = pkg.SourceTypeEastwayMedicalClinicAndUrgentC
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://eastwaymedicalclinic.com"
