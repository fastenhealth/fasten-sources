...
func GetSourceOrthopedicAssociatesOfNorthernC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthopedicAssociatesOfNorthernC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ORTHOPEDIC ASSOCIATES OF NORTHERN C"
	sourceDef.SourceType = pkg.SourceTypeOrthopedicAssociatesOfNorthernC
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.oanc.org/"
