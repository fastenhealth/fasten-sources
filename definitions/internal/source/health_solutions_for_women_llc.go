...
func GetSourceHealthSolutionsForWomenLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHealthSolutionsForWomenLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "HEALTH SOLUTIONS FOR WOMEN LLC"
	sourceDef.SourceType = pkg.SourceTypeHealthSolutionsForWomenLlc
