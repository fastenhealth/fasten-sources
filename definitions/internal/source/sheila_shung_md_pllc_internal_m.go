...
func GetSourceSheilaShungMdPllcInternalM(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSheilaShungMdPllcInternalM]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SHEILA SHUNG MD PLLC Internal M"
	sourceDef.SourceType = pkg.SourceTypeSheilaShungMdPllcInternalM
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://sheilashungmd.com"
