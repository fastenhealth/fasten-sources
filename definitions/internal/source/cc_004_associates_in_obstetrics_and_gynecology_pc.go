...
func GetSourceCc004AssociatesInObstetricsAndGynecologyPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc004AssociatesInObstetricsAndGynecologyPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC004ASSOCIATES IN OBSTETRICS AND GYNECOLOGY PC"
	sourceDef.SourceType = pkg.SourceTypeCc004AssociatesInObstetricsAndGynecologyPc
