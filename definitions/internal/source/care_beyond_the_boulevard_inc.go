...
func GetSourceCareBeyondTheBoulevardInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCareBeyondTheBoulevardInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Care Beyond the Boulevard inc"
	sourceDef.SourceType = pkg.SourceTypeCareBeyondTheBoulevardInc
