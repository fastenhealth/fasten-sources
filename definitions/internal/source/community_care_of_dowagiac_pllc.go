...
func GetSourceCommunityCareOfDowagiacPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCommunityCareOfDowagiacPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "COMMUNITY CARE OF DOWAGIAC PLLC"
	sourceDef.SourceType = pkg.SourceTypeCommunityCareOfDowagiacPllc
