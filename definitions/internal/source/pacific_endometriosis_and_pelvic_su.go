...
func GetSourcePacificEndometriosisAndPelvicSu(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePacificEndometriosisAndPelvicSu]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pacific Endometriosis and Pelvic Su"
	sourceDef.SourceType = pkg.SourceTypePacificEndometriosisAndPelvicSu
