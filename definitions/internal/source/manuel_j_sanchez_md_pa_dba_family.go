...
func GetSourceManuelJSanchezMdPaDbaFamily(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeManuelJSanchezMdPaDbaFamily]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Manuel J Sanchez Md Pa DBA Family"
	sourceDef.SourceType = pkg.SourceTypeManuelJSanchezMdPaDbaFamily
