...
func GetSourceLakesideSurgeryPA(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLakesideSurgeryPA]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Lakeside Surgery P.A."
	sourceDef.SourceType = pkg.SourceTypeLakesideSurgeryPA
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.lakesidesurgerypa.com/"
