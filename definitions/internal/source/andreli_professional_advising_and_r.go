...
func GetSourceAndreliProfessionalAdvisingAndR(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAndreliProfessionalAdvisingAndR]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Andreli Professional Advising and R"
	sourceDef.SourceType = pkg.SourceTypeAndreliProfessionalAdvisingAndR
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.inhomepalcare.org"
