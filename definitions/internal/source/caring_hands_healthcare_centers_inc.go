...
func GetSourceCaringHandsHealthcareCentersInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaringHandsHealthcareCentersInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "CARING HANDS HEALTHCARE CENTERS INC."
	sourceDef.SourceType = pkg.SourceTypeCaringHandsHealthcareCentersInc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://chhcok.com/"
