...
func GetSourceBeautifulBeginningsBeyond(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBeautifulBeginningsBeyond]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Beautiful Beginnings  Beyond"
	sourceDef.SourceType = pkg.SourceTypeBeautifulBeginningsBeyond
