...
func GetSourceBeWellFamilyMedicineAndWellnessCenterPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBeWellFamilyMedicineAndWellnessCenterPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Be Well Family Medicine and Wellness Center PLLC"
	sourceDef.SourceType = pkg.SourceTypeBeWellFamilyMedicineAndWellnessCenterPllc
