...
func GetSourceMartinHealthSystem(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeMartinHealthSystem
