...
func GetSourceAllhealthmedicalgroupcomPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAllhealthmedicalgroupcomPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ALLHEALTHMEDICALGROUPCOM PC"
	sourceDef.SourceType = pkg.SourceTypeAllhealthmedicalgroupcomPc
