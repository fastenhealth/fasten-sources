...
func GetSourceKansasDiabetesAndEndocrinologyC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKansasDiabetesAndEndocrinologyC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Kansas Diabetes and Endocrinology C"
	sourceDef.SourceType = pkg.SourceTypeKansasDiabetesAndEndocrinologyC
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.kansasdec.com"
