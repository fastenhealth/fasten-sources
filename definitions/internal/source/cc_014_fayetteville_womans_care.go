...
func GetSourceCc014FayettevilleWomansCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc014FayettevilleWomansCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC014FAYETTEVILLE WOMANS CARE"
	sourceDef.SourceType = pkg.SourceTypeCc014FayettevilleWomansCare
