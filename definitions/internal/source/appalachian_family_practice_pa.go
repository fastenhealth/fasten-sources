...
func GetSourceAppalachianFamilyPracticePa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAppalachianFamilyPracticePa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Appalachian Family Practice PA"
	sourceDef.SourceType = pkg.SourceTypeAppalachianFamilyPracticePa
