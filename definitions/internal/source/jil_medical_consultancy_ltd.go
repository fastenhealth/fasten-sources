...
func GetSourceJilMedicalConsultancyLtd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJilMedicalConsultancyLtd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Jil Medical Consultancy Ltd"
	sourceDef.SourceType = pkg.SourceTypeJilMedicalConsultancyLtd
