...
func GetSourceLakeDoraInternalMedicineGeria(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLakeDoraInternalMedicineGeria]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lake Dora Internal Medicine  Geria"
	sourceDef.SourceType = pkg.SourceTypeLakeDoraInternalMedicineGeria
