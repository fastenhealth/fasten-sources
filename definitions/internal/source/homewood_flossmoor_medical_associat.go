...
func GetSourceHomewoodFlossmoorMedicalAssociat(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHomewoodFlossmoorMedicalAssociat]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Homewood Flossmoor Medical Associat"
	sourceDef.SourceType = pkg.SourceTypeHomewoodFlossmoorMedicalAssociat
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://H F O B G Y N S dot COM"
