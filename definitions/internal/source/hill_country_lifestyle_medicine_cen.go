...
func GetSourceHillCountryLifestyleMedicineCen(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHillCountryLifestyleMedicineCen]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "HILL COUNTRY LIFESTYLE MEDICINE CEN"
	sourceDef.SourceType = pkg.SourceTypeHillCountryLifestyleMedicineCen
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://hillcountrylmc.com/"
