...
func GetSourceDavisMedicalCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDavisMedicalCenter]; clientIdOk {
	...
	sourceDef.Category = []string{"101YA0400X", "207V00000X", "225C00000X", "282N00000X"}
	sourceDef.Aliases = []string{"DAVIS MEDICAL CENTER"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1013671767", "1619964806"}}
