...
func GetSourceWholeSystemsHealthcareHilo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWholeSystemsHealthcareHilo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Whole Systems Healthcare Hilo"
	sourceDef.SourceType = pkg.SourceTypeWholeSystemsHealthcareHilo
