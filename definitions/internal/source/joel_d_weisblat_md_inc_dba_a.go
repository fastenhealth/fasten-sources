...
func GetSourceJoelDWeisblatMdIncDbaA(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJoelDWeisblatMdIncDbaA]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Joel D Weisblat MD Inc dba A"
	sourceDef.SourceType = pkg.SourceTypeJoelDWeisblatMdIncDbaA
