...
func GetSourceDonaldRAbrahmMdInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDonaldRAbrahmMdInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Donald R. Abrahm MD Inc."
	sourceDef.SourceType = pkg.SourceTypeDonaldRAbrahmMdInc
	sourceDef.PatientAccessUrl = "https://drdonaldabrahm.com/"
