...
func GetSourceNorthWhitevilleUrgentCareFamilyPracticePa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthWhitevilleUrgentCareFamilyPracticePa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "North Whiteville Urgent Care  Family Practice PA"
	sourceDef.SourceType = pkg.SourceTypeNorthWhitevilleUrgentCareFamilyPracticePa
