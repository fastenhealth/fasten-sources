...
func GetSourceUrologyAndUrologicSurgeryPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUrologyAndUrologicSurgeryPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Urology and Urologic Surgery PC"
	sourceDef.SourceType = pkg.SourceTypeUrologyAndUrologicSurgeryPc
