...
func GetSourceAssociatesInInternalMedicineHea(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAssociatesInInternalMedicineHea]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ASSOCIATES IN INTERNAL MEDICINE HEA"
	sourceDef.SourceType = pkg.SourceTypeAssociatesInInternalMedicineHea
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.aimhealthcarenj.com"
