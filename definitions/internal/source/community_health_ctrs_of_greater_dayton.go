...
func GetSourceCommunityHealthCtrsOfGreaterDayton(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCommunityHealthCtrsOfGreaterDayton]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Community Health Ctrs Of Greater Dayton"
	sourceDef.SourceType = pkg.SourceTypeCommunityHealthCtrsOfGreaterDayton
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.communityhealthdayton.org/"
