...
func GetSourceArchboldSpecialtyClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeArchboldSpecialtyClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Archbold Specialty Clinic"
	sourceDef.SourceType = pkg.SourceTypeArchboldSpecialtyClinic
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://archbold.org/archbold-specialty-clinics"
