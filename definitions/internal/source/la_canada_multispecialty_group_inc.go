...
func GetSourceLaCanadaMultispecialtyGroupInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLaCanadaMultispecialtyGroupInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "La Canada Multispecialty Group Inc"
	sourceDef.SourceType = pkg.SourceTypeLaCanadaMultispecialtyGroupInc
