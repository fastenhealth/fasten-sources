...
func GetSourceFamilyHealthCareOfFairbury(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyHealthCareOfFairbury]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Family Health Care Of Fairbury"
	sourceDef.SourceType = pkg.SourceTypeFamilyHealthCareOfFairbury
	sourceDef.PatientAccessUrl = "https://www.gibsonhospital.org/locations/profile/family-health-care-of-fairbury"
