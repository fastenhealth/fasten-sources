...
func GetSourceBrockOrthopedicSurgeryAndServic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBrockOrthopedicSurgeryAndServic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Brock Orthopedic Surgery and Servic"
	sourceDef.SourceType = pkg.SourceTypeBrockOrthopedicSurgeryAndServic
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.brockorthopedicsurgery.com"
