...
func GetSourceNorthwestSurgicalSpecialists(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthwestSurgicalSpecialists]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Northwest Surgical Specialists"
	sourceDef.SourceType = pkg.SourceTypeNorthwestSurgicalSpecialists
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://nwsurgicalspecialists.com/"
