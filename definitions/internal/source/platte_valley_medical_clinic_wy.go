...
func GetSourcePlatteValleyMedicalClinicWy(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePlatteValleyMedicalClinicWy]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Platte Valley Medical Clinic WY"
	sourceDef.SourceType = pkg.SourceTypePlatteValleyMedicalClinicWy
