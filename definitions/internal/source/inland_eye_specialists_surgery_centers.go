...
func GetSourceInlandEyeSpecialistsSurgeryCenters(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeInlandEyeSpecialistsSurgeryCenters]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Inland Eye Specialists Surgery Centers"
	sourceDef.SourceType = pkg.SourceTypeInlandEyeSpecialistsSurgeryCenters
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.inlandeyespecialists.com/"
