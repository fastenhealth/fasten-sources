...
func GetSourceGatewayCardiologyPC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGatewayCardiologyPC]; clientIdOk {
	...
	sourceDef.BrandLogo = "gateway-cardiology-p-c.gif"
