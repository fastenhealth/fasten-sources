...
func GetSourceCaitlinChandranMsnAprnfpaFn(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaitlinChandranMsnAprnfpaFn]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Caitlin Chandran MSN APRNFPA FN"
	sourceDef.SourceType = pkg.SourceTypeCaitlinChandranMsnAprnfpaFn
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://caitlinchandran.com"
