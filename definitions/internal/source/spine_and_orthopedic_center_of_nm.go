...
func GetSourceSpineAndOrthopedicCenterOfNm(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSpineAndOrthopedicCenterOfNm]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Spine and Orthopedic Center of NM"
	sourceDef.SourceType = pkg.SourceTypeSpineAndOrthopedicCenterOfNm
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.spineorthopedicnm.com"
