...
func GetSourceGerryMedicalCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGerryMedicalCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Gerry Medical Center"
	sourceDef.SourceType = pkg.SourceTypeGerryMedicalCenter
	sourceDef.PatientAccessUrl = "https://doctor.webmd.com/practice/gerry-medical-clinic-524e3667-c275-45e5-82d3-42e7f027857e"
