...
func GetSourceKidneyHypertensionOfThePalmBeaches(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKidneyHypertensionOfThePalmBeaches]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Kidney  Hypertension of the Palm Beaches"
	sourceDef.SourceType = pkg.SourceTypeKidneyHypertensionOfThePalmBeaches
