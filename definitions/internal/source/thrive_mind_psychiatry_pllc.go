...
func GetSourceThriveMindPsychiatryPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeThriveMindPsychiatryPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Thrive Mind Psychiatry PLLC"
	sourceDef.SourceType = pkg.SourceTypeThriveMindPsychiatryPllc
