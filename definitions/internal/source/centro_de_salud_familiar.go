...
func GetSourceCentroDeSaludFamiliar(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCentroDeSaludFamiliar]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CENTRO DE SALUD FAMILIAR"
	sourceDef.SourceType = pkg.SourceTypeCentroDeSaludFamiliar
