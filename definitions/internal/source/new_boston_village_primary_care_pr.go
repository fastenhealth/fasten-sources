...
func GetSourceNewBostonVillagePrimaryCarePr(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNewBostonVillagePrimaryCarePr]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "NEW BOSTON VILLAGE PRIMARY CARE PR"
	sourceDef.SourceType = pkg.SourceTypeNewBostonVillagePrimaryCarePr
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://newbostonvillageprimarycare.com"
