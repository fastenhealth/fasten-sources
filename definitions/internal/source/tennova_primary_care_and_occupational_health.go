...
func GetSourceTennovaPrimaryCareAndOccupationalHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTennovaPrimaryCareAndOccupationalHealth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tennova Primary Care and Occupational Health"
	sourceDef.SourceType = pkg.SourceTypeTennovaPrimaryCareAndOccupationalHealth
