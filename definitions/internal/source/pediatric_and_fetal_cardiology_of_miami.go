...
func GetSourcePediatricAndFetalCardiologyOfMiami(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatricAndFetalCardiologyOfMiami]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pediatric And Fetal Cardiology Of Miami"
	sourceDef.SourceType = pkg.SourceTypePediatricAndFetalCardiologyOfMiami
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "pediatric-and-fetal-cardiology-of-miami.jpg"
