...
func GetSourceKalamazooCollegeStudentHealthCenter(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeKalamazooCollegeStudentHealthCenter
