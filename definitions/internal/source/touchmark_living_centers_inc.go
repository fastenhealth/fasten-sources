...
func GetSourceTouchmarkLivingCentersInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTouchmarkLivingCentersInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TOUCHMARK LIVING CENTERS INC"
	sourceDef.SourceType = pkg.SourceTypeTouchmarkLivingCentersInc
