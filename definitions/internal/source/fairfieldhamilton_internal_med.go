...
func GetSourceFairfieldhamiltonInternalMed(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFairfieldhamiltonInternalMed]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FairfieldHamilton Internal Med"
	sourceDef.SourceType = pkg.SourceTypeFairfieldhamiltonInternalMed
