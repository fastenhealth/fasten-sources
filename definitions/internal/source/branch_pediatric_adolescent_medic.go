...
func GetSourceBranchPediatricAdolescentMedic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBranchPediatricAdolescentMedic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Branch Pediatric  Adolescent Medic"
	sourceDef.SourceType = pkg.SourceTypeBranchPediatricAdolescentMedic
