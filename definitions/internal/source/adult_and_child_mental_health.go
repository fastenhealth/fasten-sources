...
func GetSourceAdultAndChildMentalHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdultAndChildMentalHealth]; clientIdOk {
	...
	sourceDef.Category = []string{"1041C0700X", "101YM0800X", "251S00000X", "261QM1300X", "261QP2300X", "261QF0400X"}
