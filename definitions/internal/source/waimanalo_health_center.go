...
func GetSourceWaimanaloHealthCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Category = []string{"103T00000X", "122300000X", "124Q00000X", "133V00000X", "152W00000X", "207Q00000X", "208000000X", "225700000X", "261QC1500X", "261QD0000X", "261QF0400X", "261QM1300X", "261QP2300X", "333600000X", "3336C0002X", "363LF0000X"}
	sourceDef.Aliases = []string{"WAIMANALO HEALTH CENTER"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1134773344", "1427295195", "1780738005", "1952073397"}}
