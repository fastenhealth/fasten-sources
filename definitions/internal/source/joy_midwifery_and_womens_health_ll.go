...
func GetSourceJoyMidwiferyAndWomensHealthLl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJoyMidwiferyAndWomensHealthLl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Joy Midwifery and Womens Health LL"
	sourceDef.SourceType = pkg.SourceTypeJoyMidwiferyAndWomensHealthLl
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://joymidwifery.com"
