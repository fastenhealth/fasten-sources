...
func GetSourceGeneseeCommunityHealthCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGeneseeCommunityHealthCenter]; clientIdOk {
	...
	sourceDef.Aliases = []string{"CHILDREN'S INTEGRATED SERVICES", "GENESEE COMMUNITY HEALTH CENTER"}
