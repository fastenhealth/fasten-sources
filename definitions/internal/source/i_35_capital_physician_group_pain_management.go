...
func GetSourceI35CapitalPhysicianGroupPainManagement(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeI35CapitalPhysicianGroupPainManagement]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "I35 Capital Physician Group Pain Management"
	sourceDef.SourceType = pkg.SourceTypeI35CapitalPhysicianGroupPainManagement
