...
func GetSourceMarwanEdrisMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMarwanEdrisMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Marwan Edris MD"
	sourceDef.SourceType = pkg.SourceTypeMarwanEdrisMd
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://doctor.webmd.com/doctor/marwan-edris-f7483601-0bf0-4072-8ce8-65b2f7a432c7-overview"
