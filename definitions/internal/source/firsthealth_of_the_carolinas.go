...
func GetSourceFirsthealthOfTheCarolinas(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeFirsthealthOfTheCarolinas
