...
func GetSourceNeoshoMemorialRegionalMedicalCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Aliases = []string{"NMRMC FAMILY MEDICINE", "NEW HORIZONS COUNSELING", "NMRMC SWINGBED", "NMRMC ERIE FAMILY CARE CLINIC", "NMRMC WOMEN'S HEALTH CENTER", "HOME CARE PRODUCTS OF NEOSHO MEMORIAL", "NMRMC SURGERY CLINIC", "NMRMC ORTHOPEDIC CLINIC"}
