...
func GetSourceBayfrontTraumaAndAcuteCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBayfrontTraumaAndAcuteCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Bayfront Trauma and Acute Care"
	sourceDef.SourceType = pkg.SourceTypeBayfrontTraumaAndAcuteCare
