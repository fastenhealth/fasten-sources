...
func GetSourceProlianceImagingCenterAtFirstHill(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeProlianceImagingCenterAtFirstHill]; clientIdOk {
	...
	sourceDef.Category = []string{"2085R0202X", "2085U0001X", "2471S1302X", "261QR0200X"}
