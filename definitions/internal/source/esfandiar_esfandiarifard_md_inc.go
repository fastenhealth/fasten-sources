...
func GetSourceEsfandiarEsfandiarifardMdInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEsfandiarEsfandiarifardMdInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ESFANDIAR ESFANDIARIFARD MD INC"
	sourceDef.SourceType = pkg.SourceTypeEsfandiarEsfandiarifardMdInc
