...
func GetSourceBeverlyHillsSkinCareInst(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBeverlyHillsSkinCareInst]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Beverly Hills Skin Care Inst"
	sourceDef.SourceType = pkg.SourceTypeBeverlyHillsSkinCareInst
