...
func GetSourceNorthGeorgiaRheumatologyGroupPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthGeorgiaRheumatologyGroupPc]; clientIdOk {
