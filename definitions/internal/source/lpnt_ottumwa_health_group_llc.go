...
func GetSourceLpntOttumwaHealthGroupLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLpntOttumwaHealthGroupLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "LPNT Ottumwa Health Group LLC"
	sourceDef.SourceType = pkg.SourceTypeLpntOttumwaHealthGroupLlc
