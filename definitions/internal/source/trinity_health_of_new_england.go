...
func GetSourceTrinityHealthOfNewEngland(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeTrinityHealthOfNewEngland
