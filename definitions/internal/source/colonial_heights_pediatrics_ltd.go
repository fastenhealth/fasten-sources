...
func GetSourceColonialHeightsPediatricsLtd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeColonialHeightsPediatricsLtd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Colonial Heights Pediatrics Ltd"
	sourceDef.SourceType = pkg.SourceTypeColonialHeightsPediatricsLtd
