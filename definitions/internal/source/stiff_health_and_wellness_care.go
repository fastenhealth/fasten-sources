...
func GetSourceStiffHealthAndWellnessCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeStiffHealthAndWellnessCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Stiff Health and Wellness Care"
	sourceDef.SourceType = pkg.SourceTypeStiffHealthAndWellnessCare
