...
func GetSourceTheInstituteOfSurgicalArts(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheInstituteOfSurgicalArts]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Institute of Surgical Arts"
	sourceDef.SourceType = pkg.SourceTypeTheInstituteOfSurgicalArts
