...
func GetSourceCommunityHealthProgramsInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCommunityHealthProgramsInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Community Health Programs Inc"
	sourceDef.SourceType = pkg.SourceTypeCommunityHealthProgramsInc
	sourceDef.PatientAccessUrl = "https://www.chpberkshires.org/"
