...
func GetSourceAlpineOrthopedicsAndSpinePc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlpineOrthopedicsAndSpinePc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Alpine Orthopedics and Spine PC"
	sourceDef.SourceType = pkg.SourceTypeAlpineOrthopedicsAndSpinePc
