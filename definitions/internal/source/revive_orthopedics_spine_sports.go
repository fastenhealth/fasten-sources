...
func GetSourceReviveOrthopedicsSpineSports(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeReviveOrthopedicsSpineSports]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ReVive Orthopedics Spine  Sports"
	sourceDef.SourceType = pkg.SourceTypeReviveOrthopedicsSpineSports
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://reviveorthopedics.com/"
