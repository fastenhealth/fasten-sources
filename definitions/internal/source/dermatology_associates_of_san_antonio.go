...
func GetSourceDermatologyAssociatesOfSanAntonio(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDermatologyAssociatesOfSanAntonio]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Dermatology Associates Of San Antonio"
	sourceDef.SourceType = pkg.SourceTypeDermatologyAssociatesOfSanAntonio
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.dermsa.com/content/location/northeast/"
