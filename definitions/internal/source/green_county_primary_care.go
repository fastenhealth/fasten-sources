...
func GetSourceGreenCountyPrimaryCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGreenCountyPrimaryCare]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.janetoddhospital.com/clinics/green-county-primary-care"
