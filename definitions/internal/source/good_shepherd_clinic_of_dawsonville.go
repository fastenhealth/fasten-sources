...
func GetSourceGoodShepherdClinicOfDawsonville(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGoodShepherdClinicOfDawsonville]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Good Shepherd Clinic of Dawsonville"
	sourceDef.SourceType = pkg.SourceTypeGoodShepherdClinicOfDawsonville
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.goodshepherddawsonco.org/"
