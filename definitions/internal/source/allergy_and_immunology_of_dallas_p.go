...
func GetSourceAllergyAndImmunologyOfDallasP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAllergyAndImmunologyOfDallasP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Allergy and Immunology of Dallas P"
	sourceDef.SourceType = pkg.SourceTypeAllergyAndImmunologyOfDallasP
