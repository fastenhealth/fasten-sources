...
func GetSourceVieraFamilyMedicineAndWellness(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVieraFamilyMedicineAndWellness]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Viera Family Medicine and Wellness"
	sourceDef.SourceType = pkg.SourceTypeVieraFamilyMedicineAndWellness
