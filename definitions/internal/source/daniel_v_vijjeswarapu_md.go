...
func GetSourceDanielVVijjeswarapuMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDanielVVijjeswarapuMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = " DANIEL V VIJJESWARAPU MD"
	sourceDef.SourceType = pkg.SourceTypeDanielVVijjeswarapuMd
