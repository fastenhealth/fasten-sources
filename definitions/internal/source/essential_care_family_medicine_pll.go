...
func GetSourceEssentialCareFamilyMedicinePll(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEssentialCareFamilyMedicinePll]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ESSENTIAL CARE FAMILY MEDICINE PLL"
	sourceDef.SourceType = pkg.SourceTypeEssentialCareFamilyMedicinePll
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://essentialcare-familymedicine.com"
