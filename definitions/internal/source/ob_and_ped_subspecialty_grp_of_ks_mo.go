...
func GetSourceObAndPedSubspecialtyGrpOfKsMo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeObAndPedSubspecialtyGrpOfKsMo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "OB and Ped Subspecialty Grp of KS/MO"
	sourceDef.SourceType = pkg.SourceTypeObAndPedSubspecialtyGrpOfKsMo
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.kcuc.com/"
