...
func GetSourceHunterdonFamilyMedAtBridgewater(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHunterdonFamilyMedAtBridgewater]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Hunterdon Family Med At Bridgewater"
	sourceDef.SourceType = pkg.SourceTypeHunterdonFamilyMedAtBridgewater
	sourceDef.BrandLogo = "hunterdon-family-med-at-bridgewater.svg"
