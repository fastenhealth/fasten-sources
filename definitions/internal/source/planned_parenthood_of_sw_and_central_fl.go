...
func GetSourcePlannedParenthoodOfSwAndCentralFl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePlannedParenthoodOfSwAndCentralFl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Planned Parenthood Of SW and Central FL"
	sourceDef.SourceType = pkg.SourceTypePlannedParenthoodOfSwAndCentralFl
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.plannedparenthood.org/planned-parenthood-southwest-central-florida"
