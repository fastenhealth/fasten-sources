...
func GetSourceRoxeneRilesNpPediatric(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRoxeneRilesNpPediatric]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Roxene Riles NP Pediatric"
	sourceDef.SourceType = pkg.SourceTypeRoxeneRilesNpPediatric
