...
func GetSourceJulieCoponDo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJulieCoponDo]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.memorialcare.org/providers/julie-copon"
