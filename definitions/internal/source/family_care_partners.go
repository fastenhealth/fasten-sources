...
func GetSourceFamilyCarePartners(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyCarePartners]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Family Care Partners"
	sourceDef.SourceType = pkg.SourceTypeFamilyCarePartners
	sourceDef.PatientAccessUrl = "https://familycarepartners.com"
