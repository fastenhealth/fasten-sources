...
func GetSourceSaintPaulFamilyMedicalCtr(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSaintPaulFamilyMedicalCtr]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Saint Paul Family Medical Ctr"
	sourceDef.SourceType = pkg.SourceTypeSaintPaulFamilyMedicalCtr
