...
func GetSourceWexfordFootAndAnkleInstitute(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWexfordFootAndAnkleInstitute]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Wexford Foot and Ankle Institute "
	sourceDef.SourceType = pkg.SourceTypeWexfordFootAndAnkleInstitute
