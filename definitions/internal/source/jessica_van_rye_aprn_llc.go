...
func GetSourceJessicaVanRyeAprnLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJessicaVanRyeAprnLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Jessica Van Rye APRN LLC"
	sourceDef.SourceType = pkg.SourceTypeJessicaVanRyeAprnLlc
