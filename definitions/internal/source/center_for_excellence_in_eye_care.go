...
func GetSourceCenterForExcellenceInEyeCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCenterForExcellenceInEyeCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Center For Excellence In Eye Care"
	sourceDef.SourceType = pkg.SourceTypeCenterForExcellenceInEyeCare
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.centerforeyecare.com/"
