...
func GetSourceAbsoluteUrgentCareOfTexasInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAbsoluteUrgentCareOfTexasInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Absolute Urgent Care of Texas Inc"
	sourceDef.SourceType = pkg.SourceTypeAbsoluteUrgentCareOfTexasInc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://absoluteucare.com/"
