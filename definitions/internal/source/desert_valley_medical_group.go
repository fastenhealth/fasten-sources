...
func GetSourceDesertValleyMedicalGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDesertValleyMedicalGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Desert Valley Medical Group"
	sourceDef.SourceType = pkg.SourceTypeDesertValleyMedicalGroup
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://dvmc.com"
