...
func GetSourceSyracuseCommunityHealthCenterInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSyracuseCommunityHealthCenterInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Syracuse Community Health Center Inc"
	sourceDef.SourceType = pkg.SourceTypeSyracuseCommunityHealthCenterInc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://syracusecommunityhealth.org/"
