...
func GetSourceWomencareOfBaldwinParkLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomencareOfBaldwinParkLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "WOMENCARE OF BALDWIN PARK LLC"
	sourceDef.SourceType = pkg.SourceTypeWomencareOfBaldwinParkLlc
