...
func GetSourceDsaDermatology(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDsaDermatology]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "DSA Dermatology"
	sourceDef.SourceType = pkg.SourceTypeDsaDermatology
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.dsadermatology.com/"
