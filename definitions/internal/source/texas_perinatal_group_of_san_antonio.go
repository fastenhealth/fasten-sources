...
func GetSourceTexasPerinatalGroupOfSanAntonio(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTexasPerinatalGroupOfSanAntonio]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Texas Perinatal Group Of San Antonio"
	sourceDef.SourceType = pkg.SourceTypeTexasPerinatalGroupOfSanAntonio
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.healthgrades.com/group-directory/tx-texas/san-antonio/texas-perinatal-group-xbmcn9"
