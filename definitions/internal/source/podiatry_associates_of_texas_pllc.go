...
func GetSourcePodiatryAssociatesOfTexasPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePodiatryAssociatesOfTexasPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Podiatry Associates of Texas PLLC"
	sourceDef.SourceType = pkg.SourceTypePodiatryAssociatesOfTexasPllc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.podiatryassociatesoftexas.com/"
