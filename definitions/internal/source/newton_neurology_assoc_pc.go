...
func GetSourceNewtonNeurologyAssocPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNewtonNeurologyAssocPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Newton Neurology Assoc PC"
	sourceDef.SourceType = pkg.SourceTypeNewtonNeurologyAssocPc
