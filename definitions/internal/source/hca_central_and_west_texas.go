...
func GetSourceHcaCentralAndWestTexas(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeHcaCentralAndWestTexas
