...
func GetSourceMerrillvillePainReliefCenterPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMerrillvillePainReliefCenterPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Merrillville Pain Relief Center PC"
	sourceDef.SourceType = pkg.SourceTypeMerrillvillePainReliefCenterPc
