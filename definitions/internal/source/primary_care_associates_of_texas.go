...
// https://fhir4.healow.com/fhir/r4/JADCDA/metadata
func GetSourcePrimaryCareAssociatesOfTexas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Issuer = "https://fhir4.healow.com/fhir/r4/JADCDA"
	sourceDef.Audience = "https://fhir4.healow.com/fhir/r4/JADCDA"

	sourceDef.ApiEndpointBaseUrl = "https://fhir4.healow.com/fhir/r4/JADCDA"
