...
func GetSourceHeartlandHealthCenterInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHeartlandHealthCenterInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Heartland Health Center Inc."
	sourceDef.SourceType = pkg.SourceTypeHeartlandHealthCenterInc
	sourceDef.PatientAccessUrl = "https://www.heartlandhealthcenter.org/"
