...
func GetSourceWoodburyEndocrinologyAndDiabetes(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWoodburyEndocrinologyAndDiabetes]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Woodbury Endocrinology and Diabetes"
	sourceDef.SourceType = pkg.SourceTypeWoodburyEndocrinologyAndDiabetes
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.woodburyendocrinology.com"
