...
func GetSourceThornvilleFamilyMedicalCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeThornvilleFamilyMedicalCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Thornville Family Medical Center"
	sourceDef.SourceType = pkg.SourceTypeThornvilleFamilyMedicalCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.thornvillefamilymedicalcenter.com/Patients/Reviews/"
