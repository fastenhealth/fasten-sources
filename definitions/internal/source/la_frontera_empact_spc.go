...
func GetSourceLaFronteraEmpactSpc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLaFronteraEmpactSpc]; clientIdOk {
	...
	sourceDef.Aliases = []string{"EMPACT-SPC"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1215311378"}}
