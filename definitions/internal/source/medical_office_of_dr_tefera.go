...
func GetSourceMedicalOfficeOfDrTefera(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMedicalOfficeOfDrTefera]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Medical Office of Dr Tefera"
	sourceDef.SourceType = pkg.SourceTypeMedicalOfficeOfDrTefera
