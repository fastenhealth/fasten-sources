...
func GetSourceTheresaPiotrowskiMdDbaTheAdu(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheresaPiotrowskiMdDbaTheAdu]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Theresa Piotrowski MD DBA The Adu"
	sourceDef.SourceType = pkg.SourceTypeTheresaPiotrowskiMdDbaTheAdu
