...
func GetSourceKaterynaKomarovskiyMdPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKaterynaKomarovskiyMdPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Kateryna Komarovskiy MD PLLC"
	sourceDef.SourceType = pkg.SourceTypeKaterynaKomarovskiyMdPllc
