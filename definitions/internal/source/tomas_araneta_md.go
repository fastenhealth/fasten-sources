...
func GetSourceTomasAranetaMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTomasAranetaMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Tomas Araneta MD"
	sourceDef.SourceType = pkg.SourceTypeTomasAranetaMd
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://draraneta.health/"
