...
func GetSourceEarNoseThroatAssociatesOfTexas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEarNoseThroatAssociatesOfTexas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Ear Nose  Throat Associates of Texas"
	sourceDef.SourceType = pkg.SourceTypeEarNoseThroatAssociatesOfTexas
