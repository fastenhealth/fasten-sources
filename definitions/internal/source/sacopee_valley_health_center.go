...
func GetSourceSacopeeValleyHealthCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSacopeeValleyHealthCenter]; clientIdOk {
	...
	sourceDef.Category = []string{"261Q00000X", "261QD0000X"}
