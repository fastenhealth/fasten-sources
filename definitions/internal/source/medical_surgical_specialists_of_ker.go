...
func GetSourceMedicalSurgicalSpecialistsOfKer(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMedicalSurgicalSpecialistsOfKer]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MEDICAL SURGICAL SPECIALISTS OF KER"
	sourceDef.SourceType = pkg.SourceTypeMedicalSurgicalSpecialistsOfKer
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.mssk-docs.com"
