...
func GetSourceAttentionDeficitDisorder(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAttentionDeficitDisorder]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Attention Deficit Disorder"
	sourceDef.SourceType = pkg.SourceTypeAttentionDeficitDisorder
