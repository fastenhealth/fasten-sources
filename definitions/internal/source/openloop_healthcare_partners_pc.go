...
func GetSourceOpenloopHealthcarePartnersPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOpenloopHealthcarePartnersPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "OpenLoop Healthcare Partners PC"
	sourceDef.SourceType = pkg.SourceTypeOpenloopHealthcarePartnersPc
