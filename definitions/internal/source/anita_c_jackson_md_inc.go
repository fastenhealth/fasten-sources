...
func GetSourceAnitaCJacksonMdInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnitaCJacksonMdInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Anita C Jackson MD Inc"
	sourceDef.SourceType = pkg.SourceTypeAnitaCJacksonMdInc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://drjackson.health/"
