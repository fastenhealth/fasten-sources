...
func GetSourceEdmondsOrthopedicTherapy(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEdmondsOrthopedicTherapy]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Edmonds Orthopedic Therapy"
	sourceDef.SourceType = pkg.SourceTypeEdmondsOrthopedicTherapy
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.swedish.org/"
