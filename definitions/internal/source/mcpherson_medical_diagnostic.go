...
func GetSourceMcphersonMedicalDiagnostic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMcphersonMedicalDiagnostic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "McPherson Medical  Diagnostic"
	sourceDef.SourceType = pkg.SourceTypeMcphersonMedicalDiagnostic
