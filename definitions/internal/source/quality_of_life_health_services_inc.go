...
func GetSourceQualityOfLifeHealthServicesInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeQualityOfLifeHealthServicesInc]; clientIdOk {
	...
	sourceDef.Category = []string{"332B00000X", "333600000X", "3336C0002X", "3336C0003X", "3336C0004X", "3336M0002X"}
