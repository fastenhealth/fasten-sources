...
func GetSourceLowcountrySpineAndSport(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Audience = "https://fhir4.eclinicalworks.com/fhir/r4/GHGGAA"

	sourceDef.ApiEndpointBaseUrl = "https://fhir4.eclinicalworks.com/fhir/r4/GHGGAA"
	...
	sourceDef.Display = "Lowcountry Spine And Sport"
