...
func GetSourceGibsonAreaFamilyMedicine(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGibsonAreaFamilyMedicine]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.gibsonhospital.org/image/2934"
