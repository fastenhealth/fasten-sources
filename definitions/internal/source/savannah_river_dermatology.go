...
func GetSourceSavannahRiverDermatology(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSavannahRiverDermatology]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Savannah River Dermatology"
	sourceDef.SourceType = pkg.SourceTypeSavannahRiverDermatology
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "http://www.srderm.com/about-us/"
