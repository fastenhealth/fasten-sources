...
func GetSourceNikolaosISarrimanolisMdLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNikolaosISarrimanolisMdLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Nikolaos I Sarrimanolis MD LLC"
	sourceDef.SourceType = pkg.SourceTypeNikolaosISarrimanolisMdLlc
