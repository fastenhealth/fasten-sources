...
func GetSourceMikaelKHakanssonMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMikaelKHakanssonMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Mikael K Hakansson MD"
	sourceDef.SourceType = pkg.SourceTypeMikaelKHakanssonMd
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.healthgrades.com/group-directory/ca-california/fillmore/mikael-k-hakansson-md-xbdgbp"
