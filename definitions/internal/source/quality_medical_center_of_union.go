...
func GetSourceQualityMedicalCenterOfUnion(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeQualityMedicalCenterOfUnion]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Quality Medical Center of Union"
	sourceDef.SourceType = pkg.SourceTypeQualityMedicalCenterOfUnion
