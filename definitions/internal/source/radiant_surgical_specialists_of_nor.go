...
func GetSourceRadiantSurgicalSpecialistsOfNor(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRadiantSurgicalSpecialistsOfNor]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "RADIANT SURGICAL SPECIALISTS OF NOR"
	sourceDef.SourceType = pkg.SourceTypeRadiantSurgicalSpecialistsOfNor
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://radiantsurgicalntx.com"
