...
func GetSourcePainReliefGroupOfHartsville(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePainReliefGroupOfHartsville]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pain Relief Group of Hartsville"
	sourceDef.SourceType = pkg.SourceTypePainReliefGroupOfHartsville
