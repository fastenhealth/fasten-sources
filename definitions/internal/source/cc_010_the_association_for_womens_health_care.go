...
func GetSourceCc010TheAssociationForWomensHealthCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc010TheAssociationForWomensHealthCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC010THE ASSOCIATION FOR WOMENS HEALTH CARE"
	sourceDef.SourceType = pkg.SourceTypeCc010TheAssociationForWomensHealthCare
