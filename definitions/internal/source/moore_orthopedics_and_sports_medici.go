...
func GetSourceMooreOrthopedicsAndSportsMedici(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMooreOrthopedicsAndSportsMedici]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MOORE ORTHOPEDICS AND SPORTS MEDICI"
	sourceDef.SourceType = pkg.SourceTypeMooreOrthopedicsAndSportsMedici
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.mooresportsmed.com"
