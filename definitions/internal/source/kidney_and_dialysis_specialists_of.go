...
func GetSourceKidneyAndDialysisSpecialistsOf(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKidneyAndDialysisSpecialistsOf]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Kidney and Dialysis Specialists of"
	sourceDef.SourceType = pkg.SourceTypeKidneyAndDialysisSpecialistsOf
