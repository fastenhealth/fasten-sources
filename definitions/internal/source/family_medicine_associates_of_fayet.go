...
func GetSourceFamilyMedicineAssociatesOfFayet(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyMedicineAssociatesOfFayet]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Family Medicine Associates Of Fayet"
	sourceDef.SourceType = pkg.SourceTypeFamilyMedicineAssociatesOfFayet
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://familymedicineoffayetteville.com/"
