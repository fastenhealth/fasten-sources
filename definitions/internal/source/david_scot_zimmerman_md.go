...
func GetSourceDavidScotZimmermanMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDavidScotZimmermanMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "David Scot Zimmerman MD"
	sourceDef.SourceType = pkg.SourceTypeDavidScotZimmermanMd
	sourceDef.PatientAccessUrl = "https://weence.com/medical/doctors/chicago/david-zimmerman-md/"
