...
func GetSourceMedicalExpenseDivisionInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMedicalExpenseDivisionInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = " MEDICAL EXPENSE DIVISION INC"
	sourceDef.SourceType = pkg.SourceTypeMedicalExpenseDivisionInc
