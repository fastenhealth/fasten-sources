...
func GetSourceIdahoFallsInfectiousDiseases(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeIdahoFallsInfectiousDiseases]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Idaho Falls Infectious Diseases"
	sourceDef.SourceType = pkg.SourceTypeIdahoFallsInfectiousDiseases
