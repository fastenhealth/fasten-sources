...
func GetSourceTxFamilyClinicDrJenniferGwozdz(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTxFamilyClinicDrJenniferGwozdz]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TX  Family Clinic  Dr Jennifer Gwozdz"
	sourceDef.SourceType = pkg.SourceTypeTxFamilyClinicDrJenniferGwozdz
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://familyclinichouston.com"
