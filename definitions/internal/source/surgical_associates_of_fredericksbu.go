...
func GetSourceSurgicalAssociatesOfFredericksbu(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSurgicalAssociatesOfFredericksbu]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Surgical Associates of Fredericksbu"
	sourceDef.SourceType = pkg.SourceTypeSurgicalAssociatesOfFredericksbu
