...
func GetSourceNorthwestFamilyMedicine(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthwestFamilyMedicine]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Northwest Family Medicine"
	sourceDef.SourceType = pkg.SourceTypeNorthwestFamilyMedicine
	sourceDef.PatientAccessUrl = "https://www.northwestfamilymed.com/"
