...
func GetSourceCassCountyHealthClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCassCountyHealthClinic]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.casscohealth.org/healthclinic"
