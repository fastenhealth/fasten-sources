...
func GetSourceAdvancedInternalMedicine1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdvancedInternalMedicine1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeAdvancedInternalMedicine1
