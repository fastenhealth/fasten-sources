...
func GetSourceOptimalWomensCareObgynLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOptimalWomensCareObgynLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "OPTIMAL WOMENS CARE OBGYN LLC"
	sourceDef.SourceType = pkg.SourceTypeOptimalWomensCareObgynLlc
