...
func GetSourceDermatologyConsultantsOfFrisco(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDermatologyConsultantsOfFrisco]; clientIdOk {
	...
	sourceDef.BrandLogo = "dermatology-consultants-of-frisco.jpg"
