...
func GetSourceSiegelCohenKasminBrownMds(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSiegelCohenKasminBrownMds]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Siegel Cohen Kasmin  Brown MDs"
	sourceDef.SourceType = pkg.SourceTypeSiegelCohenKasminBrownMds
