...
func GetSourceWheelerClinicInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWheelerClinicInc]; clientIdOk {
	...
	sourceDef.Category = []string{"261QM0801X", "261QH0100X", "261QF0400X"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1396750840", "1265098180", "1871108076"}}
