...
func GetSourceRetinaCenterOfVermont(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRetinaCenterOfVermont]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Retina Center Of Vermont"
	sourceDef.SourceType = pkg.SourceTypeRetinaCenterOfVermont
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "retina-center-of-vermont.jpg"
	sourceDef.PatientAccessUrl = "https://retinacentervermont.com/"
