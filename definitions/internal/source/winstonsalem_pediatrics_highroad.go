...
func GetSourceWinstonsalemPediatricsHighroad(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWinstonsalemPediatricsHighroad]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "WinstonSalem Pediatrics Highroad"
	sourceDef.SourceType = pkg.SourceTypeWinstonsalemPediatricsHighroad
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.winstonsalempediatrics.com/"
