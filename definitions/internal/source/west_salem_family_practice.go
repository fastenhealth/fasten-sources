...
func GetSourceWestSalemFamilyPractice(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWestSalemFamilyPractice]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "West Salem Family Practice"
	sourceDef.SourceType = pkg.SourceTypeWestSalemFamilyPractice
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.wsfpa.com/"
