...
func GetSourceCaremoreIllinoisWisconsin(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaremoreIllinoisWisconsin]; clientIdOk {
	...
	sourceDef.BrandLogo = "caremore-illinois-wisconsin.svg"
