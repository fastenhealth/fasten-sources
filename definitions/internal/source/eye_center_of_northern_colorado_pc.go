...
func GetSourceEyeCenterOfNorthernColoradoPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeCenterOfNorthernColoradoPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Center Of Northern Colorado PC"
	sourceDef.SourceType = pkg.SourceTypeEyeCenterOfNorthernColoradoPc
	sourceDef.PatientAccessUrl = "https://www.eyecenternoco.com/"
