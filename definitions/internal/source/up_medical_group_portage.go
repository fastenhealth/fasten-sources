...
func GetSourceUpMedicalGroupPortage(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUpMedicalGroupPortage]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "UP MEDICAL GROUP  PORTAGE"
	sourceDef.SourceType = pkg.SourceTypeUpMedicalGroupPortage
