...
func GetSourceCarrieroFootAndAnkleInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCarrieroFootAndAnkleInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Carriero Foot and Ankle Inc"
	sourceDef.SourceType = pkg.SourceTypeCarrieroFootAndAnkleInc
