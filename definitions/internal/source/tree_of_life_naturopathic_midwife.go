...
func GetSourceTreeOfLifeNaturopathicMidwife(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTreeOfLifeNaturopathicMidwife]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tree of Life Naturopathic  Midwife"
	sourceDef.SourceType = pkg.SourceTypeTreeOfLifeNaturopathicMidwife
