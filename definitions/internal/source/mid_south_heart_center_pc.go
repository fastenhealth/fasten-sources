...
func GetSourceMidSouthHeartCenterPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMidSouthHeartCenterPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Mid-South Heart Center PC"
	sourceDef.SourceType = pkg.SourceTypeMidSouthHeartCenterPc
	sourceDef.PatientAccessUrl = "https://www.midsouthheartcenterjackson.com/"
