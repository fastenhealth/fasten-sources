...
func GetSourceMarkRamirezMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMarkRamirezMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Mark Ramirez MD"
	sourceDef.SourceType = pkg.SourceTypeMarkRamirezMd
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://drramirez.health/"
