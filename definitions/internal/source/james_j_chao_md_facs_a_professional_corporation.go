...
func GetSourceJamesJChaoMdFacsAProfessionalCorporation(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJamesJChaoMdFacsAProfessionalCorporation]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "JAMES J CHAO MD FACS A PROFESSIONAL CORPORATION"
	sourceDef.SourceType = pkg.SourceTypeJamesJChaoMdFacsAProfessionalCorporation
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://oasismd.com"
