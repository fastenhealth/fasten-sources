...
func GetSourceCrestviewHillsSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCrestviewHillsSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Crestview Hills Surgery Center"
	sourceDef.SourceType = pkg.SourceTypeCrestviewHillsSurgeryCenter
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "crestview-hills-surgery-center.jpg"
	sourceDef.PatientAccessUrl = "https://www.stelizabethphysicians.com/"
