...
func GetSourceAnkleFootCenterOfCentralFlor(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnkleFootCenterOfCentralFlor]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Ankle  Foot Center of Central Flor"
	sourceDef.SourceType = pkg.SourceTypeAnkleFootCenterOfCentralFlor
