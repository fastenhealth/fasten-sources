...
func GetSourceGraceAtHomeAMemberOfVillageMedical(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGraceAtHomeAMemberOfVillageMedical]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Grace at Home a Member of Village Medical"
	sourceDef.SourceType = pkg.SourceTypeGraceAtHomeAMemberOfVillageMedical
