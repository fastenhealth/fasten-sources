...
func GetSourceWestFrontPrimaryCarePllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWestFrontPrimaryCarePllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "West Front Primary Care PLLC"
	sourceDef.SourceType = pkg.SourceTypeWestFrontPrimaryCarePllc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://westfrontprimarycare.com/"
