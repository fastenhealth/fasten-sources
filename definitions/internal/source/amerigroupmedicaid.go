...
func GetSourceAmerigroupmedicaid(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeAmerigroupmedicaid
