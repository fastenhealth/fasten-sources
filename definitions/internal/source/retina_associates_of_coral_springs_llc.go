...
func GetSourceRetinaAssociatesOfCoralSpringsLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRetinaAssociatesOfCoralSpringsLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Retina Associates Of Coral Springs LLC"
	sourceDef.SourceType = pkg.SourceTypeRetinaAssociatesOfCoralSpringsLlc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://retinasurgeon.net/"
