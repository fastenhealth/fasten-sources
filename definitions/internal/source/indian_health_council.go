...
func GetSourceIndianHealthCouncil(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeIndianHealthCouncil]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.indianhealth.com/"
