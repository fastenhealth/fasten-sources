...
func GetSourceANewLifeObgynOfBrowardLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeANewLifeObgynOfBrowardLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "A NEW LIFE OBGYN OF BROWARD LLC"
	sourceDef.SourceType = pkg.SourceTypeANewLifeObgynOfBrowardLlc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.anewlifeobgyn.com/"
