...
func GetSourceHaroldMarkCotlerDoCotlerFa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHaroldMarkCotlerDoCotlerFa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Harold Mark Cotler DO  Cotler Fa"
	sourceDef.SourceType = pkg.SourceTypeHaroldMarkCotlerDoCotlerFa
