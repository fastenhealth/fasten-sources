...
func GetSourceUpperlineHealthSanBernardino(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUpperlineHealthSanBernardino]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Upperline Health San Bernardino"
	sourceDef.SourceType = pkg.SourceTypeUpperlineHealthSanBernardino
