...
func GetSourceEndocrineCenterOfKansas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEndocrineCenterOfKansas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Endocrine Center of Kansas"
	sourceDef.SourceType = pkg.SourceTypeEndocrineCenterOfKansas
