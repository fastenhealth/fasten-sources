...
func GetSourceCommunityHealthCareInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCommunityHealthCareInc]; clientIdOk {
	...
	sourceDef.Category = []string{"3336C0002X", "261QF0400X"}
	sourceDef.Aliases = []string{"CHC PHARMACY"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1861518276", "1326680067", "1275175002", "1598152019"}}
