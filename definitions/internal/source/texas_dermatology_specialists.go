...
func GetSourceTexasDermatologySpecialists(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTexasDermatologySpecialists]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Texas Dermatology Specialists"
	sourceDef.SourceType = pkg.SourceTypeTexasDermatologySpecialists
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://texasdermatology.com/"
