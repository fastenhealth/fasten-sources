...
func GetSourceTennovaFamilyMedicineDover(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTennovaFamilyMedicineDover]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tennova Family Medicine  Dover"
	sourceDef.SourceType = pkg.SourceTypeTennovaFamilyMedicineDover
