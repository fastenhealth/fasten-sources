...
func GetSourceAgataOczkodanguilanMdSc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAgataOczkodanguilanMdSc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Agata OczkoDanguilan MD SC"
	sourceDef.SourceType = pkg.SourceTypeAgataOczkodanguilanMdSc
