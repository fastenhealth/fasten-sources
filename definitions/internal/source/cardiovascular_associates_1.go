...
func GetSourceCardiovascularAssociates1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCardiovascularAssociates1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeCardiovascularAssociates1
