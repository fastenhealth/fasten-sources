...
func GetSourcePacificVascucare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePacificVascucare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pacific VascuCare"
	sourceDef.SourceType = pkg.SourceTypePacificVascucare
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "pacific-vascucare.jpg"
