...
func GetSourceCardiologyAssociatesOfPortHuronPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCardiologyAssociatesOfPortHuronPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Cardiology Associates Of Port Huron PC"
	sourceDef.SourceType = pkg.SourceTypeCardiologyAssociatesOfPortHuronPc
	sourceDef.PatientAccessUrl = "https://www.porthuronheartcenter.com/"
