...
func GetSourceSouthIslandOrthopedicsPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthIslandOrthopedicsPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SOUTH ISLAND ORTHOPEDICS PC"
	sourceDef.SourceType = pkg.SourceTypeSouthIslandOrthopedicsPc
