...
func GetSourceCapeFearClinicIncorporated(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCapeFearClinicIncorporated]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Cape Fear Clinic Incorporated"
	sourceDef.SourceType = pkg.SourceTypeCapeFearClinicIncorporated
