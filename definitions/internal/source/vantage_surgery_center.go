...
func GetSourceVantageSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVantageSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Vantage Surgery Center"
	sourceDef.SourceType = pkg.SourceTypeVantageSurgeryCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.vantageeye.com/"
