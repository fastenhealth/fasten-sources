...
func GetSourceTheOstergardGynecologyAndFemale(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheOstergardGynecologyAndFemale]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Ostergard Gynecology and Female"
	sourceDef.SourceType = pkg.SourceTypeTheOstergardGynecologyAndFemale
