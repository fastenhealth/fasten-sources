...
func GetSourceBuildingBridgesFamilyTherapy(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBuildingBridgesFamilyTherapy]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Building Bridges Family Therapy"
	sourceDef.SourceType = pkg.SourceTypeBuildingBridgesFamilyTherapy
