...
func GetSourceGeoffreyEBaumDoOrthopedicSu(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGeoffreyEBaumDoOrthopedicSu]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Geoffrey E Baum DO Orthopedic Su"
	sourceDef.SourceType = pkg.SourceTypeGeoffreyEBaumDoOrthopedicSu
