...
func GetSourceEyeSurgeryCenterOfAlbany(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeSurgeryCenterOfAlbany]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Surgery Center Of Albany"
	sourceDef.SourceType = pkg.SourceTypeEyeSurgeryCenterOfAlbany
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "http://www.albanyregionaleye.com/"
