...
func GetSourceHartfordHealthcare(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.ApiEndpointBaseUrl = "https://epicproxy.hhchealth.org/FHIR/api/FHIR/R4"
	...
	sourceDef.SourceType = definitions.SourceTypeHartfordHealthcare
