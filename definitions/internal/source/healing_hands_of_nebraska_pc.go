...
func GetSourceHealingHandsOfNebraskaPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHealingHandsOfNebraskaPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "HEALING HANDS OF NEBRASKA PC"
	sourceDef.SourceType = pkg.SourceTypeHealingHandsOfNebraskaPc
