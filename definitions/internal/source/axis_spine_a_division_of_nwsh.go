...
func GetSourceAxisSpineADivisionOfNwsh(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAxisSpineADivisionOfNwsh]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Axis Spine a Division of NWSH"
	sourceDef.SourceType = pkg.SourceTypeAxisSpineADivisionOfNwsh
