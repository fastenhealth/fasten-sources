...
func GetSourceLouisvilleOccupationalAndGeneral(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLouisvilleOccupationalAndGeneral]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "LOUISVILLE OCCUPATIONAL AND GENERAL"
	sourceDef.SourceType = pkg.SourceTypeLouisvilleOccupationalAndGeneral
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://theloghsclinic.org"
