...
func GetSourceCardioAsscOfGreaterWaterbury(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCardioAsscOfGreaterWaterbury]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Cardio Assc of Greater Waterbury"
	sourceDef.SourceType = pkg.SourceTypeCardioAsscOfGreaterWaterbury
