...
func GetSourceDrrobynYoungDrbarbaraMcquinn(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrrobynYoungDrbarbaraMcquinn]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "DrRobyn Young  DrBarbara McQuinn"
	sourceDef.SourceType = pkg.SourceTypeDrrobynYoungDrbarbaraMcquinn
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.alamedaneuro.com"
