...
func GetSourcePleasantPedsCareOfConyersLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePleasantPedsCareOfConyersLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pleasant Peds Care of Conyers LLC"
	sourceDef.SourceType = pkg.SourceTypePleasantPedsCareOfConyersLlc
