...
func GetSourceTransitionalHealthcareOfAmerica(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTransitionalHealthcareOfAmerica]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Transitional Healthcare of America"
	sourceDef.SourceType = pkg.SourceTypeTransitionalHealthcareOfAmerica
