...
func GetSourceRetnaBillanoMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRetnaBillanoMd]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.healthgrades.com/physician/dr-retna-billano-x4ww7"
