...
func GetSourceSandySpringsAnesthesiaGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSandySpringsAnesthesiaGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SANDY SPRINGS ANESTHESIA GROUP"
	sourceDef.SourceType = pkg.SourceTypeSandySpringsAnesthesiaGroup
