...
func GetSourceFloridaSportsOrthopaedicAndSpineMedicine(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFloridaSportsOrthopaedicAndSpineMedicine]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Florida Sports Orthopaedic and Spine Medicine"
	sourceDef.SourceType = pkg.SourceTypeFloridaSportsOrthopaedicAndSpineMedicine
