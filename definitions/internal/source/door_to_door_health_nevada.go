...
func GetSourceDoorToDoorHealthNevada(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDoorToDoorHealthNevada]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Door to Door Health Nevada"
	sourceDef.SourceType = pkg.SourceTypeDoorToDoorHealthNevada
