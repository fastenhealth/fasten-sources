...
func GetSourceSanJoseNephrologyMedicalPractic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSanJoseNephrologyMedicalPractic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SAN JOSE NEPHROLOGY MEDICAL PRACTIC"
	sourceDef.SourceType = pkg.SourceTypeSanJoseNephrologyMedicalPractic
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.SanJoseKidney.com"
