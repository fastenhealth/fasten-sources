...
func GetSourceBurgawMedicalCenterHampsteadFamilyMedicine(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBurgawMedicalCenterHampsteadFamilyMedicine]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Burgaw Medical Center  Hampstead Family Medicine"
	sourceDef.SourceType = pkg.SourceTypeBurgawMedicalCenterHampsteadFamilyMedicine
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://burgawmedicalcenter.com/"
