...
func GetSourceAbdelnasserElmansouryMdPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAbdelnasserElmansouryMdPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Abdelnasser Elmansoury MD PA"
	sourceDef.SourceType = pkg.SourceTypeAbdelnasserElmansouryMdPa
