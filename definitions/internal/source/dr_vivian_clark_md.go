...
func GetSourceDrVivianClarkMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrVivianClarkMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Dr Vivian Clark MD"
	sourceDef.SourceType = pkg.SourceTypeDrVivianClarkMd
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.healthcare4ppl.com/physician/tennessee/elizabethton/vivian-clark-1205889508.html"
