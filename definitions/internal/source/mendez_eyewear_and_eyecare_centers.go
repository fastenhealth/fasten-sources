...
func GetSourceMendezEyewearAndEyecareCenters(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMendezEyewearAndEyecareCenters]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Mendez EyeWear and EyeCare Centers"
	sourceDef.SourceType = pkg.SourceTypeMendezEyewearAndEyecareCenters
