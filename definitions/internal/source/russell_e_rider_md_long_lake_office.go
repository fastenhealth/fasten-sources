...
func GetSourceRussellERiderMdLongLakeOffice(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRussellERiderMdLongLakeOffice]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Russell E Rider MD Long Lake Office"
	sourceDef.SourceType = pkg.SourceTypeRussellERiderMdLongLakeOffice
