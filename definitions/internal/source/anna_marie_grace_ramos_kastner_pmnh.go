...
func GetSourceAnnaMarieGraceRamosKastnerPmnh(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnnaMarieGraceRamosKastnerPmnh]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Anna Marie Grace Ramos Kastner PMNH"
	sourceDef.SourceType = pkg.SourceTypeAnnaMarieGraceRamosKastnerPmnh
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://https://www.arkmentalhealthwellness.com/"
