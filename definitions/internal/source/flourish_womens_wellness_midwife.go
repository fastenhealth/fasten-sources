...
func GetSourceFlourishWomensWellnessMidwife(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFlourishWomensWellnessMidwife]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Flourish Womens Wellness  Midwife"
	sourceDef.SourceType = pkg.SourceTypeFlourishWomensWellnessMidwife
