...
func GetSourceMemorialHealthWashington(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMemorialHealthWashington]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MEMORIAL HEALTH WASHINGTON"
	sourceDef.SourceType = pkg.SourceTypeMemorialHealthWashington
