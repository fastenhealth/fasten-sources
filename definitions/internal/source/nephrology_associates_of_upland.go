...
func GetSourceNephrologyAssociatesOfUpland(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNephrologyAssociatesOfUpland]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Nephrology Associates of Upland"
	sourceDef.SourceType = pkg.SourceTypeNephrologyAssociatesOfUpland
	sourceDef.PatientAccessUrl = "https://www.nephrologyassociatesonline.com/contact-us.php"
