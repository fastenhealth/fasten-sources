...
func GetSourceForefrontDermatologyWestPC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeForefrontDermatologyWestPC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Forefront Dermatology-West P.C."
	sourceDef.SourceType = pkg.SourceTypeForefrontDermatologyWestPC
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "forefront-dermatology-s-c.png"
	sourceDef.PatientAccessUrl = "https://forefrontdermatology.com/"
