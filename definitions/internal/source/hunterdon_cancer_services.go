...
func GetSourceHunterdonCancerServices(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHunterdonCancerServices]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Hunterdon Cancer Services"
	sourceDef.SourceType = pkg.SourceTypeHunterdonCancerServices
	sourceDef.BrandLogo = "hunterdon-cancer-services.jpg"
