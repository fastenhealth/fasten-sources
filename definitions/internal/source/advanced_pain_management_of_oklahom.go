...
func GetSourceAdvancedPainManagementOfOklahom(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdvancedPainManagementOfOklahom]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Advanced Pain Management of Oklahom"
	sourceDef.SourceType = pkg.SourceTypeAdvancedPainManagementOfOklahom
