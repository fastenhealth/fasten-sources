...
func GetSourceMkSpineAndJointRehabPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMkSpineAndJointRehabPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MK SPINE AND JOINT REHAB PC"
	sourceDef.SourceType = pkg.SourceTypeMkSpineAndJointRehabPc
