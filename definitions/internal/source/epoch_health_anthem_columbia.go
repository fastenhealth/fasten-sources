...
func GetSourceEpochHealthAnthemColumbia(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEpochHealthAnthemColumbia]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "EPOCH Health Anthem Columbia"
	sourceDef.SourceType = pkg.SourceTypeEpochHealthAnthemColumbia
