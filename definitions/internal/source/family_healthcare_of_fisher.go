...
func GetSourceFamilyHealthcareOfFisher(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyHealthcareOfFisher]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Family Healthcare Of Fisher"
	sourceDef.SourceType = pkg.SourceTypeFamilyHealthcareOfFisher
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.gibsonhospital.org/locations/profile/family-health-care-of-fisher"
