...
func GetSourceYvesJLafondMdInternalMedic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeYvesJLafondMdInternalMedic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Yves J Lafond MD Internal Medic"
	sourceDef.SourceType = pkg.SourceTypeYvesJLafondMdInternalMedic
