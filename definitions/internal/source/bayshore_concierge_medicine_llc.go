...
func GetSourceBayshoreConciergeMedicineLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBayshoreConciergeMedicineLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BAYSHORE CONCIERGE MEDICINE LLC"
	sourceDef.SourceType = pkg.SourceTypeBayshoreConciergeMedicineLlc
