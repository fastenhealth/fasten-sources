...
func GetSourceGadsdenRegionalPhysicianGroupPracticeLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGadsdenRegionalPhysicianGroupPracticeLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Gadsden Regional Physician Group Practice LLC"
	sourceDef.SourceType = pkg.SourceTypeGadsdenRegionalPhysicianGroupPracticeLlc
