...
func GetSourceConloncrowekopeckimyers(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeConloncrowekopeckimyers]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ConlonCroweKopeckiMyers"
	sourceDef.SourceType = pkg.SourceTypeConloncrowekopeckimyers
