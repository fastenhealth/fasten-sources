...
func GetSourceIslamicSocietyOfBaltimore(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeIslamicSocietyOfBaltimore]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Islamic Society of Baltimore"
	sourceDef.SourceType = pkg.SourceTypeIslamicSocietyOfBaltimore
