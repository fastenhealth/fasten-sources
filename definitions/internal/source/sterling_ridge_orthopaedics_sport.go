...
func GetSourceSterlingRidgeOrthopaedicsSport(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSterlingRidgeOrthopaedicsSport]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sterling Ridge Orthopaedics  Sport"
	sourceDef.SourceType = pkg.SourceTypeSterlingRidgeOrthopaedicsSport
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.srosm.com"
