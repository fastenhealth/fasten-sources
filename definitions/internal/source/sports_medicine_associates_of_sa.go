...
func GetSourceSportsMedicineAssociatesOfSa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSportsMedicineAssociatesOfSa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Sports Medicine Associates Of SA"
	sourceDef.SourceType = pkg.SourceTypeSportsMedicineAssociatesOfSa
