...
func GetSourcePhillipsSpencerPhillipsKelly(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePhillipsSpencerPhillipsKelly]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Phillips Spencer Phillips Kelly"
	sourceDef.SourceType = pkg.SourceTypePhillipsSpencerPhillipsKelly
