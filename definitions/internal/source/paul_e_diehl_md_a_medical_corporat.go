...
func GetSourcePaulEDiehlMdAMedicalCorporat(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePaulEDiehlMdAMedicalCorporat]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Paul E Diehl MD A Medical Corporat"
	sourceDef.SourceType = pkg.SourceTypePaulEDiehlMdAMedicalCorporat
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.pauldiehlmd.com"
