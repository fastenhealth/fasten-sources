...
func GetSourceCco30MyLinhVuMdiipllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCco30MyLinhVuMdiipllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CCO30MY LINH VU MDIIPLLC"
	sourceDef.SourceType = pkg.SourceTypeCco30MyLinhVuMdiipllc
