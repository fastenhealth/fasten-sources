...
func GetSourceAmarilloAreaHealthcareSpecialists(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAmarilloAreaHealthcareSpecialists]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Amarillo Area Healthcare Specialists"
	sourceDef.SourceType = pkg.SourceTypeAmarilloAreaHealthcareSpecialists
