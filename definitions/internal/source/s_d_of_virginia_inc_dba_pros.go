...
func GetSourceSDOfVirginiaIncDbaPros(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSDOfVirginiaIncDbaPros]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "S  D Of Virginia Inc DBA Pros"
	sourceDef.SourceType = pkg.SourceTypeSDOfVirginiaIncDbaPros
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://prosperitymedicine.com/"
