...
func GetSourceEastGeorgiaPrimaryCareInternalMedicine(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEastGeorgiaPrimaryCareInternalMedicine]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "East Georgia Primary Care  Internal Medicine"
	sourceDef.SourceType = pkg.SourceTypeEastGeorgiaPrimaryCareInternalMedicine
