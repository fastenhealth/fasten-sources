...
func GetSourceSfeAdvancedMedicalConsulting(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSfeAdvancedMedicalConsulting]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SFE Advanced Medical Consulting"
	sourceDef.SourceType = pkg.SourceTypeSfeAdvancedMedicalConsulting
