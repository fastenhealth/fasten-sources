...
func GetSourcePamelaJeanChapmanCrna(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePamelaJeanChapmanCrna]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pamela Jean Chapman CRNA"
	sourceDef.SourceType = pkg.SourceTypePamelaJeanChapmanCrna
