...
func GetSourceCc005LyndhurstGynecologicAssociates(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc005LyndhurstGynecologicAssociates]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC005LYNDHURST GYNECOLOGIC ASSOCIATES"
	sourceDef.SourceType = pkg.SourceTypeCc005LyndhurstGynecologicAssociates
