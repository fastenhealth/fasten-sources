...
func GetSourceFrederickObGynAmbulatory(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFrederickObGynAmbulatory]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Frederick OB GYN Ambulatory"
	sourceDef.SourceType = pkg.SourceTypeFrederickObGynAmbulatory
