...
func GetSourceLouisianaSurgeonsOfExcellence(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLouisianaSurgeonsOfExcellence]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Louisiana Surgeons of Excellence"
	sourceDef.SourceType = pkg.SourceTypeLouisianaSurgeonsOfExcellence
