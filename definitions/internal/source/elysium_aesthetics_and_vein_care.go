...
func GetSourceElysiumAestheticsAndVeinCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeElysiumAestheticsAndVeinCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Elysium Aesthetics And Vein Care"
	sourceDef.SourceType = pkg.SourceTypeElysiumAestheticsAndVeinCare
