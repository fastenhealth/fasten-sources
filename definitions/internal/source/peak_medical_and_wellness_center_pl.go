...
func GetSourcePeakMedicalAndWellnessCenterPl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePeakMedicalAndWellnessCenterPl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "PEAK MEDICAL AND WELLNESS CENTER PL"
	sourceDef.SourceType = pkg.SourceTypePeakMedicalAndWellnessCenterPl
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.peakmedicalaz.com"
