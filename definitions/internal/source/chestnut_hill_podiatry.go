...
func GetSourceChestnutHillPodiatry(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeChestnutHillPodiatry]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.chestnuthillpodiatry.com/"
