...
func GetSourceFriscoCardiacAndVascularCarePl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFriscoCardiacAndVascularCarePl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FRISCO CARDIAC AND VASCULAR CARE PL"
	sourceDef.SourceType = pkg.SourceTypeFriscoCardiacAndVascularCarePl
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.friscocardiacvascularcare.com"
