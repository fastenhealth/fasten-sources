...
func GetSourceEyeSurgeryCenterOfEastTennessee(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeSurgeryCenterOfEastTennessee]; clientIdOk {
	...
	sourceDef.Aliases = []string{"EYE SURGERY CENTER OF EAST TENNESSEE"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1013997915", "1568622413"}}
