...
func GetSourceEyeCareCenters(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeCareCenters]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Care Centers"
	sourceDef.SourceType = pkg.SourceTypeEyeCareCenters
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://claytoneyecenter.com/contact-us/"
