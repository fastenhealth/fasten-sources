...
func GetSourceUnifiedSystemsOperationsIntegrationsDepartment(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUnifiedSystemsOperationsIntegrationsDepartment]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Unified Systems Operations  Integrations Department"
	sourceDef.SourceType = pkg.SourceTypeUnifiedSystemsOperationsIntegrationsDepartment
