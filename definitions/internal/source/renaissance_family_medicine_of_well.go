...
func GetSourceRenaissanceFamilyMedicineOfWell(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRenaissanceFamilyMedicineOfWell]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "RENAISSANCE FAMILY MEDICINE OF WELL"
	sourceDef.SourceType = pkg.SourceTypeRenaissanceFamilyMedicineOfWell
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://rfmofwellesley.com"
