...
func GetSourceProvidenceHealthServicesOregon(env pkg.FastenLighthouseEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = pkg.SourceTypeProvidenceHealthServicesOregon
