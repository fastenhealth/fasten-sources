...
func GetSourceMichaelJRoganMdDbaRoganFamil(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMichaelJRoganMdDbaRoganFamil]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Michael J Rogan MD DBA Rogan Famil"
	sourceDef.SourceType = pkg.SourceTypeMichaelJRoganMdDbaRoganFamil
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.roganfamilymedicine.com"
