...
func GetSourceBalanceRegenerativeSportsAndRe(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBalanceRegenerativeSportsAndRe]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BALANCE REGENERATIVE SPORTS AND RE"
	sourceDef.SourceType = pkg.SourceTypeBalanceRegenerativeSportsAndRe
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.BalanceBklyn.com"
