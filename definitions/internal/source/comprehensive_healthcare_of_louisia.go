...
func GetSourceComprehensiveHealthcareOfLouisia(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeComprehensiveHealthcareOfLouisia]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Comprehensive Healthcare of Louisia"
	sourceDef.SourceType = pkg.SourceTypeComprehensiveHealthcareOfLouisia
