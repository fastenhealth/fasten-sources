...
func GetSourceOregonRheumatologyClinicsLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOregonRheumatologyClinicsLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Oregon Rheumatology Clinics LLC"
	sourceDef.SourceType = pkg.SourceTypeOregonRheumatologyClinicsLlc
	sourceDef.PatientAccessUrl = "https://www.orrheum.com/"
