...
func GetSourceNagarathnaGManjappaMdInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNagarathnaGManjappaMdInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Nagarathna G Manjappa MD Inc"
	sourceDef.SourceType = pkg.SourceTypeNagarathnaGManjappaMdInc
