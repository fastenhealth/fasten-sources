...
func GetSourceLandenLakePediatricsCoPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLandenLakePediatricsCoPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Landen Lake Pediatrics Co PC"
	sourceDef.SourceType = pkg.SourceTypeLandenLakePediatricsCoPc
