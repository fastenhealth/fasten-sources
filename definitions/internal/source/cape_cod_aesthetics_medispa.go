...
func GetSourceCapeCodAestheticsMedispa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCapeCodAestheticsMedispa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CAPE COD AESTHETICS  MEDISPA"
	sourceDef.SourceType = pkg.SourceTypeCapeCodAestheticsMedispa
