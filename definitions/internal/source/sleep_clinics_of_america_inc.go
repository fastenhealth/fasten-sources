...
func GetSourceSleepClinicsOfAmericaInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSleepClinicsOfAmericaInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sleep Clinics of America Inc"
	sourceDef.SourceType = pkg.SourceTypeSleepClinicsOfAmericaInc
