...
func GetSourceGreenbrierPhysicalMedicineRehabilitation(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGreenbrierPhysicalMedicineRehabilitation]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Greenbrier Physical Medicine  Rehabilitation"
	sourceDef.SourceType = pkg.SourceTypeGreenbrierPhysicalMedicineRehabilitation
