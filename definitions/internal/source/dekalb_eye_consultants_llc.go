...
func GetSourceDekalbEyeConsultantsLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDekalbEyeConsultantsLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "DeKalb Eye Consultants LLC"
	sourceDef.SourceType = pkg.SourceTypeDekalbEyeConsultantsLlc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.hauser-ross.com"
