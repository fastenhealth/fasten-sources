...
func GetSourceTheKansasCityFreeEyeClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheKansasCityFreeEyeClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Kansas City Free Eye Clinic"
	sourceDef.SourceType = pkg.SourceTypeTheKansasCityFreeEyeClinic
