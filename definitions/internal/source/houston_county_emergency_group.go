...
func GetSourceHoustonCountyEmergencyGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHoustonCountyEmergencyGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "HOUSTON COUNTY EMERGENCY GROUP"
	sourceDef.SourceType = pkg.SourceTypeHoustonCountyEmergencyGroup
