...
func GetSourceRe3InnovativeNeuroscience(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRe3InnovativeNeuroscience]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "RE3 INNOVATIVE NEUROSCIENCE"
	sourceDef.SourceType = pkg.SourceTypeRe3InnovativeNeuroscience
