...
func GetSourceCaremoreNorthCarolina(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaremoreNorthCarolina]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "CareMore North Carolina"
	sourceDef.SourceType = pkg.SourceTypeCaremoreNorthCarolina
	sourceDef.BrandLogo = "caremore-north-carolina.svg"
