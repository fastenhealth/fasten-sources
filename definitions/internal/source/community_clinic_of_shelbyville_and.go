...
func GetSourceCommunityClinicOfShelbyvilleAnd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCommunityClinicOfShelbyvilleAnd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Community Clinic of Shelbyville and"
	sourceDef.SourceType = pkg.SourceTypeCommunityClinicOfShelbyvilleAnd
