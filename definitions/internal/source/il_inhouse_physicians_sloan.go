...
func GetSourceIlInhousePhysiciansSloan(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeIlInhousePhysiciansSloan]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "IL  InHouse Physicians  Sloan"
	sourceDef.SourceType = pkg.SourceTypeIlInhousePhysiciansSloan
