...
func GetSourceCoAngelaGilmerMidwifeStartup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCoAngelaGilmerMidwifeStartup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CO  Angela Gilmer  Midwife Startup"
	sourceDef.SourceType = pkg.SourceTypeCoAngelaGilmerMidwifeStartup
