...
func GetSourcePediatricPhysiciansOfNewark(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatricPhysiciansOfNewark]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pediatric Physicians Of Newark"
	sourceDef.SourceType = pkg.SourceTypePediatricPhysiciansOfNewark
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "pediatric-physicians-of-newark.jpg"
	sourceDef.PatientAccessUrl = "https://heartofohiopediatrics.com/"
