...
func GetSourceMiguelGutierrezdiazDo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMiguelGutierrezdiazDo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Miguel GutierrezDiaz DO"
	sourceDef.SourceType = pkg.SourceTypeMiguelGutierrezdiazDo
