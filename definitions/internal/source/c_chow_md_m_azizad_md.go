...
func GetSourceCChowMdMAzizadMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCChowMdMAzizadMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "C CHOW MD  M AZIZAD MD"
	sourceDef.SourceType = pkg.SourceTypeCChowMdMAzizadMd
