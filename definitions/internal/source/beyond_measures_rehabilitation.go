...
func GetSourceBeyondMeasuresRehabilitation(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBeyondMeasuresRehabilitation]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Beyond Measures Rehabilitation"
	sourceDef.SourceType = pkg.SourceTypeBeyondMeasuresRehabilitation
