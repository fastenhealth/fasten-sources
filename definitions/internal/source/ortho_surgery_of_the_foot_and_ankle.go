...
func GetSourceOrthoSurgeryOfTheFootAndAnkle(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthoSurgeryOfTheFootAndAnkle]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Ortho Surgery of the Foot And Ankle"
	sourceDef.SourceType = pkg.SourceTypeOrthoSurgeryOfTheFootAndAnkle
