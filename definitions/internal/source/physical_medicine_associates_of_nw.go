...
func GetSourcePhysicalMedicineAssociatesOfNw(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePhysicalMedicineAssociatesOfNw]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Physical Medicine Associates of NW"
	sourceDef.SourceType = pkg.SourceTypePhysicalMedicineAssociatesOfNw
