...
func GetSourceGreaterBostonPodiatryAssocs(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGreaterBostonPodiatryAssocs]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Greater Boston Podiatry Assocs"
	sourceDef.SourceType = pkg.SourceTypeGreaterBostonPodiatryAssocs
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://greaterbostonpodiatry.com"
