...
func GetSourceFeministWomensHealthCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFeministWomensHealthCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Feminist Womens Health Center"
	sourceDef.SourceType = pkg.SourceTypeFeministWomensHealthCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://feministcenter.org/"
