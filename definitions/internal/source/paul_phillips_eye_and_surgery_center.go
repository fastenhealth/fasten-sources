...
func GetSourcePaulPhillipsEyeAndSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePaulPhillipsEyeAndSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Paul Phillips Eye And Surgery Center"
	sourceDef.SourceType = pkg.SourceTypePaulPhillipsEyeAndSurgeryCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.njlasereye.com/"
