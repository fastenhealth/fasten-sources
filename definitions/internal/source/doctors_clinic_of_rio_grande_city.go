...
func GetSourceDoctorsClinicOfRioGrandeCity(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDoctorsClinicOfRioGrandeCity]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Doctors Clinic of Rio Grande City"
	sourceDef.SourceType = pkg.SourceTypeDoctorsClinicOfRioGrandeCity
