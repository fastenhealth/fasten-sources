...
func GetSourceMaverickCountyFamilyMedCtr(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMaverickCountyFamilyMedCtr]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Maverick County Family Med Ctr"
	sourceDef.SourceType = pkg.SourceTypeMaverickCountyFamilyMedCtr
