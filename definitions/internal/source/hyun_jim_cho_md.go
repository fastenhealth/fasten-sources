...
func GetSourceHyunJimChoMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHyunJimChoMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Hyun Jim Cho MD"
	sourceDef.SourceType = pkg.SourceTypeHyunJimChoMd
	sourceDef.PatientAccessUrl = "https://www.mydohc.com/find-a-doctor/profile/jim-cho/"
