...
func GetSourceAdvancedWomensCareOfPittsburgh(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdvancedWomensCareOfPittsburgh]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Advanced Womens Care of Pittsburgh"
	sourceDef.SourceType = pkg.SourceTypeAdvancedWomensCareOfPittsburgh
