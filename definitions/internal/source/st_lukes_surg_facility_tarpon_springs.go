...
func GetSourceStLukesSurgFacilityTarponSprings(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeStLukesSurgFacilityTarponSprings]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "St Lukes Surg Facility Tarpon Springs"
	sourceDef.SourceType = pkg.SourceTypeStLukesSurgFacilityTarponSprings
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.stlukeseye.com/contact/"
