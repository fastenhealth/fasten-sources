...
func GetSourceBruceAlanBarkerDoMbaPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBruceAlanBarkerDoMbaPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Bruce Alan Barker DO MBA PA"
	sourceDef.SourceType = pkg.SourceTypeBruceAlanBarkerDoMbaPa
