...
func GetSourceGenesisHealthcareSystem(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeGenesisHealthcareSystem
