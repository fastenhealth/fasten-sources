...
func GetSourceLindaLovigNpMidwifeObgyn(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLindaLovigNpMidwifeObgyn]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "LINDA LOVIG NP MIDWIFE OBGYN"
	sourceDef.SourceType = pkg.SourceTypeLindaLovigNpMidwifeObgyn
