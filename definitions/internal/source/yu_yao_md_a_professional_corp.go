...
func GetSourceYuYaoMdAProfessionalCorp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeYuYaoMdAProfessionalCorp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Yu Yao MD A Professional Corp"
	sourceDef.SourceType = pkg.SourceTypeYuYaoMdAProfessionalCorp
