...
func GetSourceStonebridgeFootAndAnklePllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeStonebridgeFootAndAnklePllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "STONEBRIDGE FOOT AND ANKLE PLLC"
	sourceDef.SourceType = pkg.SourceTypeStonebridgeFootAndAnklePllc
