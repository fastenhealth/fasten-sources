...
func GetSourceUpmcLockHavenClinicCo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUpmcLockHavenClinicCo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "UPMC  Lock Haven Clinic Co"
	sourceDef.SourceType = pkg.SourceTypeUpmcLockHavenClinicCo
