...
func GetSourceGibsonAreaMedicalClinic8(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGibsonAreaMedicalClinic8]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Gibson Area Medical Clinic 8"
	sourceDef.SourceType = pkg.SourceTypeGibsonAreaMedicalClinic8
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "gibson-area-medical-clinic-8.jpg"
	sourceDef.PatientAccessUrl = "https://www.gibsonhospital.org/locations/profile/gibson-area-medical-clinic"
