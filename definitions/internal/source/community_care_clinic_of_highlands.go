...
func GetSourceCommunityCareClinicOfHighlands(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCommunityCareClinicOfHighlands]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Community Care Clinic of Highlands"
	sourceDef.SourceType = pkg.SourceTypeCommunityCareClinicOfHighlands
