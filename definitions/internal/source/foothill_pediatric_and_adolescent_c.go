...
func GetSourceFoothillPediatricAndAdolescentC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFoothillPediatricAndAdolescentC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Foothill Pediatric and Adolescent C"
	sourceDef.SourceType = pkg.SourceTypeFoothillPediatricAndAdolescentC
