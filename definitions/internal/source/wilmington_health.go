...
func GetSourceWilmingtonHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWilmingtonHealth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Wilmington Health"
	sourceDef.SourceType = pkg.SourceTypeWilmingtonHealth
	sourceDef.BrandLogo = "wilmington-health.jpg"
	sourceDef.PatientAccessUrl = "https://www.wilmingtonhealth.com/"
