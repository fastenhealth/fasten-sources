...
func GetSourceLwrFamilyPracticeWalkin(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLwrFamilyPracticeWalkin]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "LWR Family Practice WalkIn"
	sourceDef.SourceType = pkg.SourceTypeLwrFamilyPracticeWalkin
