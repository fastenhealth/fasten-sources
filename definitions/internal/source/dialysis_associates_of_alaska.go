...
func GetSourceDialysisAssociatesOfAlaska(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDialysisAssociatesOfAlaska]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dialysis Associates of Alaska"
	sourceDef.SourceType = pkg.SourceTypeDialysisAssociatesOfAlaska
