...
func GetSourceGnoSnoringAndSinusLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGnoSnoringAndSinusLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "GNO Snoring and Sinus LLC"
	sourceDef.SourceType = pkg.SourceTypeGnoSnoringAndSinusLlc
