...
func GetSourceCarlsbadUrgentCareSanMarcos(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCarlsbadUrgentCareSanMarcos]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Carlsbad Urgent Care San Marcos"
	sourceDef.SourceType = pkg.SourceTypeCarlsbadUrgentCareSanMarcos
