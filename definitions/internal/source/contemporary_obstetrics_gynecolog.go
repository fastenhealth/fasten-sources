...
func GetSourceContemporaryObstetricsGynecolog(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeContemporaryObstetricsGynecolog]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CONTEMPORARY OBSTETRICS  GYNECOLOG"
	sourceDef.SourceType = pkg.SourceTypeContemporaryObstetricsGynecolog
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.cobgyn.com/"
