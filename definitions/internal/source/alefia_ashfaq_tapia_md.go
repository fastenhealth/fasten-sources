...
func GetSourceAlefiaAshfaqTapiaMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlefiaAshfaqTapiaMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Alefia  Ashfaq Tapia MD"
	sourceDef.SourceType = pkg.SourceTypeAlefiaAshfaqTapiaMd
