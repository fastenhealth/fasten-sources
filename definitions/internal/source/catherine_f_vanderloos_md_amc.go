...
func GetSourceCatherineFVanderloosMdAmc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCatherineFVanderloosMdAmc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Catherine F Vanderloos MD AMC"
	sourceDef.SourceType = pkg.SourceTypeCatherineFVanderloosMdAmc
