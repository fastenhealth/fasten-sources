...
func GetSourceStemCellCentersOfMinnesota(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeStemCellCentersOfMinnesota]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Stem Cell Centers of Minnesota"
	sourceDef.SourceType = pkg.SourceTypeStemCellCentersOfMinnesota
