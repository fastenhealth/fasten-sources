...
func GetSourceEyePhysiciansOfFlorida(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyePhysiciansOfFlorida]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Physicians Of Florida"
	sourceDef.SourceType = pkg.SourceTypeEyePhysiciansOfFlorida
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.eyefl.com/"
