...
func GetSourceGeorgeWashingtonUniversityMedicalFacultyAssociates(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeGeorgeWashingtonUniversityMedicalFacultyAssociates
