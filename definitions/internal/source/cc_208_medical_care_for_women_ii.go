...
func GetSourceCc208MedicalCareForWomenIi(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc208MedicalCareForWomenIi]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC208MEDICAL CARE FOR WOMEN II"
	sourceDef.SourceType = pkg.SourceTypeCc208MedicalCareForWomenIi
