...
func GetSourceEnlightenInfantHomeCareLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEnlightenInfantHomeCareLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Enlighten Infant Home Care LLC"
	sourceDef.SourceType = pkg.SourceTypeEnlightenInfantHomeCareLlc
