...
func GetSourceIdealPhysicalTherapyAndFitness(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeIdealPhysicalTherapyAndFitness]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Ideal Physical Therapy And Fitness"
	sourceDef.SourceType = pkg.SourceTypeIdealPhysicalTherapyAndFitness
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://idealphysicaltherapyandfitness.com"
