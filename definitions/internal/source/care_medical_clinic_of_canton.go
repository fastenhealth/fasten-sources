...
func GetSourceCareMedicalClinicOfCanton(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCareMedicalClinicOfCanton]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Care Medical Clinic of Canton"
	sourceDef.SourceType = pkg.SourceTypeCareMedicalClinicOfCanton
