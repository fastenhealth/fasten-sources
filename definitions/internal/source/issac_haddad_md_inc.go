...
func GetSourceIssacHaddadMdInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeIssacHaddadMdInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Issac Haddad MD Inc"
	sourceDef.SourceType = pkg.SourceTypeIssacHaddadMdInc
	sourceDef.PatientAccessUrl = "https://issachaddadmd.com"
