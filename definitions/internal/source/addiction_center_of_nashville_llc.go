...
func GetSourceAddictionCenterOfNashvilleLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAddictionCenterOfNashvilleLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Addiction Center of Nashville LLC"
	sourceDef.SourceType = pkg.SourceTypeAddictionCenterOfNashvilleLlc
