...
func GetSourceJacksonPhysicianCorp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJacksonPhysicianCorp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Jackson Physician Corp"
	sourceDef.SourceType = pkg.SourceTypeJacksonPhysicianCorp
	sourceDef.Category = []string{"207Q00000X", "207RC0000X", "2088P0231X", "208D00000X", "213ES0103X", "261QP2000X", "332B00000X", "363L00000X"}
