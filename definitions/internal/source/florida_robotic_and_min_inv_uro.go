...
func GetSourceFloridaRoboticAndMinInvUro(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFloridaRoboticAndMinInvUro]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Florida Robotic and Min Inv Uro"
	sourceDef.SourceType = pkg.SourceTypeFloridaRoboticAndMinInvUro
