...
func GetSourceTheFamilyClinicAPartOfNorthwestFamilyCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheFamilyClinicAPartOfNorthwestFamilyCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Family Clinic  A Part of Northwest Family Care"
	sourceDef.SourceType = pkg.SourceTypeTheFamilyClinicAPartOfNorthwestFamilyCare
