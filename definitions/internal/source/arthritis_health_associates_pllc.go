...
func GetSourceArthritisHealthAssociatesPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeArthritisHealthAssociatesPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Arthritis Health Associates PLLC"
	sourceDef.SourceType = pkg.SourceTypeArthritisHealthAssociatesPllc
	sourceDef.PatientAccessUrl = "http://ahasyr.com/"
