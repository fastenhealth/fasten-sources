...
func GetSourceSurgicalSpecialistsOfNorthTexas1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSurgicalSpecialistsOfNorthTexas1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeSurgicalSpecialistsOfNorthTexas1
