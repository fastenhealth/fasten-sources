...
func GetSourceAustinAreaBestCareFamilyPracti(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAustinAreaBestCareFamilyPracti]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "AUSTIN AREA BEST CARE FAMILY PRACTI"
	sourceDef.SourceType = pkg.SourceTypeAustinAreaBestCareFamilyPracti
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.Palomaprimarycare.com"
