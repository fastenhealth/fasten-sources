...
func GetSourceWesternDupageObstetricsAndGynec(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWesternDupageObstetricsAndGynec]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "WESTERN DUPAGE OBSTETRICS AND GYNEC"
	sourceDef.SourceType = pkg.SourceTypeWesternDupageObstetricsAndGynec
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.westerndupageobgyn.com/"
