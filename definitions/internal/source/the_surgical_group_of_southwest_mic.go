...
func GetSourceTheSurgicalGroupOfSouthwestMic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheSurgicalGroupOfSouthwestMic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Surgical Group of Southwest Mic"
	sourceDef.SourceType = pkg.SourceTypeTheSurgicalGroupOfSouthwestMic
