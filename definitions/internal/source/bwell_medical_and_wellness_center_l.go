...
func GetSourceBwellMedicalAndWellnessCenterL(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBwellMedicalAndWellnessCenterL]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BWELL MEDICAL AND WELLNESS CENTER L"
	sourceDef.SourceType = pkg.SourceTypeBwellMedicalAndWellnessCenterL
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.bwellmedicalandwellness.com"
