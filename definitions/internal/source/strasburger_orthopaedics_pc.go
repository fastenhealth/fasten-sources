...
func GetSourceStrasburgerOrthopaedicsPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeStrasburgerOrthopaedicsPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Strasburger Orthopaedics  PC"
	sourceDef.SourceType = pkg.SourceTypeStrasburgerOrthopaedicsPc
