...
func GetSourceBrunetteBastienMedicalServicesL(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBrunetteBastienMedicalServicesL]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BRUNETTE BASTIEN MEDICAL SERVICES L"
	sourceDef.SourceType = pkg.SourceTypeBrunetteBastienMedicalServicesL
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://Brunette Bastien Medical Services LLC"
