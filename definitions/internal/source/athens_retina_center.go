...
func GetSourceAthensRetinaCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAthensRetinaCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Athens Retina Center"
	sourceDef.SourceType = pkg.SourceTypeAthensRetinaCenter
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "athens-retina-center.svg"
	sourceDef.PatientAccessUrl = "https://www.athensretina.com/"
