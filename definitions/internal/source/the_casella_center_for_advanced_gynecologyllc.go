...
func GetSourceTheCasellaCenterForAdvancedGynecologyllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheCasellaCenterForAdvancedGynecologyllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Casella Center for Advanced GynecologyLLC"
	sourceDef.SourceType = pkg.SourceTypeTheCasellaCenterForAdvancedGynecologyllc
