...
func GetSourceFootAnkleLegSpecialistOfSFl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFootAnkleLegSpecialistOfSFl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FOOT ANKLE  LEG SPECIALIST OF S FL"
	sourceDef.SourceType = pkg.SourceTypeFootAnkleLegSpecialistOfSFl
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.south florida sports medicine .org"
