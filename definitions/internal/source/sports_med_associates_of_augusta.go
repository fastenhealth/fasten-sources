...
func GetSourceSportsMedAssociatesOfAugusta(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSportsMedAssociatesOfAugusta]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sports Med Associates of Augusta"
	sourceDef.SourceType = pkg.SourceTypeSportsMedAssociatesOfAugusta
