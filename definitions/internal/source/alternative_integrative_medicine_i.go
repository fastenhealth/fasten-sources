...
func GetSourceAlternativeIntegrativeMedicineI(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlternativeIntegrativeMedicineI]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Alternative Integrative Medicine I"
	sourceDef.SourceType = pkg.SourceTypeAlternativeIntegrativeMedicineI
