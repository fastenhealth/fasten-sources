...
func GetSourceDrGeraldKFleer(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrGeraldKFleer]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Dr Gerald K Fleer"
	sourceDef.SourceType = pkg.SourceTypeDrGeraldKFleer
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.healthgrades.com/physician/dr-gerald-fleer-yc3lf"
