...
func GetSourceClinicaDeSaludDelValle(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeClinicaDeSaludDelValle]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Clinica De Salud Del Valle"
	sourceDef.SourceType = pkg.SourceTypeClinicaDeSaludDelValle
	sourceDef.PatientAccessUrl = "https://csvs.org/"
