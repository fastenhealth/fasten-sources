...
func GetSourceTusseyMountainFootAnkleSpecia(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTusseyMountainFootAnkleSpecia]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tussey Mountain Foot  Ankle Specia"
	sourceDef.SourceType = pkg.SourceTypeTusseyMountainFootAnkleSpecia
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://tusseyfootankle.com"
