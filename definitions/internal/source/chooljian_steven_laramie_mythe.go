...
func GetSourceChooljianStevenLaramieMythe(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeChooljianStevenLaramieMythe]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Chooljian Steven  Laramie Mythe"
	sourceDef.SourceType = pkg.SourceTypeChooljianStevenLaramieMythe
