...
func GetSourceLakelandAllergyAsthmaImmunoth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLakelandAllergyAsthmaImmunoth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lakeland Allergy Asthma  Immunoth"
	sourceDef.SourceType = pkg.SourceTypeLakelandAllergyAsthmaImmunoth
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.lakelandallergy.com"
