...
func GetSourceGwendolynVYoungbloodMdPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGwendolynVYoungbloodMdPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Gwendolyn V Youngblood MD PC"
	sourceDef.SourceType = pkg.SourceTypeGwendolynVYoungbloodMdPc
