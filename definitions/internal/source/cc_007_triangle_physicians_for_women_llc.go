...
func GetSourceCc007TrianglePhysiciansForWomenLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc007TrianglePhysiciansForWomenLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC007TRIANGLE PHYSICIANS FOR WOMEN LLC"
	sourceDef.SourceType = pkg.SourceTypeCc007TrianglePhysiciansForWomenLlc
