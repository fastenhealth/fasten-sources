...
func GetSourceDrVinayParameswaraDrAditiS(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrVinayParameswaraDrAditiS]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dr Vinay Parameswara  Dr Aditi S"
	sourceDef.SourceType = pkg.SourceTypeDrVinayParameswaraDrAditiS
