...
func GetSourceChaBehavioralHealthcarePa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeChaBehavioralHealthcarePa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CHA Behavioral Healthcare PA"
	sourceDef.SourceType = pkg.SourceTypeChaBehavioralHealthcarePa
