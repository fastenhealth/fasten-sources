...
func GetSourceDentonFootAndAnkleSurgicalSpec(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDentonFootAndAnkleSurgicalSpec]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Denton Foot and Ankle Surgical Spec"
	sourceDef.SourceType = pkg.SourceTypeDentonFootAndAnkleSurgicalSpec
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.dentonfootandanklesurgery.com"
