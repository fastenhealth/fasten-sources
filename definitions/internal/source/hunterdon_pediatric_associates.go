...
func GetSourceHunterdonPediatricAssociates(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHunterdonPediatricAssociates]; clientIdOk {
	...
	sourceDef.BrandLogo = "hunterdon-pediatric-associates.svg"
