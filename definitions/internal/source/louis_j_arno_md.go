...
func GetSourceLouisJArnoMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLouisJArnoMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Louis J Arno MD"
	sourceDef.SourceType = pkg.SourceTypeLouisJArnoMd
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://thelungdoctor.net/"
