...
func GetSourceTheRiseProjectOfTheCarolinas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheRiseProjectOfTheCarolinas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The RISE Project of the Carolinas"
	sourceDef.SourceType = pkg.SourceTypeTheRiseProjectOfTheCarolinas
