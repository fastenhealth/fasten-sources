...
func GetSourceBastionHealthHoldingsInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBastionHealthHoldingsInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BASTION HEALTH HOLDINGS INC"
	sourceDef.SourceType = pkg.SourceTypeBastionHealthHoldingsInc
