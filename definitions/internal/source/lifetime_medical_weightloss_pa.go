...
func GetSourceLifetimeMedicalWeightlossPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLifetimeMedicalWeightlossPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lifetime Medical Weightloss PA"
	sourceDef.SourceType = pkg.SourceTypeLifetimeMedicalWeightlossPa
