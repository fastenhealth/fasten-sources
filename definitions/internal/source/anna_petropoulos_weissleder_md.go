...
func GetSourceAnnaPetropoulosWeisslederMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnnaPetropoulosWeisslederMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Anna Petropoulos Weissleder MD"
	sourceDef.SourceType = pkg.SourceTypeAnnaPetropoulosWeisslederMd
