...
func GetSourceCyfairHeadacheAndNeurological(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCyfairHeadacheAndNeurological]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CyFair Headache and Neurological"
	sourceDef.SourceType = pkg.SourceTypeCyfairHeadacheAndNeurological
