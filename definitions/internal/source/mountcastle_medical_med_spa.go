...
func GetSourceMountcastleMedicalMedSpa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMountcastleMedicalMedSpa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Mountcastle Medical  Med Spa"
	sourceDef.SourceType = pkg.SourceTypeMountcastleMedicalMedSpa
