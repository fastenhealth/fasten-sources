...
func GetSourceJeffreyAFischerDpm(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJeffreyAFischerDpm]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.fischerpodiatry.com/"
