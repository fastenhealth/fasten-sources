...
func GetSourceSpaceCityPainSpecialistLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSpaceCityPainSpecialistLlp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Space City Pain Specialist LLP"
	sourceDef.SourceType = pkg.SourceTypeSpaceCityPainSpecialistLlp
