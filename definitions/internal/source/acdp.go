...
func GetSourceAcdp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAcdp]; clientIdOk {
	...
	sourceDef.Category = []string{"261QM0801X", "251S00000X"}
	sourceDef.Aliases = []string{"ACDP"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1629149125", "1396997201"}}
