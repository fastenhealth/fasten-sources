...
func GetSourceSevenStarSurgery(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSevenStarSurgery]; clientIdOk {
	...
	sourceDef.Aliases = []string{"SEVEN STAR SURGERY"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1265035356"}}
