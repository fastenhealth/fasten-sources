...
func GetSourceLehighValleyOsteopathyForEveryb(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLehighValleyOsteopathyForEveryb]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lehigh Valley Osteopathy for Everyb"
	sourceDef.SourceType = pkg.SourceTypeLehighValleyOsteopathyForEveryb
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://dolifemed.org"
