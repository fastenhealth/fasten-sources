...
func GetSourceChoctawWomensClinicPllcSaraB(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeChoctawWomensClinicPllcSaraB]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Choctaw Womens Clinic PLLC Sara B"
	sourceDef.SourceType = pkg.SourceTypeChoctawWomensClinicPllcSaraB
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.choctawwomensclinic.com"
