...
func GetSourceSiouxlandAdultMedicinePllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSiouxlandAdultMedicinePllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SIOUXLAND ADULT MEDICINE PLLC"
	sourceDef.SourceType = pkg.SourceTypeSiouxlandAdultMedicinePllc
