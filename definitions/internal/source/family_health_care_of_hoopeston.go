...
func GetSourceFamilyHealthCareOfHoopeston(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyHealthCareOfHoopeston]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Family Health Care of Hoopeston"
	sourceDef.SourceType = pkg.SourceTypeFamilyHealthCareOfHoopeston
	sourceDef.BrandLogo = "family-health-care-of-hoopeston.jpg"
