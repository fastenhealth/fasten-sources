...
func GetSourceKolbeClinicOfFloridaNavarreLo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKolbeClinicOfFloridaNavarreLo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Kolbe Clinic of Florida Navarre Lo"
	sourceDef.SourceType = pkg.SourceTypeKolbeClinicOfFloridaNavarreLo
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.kolbehealthservices.com"
