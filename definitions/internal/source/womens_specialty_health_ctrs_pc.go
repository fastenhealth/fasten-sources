...
func GetSourceWomensSpecialtyHealthCtrsPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomensSpecialtyHealthCtrsPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Womens Specialty Health Ctrs PC"
	sourceDef.SourceType = pkg.SourceTypeWomensSpecialtyHealthCtrsPc
