...
func GetSourceKleimanEvangelistaEyeCentersOfTexas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKleimanEvangelistaEyeCentersOfTexas]; clientIdOk {
	...
	sourceDef.Aliases = []string{"KLEIMAN EVANGELISTA EYE CENTERS OF TEXAS", "RADIANCE WELLNESS MEDISPA"}
