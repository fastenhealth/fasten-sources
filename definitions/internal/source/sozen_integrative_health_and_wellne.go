...
func GetSourceSozenIntegrativeHealthAndWellne(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSozenIntegrativeHealthAndWellne]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SOZEN INTEGRATIVE HEALTH AND WELLNE"
	sourceDef.SourceType = pkg.SourceTypeSozenIntegrativeHealthAndWellne
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.sozenhealth.com"
