...
func GetSourceCoastalRheumatology(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCoastalRheumatology]; clientIdOk {
	...
	sourceDef.BrandLogo = "coastal-rheumatology.jpg"
	sourceDef.PatientAccessUrl = "https://www.coastalrheumatology.com/"
