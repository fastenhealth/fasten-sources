...
func GetSourcePalliativeMedicineOfSouthernMar(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePalliativeMedicineOfSouthernMar]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Palliative Medicine of Southern Mar"
	sourceDef.SourceType = pkg.SourceTypePalliativeMedicineOfSouthernMar
