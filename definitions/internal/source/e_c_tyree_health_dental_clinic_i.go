...
func GetSourceECTyreeHealthDentalClinicI(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeECTyreeHealthDentalClinicI]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "E C TYREE HEALTH  DENTAL CLINIC I"
	sourceDef.SourceType = pkg.SourceTypeECTyreeHealthDentalClinicI
