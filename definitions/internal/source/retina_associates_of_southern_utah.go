...
func GetSourceRetinaAssociatesOfSouthernUtah(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRetinaAssociatesOfSouthernUtah]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Retina Associates Of Southern Utah"
	sourceDef.SourceType = pkg.SourceTypeRetinaAssociatesOfSouthernUtah
	sourceDef.BrandLogo = "retina-associates-of-southern-utah.jpg"
