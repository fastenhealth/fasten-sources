...
func GetSourceNorthernEyeCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthernEyeCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Northern Eye Center"
	sourceDef.SourceType = pkg.SourceTypeNorthernEyeCenter
	sourceDef.PatientAccessUrl = "https://www.northerneyecenter.com"
