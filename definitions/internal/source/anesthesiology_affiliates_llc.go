...
func GetSourceAnesthesiologyAffiliatesLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAnesthesiologyAffiliatesLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Anesthesiology Affiliates LLC"
	sourceDef.SourceType = pkg.SourceTypeAnesthesiologyAffiliatesLlc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://anesthesiaokc.com/"
