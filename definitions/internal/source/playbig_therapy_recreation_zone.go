...
func GetSourcePlaybigTherapyRecreationZone(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePlaybigTherapyRecreationZone]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "PlayBig Therapy  Recreation Zone"
	sourceDef.SourceType = pkg.SourceTypePlaybigTherapyRecreationZone
