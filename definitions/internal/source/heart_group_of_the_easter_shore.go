...
func GetSourceHeartGroupOfTheEasterShore(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHeartGroupOfTheEasterShore]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "HEART GROUP OF THE EASTER SHORE"
	sourceDef.SourceType = pkg.SourceTypeHeartGroupOfTheEasterShore
