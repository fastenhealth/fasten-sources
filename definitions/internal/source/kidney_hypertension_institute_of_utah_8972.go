...
func GetSourceKidneyHypertensionInstituteOfUtah8972(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKidneyHypertensionInstituteOfUtah8972]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Kidney  Hypertension Institute of Utah8972"
	sourceDef.SourceType = pkg.SourceTypeKidneyHypertensionInstituteOfUtah8972
