...
func GetSourcePowellHealthCareCoalition(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePowellHealthCareCoalition]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Powell Health Care Coalition"
	sourceDef.SourceType = pkg.SourceTypePowellHealthCareCoalition
