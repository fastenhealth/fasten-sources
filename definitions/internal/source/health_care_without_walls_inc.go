...
func GetSourceHealthCareWithoutWallsInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHealthCareWithoutWallsInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "HEALTH CARE WITHOUT WALLS INC"
	sourceDef.SourceType = pkg.SourceTypeHealthCareWithoutWallsInc
