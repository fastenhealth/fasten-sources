...
func GetSourceCommunityHealthClinicOfHardinl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCommunityHealthClinicOfHardinl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Community Health Clinic of HardinL"
	sourceDef.SourceType = pkg.SourceTypeCommunityHealthClinicOfHardinl
