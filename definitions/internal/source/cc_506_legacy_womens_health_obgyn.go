...
func GetSourceCc506LegacyWomensHealthObgyn(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc506LegacyWomensHealthObgyn]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC506LEGACY WOMENS HEALTH OBGYN"
	sourceDef.SourceType = pkg.SourceTypeCc506LegacyWomensHealthObgyn
