...
func GetSourceShipleyAndSillsFamilyDoctors(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeShipleyAndSillsFamilyDoctors]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Shipley And Sills Family Doctors"
	sourceDef.SourceType = pkg.SourceTypeShipleyAndSillsFamilyDoctors
