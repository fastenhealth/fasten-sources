...
func GetSourceCoyleInstituteOfFemalePelvicMe(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCoyleInstituteOfFemalePelvicMe]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Coyle Institute of Female Pelvic Me"
	sourceDef.SourceType = pkg.SourceTypeCoyleInstituteOfFemalePelvicMe
