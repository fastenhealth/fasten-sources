...
func GetSourceAllergycareOfCoolSpringsPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAllergycareOfCoolSpringsPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Allergycare Of Cool Springs PLLC"
	sourceDef.SourceType = pkg.SourceTypeAllergycareOfCoolSpringsPllc
	sourceDef.PatientAccessUrl = "http://allergydropz.com/"
