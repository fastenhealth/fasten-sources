...
func GetSourceAzIcnaReliefUsaProgramsAz(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAzIcnaReliefUsaProgramsAz]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "AZ  ICNA RELIEF USA PROGRAMS  AZ"
	sourceDef.SourceType = pkg.SourceTypeAzIcnaReliefUsaProgramsAz
