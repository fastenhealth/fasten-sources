...
func GetSourceSportsMedicineAtChelseaPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSportsMedicineAtChelseaPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sports Medicine at Chelsea PLLC"
	sourceDef.SourceType = pkg.SourceTypeSportsMedicineAtChelseaPllc
