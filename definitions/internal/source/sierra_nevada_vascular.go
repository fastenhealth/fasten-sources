...
func GetSourceSierraNevadaVascular(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSierraNevadaVascular]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Sierra Nevada Vascular"
	sourceDef.SourceType = pkg.SourceTypeSierraNevadaVascular
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.azuravascularcare.com/center/sierra-nevada-access-center/"
