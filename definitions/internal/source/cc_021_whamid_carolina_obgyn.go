...
func GetSourceCc021WhamidCarolinaObgyn(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc021WhamidCarolinaObgyn]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC021WHAMID CAROLINA OBGYN"
	sourceDef.SourceType = pkg.SourceTypeCc021WhamidCarolinaObgyn
