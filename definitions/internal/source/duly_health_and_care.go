...
func GetSourceDulyHealthAndCare(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeDulyHealthAndCare
