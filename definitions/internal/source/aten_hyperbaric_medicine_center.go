...
func GetSourceAtenHyperbaricMedicineCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAtenHyperbaricMedicineCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ATEN HYPERBARIC MEDICINE CENTER"
	sourceDef.SourceType = pkg.SourceTypeAtenHyperbaricMedicineCenter
