...
func GetSourceOhioSleepMedicineAndNeuroscienc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOhioSleepMedicineAndNeuroscienc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Ohio Sleep Medicine and Neuroscienc"
	sourceDef.SourceType = pkg.SourceTypeOhioSleepMedicineAndNeuroscienc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.sleepmedicine.com"
