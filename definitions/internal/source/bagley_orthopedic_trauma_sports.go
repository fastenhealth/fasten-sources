...
func GetSourceBagleyOrthopedicTraumaSports(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBagleyOrthopedicTraumaSports]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Bagley Orthopedic Trauma  Sports"
	sourceDef.SourceType = pkg.SourceTypeBagleyOrthopedicTraumaSports
