...
func GetSourceEyeHealthCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeHealthCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Health Center"
	sourceDef.SourceType = pkg.SourceTypeEyeHealthCenter
	sourceDef.BrandLogo = "eye-health-center.jpg"
	sourceDef.PatientAccessUrl = "https://eyehealthcentertroy.com"
