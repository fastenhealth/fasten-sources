...
func GetSourceNorthRidgeEyeCenterLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthRidgeEyeCenterLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "North Ridge Eye Center LLC"
	sourceDef.SourceType = pkg.SourceTypeNorthRidgeEyeCenterLlc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://holycross.com"
