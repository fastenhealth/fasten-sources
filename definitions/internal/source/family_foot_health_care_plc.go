...
func GetSourceFamilyFootHealthCarePlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyFootHealthCarePlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FAMILY FOOT HEALTH CARE PLC"
	sourceDef.SourceType = pkg.SourceTypeFamilyFootHealthCarePlc
