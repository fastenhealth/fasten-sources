...
func GetSourceFootAnkleSpecialistsOfCentral(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFootAnkleSpecialistsOfCentral]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Foot  Ankle Specialists of Central"
	sourceDef.SourceType = pkg.SourceTypeFootAnkleSpecialistsOfCentral
