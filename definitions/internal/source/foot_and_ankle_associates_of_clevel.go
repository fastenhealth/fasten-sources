...
func GetSourceFootAndAnkleAssociatesOfClevel(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFootAndAnkleAssociatesOfClevel]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Foot and Ankle Associates of Clevel"
	sourceDef.SourceType = pkg.SourceTypeFootAndAnkleAssociatesOfClevel
