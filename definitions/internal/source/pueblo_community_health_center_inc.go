...
func GetSourcePuebloCommunityHealthCenterInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Aliases = []string{"CENTRAL HIGH SCHOOL SBWC", "PUEBLO COMMUNITY COLLEGE HEALTH CLINIC", "PUEBLO COMMUNITY HEALTH CENTER", "PUEBLO COMMUNITY HEALTH CENTER PARK HILL", "WALSENBURG CLINIC"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1316466816", "1447900717", "1700139813", "1790730737", "1790966174", "1801818398", "1952071219"}}
