...
func GetSourceMethodistHospitalsPrd(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeMethodistHospitalsPrd
