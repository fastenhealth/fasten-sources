...
func GetSourceMajeedPaduvanaMdFacpPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMajeedPaduvanaMdFacpPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MAJEED PADUVANA MD FACP PLLC"
	sourceDef.SourceType = pkg.SourceTypeMajeedPaduvanaMdFacpPllc
