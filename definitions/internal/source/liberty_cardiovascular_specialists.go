...
func GetSourceLibertyCardiovascularSpecialists(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLibertyCardiovascularSpecialists]; clientIdOk {
	...
	sourceDef.Category = []string{"207RC0000X", "208G00000X"}
