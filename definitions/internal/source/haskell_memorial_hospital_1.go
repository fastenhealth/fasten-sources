...
func GetSourceHaskellMemorialHospital1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHaskellMemorialHospital1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeHaskellMemorialHospital1
