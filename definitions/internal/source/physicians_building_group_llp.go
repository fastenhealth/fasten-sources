...
func GetSourcePhysiciansBuildingGroupLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePhysiciansBuildingGroupLlp]; clientIdOk {
	...
	sourceDef.Category = []string{"207R00000X", "207RE0101X", "207RR0500X"}
