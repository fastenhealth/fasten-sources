...
func GetSourceTheDiabetesAndEndocrineCenterO(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheDiabetesAndEndocrineCenterO]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Diabetes and endocrine center o"
	sourceDef.SourceType = pkg.SourceTypeTheDiabetesAndEndocrineCenterO
