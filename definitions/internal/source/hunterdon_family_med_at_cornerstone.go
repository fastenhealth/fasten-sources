...
func GetSourceHunterdonFamilyMedAtCornerstone(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHunterdonFamilyMedAtCornerstone]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Hunterdon Family Med At Cornerstone"
	sourceDef.SourceType = pkg.SourceTypeHunterdonFamilyMedAtCornerstone
	sourceDef.BrandLogo = "hunterdon-family-med-at-cornerstone.svg"
