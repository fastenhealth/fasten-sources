...
func GetSourceMandersonOrthopaedicClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMandersonOrthopaedicClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Manderson Orthopaedic Clinic"
	sourceDef.SourceType = pkg.SourceTypeMandersonOrthopaedicClinic
