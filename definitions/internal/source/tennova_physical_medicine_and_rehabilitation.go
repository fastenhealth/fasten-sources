...
func GetSourceTennovaPhysicalMedicineAndRehabilitation(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTennovaPhysicalMedicineAndRehabilitation]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tennova Physical Medicine and Rehabilitation"
	sourceDef.SourceType = pkg.SourceTypeTennovaPhysicalMedicineAndRehabilitation
