...
func GetSourceMetropolitanNeurosurgeryPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMetropolitanNeurosurgeryPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Metropolitan Neurosurgery PA"
	sourceDef.SourceType = pkg.SourceTypeMetropolitanNeurosurgeryPa
