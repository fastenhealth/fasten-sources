...
func GetSourceProlianceEastsideEnt(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeProlianceEastsideEnt]; clientIdOk {
	...
	sourceDef.Category = []string{"207Y00000X", "207YX0905X", "261QM1300X", "363AS0400X"}
