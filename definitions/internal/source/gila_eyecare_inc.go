...
func GetSourceGilaEyecareInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGilaEyecareInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Gila Eyecare Inc"
	sourceDef.SourceType = pkg.SourceTypeGilaEyecareInc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.gilaeyecare.com/"
