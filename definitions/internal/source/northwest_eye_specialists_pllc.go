...
func GetSourceNorthwestEyeSpecialistsPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthwestEyeSpecialistsPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Northwest Eye Specialists PLLC"
	sourceDef.SourceType = pkg.SourceTypeNorthwestEyeSpecialistsPllc
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "northwest-eye-specialists-pllc.jpg"
	sourceDef.PatientAccessUrl = "https://eyestucson.com/"
