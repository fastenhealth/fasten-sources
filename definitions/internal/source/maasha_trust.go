...
func GetSourceMaashaTrust(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMaashaTrust]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "http://maashatrust.org"
