...
func GetSourceFutureHopeHealthGroupLlcDba(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFutureHopeHealthGroupLlcDba]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Future Hope Health Group LLC DBA"
	sourceDef.SourceType = pkg.SourceTypeFutureHopeHealthGroupLlcDba
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.futurehopepediatrics.com"
