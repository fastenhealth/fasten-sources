...
func GetSourcePodiatryAssociatesOfCincinnati(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePodiatryAssociatesOfCincinnati]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Podiatry Associates of Cincinnati"
	sourceDef.SourceType = pkg.SourceTypePodiatryAssociatesOfCincinnati
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://cincypodiatryoh.com/"
