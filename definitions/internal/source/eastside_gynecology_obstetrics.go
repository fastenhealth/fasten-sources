...
func GetSourceEastsideGynecologyObstetrics(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEastsideGynecologyObstetrics]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Eastside Gynecology  Obstetrics"
	sourceDef.SourceType = pkg.SourceTypeEastsideGynecologyObstetrics
