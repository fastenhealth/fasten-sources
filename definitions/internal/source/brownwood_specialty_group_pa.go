...
func GetSourceBrownwoodSpecialtyGroupPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBrownwoodSpecialtyGroupPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BROWNWOOD SPECIALTY GROUP PA"
	sourceDef.SourceType = pkg.SourceTypeBrownwoodSpecialtyGroupPa
