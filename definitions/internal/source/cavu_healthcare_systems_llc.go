...
func GetSourceCavuHealthcareSystemsLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCavuHealthcareSystemsLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CAVU Healthcare Systems LLC"
	sourceDef.SourceType = pkg.SourceTypeCavuHealthcareSystemsLlc
