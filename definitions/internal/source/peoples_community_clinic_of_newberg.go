...
func GetSourcePeoplesCommunityClinicOfNewberg(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePeoplesCommunityClinicOfNewberg]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Peoples Community Clinic of Newberg"
	sourceDef.SourceType = pkg.SourceTypePeoplesCommunityClinicOfNewberg
