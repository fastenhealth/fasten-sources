...
func GetSourceStephenThomsenMdPa8933(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeStephenThomsenMdPa8933]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "STEPHEN THOMSEN MD PA8933"
	sourceDef.SourceType = pkg.SourceTypeStephenThomsenMdPa8933
