...
func GetSourcePhillipsHealthcareANursePractit(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePhillipsHealthcareANursePractit]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "PHILLIPS HEALTHCARE A NURSE PRACTIT"
	sourceDef.SourceType = pkg.SourceTypePhillipsHealthcareANursePractit
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.phillipshealthcarecenter.com"
