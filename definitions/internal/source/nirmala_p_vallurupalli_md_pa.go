...
func GetSourceNirmalaPVallurupalliMdPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNirmalaPVallurupalliMdPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Nirmala P Vallurupalli MD PA"
	sourceDef.SourceType = pkg.SourceTypeNirmalaPVallurupalliMdPa
