...
func GetSourceRegionalEyeSpecialistsPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRegionalEyeSpecialistsPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Regional Eye Specialists PA"
	sourceDef.SourceType = pkg.SourceTypeRegionalEyeSpecialistsPa
	sourceDef.PatientAccessUrl = "https://regeyecenter.com/"
