...
func GetSourceOpelikaCardiovascularAssocPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOpelikaCardiovascularAssocPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Opelika Cardiovascular  Assoc PC"
	sourceDef.SourceType = pkg.SourceTypeOpelikaCardiovascularAssocPc
