...
func GetSourceEricCwynarDpm(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEricCwynarDpm]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://mychart.ohiohealth.com"
