...
func GetSourceFamilyFootAndAnkleCareOfMoriches(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyFootAndAnkleCareOfMoriches]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Family Foot and Ankle Care of Moriches"
	sourceDef.SourceType = pkg.SourceTypeFamilyFootAndAnkleCareOfMoriches
