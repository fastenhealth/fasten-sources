...
func GetSourceNcpCollegeParkCathLab(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNcpCollegeParkCathLab]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "NCP College Park Cath Lab"
	sourceDef.SourceType = pkg.SourceTypeNcpCollegeParkCathLab
	sourceDef.PatientAccessUrl = "https://www.collegeparkheart.com"
