...
func GetSourceSonomaValleyHospitalDistrict(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSonomaValleyHospitalDistrict]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SONOMA VALLEY HOSPITAL DISTRICT"
	sourceDef.SourceType = pkg.SourceTypeSonomaValleyHospitalDistrict
