...
func GetSourceAmericanVisionPartners(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Category = []string{"207W00000X", "207WX0009X", "207WX0107X", "207WX0108X", "207WX0120X", "207WX0200X", "261QA1903X", "332B00000X"}
	sourceDef.Aliases = []string{"AMERICAN VISION PARTNERS"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1013952522", "1306119615", "1306922513", "1336742790", "1497727093", "1649202771", "1689619272", "1760973259", "1801387261", "1851317861"}}
