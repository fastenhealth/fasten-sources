...
func GetSourceCreightonUniversitySchoolOfMedi(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCreightonUniversitySchoolOfMedi]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Creighton University School of Medi"
	sourceDef.SourceType = pkg.SourceTypeCreightonUniversitySchoolOfMedi
