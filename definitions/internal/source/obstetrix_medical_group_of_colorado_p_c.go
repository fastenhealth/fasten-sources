...
func GetSourceObstetrixMedicalGroupOfColoradoPC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeObstetrixMedicalGroupOfColoradoPC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Obstetrix Medical Group Of Colorado P.C"
	sourceDef.SourceType = pkg.SourceTypeObstetrixMedicalGroupOfColoradoPC
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "obstetrix-medical-group-of-colorado-p-c.jpg"
