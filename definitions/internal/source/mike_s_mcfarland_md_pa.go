...
func GetSourceMikeSMcfarlandMdPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMikeSMcfarlandMdPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Mike S McFarland MD PA"
	sourceDef.SourceType = pkg.SourceTypeMikeSMcfarlandMdPa
	sourceDef.PatientAccessUrl = "https://www.healthgrades.com/physician/dr-mike-mcfarland-ypfgh"
