...
func GetSourceNorthMountainFamilyMedicinePll(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthMountainFamilyMedicinePll]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "NORTH MOUNTAIN FAMILY MEDICINE PLL"
	sourceDef.SourceType = pkg.SourceTypeNorthMountainFamilyMedicinePll
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://NMFMDoc.com"
