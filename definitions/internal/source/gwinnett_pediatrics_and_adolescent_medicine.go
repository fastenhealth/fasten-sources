...
func GetSourceGwinnettPediatricsAndAdolescentMedicine(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGwinnettPediatricsAndAdolescentMedicine]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Gwinnett Pediatrics and Adolescent Medicine"
	sourceDef.SourceType = pkg.SourceTypeGwinnettPediatricsAndAdolescentMedicine
