...
func GetSourceCc204PhysiciansToWomenIiLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc204PhysiciansToWomenIiLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC204PHYSICIANS TO WOMEN II LLC"
	sourceDef.SourceType = pkg.SourceTypeCc204PhysiciansToWomenIiLlc
