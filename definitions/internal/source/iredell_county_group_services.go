...
func GetSourceIredellCountyGroupServices(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeIredellCountyGroupServices]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "IREDELL COUNTY GROUP SERVICES"
	sourceDef.SourceType = pkg.SourceTypeIredellCountyGroupServices
