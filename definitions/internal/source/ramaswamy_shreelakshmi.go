...
func GetSourceRamaswamyShreelakshmi(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRamaswamyShreelakshmi]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Ramaswamy Shreelakshmi"
	sourceDef.SourceType = pkg.SourceTypeRamaswamyShreelakshmi
