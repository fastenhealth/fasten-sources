...
func GetSourceAvenalCommunityHealthCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAvenalCommunityHealthCenter]; clientIdOk {
	...
	sourceDef.Aliases = []string{"ARIA COMMUNITY HEALTH CENTER", "ARIA COMMUNITY HEALTH CENTER STRATFORD"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1235562224", "1912312273", "1992176267", "1265051882", "1174142798", "1154736429", "1811516438", "1932169240"}}
