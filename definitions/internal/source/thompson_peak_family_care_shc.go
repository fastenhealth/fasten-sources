...
func GetSourceThompsonPeakFamilyCareShc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeThompsonPeakFamilyCareShc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Thompson Peak Family Care SHC"
	sourceDef.SourceType = pkg.SourceTypeThompsonPeakFamilyCareShc
