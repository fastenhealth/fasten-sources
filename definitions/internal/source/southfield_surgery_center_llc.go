...
func GetSourceSouthfieldSurgeryCenterLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthfieldSurgeryCenterLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Southfield Surgery Center LLC"
	sourceDef.SourceType = pkg.SourceTypeSouthfieldSurgeryCenterLlc
	sourceDef.BrandLogo = "southfield-surgery-center-llc.jpg"
	sourceDef.PatientAccessUrl = "https://www.facebook.com/SouthfieldSurgeryCenter/"
