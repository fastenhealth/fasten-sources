...
func GetSourceFridFamilyPracticeGf(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFridFamilyPracticeGf]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Frid Family Practice GF"
	sourceDef.SourceType = pkg.SourceTypeFridFamilyPracticeGf
	sourceDef.PatientAccessUrl = "https://doctor.webmd.com/doctor/germaine-frid-dbe2ef8d-bd38-4c9e-852e-4b4c45fbc63f-overview"
