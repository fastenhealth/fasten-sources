...
func GetSourceJosephFRobertsMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJosephFRobertsMd]; clientIdOk {
	...
	sourceDef.BrandLogo = "joseph-f-roberts-md.jpg"
	sourceDef.PatientAccessUrl = "https://www.rumcsi.org/doctors/roberts-joseph-md/"
