...
func GetSourceAxiaPhysicianSolutionsMaster(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAxiaPhysicianSolutionsMaster]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Axia Physician Solutions Master"
	sourceDef.SourceType = pkg.SourceTypeAxiaPhysicianSolutionsMaster
