...
func GetSourceAllianceFamilyHealthCenter1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAllianceFamilyHealthCenter1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeAllianceFamilyHealthCenter1
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "alliance-family-health-center.png"
