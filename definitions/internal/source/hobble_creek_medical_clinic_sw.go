...
func GetSourceHobbleCreekMedicalClinicSw(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHobbleCreekMedicalClinicSw]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Hobble Creek Medical Clinic SW"
	sourceDef.SourceType = pkg.SourceTypeHobbleCreekMedicalClinicSw
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.hobblecreekmedicalclinic.com"
