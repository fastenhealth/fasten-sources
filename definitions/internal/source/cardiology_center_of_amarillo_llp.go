...
func GetSourceCardiologyCenterOfAmarilloLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCardiologyCenterOfAmarilloLlp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Cardiology Center Of Amarillo LLP"
	sourceDef.SourceType = pkg.SourceTypeCardiologyCenterOfAmarilloLlp
	sourceDef.PatientAccessUrl = "https://www.ccallp.com/"
