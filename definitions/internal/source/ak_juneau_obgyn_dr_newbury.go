...
func GetSourceAkJuneauObgynDrNewbury(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAkJuneauObgynDrNewbury]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "AK  Juneau OBGYN  Dr Newbury"
	sourceDef.SourceType = pkg.SourceTypeAkJuneauObgynDrNewbury
