...
func GetSourceVernMChristensenDpmPaDbaFo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVernMChristensenDpmPaDbaFo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Vern M Christensen DPM PA dba Fo"
	sourceDef.SourceType = pkg.SourceTypeVernMChristensenDpmPaDbaFo
