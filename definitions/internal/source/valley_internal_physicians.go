...
func GetSourceValleyInternalPhysicians(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeValleyInternalPhysicians]; clientIdOk {
	...
	sourceDef.Aliases = []string{"VALLEY INTERNAL PHYSICIANS"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1902113186"}}
