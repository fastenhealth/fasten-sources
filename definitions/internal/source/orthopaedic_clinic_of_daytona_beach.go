...
func GetSourceOrthopaedicClinicOfDaytonaBeach(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthopaedicClinicOfDaytonaBeach]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Orthopaedic Clinic of Daytona Beach"
	sourceDef.SourceType = pkg.SourceTypeOrthopaedicClinicOfDaytonaBeach
