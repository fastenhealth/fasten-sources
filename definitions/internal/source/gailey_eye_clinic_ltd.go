...
func GetSourceGaileyEyeClinicLtd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGaileyEyeClinicLtd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Gailey Eye Clinic LTD"
	sourceDef.SourceType = pkg.SourceTypeGaileyEyeClinicLtd
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "gailey-eye-clinic-ltd.jpg"
	sourceDef.PatientAccessUrl = "https://gaileyeyeclinic.com/"
