...
func GetSourceHigiProfessionalsOfDelaware(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHigiProfessionalsOfDelaware]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Higi Professionals of Delaware"
	sourceDef.SourceType = pkg.SourceTypeHigiProfessionalsOfDelaware
