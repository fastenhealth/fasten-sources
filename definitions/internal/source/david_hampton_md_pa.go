...
func GetSourceDavidHamptonMdPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDavidHamptonMdPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "David Hampton MD PA"
	sourceDef.SourceType = pkg.SourceTypeDavidHamptonMdPa
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "http://davidhamptonmd.com/"
