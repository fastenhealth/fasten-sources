...
func GetSourceLoveInActionOfTheTricities(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLoveInActionOfTheTricities]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Love In Action of the TriCities"
	sourceDef.SourceType = pkg.SourceTypeLoveInActionOfTheTricities
