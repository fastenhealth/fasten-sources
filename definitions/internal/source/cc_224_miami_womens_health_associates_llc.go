...
func GetSourceCc224MiamiWomensHealthAssociatesLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc224MiamiWomensHealthAssociatesLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC224MIAMI WOMENS HEALTH ASSOCIATES LLC"
	sourceDef.SourceType = pkg.SourceTypeCc224MiamiWomensHealthAssociatesLlc
