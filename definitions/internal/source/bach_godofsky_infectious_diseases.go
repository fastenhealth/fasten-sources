...
func GetSourceBachGodofskyInfectiousDiseases(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBachGodofskyInfectiousDiseases]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Bach  Godofsky Infectious Diseases"
	sourceDef.SourceType = pkg.SourceTypeBachGodofskyInfectiousDiseases
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.bachandgodofsky.com/"
