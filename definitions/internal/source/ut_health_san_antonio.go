...
func GetSourceUtHealthSanAntonio(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeUtHealthSanAntonio
