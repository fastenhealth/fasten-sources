...
func GetSourceNorrisHealthcareConcierge(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorrisHealthcareConcierge]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Norris Healthcare Concierge"
	sourceDef.SourceType = pkg.SourceTypeNorrisHealthcareConcierge
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://\thttps://www.norrishealthcareconcierge.com/"
