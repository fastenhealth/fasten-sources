...
func GetSourceBonSecoursHamptonRoads(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBonSecoursHamptonRoads]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Bon Secours Hampton Roads"
	sourceDef.SourceType = pkg.SourceTypeBonSecoursHamptonRoads
