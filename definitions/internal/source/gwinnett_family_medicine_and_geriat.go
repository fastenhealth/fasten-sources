...
func GetSourceGwinnettFamilyMedicineAndGeriat(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGwinnettFamilyMedicineAndGeriat]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Gwinnett Family Medicine and Geriat"
	sourceDef.SourceType = pkg.SourceTypeGwinnettFamilyMedicineAndGeriat
