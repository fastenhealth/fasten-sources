...
func GetSourceWomensHealthOfSouthMiamiLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomensHealthOfSouthMiamiLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "WOMENS HEALTH OF SOUTH MIAMI LLC"
	sourceDef.SourceType = pkg.SourceTypeWomensHealthOfSouthMiamiLlc
