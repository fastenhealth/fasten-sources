...
func GetSourceDouglasKlimCarlosTorrellas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDouglasKlimCarlosTorrellas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Douglas Klim  Carlos Torrellas"
	sourceDef.SourceType = pkg.SourceTypeDouglasKlimCarlosTorrellas
