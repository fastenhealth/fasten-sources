...
func GetSourceDrSpyrosTsoumpariotisDpm(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrSpyrosTsoumpariotisDpm]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dr Spyros Tsoumpariotis DPM"
	sourceDef.SourceType = pkg.SourceTypeDrSpyrosTsoumpariotisDpm
