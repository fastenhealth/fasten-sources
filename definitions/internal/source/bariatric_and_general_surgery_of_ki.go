...
func GetSourceBariatricAndGeneralSurgeryOfKi(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBariatricAndGeneralSurgeryOfKi]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Bariatric And General Surgery Of Ki"
	sourceDef.SourceType = pkg.SourceTypeBariatricAndGeneralSurgeryOfKi
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.bariatricsofkingwood.com"
