...
func GetSourceBoyntonBeachPerinatologyLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBoyntonBeachPerinatologyLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BOYNTON BEACH PERINATOLOGY LLC"
	sourceDef.SourceType = pkg.SourceTypeBoyntonBeachPerinatologyLlc
