...
func GetSourceGoshenPhysicians(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGoshenPhysicians]; clientIdOk {
	...
	sourceDef.BrandLogo = "goshen-physicians.svg"
