...
func GetSourceRetinaCenterOfTexas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRetinaCenterOfTexas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Retina Center Of Texas"
	sourceDef.SourceType = pkg.SourceTypeRetinaCenterOfTexas
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "retina-center-of-texas.svg"
	sourceDef.PatientAccessUrl = "https://www.retinacentertx.com/"
