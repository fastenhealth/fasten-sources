...
func GetSourcePediatricHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatricHealth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pediatric Health"
	sourceDef.SourceType = pkg.SourceTypePediatricHealth
	sourceDef.PatientAccessUrl = "https://www.yelp.com/biz/jan-tayyaba-md-allentown"
