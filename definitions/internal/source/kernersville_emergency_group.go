...
func GetSourceKernersvilleEmergencyGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKernersvilleEmergencyGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "KERNERSVILLE EMERGENCY GROUP"
	sourceDef.SourceType = pkg.SourceTypeKernersvilleEmergencyGroup
