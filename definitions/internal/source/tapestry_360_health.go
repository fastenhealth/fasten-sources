...
func GetSourceTapestry360Health(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTapestry360Health]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://tap360health.org/"
