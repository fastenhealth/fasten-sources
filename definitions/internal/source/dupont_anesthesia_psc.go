...
func GetSourceDupontAnesthesiaPsc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDupontAnesthesiaPsc]; clientIdOk {
	...
	sourceDef.Category = []string{"367500000X", "207L00000X"}
