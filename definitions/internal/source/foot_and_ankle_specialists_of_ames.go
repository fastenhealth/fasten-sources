...
func GetSourceFootAndAnkleSpecialistsOfAmes(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFootAndAnkleSpecialistsOfAmes]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Foot and Ankle Specialists of Ames"
	sourceDef.SourceType = pkg.SourceTypeFootAndAnkleSpecialistsOfAmes
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.fas-ames.com"
