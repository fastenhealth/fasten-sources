...
func GetSourcePediatrixCardiologyAssocOfNewMexico(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatrixCardiologyAssocOfNewMexico]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pediatrix Cardiology Assoc Of New Mexico"
	sourceDef.SourceType = pkg.SourceTypePediatrixCardiologyAssocOfNewMexico
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "pediatrix-cardiology-assoc-of-new-mexico.jpg"
