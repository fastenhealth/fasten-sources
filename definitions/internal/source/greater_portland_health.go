...
func GetSourceGreaterPortlandHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGreaterPortlandHealth]; clientIdOk {
	...
	sourceDef.Category = []string{"207V00000X", "261QF0400X"}
	sourceDef.Aliases = []string{"GREATER PORTLAND HEALTH"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1073144622", "1700510062", "1912610197", "1982338240"}}
