...
func GetSourceAlexandriaNeuroHeadacheCtr(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlexandriaNeuroHeadacheCtr]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Alexandria Neuro Headache Ctr"
	sourceDef.SourceType = pkg.SourceTypeAlexandriaNeuroHeadacheCtr
