...
func GetSourceJeffreyBGlaserMdAMedicalCo(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJeffreyBGlaserMdAMedicalCo]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Jeffrey B Glaser MD A Medical Co"
	sourceDef.SourceType = pkg.SourceTypeJeffreyBGlaserMdAMedicalCo
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.glaserpainrelief.com"
