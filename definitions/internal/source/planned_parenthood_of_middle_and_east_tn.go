...
func GetSourcePlannedParenthoodOfMiddleAndEastTn(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePlannedParenthoodOfMiddleAndEastTn]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Planned Parenthood of Middle and East TN"
	sourceDef.SourceType = pkg.SourceTypePlannedParenthoodOfMiddleAndEastTn
	sourceDef.PatientAccessUrl = "https://www.guidestar.org"
