...
func GetSourceAdvancedAccessMedicalCarePllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdvancedAccessMedicalCarePllc]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.aamcaccess.com/"
