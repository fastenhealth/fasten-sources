...
func GetSourceBrevardOrthopaedicSpinePainClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBrevardOrthopaedicSpinePainClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Brevard Orthopaedic Spine  Pain Clinic"
	sourceDef.SourceType = pkg.SourceTypeBrevardOrthopaedicSpinePainClinic
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http:// http://emergehealthcare.com"
