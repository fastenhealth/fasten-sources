...
func GetSourceHamptonRoadsGastroenterology(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHamptonRoadsGastroenterology]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Hampton Roads Gastroenterology"
	sourceDef.SourceType = pkg.SourceTypeHamptonRoadsGastroenterology
	sourceDef.PatientAccessUrl = "https://www.hamptonroadsgastro.com/"
