...
func GetSourcePainCentersOfWisconsinOcontoFalls(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePainCentersOfWisconsinOcontoFalls]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pain Centers Of Wisconsin Oconto Falls"
	sourceDef.SourceType = pkg.SourceTypePainCentersOfWisconsinOcontoFalls
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://npino.com/medical-supplies/1265095178-pain-centers-of-wisconsin---oconto-falls%2C-llc/"
