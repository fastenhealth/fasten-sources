...
func GetSourceObstetrixMedicalGroupOfDallas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeObstetrixMedicalGroupOfDallas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Obstetrix Medical Group Of Dallas"
	sourceDef.SourceType = pkg.SourceTypeObstetrixMedicalGroupOfDallas
	sourceDef.PatientAccessUrl = "https://www.yelp.com/biz/obstetrix-medical-group-of-dallas-dallas-dallas"
