...
func GetSourcePacificWoundCenterMedicalGroupIncDoNotUse(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePacificWoundCenterMedicalGroupIncDoNotUse]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "PACIFIC WOUND CENTER MEDICAL GROUP INC Do Not Use"
