...
func GetSourceJALSantosMdInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJALSantosMdInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "J A L Santos MD Inc"
	sourceDef.SourceType = pkg.SourceTypeJALSantosMdInc
	sourceDef.PatientAccessUrl = "https://www.healthgrades.com/physician/dr-joey-santos-yw7cj"
