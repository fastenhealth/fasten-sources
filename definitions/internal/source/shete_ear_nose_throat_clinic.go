...
func GetSourceSheteEarNoseThroatClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSheteEarNoseThroatClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Shete Ear Nose Throat Clinic"
	sourceDef.SourceType = pkg.SourceTypeSheteEarNoseThroatClinic
