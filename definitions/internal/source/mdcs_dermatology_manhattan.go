...
func GetSourceMdcsDermatologyManhattan(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMdcsDermatologyManhattan]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MDCS Dermatology Manhattan"
	sourceDef.SourceType = pkg.SourceTypeMdcsDermatologyManhattan
