...
func GetSourceSalemPediatricClinicLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSalemPediatricClinicLlp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Salem Pediatric Clinic LLP"
	sourceDef.SourceType = pkg.SourceTypeSalemPediatricClinicLlp
	sourceDef.PatientAccessUrl = "https://salempediatricclinic.com/"
