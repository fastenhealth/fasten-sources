...
func GetSourceEricEllisMdLincolnUrgentCa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEricEllisMdLincolnUrgentCa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Eric Ellis MD  Lincoln Urgent Ca"
	sourceDef.SourceType = pkg.SourceTypeEricEllisMdLincolnUrgentCa
