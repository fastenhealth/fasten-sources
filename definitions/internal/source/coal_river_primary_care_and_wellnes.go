...
func GetSourceCoalRiverPrimaryCareAndWellnes(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCoalRiverPrimaryCareAndWellnes]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Coal River Primary Care And Wellnes"
	sourceDef.SourceType = pkg.SourceTypeCoalRiverPrimaryCareAndWellnes
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.coalriverprimary.com"
