...
func GetSourceGalatiansCommunityHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGalatiansCommunityHealth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Galatians Community Health"
	sourceDef.SourceType = pkg.SourceTypeGalatiansCommunityHealth
	sourceDef.Category = []string{"207Q00000X", "207V00000X", "208000000X", "261QM1300X"}
