...
func GetSourcePerformanceOrthoSportsMedPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePerformanceOrthoSportsMedPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Performance Ortho  Sports Med PA"
	sourceDef.SourceType = pkg.SourceTypePerformanceOrthoSportsMedPa
