...
func GetSourceCookevilleMedicalClinicRhc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCookevilleMedicalClinicRhc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "COOKEVILLE MEDICAL CLINIC RHC"
	sourceDef.SourceType = pkg.SourceTypeCookevilleMedicalClinicRhc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.cookevillemed.com"
