...
func GetSourceGahannaPediatrics(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGahannaPediatrics]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Gahanna Pediatrics"
	sourceDef.SourceType = pkg.SourceTypeGahannaPediatrics
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.gahannapediatrics.com"
