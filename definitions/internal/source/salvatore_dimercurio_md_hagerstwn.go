...
func GetSourceSalvatoreDimercurioMdHagerstwn(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSalvatoreDimercurioMdHagerstwn]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Salvatore DiMercurio MD Hagerstwn"
	sourceDef.SourceType = pkg.SourceTypeSalvatoreDimercurioMdHagerstwn
