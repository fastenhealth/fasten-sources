...
func GetSourceFredericksburgAreaHealthAndSupp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFredericksburgAreaHealthAndSupp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Fredericksburg Area Health and Supp"
	sourceDef.SourceType = pkg.SourceTypeFredericksburgAreaHealthAndSupp
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.mosaiccarecenter.com/"
