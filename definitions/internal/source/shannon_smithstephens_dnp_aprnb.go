...
func GetSourceShannonSmithstephensDnpAprnb(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeShannonSmithstephensDnpAprnb]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Shannon SmithStephens DNP APRNB"
	sourceDef.SourceType = pkg.SourceTypeShannonSmithstephensDnpAprnb
