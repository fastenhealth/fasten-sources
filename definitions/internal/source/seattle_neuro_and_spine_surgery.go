...
func GetSourceSeattleNeuroAndSpineSurgery(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSeattleNeuroAndSpineSurgery]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Seattle Neuro And Spine Surgery"
	sourceDef.SourceType = pkg.SourceTypeSeattleNeuroAndSpineSurgery
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://seattleneuro.com/"
