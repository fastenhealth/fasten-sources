...
func GetSourceMcknightEyeCenterPC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMcknightEyeCenterPC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "McKnight Eye Center P.C."
	sourceDef.SourceType = pkg.SourceTypeMcknightEyeCenterPC
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://mcknighteyecenters.com"
