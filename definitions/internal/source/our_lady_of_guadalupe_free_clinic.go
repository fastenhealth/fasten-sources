...
func GetSourceOurLadyOfGuadalupeFreeClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOurLadyOfGuadalupeFreeClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Our Lady of Guadalupe Free Clinic"
	sourceDef.SourceType = pkg.SourceTypeOurLadyOfGuadalupeFreeClinic
