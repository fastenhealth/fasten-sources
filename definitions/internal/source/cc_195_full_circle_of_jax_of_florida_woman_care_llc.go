...
func GetSourceCc195FullCircleOfJaxOfFloridaWomanCareLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc195FullCircleOfJaxOfFloridaWomanCareLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC195FULL CIRCLE OF JAX OF FLORIDA WOMAN CARE LLC"
	sourceDef.SourceType = pkg.SourceTypeCc195FullCircleOfJaxOfFloridaWomanCareLlc
