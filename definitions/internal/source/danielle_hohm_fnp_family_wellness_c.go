...
func GetSourceDanielleHohmFnpFamilyWellnessC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDanielleHohmFnpFamilyWellnessC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Danielle Hohm FNP Family Wellness C"
	sourceDef.SourceType = pkg.SourceTypeDanielleHohmFnpFamilyWellnessC
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.hohmfwc.com"
