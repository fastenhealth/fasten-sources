...
func GetSourceAsadBakir(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAsadBakir]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Asad Bakir"
	sourceDef.SourceType = pkg.SourceTypeAsadBakir
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.nephdocs.com/doctor/81/asad-bakir-md"
