...
func GetSourceLuncefordFamilyHealthCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLuncefordFamilyHealthCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Lunceford Family Health Center"
	sourceDef.SourceType = pkg.SourceTypeLuncefordFamilyHealthCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://luncefordfamhealth.wixsite.com/luncefordhealth"
