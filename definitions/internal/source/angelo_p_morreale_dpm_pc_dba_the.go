...
func GetSourceAngeloPMorrealeDpmPcDbaThe(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAngeloPMorrealeDpmPcDbaThe]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Angelo P Morreale DPM PC dba The"
	sourceDef.SourceType = pkg.SourceTypeAngeloPMorrealeDpmPcDbaThe
