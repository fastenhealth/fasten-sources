...
func GetSourceLaurinburgEarNoseThroatClini(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLaurinburgEarNoseThroatClini]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Laurinburg Ear Nose  Throat Clini"
	sourceDef.SourceType = pkg.SourceTypeLaurinburgEarNoseThroatClini
