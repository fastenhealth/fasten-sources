...
func GetSourceOphthalmicConsultantsOfConnecticut(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOphthalmicConsultantsOfConnecticut]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Ophthalmic Consultants Of Connecticut"
	sourceDef.SourceType = pkg.SourceTypeOphthalmicConsultantsOfConnecticut
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "ophthalmic-consultants-of-connecticut.svg"
