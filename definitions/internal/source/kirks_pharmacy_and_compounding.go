...
func GetSourceKirksPharmacyAndCompounding(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKirksPharmacyAndCompounding]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "KIRKS PHARMACY AND COMPOUNDING"
	sourceDef.SourceType = pkg.SourceTypeKirksPharmacyAndCompounding
