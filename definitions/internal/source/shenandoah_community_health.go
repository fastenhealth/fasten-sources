...
func GetSourceShenandoahCommunityHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeShenandoahCommunityHealth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Shenandoah Community Health"
	sourceDef.SourceType = pkg.SourceTypeShenandoahCommunityHealth
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.shencommhealth.com/"
