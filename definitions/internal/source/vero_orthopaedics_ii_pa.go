...
func GetSourceVeroOrthopaedicsIiPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVeroOrthopaedicsIiPa]; clientIdOk {
	...
	sourceDef.Category = []string{"204D00000X", "207X00000X", "207XS0106X", "208100000X", "2084N0400X"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1134441660", "1184626079"}}
