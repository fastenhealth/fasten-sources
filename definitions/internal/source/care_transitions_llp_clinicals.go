...
func GetSourceCareTransitionsLlpClinicals(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCareTransitionsLlpClinicals]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Care Transitions LLP Clinicals"
	sourceDef.SourceType = pkg.SourceTypeCareTransitionsLlpClinicals
