...
func GetSourceAlignSeniorClinicVirginia(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlignSeniorClinicVirginia]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Align Senior Clinic  Virginia"
	sourceDef.SourceType = pkg.SourceTypeAlignSeniorClinicVirginia
