...
func GetSourceHeartAndVascularInstituteOfCen(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHeartAndVascularInstituteOfCen]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Heart and Vascular Institute of Cen"
	sourceDef.SourceType = pkg.SourceTypeHeartAndVascularInstituteOfCen
