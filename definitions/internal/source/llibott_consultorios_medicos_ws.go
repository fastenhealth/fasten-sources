...
func GetSourceLlibottConsultoriosMedicosWs(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLlibottConsultoriosMedicosWs]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "LliBott Consultorios Medicos WS"
	sourceDef.SourceType = pkg.SourceTypeLlibottConsultoriosMedicosWs
