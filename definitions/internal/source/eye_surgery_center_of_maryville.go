...
func GetSourceEyeSurgeryCenterOfMaryville(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeSurgeryCenterOfMaryville]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Surgery Center Of Maryville"
	sourceDef.SourceType = pkg.SourceTypeEyeSurgeryCenterOfMaryville
	sourceDef.PatientAccessUrl = "https://www.eyesofillinoissurgerycenter.com/"
