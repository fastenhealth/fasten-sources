...
func GetSourceRiversideHealthSystemNewportNewsVa(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeRiversideHealthSystemNewportNewsVa
