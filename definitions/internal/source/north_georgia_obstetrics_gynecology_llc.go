...
func GetSourceNorthGeorgiaObstetricsGynecologyLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthGeorgiaObstetricsGynecologyLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "NORTH GEORGIA OBSTETRICS  GYNECOLOGY LLC"
	sourceDef.SourceType = pkg.SourceTypeNorthGeorgiaObstetricsGynecologyLlc
