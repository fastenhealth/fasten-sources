...
func GetSourceHunterdonInfectiousDiseaseSpecialists(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHunterdonInfectiousDiseaseSpecialists]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Hunterdon Infectious Disease Specialists"
	sourceDef.SourceType = pkg.SourceTypeHunterdonInfectiousDiseaseSpecialists
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "hunterdon-infectious-disease-specialists.svg"
