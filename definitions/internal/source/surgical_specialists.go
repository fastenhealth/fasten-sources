...
func GetSourceSurgicalSpecialists(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSurgicalSpecialists]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Surgical Specialists"
	sourceDef.SourceType = pkg.SourceTypeSurgicalSpecialists
	sourceDef.PatientAccessUrl = "https://www.swedish.org/services/swedish-surgical-specialists"
