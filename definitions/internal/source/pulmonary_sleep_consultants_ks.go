...
func GetSourcePulmonarySleepConsultantsKs(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePulmonarySleepConsultantsKs]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pulmonary  Sleep Consultants KS"
	sourceDef.SourceType = pkg.SourceTypePulmonarySleepConsultantsKs
