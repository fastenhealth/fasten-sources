...
func GetSourceBozemanClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBozemanClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Bozeman Clinic"
	sourceDef.SourceType = pkg.SourceTypeBozemanClinic
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.bozemanclinic.com/?gclid=CjwKCAiAiarfBRASEiwAw1tYv3p_KAHTOv7Vfyl3O-hV7GX3SKBMzvb_Me9jssCm"
