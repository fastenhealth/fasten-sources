...
func GetSourceCenterForInternalMedicine1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCenterForInternalMedicine1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeCenterForInternalMedicine1
