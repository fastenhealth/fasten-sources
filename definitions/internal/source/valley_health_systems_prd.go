...
func GetSourceValleyHealthSystemsPrd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.ApiEndpointBaseUrl = "https://api.valleyhealth.org/fhirproxy/api/FHIR/R4"
	// retrieve client-id, if available
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeValleyHealthSystemsPrd]; clientIdOk {
