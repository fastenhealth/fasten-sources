...
func GetSourceEndocrineCareOfBocaRaton(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEndocrineCareOfBocaRaton]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Endocrine Care of Boca Raton"
	sourceDef.SourceType = pkg.SourceTypeEndocrineCareOfBocaRaton
