...
func GetSourceAdvancedFootAnkleClinicLlp(env pkg.FastenLighthouseEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = pkg.SourceTypeAdvancedFootAnkleClinicLlp
