...
func GetSourceCardiacSurgeryCenterOfArizona(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCardiacSurgeryCenterOfArizona]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Cardiac Surgery Center of Arizona"
	sourceDef.SourceType = pkg.SourceTypeCardiacSurgeryCenterOfArizona
