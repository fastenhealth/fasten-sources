...
func GetSourceNewFoundationMedicalGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNewFoundationMedicalGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "New Foundation Medical Group"
	sourceDef.SourceType = pkg.SourceTypeNewFoundationMedicalGroup
	sourceDef.PatientAccessUrl = "https://www.nfmginc.com"
