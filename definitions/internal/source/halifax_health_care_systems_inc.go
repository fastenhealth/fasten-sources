...
func GetSourceHalifaxHealthCareSystemsInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHalifaxHealthCareSystemsInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "HALIFAX HEALTH CARE SYSTEMS INC"
	sourceDef.SourceType = pkg.SourceTypeHalifaxHealthCareSystemsInc
