...
func GetSourceFlPremierAssocHealthcareOfWomen(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFlPremierAssocHealthcareOfWomen]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FL  Premier Assoc  Healthcare of Women"
	sourceDef.SourceType = pkg.SourceTypeFlPremierAssocHealthcareOfWomen
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://MYPBCA.COM"
