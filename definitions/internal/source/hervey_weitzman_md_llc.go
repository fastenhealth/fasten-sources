...
func GetSourceHerveyWeitzmanMdLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHerveyWeitzmanMdLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "HERVEY WEITZMAN MD LLC"
	sourceDef.SourceType = pkg.SourceTypeHerveyWeitzmanMdLlc
