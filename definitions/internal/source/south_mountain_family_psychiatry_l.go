...
func GetSourceSouthMountainFamilyPsychiatryL(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthMountainFamilyPsychiatryL]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SOUTH MOUNTAIN FAMILY PSYCHIATRY L"
	sourceDef.SourceType = pkg.SourceTypeSouthMountainFamilyPsychiatryL
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.smfamilypsych.com"
