...
func GetSourceHeartlandMedicinePhysiciansOfIl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHeartlandMedicinePhysiciansOfIl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Heartland Medicine Physicians of IL"
	sourceDef.SourceType = pkg.SourceTypeHeartlandMedicinePhysiciansOfIl
