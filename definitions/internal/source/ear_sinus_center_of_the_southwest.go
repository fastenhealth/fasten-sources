...
func GetSourceEarSinusCenterOfTheSouthwest(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEarSinusCenterOfTheSouthwest]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Ear  Sinus Center of the Southwest"
	sourceDef.SourceType = pkg.SourceTypeEarSinusCenterOfTheSouthwest
