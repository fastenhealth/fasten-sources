...
func GetSourceSouthwestEyeInstitute(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthwestEyeInstitute]; clientIdOk {
	...
	sourceDef.Category = []string{"152W00000X", "207L00000X", "207W00000X"}
