...
func GetSourceWeCarePediatricsAdolescent(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWeCarePediatricsAdolescent]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "We Care Pediatrics  Adolescent"
	sourceDef.SourceType = pkg.SourceTypeWeCarePediatricsAdolescent
