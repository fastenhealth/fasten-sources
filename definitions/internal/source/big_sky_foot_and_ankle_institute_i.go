...
func GetSourceBigSkyFootAndAnkleInstituteI(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBigSkyFootAndAnkleInstituteI]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Big Sky Foot and Ankle Institute I"
	sourceDef.SourceType = pkg.SourceTypeBigSkyFootAndAnkleInstituteI
