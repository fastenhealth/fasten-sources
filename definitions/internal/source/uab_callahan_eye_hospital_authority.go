...
func GetSourceUabCallahanEyeHospitalAuthority(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUabCallahanEyeHospitalAuthority]; clientIdOk {
	...
	sourceDef.Category = []string{"207W00000X", "282N00000X", "367500000X"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1023358850", "1427398254", "1578809430"}}
