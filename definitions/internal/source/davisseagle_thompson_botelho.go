...
func GetSourceDavisseagleThompsonBotelho(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDavisseagleThompsonBotelho]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "DavisSeagle  Thompson  Botelho"
	sourceDef.SourceType = pkg.SourceTypeDavisseagleThompsonBotelho
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://mtpinternalmedicine.wixsite.com/mtpim"
