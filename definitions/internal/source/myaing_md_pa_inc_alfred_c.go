...
func GetSourceMyaingMdPaIncAlfredC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMyaingMdPaIncAlfredC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Myaing MD PA Inc Alfred C"
	sourceDef.SourceType = pkg.SourceTypeMyaingMdPaIncAlfredC
