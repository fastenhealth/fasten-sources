...
func GetSourceCc009CaringCenterForWomenOfCentralTexas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc009CaringCenterForWomenOfCentralTexas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC009CARING CENTER FOR WOMEN OF CENTRAL TEXAS"
	sourceDef.SourceType = pkg.SourceTypeCc009CaringCenterForWomenOfCentralTexas
