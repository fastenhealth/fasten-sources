...
func GetSourceKsFwHustonMedicalCenterDba(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKsFwHustonMedicalCenterDba]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "KS  FW Huston Medical Center  DBA"
	sourceDef.SourceType = pkg.SourceTypeKsFwHustonMedicalCenterDba
