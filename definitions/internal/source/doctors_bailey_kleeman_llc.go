...
func GetSourceDoctorsBaileyKleemanLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDoctorsBaileyKleemanLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Doctors Bailey  Kleeman LLC"
	sourceDef.SourceType = pkg.SourceTypeDoctorsBaileyKleemanLlc
