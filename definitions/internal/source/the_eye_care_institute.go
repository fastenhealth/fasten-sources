...
func GetSourceTheEyeCareInstitute(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheEyeCareInstitute]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "The Eye Care Institute"
	sourceDef.SourceType = pkg.SourceTypeTheEyeCareInstitute
	sourceDef.PatientAccessUrl = "https://nsuhealth.nova.edu/services/eye-care-institute/index.html"
