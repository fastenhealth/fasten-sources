...
func GetSourceNorthwestRheumatologySpecialistSc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthwestRheumatologySpecialistSc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Northwest Rheumatology Specialist SC"
	sourceDef.SourceType = pkg.SourceTypeNorthwestRheumatologySpecialistSc
	sourceDef.PatientAccessUrl = "http://nwrheum.com/"
