...
func GetSourceTheSpineInstituteOfElPasoPll(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheSpineInstituteOfElPasoPll]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Spine Institute of El Paso PLL"
	sourceDef.SourceType = pkg.SourceTypeTheSpineInstituteOfElPasoPll
