...
func GetSourceTownOfNorthHavenDbaNorthHaven(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTownOfNorthHavenDbaNorthHaven]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Town of North Haven dba North Haven"
	sourceDef.SourceType = pkg.SourceTypeTownOfNorthHavenDbaNorthHaven
