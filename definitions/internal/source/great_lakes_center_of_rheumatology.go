...
func GetSourceGreatLakesCenterOfRheumatology(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGreatLakesCenterOfRheumatology]; clientIdOk {
	...
	sourceDef.Aliases = []string{"GREAT LAKES CENTER OF RHEUMATOLOGY"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1548717580"}}
