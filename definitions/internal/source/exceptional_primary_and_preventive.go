...
func GetSourceExceptionalPrimaryAndPreventive(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeExceptionalPrimaryAndPreventive]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "EXCEPTIONAL PRIMARY AND PREVENTIVE"
	sourceDef.SourceType = pkg.SourceTypeExceptionalPrimaryAndPreventive
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.exceptionalppc.com/"
