...
func GetSourceNortheastPediatricAssocOfHumble(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNortheastPediatricAssocOfHumble]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Northeast Pediatric Assoc of Humble"
	sourceDef.SourceType = pkg.SourceTypeNortheastPediatricAssocOfHumble
