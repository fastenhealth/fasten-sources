...
func GetSourceEyeCareSurgeryCenterOfOliveBranch(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeCareSurgeryCenterOfOliveBranch]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.olivebrancheyecare.com/"
