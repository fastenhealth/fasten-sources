...
func GetSourcePulmonarySleepCenterOfTheVal(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePulmonarySleepCenterOfTheVal]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pulmonary  Sleep Center of the Val"
	sourceDef.SourceType = pkg.SourceTypePulmonarySleepCenterOfTheVal
