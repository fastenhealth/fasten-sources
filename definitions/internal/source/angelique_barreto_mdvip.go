...
func GetSourceAngeliqueBarretoMdvip(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAngeliqueBarretoMdvip]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Angelique Barreto MDVIP"
	sourceDef.SourceType = pkg.SourceTypeAngeliqueBarretoMdvip
