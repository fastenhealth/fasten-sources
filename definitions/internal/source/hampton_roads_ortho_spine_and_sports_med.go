...
func GetSourceHamptonRoadsOrthoSpineAndSportsMed(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHamptonRoadsOrthoSpineAndSportsMed]; clientIdOk {
	...
	sourceDef.BrandLogo = "hampton-roads-ortho-spine-and-sports-med.webp"
