...
func GetSourceHearingCommunicationPartnersI(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHearingCommunicationPartnersI]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Hearing  Communication Partners I"
	sourceDef.SourceType = pkg.SourceTypeHearingCommunicationPartnersI
