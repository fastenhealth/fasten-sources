...
func GetSourceMonicaBrownfieldCareNow(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMonicaBrownfieldCareNow]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Monica Brownfield Care Now"
	sourceDef.SourceType = pkg.SourceTypeMonicaBrownfieldCareNow
