...
func GetSourceNcpFtLauderdaleCathLab(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNcpFtLauderdaleCathLab]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "NCP Ft Lauderdale Cath Lab"
	sourceDef.SourceType = pkg.SourceTypeNcpFtLauderdaleCathLab
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://ftlauderdalecathlab.com"
