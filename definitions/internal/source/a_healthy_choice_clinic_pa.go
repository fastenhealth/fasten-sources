...
func GetSourceAHealthyChoiceClinicPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAHealthyChoiceClinicPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "A Healthy Choice Clinic PA"
	sourceDef.SourceType = pkg.SourceTypeAHealthyChoiceClinicPa
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "a-healthy-choice-clinic-pa.esp"
	sourceDef.PatientAccessUrl = "http://www.healthychoiceclinic.com/about"
