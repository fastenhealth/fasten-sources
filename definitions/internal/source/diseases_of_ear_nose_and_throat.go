...
func GetSourceDiseasesOfEarNoseAndThroat(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDiseasesOfEarNoseAndThroat]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Diseases of Ear Nose and Throat"
	sourceDef.SourceType = pkg.SourceTypeDiseasesOfEarNoseAndThroat
