...
func GetSourceRockyMountainEyeCenterInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRockyMountainEyeCenterInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Rocky Mountain Eye Center Inc"
	sourceDef.SourceType = pkg.SourceTypeRockyMountainEyeCenterInc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://rockymountaineyecenter.com/"
