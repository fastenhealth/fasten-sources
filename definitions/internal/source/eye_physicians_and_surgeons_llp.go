...
func GetSourceEyePhysiciansAndSurgeonsLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyePhysiciansAndSurgeonsLlp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Physicians And Surgeons LLP"
	sourceDef.SourceType = pkg.SourceTypeEyePhysiciansAndSurgeonsLlp
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.iowaeyephysicians.com/"
