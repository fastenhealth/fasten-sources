...
func GetSourceNeighborhoodMedicalClinicOfRiverside(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNeighborhoodMedicalClinicOfRiverside]; clientIdOk {
	...
	sourceDef.Category = []string{"101YP2500X", "1041C0700X", "2084P0800X", "2084P0805X"}
