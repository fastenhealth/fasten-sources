...
func GetSourceAdvancedObgynOfCentralFloridaL(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdvancedObgynOfCentralFloridaL]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ADVANCED OBGYN OF CENTRAL FLORIDA L"
	sourceDef.SourceType = pkg.SourceTypeAdvancedObgynOfCentralFloridaL
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.advancedobgyncfl.com"
