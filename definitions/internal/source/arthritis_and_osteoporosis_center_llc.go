...
func GetSourceArthritisAndOsteoporosisCenterLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeArthritisAndOsteoporosisCenterLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Arthritis And Osteoporosis Center  LLC"
	sourceDef.SourceType = pkg.SourceTypeArthritisAndOsteoporosisCenterLlc
	sourceDef.BrandLogo = "arthritis-and-osteoporosis-center-llc.jpg"
