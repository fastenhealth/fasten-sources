...
func GetSourceCorePhysicalTherapyTraining(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCorePhysicalTherapyTraining]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Core Physical Therapy  Training"
	sourceDef.SourceType = pkg.SourceTypeCorePhysicalTherapyTraining
