...
func GetSourceRabadiOccupationalTherapyRehabP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRabadiOccupationalTherapyRehabP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "RABADI OCCUPATIONAL THERAPY REHAB P"
	sourceDef.SourceType = pkg.SourceTypeRabadiOccupationalTherapyRehabP
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.upperhandorthopedicrehab.com"
