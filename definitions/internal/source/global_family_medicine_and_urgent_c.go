...
func GetSourceGlobalFamilyMedicineAndUrgentC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGlobalFamilyMedicineAndUrgentC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Global Family Medicine and Urgent C"
	sourceDef.SourceType = pkg.SourceTypeGlobalFamilyMedicineAndUrgentC
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://globalfamilymed.com/"
