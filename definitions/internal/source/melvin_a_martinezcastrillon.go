...
func GetSourceMelvinAMartinezcastrillon(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMelvinAMartinezcastrillon]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Melvin A MartinezCastrillon"
	sourceDef.SourceType = pkg.SourceTypeMelvinAMartinezcastrillon
