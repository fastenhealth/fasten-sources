...
func GetSourceSaintfleurInternalMedicineAss(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSaintfleurInternalMedicineAss]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SaintFleur Internal Medicine  Ass"
	sourceDef.SourceType = pkg.SourceTypeSaintfleurInternalMedicineAss
