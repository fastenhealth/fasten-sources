...
func GetSourceCrescentNeurologyAndSleep(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCrescentNeurologyAndSleep]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Crescent Neurology and Sleep"
	sourceDef.SourceType = pkg.SourceTypeCrescentNeurologyAndSleep
