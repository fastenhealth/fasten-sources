...
func GetSourceDrRhodoraMangaserMdLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrRhodoraMangaserMdLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "DR RHODORA MANGASER MD LLC"
	sourceDef.SourceType = pkg.SourceTypeDrRhodoraMangaserMdLlc
