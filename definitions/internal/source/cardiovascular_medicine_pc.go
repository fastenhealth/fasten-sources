...
func GetSourceCardiovascularMedicinePc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCardiovascularMedicinePc]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.cvmedpc.com/"
