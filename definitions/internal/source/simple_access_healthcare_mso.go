...
func GetSourceSimpleAccessHealthcareMso(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSimpleAccessHealthcareMso]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Simple Access Healthcare MSO"
	sourceDef.SourceType = pkg.SourceTypeSimpleAccessHealthcareMso
