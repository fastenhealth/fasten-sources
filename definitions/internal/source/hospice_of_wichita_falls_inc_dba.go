...
func GetSourceHospiceOfWichitaFallsIncDba(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHospiceOfWichitaFallsIncDba]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Hospice of Wichita Falls Inc DBA"
	sourceDef.SourceType = pkg.SourceTypeHospiceOfWichitaFallsIncDba
