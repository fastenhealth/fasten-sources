...
func GetSourceInnovativeUrgentCareFamilyHealthClinics(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeInnovativeUrgentCareFamilyHealthClinics]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Innovative Urgent Care  Family Health Clinics"
	sourceDef.SourceType = pkg.SourceTypeInnovativeUrgentCareFamilyHealthClinics
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.innovativeuc.com/"
