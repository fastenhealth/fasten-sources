...
func GetSourceOrangeGroveMedicalSpecialtiesP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrangeGroveMedicalSpecialtiesP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Orange Grove Medical Specialties P"
	sourceDef.SourceType = pkg.SourceTypeOrangeGroveMedicalSpecialtiesP
