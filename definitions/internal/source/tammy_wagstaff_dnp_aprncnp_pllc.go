...
func GetSourceTammyWagstaffDnpAprncnpPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTammyWagstaffDnpAprncnpPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TAMMY WAGSTAFF DNP APRNCNP PLLC"
	sourceDef.SourceType = pkg.SourceTypeTammyWagstaffDnpAprncnpPllc
