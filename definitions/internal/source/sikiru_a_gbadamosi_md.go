...
func GetSourceSikiruAGbadamosiMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSikiruAGbadamosiMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SIKIRU A GBADAMOSI MD"
	sourceDef.SourceType = pkg.SourceTypeSikiruAGbadamosiMd
