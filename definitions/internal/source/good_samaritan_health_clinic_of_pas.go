...
func GetSourceGoodSamaritanHealthClinicOfPas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGoodSamaritanHealthClinicOfPas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Good Samaritan Health Clinic of Pas"
	sourceDef.SourceType = pkg.SourceTypeGoodSamaritanHealthClinicOfPas
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.goodsamclinic.org"
