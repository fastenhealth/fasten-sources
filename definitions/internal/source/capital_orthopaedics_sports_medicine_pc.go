...
func GetSourceCapitalOrthopaedicsSportsMedicinePc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCapitalOrthopaedicsSportsMedicinePc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CAPITAL ORTHOPAEDICS  SPORTS MEDICINE PC"
	sourceDef.SourceType = pkg.SourceTypeCapitalOrthopaedicsSportsMedicinePc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.dsmcapitalortho.com/"
