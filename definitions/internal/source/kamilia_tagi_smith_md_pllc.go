...
func GetSourceKamiliaTagiSmithMdPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKamiliaTagiSmithMdPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "KAMILIA TAGI SMITH MD PLLC"
	sourceDef.SourceType = pkg.SourceTypeKamiliaTagiSmithMdPllc
