...
func GetSourceCliftoncentrevilleMedicalAssocia(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCliftoncentrevilleMedicalAssocia]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CliftonCentreville Medical Associa"
	sourceDef.SourceType = pkg.SourceTypeCliftoncentrevilleMedicalAssocia
