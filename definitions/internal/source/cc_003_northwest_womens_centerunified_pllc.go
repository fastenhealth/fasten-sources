...
func GetSourceCc003NorthwestWomensCenterunifiedPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc003NorthwestWomensCenterunifiedPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC003NORTHWEST WOMENS CENTERUNIFIED PLLC"
	sourceDef.SourceType = pkg.SourceTypeCc003NorthwestWomensCenterunifiedPllc
