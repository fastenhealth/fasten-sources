...
func GetSourceClbPharmaceuticalResources(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeClbPharmaceuticalResources]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CLB Pharmaceutical Resources"
	sourceDef.SourceType = pkg.SourceTypeClbPharmaceuticalResources
