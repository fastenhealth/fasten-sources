...
func GetSourceBreckenridgeMedicalCenterRhc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBreckenridgeMedicalCenterRhc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Breckenridge Medical Center RHC"
	sourceDef.SourceType = pkg.SourceTypeBreckenridgeMedicalCenterRhc
