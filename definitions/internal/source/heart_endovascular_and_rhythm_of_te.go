...
func GetSourceHeartEndovascularAndRhythmOfTe(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHeartEndovascularAndRhythmOfTe]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Heart Endovascular and Rhythm of Te"
	sourceDef.SourceType = pkg.SourceTypeHeartEndovascularAndRhythmOfTe
