...
func GetSourceJulieSacharkoAprnLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJulieSacharkoAprnLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "JULIE SACHARKO APRN LLC"
	sourceDef.SourceType = pkg.SourceTypeJulieSacharkoAprnLlc
