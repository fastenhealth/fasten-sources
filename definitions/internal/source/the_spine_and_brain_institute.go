...
func GetSourceTheSpineAndBrainInstitute(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Audience = "https://fhir4.eclinicalworks.com/fhir/r4/HAEJAA"

	sourceDef.ApiEndpointBaseUrl = "https://fhir4.eclinicalworks.com/fhir/r4/HAEJAA"
	...
	sourceDef.Display = "The Spine and Brain Institute"
