...
func GetSourceCarolinaCtrSpecialtySurg(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCarolinaCtrSpecialtySurg]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.carolinaspecialtysurgery.com/"
