...
func GetSourceProlianceSouthwestSeattleOrthopedics(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeProlianceSouthwestSeattleOrthopedics]; clientIdOk {
	...
	sourceDef.Category = []string{"207X00000X", "207XS0106X", "207XS0117X", "207XX0005X"}
