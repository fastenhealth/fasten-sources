...
func GetSourceArchboldPelhamPrimaryCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeArchboldPelhamPrimaryCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Archbold Pelham Primary Care"
	sourceDef.SourceType = pkg.SourceTypeArchboldPelhamPrimaryCare
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://archbold.org/hospitals-locations/primary-care/locations/primary-care/pelham-primary-care"
