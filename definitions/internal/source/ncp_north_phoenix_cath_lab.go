...
func GetSourceNcpNorthPhoenixCathLab(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNcpNorthPhoenixCathLab]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "NCP North Phoenix Cath Lab"
	sourceDef.SourceType = pkg.SourceTypeNcpNorthPhoenixCathLab
	sourceDef.PatientAccessUrl = "https://www.phoenixcathlab.com/"
