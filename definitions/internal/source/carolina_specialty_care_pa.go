...
func GetSourceCarolinaSpecialtyCarePa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCarolinaSpecialtyCarePa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Carolina Specialty Care PA"
	sourceDef.SourceType = pkg.SourceTypeCarolinaSpecialtyCarePa
	sourceDef.PatientAccessUrl = "https://carolinaspecialtycare.com/"
