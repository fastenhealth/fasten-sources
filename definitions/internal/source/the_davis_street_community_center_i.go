...
func GetSourceTheDavisStreetCommunityCenterI(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheDavisStreetCommunityCenterI]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Davis Street Community Center I"
	sourceDef.SourceType = pkg.SourceTypeTheDavisStreetCommunityCenterI
