...
func GetSourceNewEnglandEarNoseThroatfacialPlasticSurgeryPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNewEnglandEarNoseThroatfacialPlasticSurgeryPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "NEW ENGLAND EAR NOSE  THROATFACIAL PLASTIC SURGERY PC"
