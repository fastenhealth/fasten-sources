...
func GetSourceNcpLakeCharlesCathLab(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNcpLakeCharlesCathLab]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "NCP Lake Charles Cath Lab"
	sourceDef.SourceType = pkg.SourceTypeNcpLakeCharlesCathLab
	sourceDef.PatientAccessUrl = "https://www.lakecharlescathlab.com/lake-charles-cath-lab-contact.html"
