...
func GetSourceCharlesBGoldbergMdFamilyMed(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCharlesBGoldbergMdFamilyMed]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Charles B Goldberg MD Family Med"
	sourceDef.SourceType = pkg.SourceTypeCharlesBGoldbergMdFamilyMed
