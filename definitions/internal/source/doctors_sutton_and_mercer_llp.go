...
func GetSourceDoctorsSuttonAndMercerLlp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDoctorsSuttonAndMercerLlp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Doctors Sutton and Mercer LLP"
	sourceDef.SourceType = pkg.SourceTypeDoctorsSuttonAndMercerLlp
