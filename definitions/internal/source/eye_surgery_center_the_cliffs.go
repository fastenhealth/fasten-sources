...
func GetSourceEyeSurgeryCenterTheCliffs(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeSurgeryCenterTheCliffs]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Surgery Center- The Cliffs"
	sourceDef.SourceType = pkg.SourceTypeEyeSurgeryCenterTheCliffs
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.discovervision.com/locations/eye-surgery-center-independence-mo/"
