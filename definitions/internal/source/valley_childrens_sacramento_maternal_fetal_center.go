...
func GetSourceValleyChildrensSacramentoMaternalFetalCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeValleyChildrensSacramentoMaternalFetalCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Valley Childrens Sacramento Maternal Fetal Center"
	sourceDef.SourceType = pkg.SourceTypeValleyChildrensSacramentoMaternalFetalCenter
