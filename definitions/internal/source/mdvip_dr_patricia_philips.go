...
func GetSourceMdvipDrPatriciaPhilips(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMdvipDrPatriciaPhilips]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MDVIP Dr Patricia Philips"
	sourceDef.SourceType = pkg.SourceTypeMdvipDrPatriciaPhilips
