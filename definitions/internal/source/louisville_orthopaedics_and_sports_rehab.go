...
func GetSourceLouisvilleOrthopaedicsAndSportsRehab(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLouisvilleOrthopaedicsAndSportsRehab]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Louisville Orthopaedics and Sports Rehab"
	sourceDef.SourceType = pkg.SourceTypeLouisvilleOrthopaedicsAndSportsRehab
