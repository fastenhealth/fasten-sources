...
func GetSourceKetteringHealthNetwork(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeKetteringHealthNetwork
