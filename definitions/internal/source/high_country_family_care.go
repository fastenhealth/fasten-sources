...
func GetSourceHighCountryFamilyCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHighCountryFamilyCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "High Country Family Care"
	sourceDef.SourceType = pkg.SourceTypeHighCountryFamilyCare
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://highcountryfamilycare.com/"
