...
func GetSourcePediatricsAssociatesOfFriscoInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatricsAssociatesOfFriscoInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pediatrics Associates of Frisco Inc"
	sourceDef.SourceType = pkg.SourceTypePediatricsAssociatesOfFriscoInc
