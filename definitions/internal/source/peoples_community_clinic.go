...
func GetSourcePeoplesCommunityClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePeoplesCommunityClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Peoples Community Clinic"
	sourceDef.SourceType = pkg.SourceTypePeoplesCommunityClinic
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.austinpcc.org/"
