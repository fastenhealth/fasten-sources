...
func GetSourceGreaterNewportPhysiciansDischargeCl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGreaterNewportPhysiciansDischargeCl]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.gnpweb.com/locations/memorialcare-cancer-institute"
