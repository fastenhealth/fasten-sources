...
func GetSourceFieldsCenterForWomensHealthR(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFieldsCenterForWomensHealthR]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Fields Center for Womens Health  R"
	sourceDef.SourceType = pkg.SourceTypeFieldsCenterForWomensHealthR
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://fieldsgynroboticsurgery.com/"
