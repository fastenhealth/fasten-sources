...
func GetSourceMidessaNeurosurgeryAndComplexSp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMidessaNeurosurgeryAndComplexSp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MIDESSA NEUROSURGERY AND COMPLEX SP"
	sourceDef.SourceType = pkg.SourceTypeMidessaNeurosurgeryAndComplexSp
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.midessaneurosurgery.com"
