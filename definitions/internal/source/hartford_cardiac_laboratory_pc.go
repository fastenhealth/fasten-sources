...
func GetSourceHartfordCardiacLaboratoryPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHartfordCardiacLaboratoryPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Hartford Cardiac Laboratory PC"
	sourceDef.SourceType = pkg.SourceTypeHartfordCardiacLaboratoryPc
