...
func GetSourceAffiliatedPhysiciansGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAffiliatedPhysiciansGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Affiliated Physicians Group"
	sourceDef.SourceType = pkg.SourceTypeAffiliatedPhysiciansGroup
