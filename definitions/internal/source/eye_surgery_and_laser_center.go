...
func GetSourceEyeSurgeryAndLaserCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeSurgeryAndLaserCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Surgery and Laser Center"
	sourceDef.SourceType = pkg.SourceTypeEyeSurgeryAndLaserCenter
	sourceDef.PatientAccessUrl = "https://eyesurgeryandlasercenter.com/"
