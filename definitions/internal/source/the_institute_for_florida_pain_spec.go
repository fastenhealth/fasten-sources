...
func GetSourceTheInstituteForFloridaPainSpec(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheInstituteForFloridaPainSpec]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Institute for Florida Pain Spec"
	sourceDef.SourceType = pkg.SourceTypeTheInstituteForFloridaPainSpec
