...
func GetSourcePulmonaryConsultantsOfSanAntonioPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePulmonaryConsultantsOfSanAntonioPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pulmonary Consultants of San Antonio PA"
	sourceDef.SourceType = pkg.SourceTypePulmonaryConsultantsOfSanAntonioPa
