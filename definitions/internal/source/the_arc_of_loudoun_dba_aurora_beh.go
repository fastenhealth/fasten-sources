...
func GetSourceTheArcOfLoudounDbaAuroraBeh(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheArcOfLoudounDbaAuroraBeh]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Arc of Loudoun DBA Aurora Beh"
	sourceDef.SourceType = pkg.SourceTypeTheArcOfLoudounDbaAuroraBeh
