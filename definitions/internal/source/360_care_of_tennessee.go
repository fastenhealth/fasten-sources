...
func GetSource360CareOfTennessee(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceType360CareOfTennessee]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "360care Of Tennessee"
	sourceDef.SourceType = pkg.SourceType360CareOfTennessee
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.ihca.org/vendor/360care/"
