...
func GetSourceRachaelCTerritoNursePractitio(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRachaelCTerritoNursePractitio]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "RACHAEL C TERRITO NURSE PRACTITIO"
	sourceDef.SourceType = pkg.SourceTypeRachaelCTerritoNursePractitio
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.rachaelterritofnp.com"
