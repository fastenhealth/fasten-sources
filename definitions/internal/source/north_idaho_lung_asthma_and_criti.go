...
func GetSourceNorthIdahoLungAsthmaAndCriti(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthIdahoLungAsthmaAndCriti]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "North Idaho Lung Asthma and Criti"
	sourceDef.SourceType = pkg.SourceTypeNorthIdahoLungAsthmaAndCriti
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.niladocs.com"
