...
func GetSourceGeorgiaPainAndSpineInstitutePc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGeorgiaPainAndSpineInstitutePc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Georgia Pain and Spine Institute PC"
	sourceDef.SourceType = pkg.SourceTypeGeorgiaPainAndSpineInstitutePc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://GaPainandSpine.com"
