...
func GetSourceTheNeurosurgeryCenterAtNorthwestHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheNeurosurgeryCenterAtNorthwestHealth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Neurosurgery Center at Northwest Health"
	sourceDef.SourceType = pkg.SourceTypeTheNeurosurgeryCenterAtNorthwestHealth
