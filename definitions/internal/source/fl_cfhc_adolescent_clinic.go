...
func GetSourceFlCfhcAdolescentClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFlCfhcAdolescentClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FL  CFHC  Adolescent Clinic"
	sourceDef.SourceType = pkg.SourceTypeFlCfhcAdolescentClinic
