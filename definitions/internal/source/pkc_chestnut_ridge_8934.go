...
func GetSourcePkcChestnutRidge8934(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePkcChestnutRidge8934]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "PKC Chestnut Ridge8934"
	sourceDef.SourceType = pkg.SourceTypePkcChestnutRidge8934
