...
func GetSourceOrthopaedicSpecialtiesOfTampaBay(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthopaedicSpecialtiesOfTampaBay]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Orthopaedic Specialties of Tampa Bay"
	sourceDef.SourceType = pkg.SourceTypeOrthopaedicSpecialtiesOfTampaBay
