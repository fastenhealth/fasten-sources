...
func GetSourceHighlandsInternalMedicine1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHighlandsInternalMedicine1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeHighlandsInternalMedicine1
