...
func GetSourceCentersForAdvOrthoCalvertDiv41(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCentersForAdvOrthoCalvertDiv41]; clientIdOk {
