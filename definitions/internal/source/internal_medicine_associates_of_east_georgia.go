...
func GetSourceInternalMedicineAssociatesOfEastGeorgia(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeInternalMedicineAssociatesOfEastGeorgia]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Internal Medicine Associates of East Georgia"
	sourceDef.SourceType = pkg.SourceTypeInternalMedicineAssociatesOfEastGeorgia
