...
func GetSourcePlannedParenthoodOfCentralPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePlannedParenthoodOfCentralPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Planned Parenthood of Central PA"
	sourceDef.SourceType = pkg.SourceTypePlannedParenthoodOfCentralPa
	sourceDef.BrandLogo = "planned-parenthood-of-central-pa.svg"
