...
func GetSourceDoctorsDietProgramOfSFlorida(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDoctorsDietProgramOfSFlorida]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Doctors Diet Program of S Florida"
	sourceDef.SourceType = pkg.SourceTypeDoctorsDietProgramOfSFlorida
