...
func GetSourceTheDoctorsCenterNeighbormd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheDoctorsCenterNeighbormd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Doctors Center  NeighborMD"
	sourceDef.SourceType = pkg.SourceTypeTheDoctorsCenterNeighbormd
