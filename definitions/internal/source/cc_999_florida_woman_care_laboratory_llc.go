...
func GetSourceCc999FloridaWomanCareLaboratoryLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc999FloridaWomanCareLaboratoryLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC999FLORIDA WOMAN CARE LABORATORY LLC"
	sourceDef.SourceType = pkg.SourceTypeCc999FloridaWomanCareLaboratoryLlc
