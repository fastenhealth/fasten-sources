...
func GetSourceEdwardWHartzlerMdIncps(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEdwardWHartzlerMdIncps]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Edward W Hartzler MD IncPS"
	sourceDef.SourceType = pkg.SourceTypeEdwardWHartzlerMdIncps
