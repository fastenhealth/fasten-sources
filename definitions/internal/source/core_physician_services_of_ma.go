...
func GetSourceCorePhysicianServicesOfMa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCorePhysicianServicesOfMa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Core Physician Services of MA"
	sourceDef.SourceType = pkg.SourceTypeCorePhysicianServicesOfMa
