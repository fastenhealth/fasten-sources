...
func GetSourceMauiLaniPhysiciansAndSurgeons(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMauiLaniPhysiciansAndSurgeons]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Maui Lani Physicians and Surgeons"
	sourceDef.SourceType = pkg.SourceTypeMauiLaniPhysiciansAndSurgeons
