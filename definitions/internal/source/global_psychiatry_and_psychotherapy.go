...
func GetSourceGlobalPsychiatryAndPsychotherapy(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGlobalPsychiatryAndPsychotherapy]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "GLOBAL PSYCHIATRY AND PSYCHOTHERAPY"
	sourceDef.SourceType = pkg.SourceTypeGlobalPsychiatryAndPsychotherapy
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.rejuvenatemaryland.com"
