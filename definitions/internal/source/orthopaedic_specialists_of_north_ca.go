...
func GetSourceOrthopaedicSpecialistsOfNorthCa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthopaedicSpecialistsOfNorthCa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Orthopaedic Specialists of North Ca"
	sourceDef.SourceType = pkg.SourceTypeOrthopaedicSpecialistsOfNorthCa
