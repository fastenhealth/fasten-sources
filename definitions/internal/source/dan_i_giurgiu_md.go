...
func GetSourceDanIGiurgiuMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDanIGiurgiuMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Dan I Giurgiu MD"
	sourceDef.SourceType = pkg.SourceTypeDanIGiurgiuMd
	sourceDef.PatientAccessUrl = "https://www.scripps.org/physicians/4156-dan-giurgiu"
