...
func GetSourceFlPatriciaTrnkastoneFnpStartup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFlPatriciaTrnkastoneFnpStartup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "FL  Patricia TrnkaStone FNP  Startup"
	sourceDef.SourceType = pkg.SourceTypeFlPatriciaTrnkastoneFnpStartup
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.thrivefamilypractice.com"
