...
func GetSourceJewishFamilyServiceOfGreaterDallas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJewishFamilyServiceOfGreaterDallas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Jewish Family Service of Greater Dallas"
	sourceDef.SourceType = pkg.SourceTypeJewishFamilyServiceOfGreaterDallas
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://jfsdallas.org/"
