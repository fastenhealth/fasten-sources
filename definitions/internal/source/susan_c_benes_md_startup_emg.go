...
func GetSourceSusanCBenesMdStartupEmg(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSusanCBenesMdStartupEmg]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Susan C Benes MD StartUp EMG"
	sourceDef.SourceType = pkg.SourceTypeSusanCBenesMdStartupEmg
