...
func GetSourceAmandaHendricksAprnPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAmandaHendricksAprnPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Amanda Hendricks APRN PLLC"
	sourceDef.SourceType = pkg.SourceTypeAmandaHendricksAprnPllc
