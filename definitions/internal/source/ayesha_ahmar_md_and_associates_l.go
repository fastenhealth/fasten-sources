...
func GetSourceAyeshaAhmarMdAndAssociatesL(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAyeshaAhmarMdAndAssociatesL]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "AYESHA AHMAR MD AND ASSOCIATES L"
	sourceDef.SourceType = pkg.SourceTypeAyeshaAhmarMdAndAssociatesL
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://principalhealth.net/index.html"
