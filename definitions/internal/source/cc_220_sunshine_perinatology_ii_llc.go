...
func GetSourceCc220SunshinePerinatologyIiLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc220SunshinePerinatologyIiLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC220SUNSHINE PERINATOLOGY II LLC"
	sourceDef.SourceType = pkg.SourceTypeCc220SunshinePerinatologyIiLlc
