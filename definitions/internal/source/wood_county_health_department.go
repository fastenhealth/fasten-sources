...
func GetSourceWoodCountyHealthDepartment(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWoodCountyHealthDepartment]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Wood County Health Department"
	sourceDef.SourceType = pkg.SourceTypeWoodCountyHealthDepartment
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://woodcountyhealth.org/"
