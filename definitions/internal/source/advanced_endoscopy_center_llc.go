...
func GetSourceAdvancedEndoscopyCenterLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdvancedEndoscopyCenterLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Advanced Endoscopy Center LLC"
	sourceDef.SourceType = pkg.SourceTypeAdvancedEndoscopyCenterLlc
	sourceDef.PatientAccessUrl = "https://www.advancedendocenter.com/?utm_source=gmb_auth"
