...
func GetSourceCoastalHealthAndWellness(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCoastalHealthAndWellness]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.coastalhw.org/"
