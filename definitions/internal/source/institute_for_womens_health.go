...
func GetSourceInstituteForWomensHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeInstituteForWomensHealth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Institute For Womens Health"
	sourceDef.SourceType = pkg.SourceTypeInstituteForWomensHealth
	sourceDef.PatientAccessUrl = "https://sanantonioobgyn.womenshealthtx.com/"
