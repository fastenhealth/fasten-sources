...
func GetSourcePaulCMurphyMdDbaMurphySport(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePaulCMurphyMdDbaMurphySport]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Paul C Murphy MD DBA Murphy Sport"
	sourceDef.SourceType = pkg.SourceTypePaulCMurphyMdDbaMurphySport
