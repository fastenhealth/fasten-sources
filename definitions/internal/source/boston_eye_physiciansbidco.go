...
func GetSourceBostonEyePhysiciansbidco(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBostonEyePhysiciansbidco]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Boston Eye PhysiciansBIDCO"
	sourceDef.SourceType = pkg.SourceTypeBostonEyePhysiciansbidco
