...
func GetSourceIcnaReliefShifaClinicDuluth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeIcnaReliefShifaClinicDuluth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ICNA Relief Shifa Clinic Duluth"
	sourceDef.SourceType = pkg.SourceTypeIcnaReliefShifaClinicDuluth
