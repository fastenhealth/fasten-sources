...
func GetSourceHandAndPlasticSurgeonsOfKaty(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHandAndPlasticSurgeonsOfKaty]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Hand and Plastic Surgeons of Katy"
	sourceDef.SourceType = pkg.SourceTypeHandAndPlasticSurgeonsOfKaty
