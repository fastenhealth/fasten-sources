...
func GetSourceTeampraxisMasterTablespace(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTeampraxisMasterTablespace]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TeamPraxis Master Tablespace"
	sourceDef.SourceType = pkg.SourceTypeTeampraxisMasterTablespace
