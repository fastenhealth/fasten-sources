...
func GetSourceTalamoFamilyPracticeGroupPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTalamoFamilyPracticeGroupPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TALAMO FAMILY PRACTICE GROUP PC"
	sourceDef.SourceType = pkg.SourceTypeTalamoFamilyPracticeGroupPc
