...
func GetSourceSevagBalikianMdAProfessional(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSevagBalikianMdAProfessional]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sevag Balikian MD A Professional"
	sourceDef.SourceType = pkg.SourceTypeSevagBalikianMdAProfessional
