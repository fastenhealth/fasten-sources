...
func GetSourceJMoranAssocFootankleClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJMoranAssocFootankleClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "J Moran  Assoc FootAnkle Clinic"
	sourceDef.SourceType = pkg.SourceTypeJMoranAssocFootankleClinic
