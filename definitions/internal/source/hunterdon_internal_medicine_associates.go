...
func GetSourceHunterdonInternalMedicineAssociates(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHunterdonInternalMedicineAssociates]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Hunterdon Internal Medicine Associates"
	sourceDef.SourceType = pkg.SourceTypeHunterdonInternalMedicineAssociates
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "hunterdon-internal-medicine-associates.jpg"
