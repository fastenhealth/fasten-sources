...
func GetSourceBattsFamilyPractitionersLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBattsFamilyPractitionersLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Batts Family Practitioners LLC"
	sourceDef.SourceType = pkg.SourceTypeBattsFamilyPractitionersLlc
