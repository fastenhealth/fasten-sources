...
func GetSourceMagnoliaAllergyAndAsthmaGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMagnoliaAllergyAndAsthmaGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MAGNOLIA ALLERGY AND ASTHMA GROUP"
	sourceDef.SourceType = pkg.SourceTypeMagnoliaAllergyAndAsthmaGroup
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.magnoliaallergyandasthma.com"
