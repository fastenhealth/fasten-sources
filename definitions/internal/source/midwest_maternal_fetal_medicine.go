...
func GetSourceMidwestMaternalFetalMedicine(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMidwestMaternalFetalMedicine]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Midwest Maternal Fetal Medicine"
	sourceDef.SourceType = pkg.SourceTypeMidwestMaternalFetalMedicine
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://doctor.webmd.com/practice/midwest-maternal-fetal-medical-a56a48d9-669b-4ff1-a7e1-50de57ce492b"
