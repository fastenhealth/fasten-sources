...
func GetSourceKiritkumarSShahMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKiritkumarSShahMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Kiritkumar S Shah MD"
	sourceDef.SourceType = pkg.SourceTypeKiritkumarSShahMd
	sourceDef.PatientAccessUrl = "https://www.healthgrades.com/physician/dr-kiritkumar-shah-2r78p"
