...
func GetSourceSimmonsCareClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSimmonsCareClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Simmons Care Clinic"
	sourceDef.SourceType = pkg.SourceTypeSimmonsCareClinic
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.simmonscareclinic.com/"
