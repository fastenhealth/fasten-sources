...
func GetSourcePainCentersOfMinnesotaMankatoLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePainCentersOfMinnesotaMankatoLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pain Centers Of Minnesota Mankato LLC"
	sourceDef.SourceType = pkg.SourceTypePainCentersOfMinnesotaMankatoLlc
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "pain-centers-of-minnesota-mankato-llc.svg"
	sourceDef.PatientAccessUrl = "https://www.mankatoclinic.com/"
