...
func GetSourceTennovaMedicalGroupFamilyMedicineAndWomensHealth(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTennovaMedicalGroupFamilyMedicineAndWomensHealth]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tennova Medical Group Family Medicine and Womens Health"
	sourceDef.SourceType = pkg.SourceTypeTennovaMedicalGroupFamilyMedicineAndWomensHealth
