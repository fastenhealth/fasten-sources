...
func GetSourcePersonFamilyMedicalCenterInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePersonFamilyMedicalCenterInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Person Family Medical Center Inc"
	sourceDef.SourceType = pkg.SourceTypePersonFamilyMedicalCenterInc
	sourceDef.BrandLogo = "person-family-medical-center-inc.jpg"
	sourceDef.PatientAccessUrl = "https://www.personfamilymedical.com/"
