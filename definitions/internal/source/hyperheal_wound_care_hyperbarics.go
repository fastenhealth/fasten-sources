...
func GetSourceHyperhealWoundCareHyperbarics(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHyperhealWoundCareHyperbarics]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "HyperHeal Wound Care  Hyperbarics"
	sourceDef.SourceType = pkg.SourceTypeHyperhealWoundCareHyperbarics
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.hyperheal.com"
