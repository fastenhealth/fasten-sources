...
func GetSourceTexasNephrologyHypertensionSpe(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTexasNephrologyHypertensionSpe]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Texas Nephrology  Hypertension Spe"
	sourceDef.SourceType = pkg.SourceTypeTexasNephrologyHypertensionSpe
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://itconcepts.com/TexasNephrology/web/index.ht"
