...
func GetSourceAdvancedNeuroscienceNetworkPhysicians(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdvancedNeuroscienceNetworkPhysicians]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Advanced Neuroscience Network Physicians"
	sourceDef.SourceType = pkg.SourceTypeAdvancedNeuroscienceNetworkPhysicians
