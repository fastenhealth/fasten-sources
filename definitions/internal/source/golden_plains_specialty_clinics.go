...
func GetSourceGoldenPlainsSpecialtyClinics(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGoldenPlainsSpecialtyClinics]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://doctor.webmd.com/practice/golden-plains-specialty-clinic-f22017c3-7f13-e411-a22a-001f29e3bb64"
