...
func GetSourceFraserChildFamilyCenter(env pkg.FastenLighthouseEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = pkg.SourceTypeFraserChildFamilyCenter
