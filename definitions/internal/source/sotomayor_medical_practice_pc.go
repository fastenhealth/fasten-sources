...
func GetSourceSotomayorMedicalPracticePc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSotomayorMedicalPracticePc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sotomayor Medical Practice PC"
	sourceDef.SourceType = pkg.SourceTypeSotomayorMedicalPracticePc
