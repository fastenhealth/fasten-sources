...
func GetSourceConnecticutNeurosurgeryConsultant(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeConnecticutNeurosurgeryConsultant]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Connecticut Neurosurgery Consultant"
	sourceDef.SourceType = pkg.SourceTypeConnecticutNeurosurgeryConsultant
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://WWW.CTNEUROSURGERYCONSULTANTS.COM"
