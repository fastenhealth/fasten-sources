...
func GetSourceColumbusWomensCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeColumbusWomensCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Columbus Womens Care"
	sourceDef.SourceType = pkg.SourceTypeColumbusWomensCare
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://columbuswomenscare.com/"
