...
func GetSourceThoughtfulMindPsychiatryPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeThoughtfulMindPsychiatryPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Thoughtful Mind Psychiatry PLLC"
	sourceDef.SourceType = pkg.SourceTypeThoughtfulMindPsychiatryPllc
