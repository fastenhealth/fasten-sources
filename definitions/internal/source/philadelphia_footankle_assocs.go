...
func GetSourcePhiladelphiaFootankleAssocs(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePhiladelphiaFootankleAssocs]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Philadelphia FootAnkle Assocs"
	sourceDef.SourceType = pkg.SourceTypePhiladelphiaFootankleAssocs
