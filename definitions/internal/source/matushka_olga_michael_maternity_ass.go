...
func GetSourceMatushkaOlgaMichaelMaternityAss(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMatushkaOlgaMichaelMaternityAss]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MATUSHKA OLGA MICHAEL MATERNITY ASS"
	sourceDef.SourceType = pkg.SourceTypeMatushkaOlgaMichaelMaternityAss
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.mommaincmentalhealth.com/"
