...
func GetSourceBettermedUrgentCarePortal(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBettermedUrgentCarePortal]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BetterMed Urgent Care Portal"
	sourceDef.SourceType = pkg.SourceTypeBettermedUrgentCarePortal
