...
func GetSource7SpringsOrthopedicsPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceType7SpringsOrthopedicsPc]; clientIdOk {
