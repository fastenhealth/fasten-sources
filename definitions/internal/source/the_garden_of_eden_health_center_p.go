...
func GetSourceTheGardenOfEdenHealthCenterP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheGardenOfEdenHealthCenterP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Garden of Eden Health Center P"
	sourceDef.SourceType = pkg.SourceTypeTheGardenOfEdenHealthCenterP
