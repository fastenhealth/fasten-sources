...
func GetSourceWomensHealthcareCtrOfBaytown(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomensHealthcareCtrOfBaytown]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Womens Healthcare Ctr of Baytown"
	sourceDef.SourceType = pkg.SourceTypeWomensHealthcareCtrOfBaytown
