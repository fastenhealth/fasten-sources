...
func GetSourceRedMtnCardiothoracicSurgeons(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRedMtnCardiothoracicSurgeons]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Red Mtn Cardiothoracic Surgeons"
	sourceDef.SourceType = pkg.SourceTypeRedMtnCardiothoracicSurgeons
