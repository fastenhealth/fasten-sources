...
func GetSourceAdamsCompassionateHealthcareNetw(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdamsCompassionateHealthcareNetw]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Adams Compassionate Healthcare Netw"
	sourceDef.SourceType = pkg.SourceTypeAdamsCompassionateHealthcareNetw
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://achnhealth.org/"
