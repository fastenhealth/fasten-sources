...
func GetSourceDiabetesEndocrinologyOfDenver(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDiabetesEndocrinologyOfDenver]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Diabetes  Endocrinology of Denver"
	sourceDef.SourceType = pkg.SourceTypeDiabetesEndocrinologyOfDenver
