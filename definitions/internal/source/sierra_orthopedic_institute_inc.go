...
func GetSourceSierraOrthopedicInstituteInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSierraOrthopedicInstituteInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sierra Orthopedic Institute Inc"
	sourceDef.SourceType = pkg.SourceTypeSierraOrthopedicInstituteInc
