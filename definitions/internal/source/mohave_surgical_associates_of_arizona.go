...
func GetSourceMohaveSurgicalAssociatesOfArizona(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMohaveSurgicalAssociatesOfArizona]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Mohave Surgical Associates of Arizona"
	sourceDef.SourceType = pkg.SourceTypeMohaveSurgicalAssociatesOfArizona
