...
func GetSourceFisherCardiologyAndElectrophysio(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFisherCardiologyAndElectrophysio]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Fisher Cardiology and Electrophysio"
	sourceDef.SourceType = pkg.SourceTypeFisherCardiologyAndElectrophysio
