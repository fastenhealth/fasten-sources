...
func GetSourceBiocareOrthopedicsSpineInstitu(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBiocareOrthopedicsSpineInstitu]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Biocare Orthopedics  Spine Institu"
	sourceDef.SourceType = pkg.SourceTypeBiocareOrthopedicsSpineInstitu
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.biocareorthopedics.com"
