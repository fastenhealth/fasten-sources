...
func GetSourcePriscillaJMetcalfMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePriscillaJMetcalfMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Priscilla J  Metcalf  MD"
	sourceDef.SourceType = pkg.SourceTypePriscillaJMetcalfMd
