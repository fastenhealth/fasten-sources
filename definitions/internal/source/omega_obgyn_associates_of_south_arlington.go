...
func GetSourceOmegaObgynAssociatesOfSouthArlington(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOmegaObgynAssociatesOfSouthArlington]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "OMEGA OBGYN ASSOCIATES OF SOUTH ARLINGTON"
	sourceDef.SourceType = pkg.SourceTypeOmegaObgynAssociatesOfSouthArlington
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.omegaobgyn.com/"
