...
func GetSourceIowaRehabMedicineAndPainCoachi(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeIowaRehabMedicineAndPainCoachi]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Iowa Rehab Medicine and Pain Coachi"
	sourceDef.SourceType = pkg.SourceTypeIowaRehabMedicineAndPainCoachi
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.IowaRehabMedicine.com"
