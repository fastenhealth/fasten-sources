...
func GetSourceBewellHealthAndDrGulish(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBewellHealthAndDrGulish]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BeWell Health and Dr Gulish"
	sourceDef.SourceType = pkg.SourceTypeBewellHealthAndDrGulish
