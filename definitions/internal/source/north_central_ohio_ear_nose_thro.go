...
func GetSourceNorthCentralOhioEarNoseThro(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNorthCentralOhioEarNoseThro]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "North Central Ohio Ear Nose  Thro"
	sourceDef.SourceType = pkg.SourceTypeNorthCentralOhioEarNoseThro
