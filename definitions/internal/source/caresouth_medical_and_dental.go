...
func GetSourceCaresouthMedicalAndDental(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaresouthMedicalAndDental]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CareSouth Medical and Dental"
	sourceDef.SourceType = pkg.SourceTypeCaresouthMedicalAndDental
