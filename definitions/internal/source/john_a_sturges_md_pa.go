...
func GetSourceJohnASturgesMdPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJohnASturgesMdPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "John A Sturges MD PA"
	sourceDef.SourceType = pkg.SourceTypeJohnASturgesMdPa
	sourceDef.PatientAccessUrl = "https://www.kh.org/provider/john-sturges/"
