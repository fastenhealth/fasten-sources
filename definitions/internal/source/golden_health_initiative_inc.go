...
func GetSourceGoldenHealthInitiativeInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGoldenHealthInitiativeInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "GOLDEN HEALTH INITIATIVE INC"
	sourceDef.SourceType = pkg.SourceTypeGoldenHealthInitiativeInc
