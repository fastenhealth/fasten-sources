...
func GetSourceFarmingtonPedAdolescentMed(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFarmingtonPedAdolescentMed]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Farmington Ped  Adolescent Med"
	sourceDef.SourceType = pkg.SourceTypeFarmingtonPedAdolescentMed
