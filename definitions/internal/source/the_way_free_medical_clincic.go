...
func GetSourceTheWayFreeMedicalClincic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheWayFreeMedicalClincic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Way Free Medical Clincic"
	sourceDef.SourceType = pkg.SourceTypeTheWayFreeMedicalClincic
