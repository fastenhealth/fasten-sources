...
func GetSourceBeaufortOrthopedicSportsSpine(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBeaufortOrthopedicSportsSpine]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Beaufort Orthopedic Sports  Spine"
	sourceDef.SourceType = pkg.SourceTypeBeaufortOrthopedicSportsSpine
