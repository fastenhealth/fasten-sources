...
func GetSourceYakimaValleyFarmWorkersClinic(env pkg.FastenEnvType) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.SourceType = definitions.SourceTypeYakimaValleyFarmWorkersClinic
