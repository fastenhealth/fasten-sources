...
func GetSourceRapidCityRegionalFootClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRapidCityRegionalFootClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Rapid City Regional Foot Clinic"
	sourceDef.SourceType = pkg.SourceTypeRapidCityRegionalFootClinic
