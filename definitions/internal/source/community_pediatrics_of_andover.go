...
func GetSourceCommunityPediatricsOfAndover(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCommunityPediatricsOfAndover]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Community Pediatrics of Andover"
	sourceDef.SourceType = pkg.SourceTypeCommunityPediatricsOfAndover
