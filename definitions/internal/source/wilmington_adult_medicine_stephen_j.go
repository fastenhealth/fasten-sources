...
func GetSourceWilmingtonAdultMedicineStephenJ(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWilmingtonAdultMedicineStephenJ]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Wilmington Adult Medicine Stephen J"
	sourceDef.SourceType = pkg.SourceTypeWilmingtonAdultMedicineStephenJ
