...
func GetSourceDrGhandourAndDrSoape(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrGhandourAndDrSoape]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dr Ghandour and Dr Soape"
	sourceDef.SourceType = pkg.SourceTypeDrGhandourAndDrSoape
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://jessicasilvas1.wixsite.com/egmdpa"
