...
func GetSourceTheFreeMedicalClinicOfNewberry(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheFreeMedicalClinicOfNewberry]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Free Medical Clinic of Newberry"
	sourceDef.SourceType = pkg.SourceTypeTheFreeMedicalClinicOfNewberry
