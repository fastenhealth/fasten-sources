...
func GetSourceFamilyWomensHealthcareOfCinci(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyWomensHealthcareOfCinci]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Family  Womens Healthcare of Cinci"
	sourceDef.SourceType = pkg.SourceTypeFamilyWomensHealthcareOfCinci
