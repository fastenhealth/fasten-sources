...
func GetSourceMiddletownValleyFamilyMedicine1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMiddletownValleyFamilyMedicine1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeMiddletownValleyFamilyMedicine1
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "middletown-valley-family-medicine.png"
	sourceDef.PatientAccessUrl = "https://www.middletownvalleyfamilymedicine.com/"
