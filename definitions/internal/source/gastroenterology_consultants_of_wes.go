...
func GetSourceGastroenterologyConsultantsOfWes(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGastroenterologyConsultantsOfWes]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Gastroenterology Consultants of Wes"
	sourceDef.SourceType = pkg.SourceTypeGastroenterologyConsultantsOfWes
