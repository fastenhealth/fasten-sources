...
func GetSourceRockyForkFamilyPracticeInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRockyForkFamilyPracticeInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Rocky Fork Family Practice Inc"
	sourceDef.SourceType = pkg.SourceTypeRockyForkFamilyPracticeInc
