...
func GetSourceCcMedicalConsultantsPcDba(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCcMedicalConsultantsPcDba]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC Medical Consultants PC DBA"
	sourceDef.SourceType = pkg.SourceTypeCcMedicalConsultantsPcDba
