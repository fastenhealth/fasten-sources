...
func GetSourceCardiovascularInstituteOfSouthernMissouri(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCardiovascularInstituteOfSouthernMissouri]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Cardiovascular Institute of Southern Missouri"
	sourceDef.SourceType = pkg.SourceTypeCardiovascularInstituteOfSouthernMissouri
