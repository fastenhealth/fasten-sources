...
func GetSourceNcpEpicHeartCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNcpEpicHeartCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "NCP EPIC Heart Center"
	sourceDef.SourceType = pkg.SourceTypeNcpEpicHeartCenter
	sourceDef.PatientAccessUrl = "https://www.epicheartcenter.com"
