...
func GetSourceHillemannAndKirwanMdsPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHillemannAndKirwanMdsPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Hillemann and Kirwan MDs PC"
	sourceDef.SourceType = pkg.SourceTypeHillemannAndKirwanMdsPc
