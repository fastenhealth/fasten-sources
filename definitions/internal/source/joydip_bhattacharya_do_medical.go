...
func GetSourceJoydipBhattacharyaDoMedical(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJoydipBhattacharyaDoMedical]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "JOYDIP BHATTACHARYA DO MEDICAL"
	sourceDef.SourceType = pkg.SourceTypeJoydipBhattacharyaDoMedical
