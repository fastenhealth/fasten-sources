...
func GetSourceTennovaWalkinClinicOoltewah(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTennovaWalkinClinicOoltewah]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tennova WalkIn Clinic  Ooltewah"
	sourceDef.SourceType = pkg.SourceTypeTennovaWalkinClinicOoltewah
