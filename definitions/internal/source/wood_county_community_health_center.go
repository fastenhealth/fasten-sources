...
func GetSourceWoodCountyCommunityHealthCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWoodCountyCommunityHealthCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Wood County Community Health Center"
	sourceDef.SourceType = pkg.SourceTypeWoodCountyCommunityHealthCenter
	sourceDef.PatientAccessUrl = "https://woodcountyhealth.org/health-center/"
