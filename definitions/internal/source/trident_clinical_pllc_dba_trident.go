...
func GetSourceTridentClinicalPllcDbaTrident(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTridentClinicalPllcDbaTrident]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Trident Clinical PLLC dba Trident"
	sourceDef.SourceType = pkg.SourceTypeTridentClinicalPllcDbaTrident
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.tridenthealthcenter.com"
