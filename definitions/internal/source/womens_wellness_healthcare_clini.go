...
func GetSourceWomensWellnessHealthcareClini(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeWomensWellnessHealthcareClini]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "WOMENS WELLNESS  HEALTHCARE CLINI"
	sourceDef.SourceType = pkg.SourceTypeWomensWellnessHealthcareClini
