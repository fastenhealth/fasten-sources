...
func GetSourceCc034AshevilleWomensMedicalCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc034AshevilleWomensMedicalCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC034ASHEVILLE WOMENS MEDICAL CENTER"
	sourceDef.SourceType = pkg.SourceTypeCc034AshevilleWomensMedicalCenter
