...
func GetSourceSanAntonioFootAndAnkleCenterL(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSanAntonioFootAndAnkleCenterL]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SAN ANTONIO FOOT AND ANKLE CENTER L"
	sourceDef.SourceType = pkg.SourceTypeSanAntonioFootAndAnkleCenterL
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.safootandankle.com"
