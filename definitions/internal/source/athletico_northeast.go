...
func GetSourceAthleticoNortheast(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAthleticoNortheast]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Athletico Northeast"
	sourceDef.SourceType = pkg.SourceTypeAthleticoNortheast
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "athletico-northeast.svg"
	sourceDef.PatientAccessUrl = "https://www.athletico.com/locations/"
