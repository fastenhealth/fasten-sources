...
func GetSourceNcNewhRegionalMedicalCenterStar(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNcNewhRegionalMedicalCenterStar]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "NC  Newh Regional Medical Center  Star"
	sourceDef.SourceType = pkg.SourceTypeNcNewhRegionalMedicalCenterStar
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.newhrmc.com"
