...
func GetSourceUtMedicalGroupInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeUtMedicalGroupInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "UT Medical Group Inc."
	sourceDef.SourceType = pkg.SourceTypeUtMedicalGroupInc
	sourceDef.PatientAccessUrl = "https://doctor.webmd.com/practice/ut-medical-group-inc-5e6e5750-2951-4b2d-a512-70439598a199"
