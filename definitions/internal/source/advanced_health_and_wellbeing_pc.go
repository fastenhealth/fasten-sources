...
func GetSourceAdvancedHealthAndWellbeingPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAdvancedHealthAndWellbeingPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Advanced Health and WellBeing PC"
	sourceDef.SourceType = pkg.SourceTypeAdvancedHealthAndWellbeingPc
