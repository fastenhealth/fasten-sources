...
func GetSourceAccessMedicalCareOfMonroeCount(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAccessMedicalCareOfMonroeCount]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Access Medical Care of Monroe Count"
	sourceDef.SourceType = pkg.SourceTypeAccessMedicalCareOfMonroeCount
