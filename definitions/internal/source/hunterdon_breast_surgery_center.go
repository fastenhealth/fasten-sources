...
func GetSourceHunterdonBreastSurgeryCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHunterdonBreastSurgeryCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Hunterdon Breast Surgery Center"
	sourceDef.SourceType = pkg.SourceTypeHunterdonBreastSurgeryCenter
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "hunterdon-breast-surgery-center.svg"
	sourceDef.PatientAccessUrl = "https://www.hunterdonhealth.org/hunterdon-breast-surgery-center"
