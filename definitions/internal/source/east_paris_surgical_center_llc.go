...
func GetSourceEastParisSurgicalCenterLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEastParisSurgicalCenterLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "East Paris Surgical Center LLC"
	sourceDef.SourceType = pkg.SourceTypeEastParisSurgicalCenterLlc
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "east-paris-surgical-center-llc.jpg"
	sourceDef.PatientAccessUrl = "https://eastparis-surgicalcenter.com/"
