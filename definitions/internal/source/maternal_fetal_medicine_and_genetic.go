...
func GetSourceMaternalFetalMedicineAndGenetic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMaternalFetalMedicineAndGenetic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Maternal Fetal Medicine and Genetic"
	sourceDef.SourceType = pkg.SourceTypeMaternalFetalMedicineAndGenetic
