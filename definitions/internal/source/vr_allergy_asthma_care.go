...
func GetSourceVrAllergyAsthmaCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeVrAllergyAsthmaCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "VR Allergy  Asthma Care"
	sourceDef.SourceType = pkg.SourceTypeVrAllergyAsthmaCare
