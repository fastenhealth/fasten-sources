...
func GetSourceJaniceRPowellsMdpaDbaTheCh(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJaniceRPowellsMdpaDbaTheCh]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Janice R Powells MDPA  DBA THE CH"
	sourceDef.SourceType = pkg.SourceTypeJaniceRPowellsMdpaDbaTheCh
