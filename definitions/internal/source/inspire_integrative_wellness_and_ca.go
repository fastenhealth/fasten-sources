...
func GetSourceInspireIntegrativeWellnessAndCa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeInspireIntegrativeWellnessAndCa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "INSPIRE INTEGRATIVE WELLNESS AND CA"
	sourceDef.SourceType = pkg.SourceTypeInspireIntegrativeWellnessAndCa
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.inspireintegrativewellness.com"
