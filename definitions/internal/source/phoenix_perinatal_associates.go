...
func GetSourcePhoenixPerinatalAssociates(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePhoenixPerinatalAssociates]; clientIdOk {
	...
	sourceDef.Category = []string{"207VM0101X", "2080N0001X", "2080P0203X", "363LN0000X", "367A00000X"}
