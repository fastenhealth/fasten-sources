...
func GetSourceSharmilaRoyChowdhury(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSharmilaRoyChowdhury]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sharmila Roy Chowdhury"
	sourceDef.SourceType = pkg.SourceTypeSharmilaRoyChowdhury
