...
func GetSourceAntelopeValleyImpotenceAndIncon(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAntelopeValleyImpotenceAndIncon]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ANTELOPE VALLEY IMPOTENCE AND INCON"
	sourceDef.SourceType = pkg.SourceTypeAntelopeValleyImpotenceAndIncon
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.drrajaratnam.com"
