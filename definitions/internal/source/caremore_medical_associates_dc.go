...
func GetSourceCaremoreMedicalAssociatesDc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaremoreMedicalAssociatesDc]; clientIdOk {
	...
	sourceDef.BrandLogo = "caremore-medical-associates-dc.svg"
