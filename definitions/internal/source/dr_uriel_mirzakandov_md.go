...
func GetSourceDrUrielMirzakandovMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrUrielMirzakandovMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dr  Uriel Mirzakandov MD"
	sourceDef.SourceType = pkg.SourceTypeDrUrielMirzakandovMd
