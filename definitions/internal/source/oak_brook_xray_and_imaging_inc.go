...
func GetSourceOakBrookXrayAndImagingInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOakBrookXrayAndImagingInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "OAK BROOK XRAY AND IMAGING INC"
	sourceDef.SourceType = pkg.SourceTypeOakBrookXrayAndImagingInc
