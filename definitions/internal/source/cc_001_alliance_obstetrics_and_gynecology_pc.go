...
func GetSourceCc001AllianceObstetricsAndGynecologyPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc001AllianceObstetricsAndGynecologyPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC001ALLIANCE OBSTETRICS AND GYNECOLOGY PC"
	sourceDef.SourceType = pkg.SourceTypeCc001AllianceObstetricsAndGynecologyPc
