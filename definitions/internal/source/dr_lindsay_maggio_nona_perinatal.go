...
func GetSourceDrLindsayMaggioNonaPerinatal(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrLindsayMaggioNonaPerinatal]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dr Lindsay Maggio Nona Perinatal"
	sourceDef.SourceType = pkg.SourceTypeDrLindsayMaggioNonaPerinatal
