...
func GetSourcePlasticSurgerySpecialistsOfNew(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePlasticSurgerySpecialistsOfNew]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Plastic Surgery Specialists Of New"
	sourceDef.SourceType = pkg.SourceTypePlasticSurgerySpecialistsOfNew
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.pssnj.com/"
