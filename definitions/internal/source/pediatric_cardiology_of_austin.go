...
func GetSourcePediatricCardiologyOfAustin(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatricCardiologyOfAustin]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pediatric Cardiology Of Austin"
	sourceDef.SourceType = pkg.SourceTypePediatricCardiologyOfAustin
	sourceDef.PatientAccessUrl = "https://www.austexpediatrics.com"
