...
func GetSourceHunterdonNeonatalPediatrics(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHunterdonNeonatalPediatrics]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Hunterdon Neonatal Pediatrics"
	sourceDef.SourceType = pkg.SourceTypeHunterdonNeonatalPediatrics
	sourceDef.Hidden = true
	sourceDef.BrandLogo = "hunterdon-neonatal-pediatrics.svg"
