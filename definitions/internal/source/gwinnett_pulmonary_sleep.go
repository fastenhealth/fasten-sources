...
func GetSourceGwinnettPulmonarySleep(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGwinnettPulmonarySleep]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Gwinnett Pulmonary  Sleep"
	sourceDef.SourceType = pkg.SourceTypeGwinnettPulmonarySleep
