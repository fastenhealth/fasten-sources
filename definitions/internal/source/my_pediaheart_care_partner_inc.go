...
func GetSourceMyPediaheartCarePartnerInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMyPediaheartCarePartnerInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "My Pediaheart Care Partner Inc"
	sourceDef.SourceType = pkg.SourceTypeMyPediaheartCarePartnerInc
