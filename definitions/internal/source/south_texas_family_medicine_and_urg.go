...
func GetSourceSouthTexasFamilyMedicineAndUrg(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthTexasFamilyMedicineAndUrg]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SOUTH TEXAS FAMILY MEDICINE AND URG"
	sourceDef.SourceType = pkg.SourceTypeSouthTexasFamilyMedicineAndUrg
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://southtexasfamilymedicine.com"
