...
func GetSourceMaineCoastHandAndShoulder(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMaineCoastHandAndShoulder]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Maine Coast Hand and Shoulder"
	sourceDef.SourceType = pkg.SourceTypeMaineCoastHandAndShoulder
