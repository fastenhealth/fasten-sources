...
func GetSourceHarryChenMdAProfessionalCor(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHarryChenMdAProfessionalCor]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Harry Chen MD A Professional Cor"
	sourceDef.SourceType = pkg.SourceTypeHarryChenMdAProfessionalCor
