...
func GetSourceTheTanenbaumDermatologyCenterPl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheTanenbaumDermatologyCenterPl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Tanenbaum Dermatology Center PL"
	sourceDef.SourceType = pkg.SourceTypeTheTanenbaumDermatologyCenterPl
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.tanenbaumdermatologycenter.com/"
