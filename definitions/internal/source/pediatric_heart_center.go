...
func GetSourcePediatricHeartCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatricHeartCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pediatric Heart Center"
	sourceDef.SourceType = pkg.SourceTypePediatricHeartCenter
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.pediatrix.com/find-care/practices/heartcenter"
