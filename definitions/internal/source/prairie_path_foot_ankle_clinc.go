...
func GetSourcePrairiePathFootAnkleClinc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePrairiePathFootAnkleClinc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Prairie Path Foot  Ankle Clinc"
	sourceDef.SourceType = pkg.SourceTypePrairiePathFootAnkleClinc
