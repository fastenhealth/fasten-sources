...
func GetSourceLouisvilleHipKneeInstitutePll(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLouisvilleHipKneeInstitutePll]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Louisville Hip  Knee Institute PLL"
	sourceDef.SourceType = pkg.SourceTypeLouisvilleHipKneeInstitutePll
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.louisvillehipandkneeinstitute.com"
