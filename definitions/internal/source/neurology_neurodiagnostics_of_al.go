...
func GetSourceNeurologyNeurodiagnosticsOfAl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNeurologyNeurodiagnosticsOfAl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Neurology  Neurodiagnostics of AL"
	sourceDef.SourceType = pkg.SourceTypeNeurologyNeurodiagnosticsOfAl
