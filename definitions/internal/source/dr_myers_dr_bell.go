...
func GetSourceDrMyersDrBell(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrMyersDrBell]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "DR MYERS  DR BELL"
	sourceDef.SourceType = pkg.SourceTypeDrMyersDrBell
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.healthgrades.com/physician/dr-jeffrey-bell-2lpd3"
