...
func GetSourceEyeAssociatesPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeAssociatesPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Associates PLLC"
	sourceDef.SourceType = pkg.SourceTypeEyeAssociatesPllc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://devinkingmd.com/"
