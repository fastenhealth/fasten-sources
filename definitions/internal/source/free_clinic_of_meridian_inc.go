...
func GetSourceFreeClinicOfMeridianInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFreeClinicOfMeridianInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Free Clinic of Meridian Inc"
	sourceDef.SourceType = pkg.SourceTypeFreeClinicOfMeridianInc
