...
func GetSourceEyeSpecialistsOfIllinoisSC(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeSpecialistsOfIllinoisSC]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "EYE SPECIALISTS OF ILLINOIS S C"
	sourceDef.SourceType = pkg.SourceTypeEyeSpecialistsOfIllinoisSC
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.eyespecialistsofillinois.com/"
