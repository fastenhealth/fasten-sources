...
func GetSourceCenterOfExcellenceInFamilyAnd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCenterOfExcellenceInFamilyAnd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Center of Excellence in Family and"
	sourceDef.SourceType = pkg.SourceTypeCenterOfExcellenceInFamilyAnd
