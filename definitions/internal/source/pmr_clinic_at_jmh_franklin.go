...
func GetSourcePmrClinicAtJmhFranklin(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePmrClinicAtJmhFranklin]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "PMR Clinic At JMH Franklin"
	sourceDef.SourceType = pkg.SourceTypePmrClinicAtJmhFranklin
