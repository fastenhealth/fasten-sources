...
func GetSourceExpressMedicalCareOfNorthOkaloosaMedicalCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeExpressMedicalCareOfNorthOkaloosaMedicalCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Express Medical Care of North Okaloosa Medical Center"
	sourceDef.SourceType = pkg.SourceTypeExpressMedicalCareOfNorthOkaloosaMedicalCenter
