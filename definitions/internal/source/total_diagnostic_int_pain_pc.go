...
func GetSourceTotalDiagnosticIntPainPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTotalDiagnosticIntPainPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Total Diagnostic  Int Pain PC"
	sourceDef.SourceType = pkg.SourceTypeTotalDiagnosticIntPainPc
