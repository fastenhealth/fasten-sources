...
func GetSourceSaintJosephPhysicianNetwork(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Category = []string{"207Q00000X", "207R00000X", "207RC0000X", "207RC0001X", "207RI0011X", "207RI0200X", "207RP1001X", "207V00000X", "207VM0101X", "208000000X", "2084N0400X", "2086S0129X", "208800000X", "208G00000X", "261QU0200X", "363A00000X", "363L00000X", "363LF0000X", "363LP0200X"}
	sourceDef.Aliases = []string{"SAINT JOSEPH PHYSICIAN NETWORK"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1225082878", "1467406074"}}
