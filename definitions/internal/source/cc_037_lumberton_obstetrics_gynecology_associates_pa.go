...
func GetSourceCc037LumbertonObstetricsGynecologyAssociatesPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCc037LumbertonObstetricsGynecologyAssociatesPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CC037Lumberton Obstetrics  Gynecology Associates PA"
	sourceDef.SourceType = pkg.SourceTypeCc037LumbertonObstetricsGynecologyAssociatesPa
