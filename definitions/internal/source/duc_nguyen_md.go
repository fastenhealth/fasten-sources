...
func GetSourceDucNguyenMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDucNguyenMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Duc Nguyen MD"
	sourceDef.SourceType = pkg.SourceTypeDucNguyenMd
	sourceDef.PatientAccessUrl = "https://doctors.adventisthealth.org/provider/Duc+V+Nguyen/1339749"
