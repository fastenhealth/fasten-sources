...
func GetSourceAssociatedPulmonologistsOfWester(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAssociatedPulmonologistsOfWester]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Associated Pulmonologists of Wester"
	sourceDef.SourceType = pkg.SourceTypeAssociatedPulmonologistsOfWester
