...
func GetSourcePremierMedicalGroup1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePremierMedicalGroup1]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Premier Medical Group"
	sourceDef.SourceType = pkg.SourceTypePremierMedicalGroup1
	...
	sourceDef.BrandLogo = "premier-medical-group.png"
