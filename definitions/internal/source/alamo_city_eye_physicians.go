...
func GetSourceAlamoCityEyePhysicians(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlamoCityEyePhysicians]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Alamo City Eye Physicians"
	sourceDef.SourceType = pkg.SourceTypeAlamoCityEyePhysicians
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.alamocityeye.com/"
