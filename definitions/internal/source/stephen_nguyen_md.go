...
func GetSourceStephenNguyenMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeStephenNguyenMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Stephen Nguyen MD"
	sourceDef.SourceType = pkg.SourceTypeStephenNguyenMd
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://health.usnews.com/doctors/stephen-nguyen-152793"
