...
func GetSourceDelmarvaKidneyHypertensionSpec(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDelmarvaKidneyHypertensionSpec]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Delmarva Kidney  Hypertension Spec"
	sourceDef.SourceType = pkg.SourceTypeDelmarvaKidneyHypertensionSpec
