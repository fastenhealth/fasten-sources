...
func GetSourceFamilyNeurologyAndNeurodevelopme(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyNeurologyAndNeurodevelopme]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Family Neurology and Neurodevelopme"
	sourceDef.SourceType = pkg.SourceTypeFamilyNeurologyAndNeurodevelopme
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.familyneurology.com"
