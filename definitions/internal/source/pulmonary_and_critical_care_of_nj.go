...
func GetSourcePulmonaryAndCriticalCareOfNj(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePulmonaryAndCriticalCareOfNj]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pulmonary and Critical Care of NJ"
	sourceDef.SourceType = pkg.SourceTypePulmonaryAndCriticalCareOfNj
