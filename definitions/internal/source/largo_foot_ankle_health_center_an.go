...
func GetSourceLargoFootAnkleHealthCenterAn(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLargoFootAnkleHealthCenterAn]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "LARGO FOOT  ANKLE HEALTH CENTER AN"
	sourceDef.SourceType = pkg.SourceTypeLargoFootAnkleHealthCenterAn
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://largofoot.com"
