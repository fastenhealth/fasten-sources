...
func GetSourceEyecareAssociatesOfTexasPA(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyecareAssociatesOfTexasPA]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://www.texaseyes.com/"
