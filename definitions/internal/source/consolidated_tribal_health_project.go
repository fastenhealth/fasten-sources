...
func GetSourceConsolidatedTribalHealthProject(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeConsolidatedTribalHealthProject]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Consolidated Tribal Health Project"
	sourceDef.SourceType = pkg.SourceTypeConsolidatedTribalHealthProject
