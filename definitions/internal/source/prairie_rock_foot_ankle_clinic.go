...
func GetSourcePrairieRockFootAnkleClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePrairieRockFootAnkleClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Prairie Rock Foot  Ankle Clinic"
	sourceDef.SourceType = pkg.SourceTypePrairieRockFootAnkleClinic
