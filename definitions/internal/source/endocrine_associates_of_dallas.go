...
func GetSourceEndocrineAssociatesOfDallas(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEndocrineAssociatesOfDallas]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Endocrine Associates Of Dallas"
	sourceDef.SourceType = pkg.SourceTypeEndocrineAssociatesOfDallas
