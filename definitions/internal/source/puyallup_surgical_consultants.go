...
func GetSourcePuyallupSurgicalConsultants(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePuyallupSurgicalConsultants]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Puyallup Surgical Consultants"
	sourceDef.SourceType = pkg.SourceTypePuyallupSurgicalConsultants
	sourceDef.PatientAccessUrl = "https://puyallupsurgeons.com/"
