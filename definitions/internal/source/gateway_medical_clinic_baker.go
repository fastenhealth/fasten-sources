...
func GetSourceGatewayMedicalClinicBaker(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGatewayMedicalClinicBaker]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Gateway Medical Clinic  Baker"
	sourceDef.SourceType = pkg.SourceTypeGatewayMedicalClinicBaker
