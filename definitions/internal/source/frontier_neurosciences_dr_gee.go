...
func GetSourceFrontierNeurosciencesDrGee(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFrontierNeurosciencesDrGee]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Frontier Neurosciences Dr Gee"
	sourceDef.SourceType = pkg.SourceTypeFrontierNeurosciencesDrGee
