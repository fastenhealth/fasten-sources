...
func GetSourceDelawareValleyDermatologyGroupLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDelawareValleyDermatologyGroupLlc]; clientIdOk {
	...
	sourceDef.Category = []string{"207ND0101X", "207ND0900X", "207NS0135X", "332900000X", "207N00000X"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1568602969"}}
