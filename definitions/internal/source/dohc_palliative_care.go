...
func GetSourceDohcPalliativeCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDohcPalliativeCare]; clientIdOk {
	...
	sourceDef.Aliases = []string{"DESERT OASIS HEALTHCARE"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1639407208"}}
	sourceDef.BrandLogo = "dohc-palliative-care.svg"
