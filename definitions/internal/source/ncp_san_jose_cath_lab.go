...
func GetSourceNcpSanJoseCathLab(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNcpSanJoseCathLab]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "NCP San Jose Cath Lab"
	sourceDef.SourceType = pkg.SourceTypeNcpSanJoseCathLab
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.siliconvalleycathlab.com/"
