...
func GetSourceGastroenterologyConsultantsOfAugusta(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGastroenterologyConsultantsOfAugusta]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Gastroenterology Consultants of Augusta"
	sourceDef.SourceType = pkg.SourceTypeGastroenterologyConsultantsOfAugusta
