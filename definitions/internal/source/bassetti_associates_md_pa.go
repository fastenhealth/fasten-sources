...
func GetSourceBassettiAssociatesMdPa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBassettiAssociatesMdPa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "BASSETTI  ASSOCIATES MD PA"
	sourceDef.SourceType = pkg.SourceTypeBassettiAssociatesMdPa
