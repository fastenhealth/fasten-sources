...
func GetSourceOrthopedicSpecialistsOfSeattle(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOrthopedicSpecialistsOfSeattle]; clientIdOk {
	...
	sourceDef.Category = []string{"207X00000X", "207XS0106X", "207XS0114X", "207XX0004X", "207XX0005X", "207XX0801X", "261QM1300X", "363AS0400X"}
