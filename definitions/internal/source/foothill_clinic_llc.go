...
func GetSourceFoothillClinicLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFoothillClinicLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Foothill Clinic LLC"
	sourceDef.SourceType = pkg.SourceTypeFoothillClinicLlc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://foothillfamilyclinic.com/"
