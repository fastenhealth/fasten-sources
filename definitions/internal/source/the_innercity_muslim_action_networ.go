...
func GetSourceTheInnercityMuslimActionNetwor(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheInnercityMuslimActionNetwor]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The InnerCity Muslim Action Networ"
	sourceDef.SourceType = pkg.SourceTypeTheInnercityMuslimActionNetwor
