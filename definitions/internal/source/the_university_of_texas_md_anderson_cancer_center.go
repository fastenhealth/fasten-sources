...
func GetSourceTheUniversityOfTexasMdAndersonCancerCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.RegistrationEndpoint = "https://fhir.mdanderson.org/FHIR/oauth2/register"
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheUniversityOfTexasMdAndersonCancerCenter]; clientIdOk {
