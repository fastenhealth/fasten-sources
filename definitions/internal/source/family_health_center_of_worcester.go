...
func GetSourceFamilyHealthCenterOfWorcester(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeFamilyHealthCenterOfWorcester]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Family Health Center Of Worcester"
	sourceDef.SourceType = pkg.SourceTypeFamilyHealthCenterOfWorcester
	sourceDef.BrandLogo = "family-health-center-of-worcester.jpeg"
	sourceDef.PatientAccessUrl = "https://fhcw.org/"
