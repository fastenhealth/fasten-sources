...
func GetSourceMedicalSpecialistsOfNorthernNewJersey(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMedicalSpecialistsOfNorthernNewJersey]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Medical Specialists of Northern New Jersey"
	sourceDef.SourceType = pkg.SourceTypeMedicalSpecialistsOfNorthernNewJersey
