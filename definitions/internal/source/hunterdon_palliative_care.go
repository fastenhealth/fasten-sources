...
func GetSourceHunterdonPalliativeCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeHunterdonPalliativeCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Hunterdon Palliative Care"
	sourceDef.SourceType = pkg.SourceTypeHunterdonPalliativeCare
	sourceDef.BrandLogo = "hunterdon-palliative-care.svg"
	sourceDef.PatientAccessUrl = "https://www.hunterdonhealth.org/services/hunterdon-palliative-care"
