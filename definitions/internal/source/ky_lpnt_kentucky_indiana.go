...
func GetSourceKyLpntKentuckyIndiana(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeKyLpntKentuckyIndiana]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "KY  LPNT  Kentucky  Indiana"
	sourceDef.SourceType = pkg.SourceTypeKyLpntKentuckyIndiana
