...
func GetSourceNanticokeCardiologyAssocs(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNanticokeCardiologyAssocs]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Nanticoke Cardiology Assocs"
	sourceDef.SourceType = pkg.SourceTypeNanticokeCardiologyAssocs
