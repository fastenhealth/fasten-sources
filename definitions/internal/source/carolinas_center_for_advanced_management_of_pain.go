...
func GetSourceCarolinasCenterForAdvancedManagementOfPain(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCarolinasCenterForAdvancedManagementOfPain]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Carolinas Center for Advanced Management of Pain"
	sourceDef.SourceType = pkg.SourceTypeCarolinasCenterForAdvancedManagementOfPain
