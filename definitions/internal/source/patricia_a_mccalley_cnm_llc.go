...
func GetSourcePatriciaAMccalleyCnmLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePatriciaAMccalleyCnmLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Patricia A McCalley CNM LLC"
	sourceDef.SourceType = pkg.SourceTypePatriciaAMccalleyCnmLlc
