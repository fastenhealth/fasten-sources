...
func GetSourceSanAntonioKidneyDisease1(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSanAntonioKidneyDisease1]; clientIdOk {
	...
	sourceDef.SourceType = pkg.SourceTypeSanAntonioKidneyDisease1
