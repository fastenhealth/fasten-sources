...
func GetSourceRichardMSooyDpm(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRichardMSooyDpm]; clientIdOk {
	...
	sourceDef.PatientAccessUrl = "https://familyfootcarespecialist.com/"
