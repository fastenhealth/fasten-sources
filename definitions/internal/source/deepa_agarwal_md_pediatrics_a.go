...
func GetSourceDeepaAgarwalMdPediatricsA(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDeepaAgarwalMdPediatricsA]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Deepa Agarwal MD Pediatrics A"
	sourceDef.SourceType = pkg.SourceTypeDeepaAgarwalMdPediatricsA
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.tucson-peds.com"
