...
func GetSourceTannazEbrahimiAdibMdApcDbaV(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTannazEbrahimiAdibMdApcDbaV]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Tannaz Ebrahimi Adib MD APC dba V"
	sourceDef.SourceType = pkg.SourceTypeTannazEbrahimiAdibMdApcDbaV
