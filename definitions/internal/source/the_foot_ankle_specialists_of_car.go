...
func GetSourceTheFootAnkleSpecialistsOfCar(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheFootAnkleSpecialistsOfCar]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Foot  Ankle Specialists of Car"
	sourceDef.SourceType = pkg.SourceTypeTheFootAnkleSpecialistsOfCar
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.footandanklespecialistsmi.com"
