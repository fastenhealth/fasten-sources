...
func GetSourceLowhamSurgeryAndEndoscopyPc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLowhamSurgeryAndEndoscopyPc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "LOWHAM SURGERY AND ENDOSCOPY PC"
	sourceDef.SourceType = pkg.SourceTypeLowhamSurgeryAndEndoscopyPc
