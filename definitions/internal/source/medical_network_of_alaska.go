...
func GetSourceMedicalNetworkOfAlaska(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMedicalNetworkOfAlaska]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MEDICAL NETWORK OF ALASKA"
	sourceDef.SourceType = pkg.SourceTypeMedicalNetworkOfAlaska
