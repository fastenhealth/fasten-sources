...
func GetSourcePediatricsOfFlorence(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatricsOfFlorence]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pediatrics Of Florence"
	sourceDef.SourceType = pkg.SourceTypePediatricsOfFlorence
	sourceDef.PatientAccessUrl = "https://pediatricsofflorence.com/"
