...
func GetSourceTheObesityCenterAtRiverOaks(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheObesityCenterAtRiverOaks]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Obesity Center at River Oaks"
	sourceDef.SourceType = pkg.SourceTypeTheObesityCenterAtRiverOaks
