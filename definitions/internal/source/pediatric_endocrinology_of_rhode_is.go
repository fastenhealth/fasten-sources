...
func GetSourcePediatricEndocrinologyOfRhodeIs(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatricEndocrinologyOfRhodeIs]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Pediatric Endocrinology of Rhode Is"
	sourceDef.SourceType = pkg.SourceTypePediatricEndocrinologyOfRhodeIs
