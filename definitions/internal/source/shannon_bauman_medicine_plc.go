...
func GetSourceShannonBaumanMedicinePlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeShannonBaumanMedicinePlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "SHANNON BAUMAN MEDICINE PLC"
	sourceDef.SourceType = pkg.SourceTypeShannonBaumanMedicinePlc
