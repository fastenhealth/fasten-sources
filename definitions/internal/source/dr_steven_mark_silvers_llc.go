...
func GetSourceDrStevenMarkSilversLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrStevenMarkSilversLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "DR STEVEN MARK SILVERS LLC"
	sourceDef.SourceType = pkg.SourceTypeDrStevenMarkSilversLlc
