...
func GetSourceLakeshoreFamilyClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLakeshoreFamilyClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Lakeshore Family Clinic"
	sourceDef.SourceType = pkg.SourceTypeLakeshoreFamilyClinic
	sourceDef.PatientAccessUrl = "https://www.lakeshorefamilypractice.com"
