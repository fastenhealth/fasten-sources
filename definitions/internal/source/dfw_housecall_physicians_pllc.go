...
func GetSourceDfwHousecallPhysiciansPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDfwHousecallPhysiciansPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "DFW Housecall Physicians PLLC"
	sourceDef.SourceType = pkg.SourceTypeDfwHousecallPhysiciansPllc
