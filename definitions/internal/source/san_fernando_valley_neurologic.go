...
func GetSourceSanFernandoValleyNeurologic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSanFernandoValleyNeurologic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "San Fernando Valley Neurologic"
	sourceDef.SourceType = pkg.SourceTypeSanFernandoValleyNeurologic
