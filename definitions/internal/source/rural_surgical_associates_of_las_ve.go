...
func GetSourceRuralSurgicalAssociatesOfLasVe(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeRuralSurgicalAssociatesOfLasVe]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Rural Surgical Associates of Las Ve"
	sourceDef.SourceType = pkg.SourceTypeRuralSurgicalAssociatesOfLasVe
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.ruralsurgicalassociates.com"
