...
func GetSourceOlympusSpineAndPainPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeOlympusSpineAndPainPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Olympus Spine and Pain PLLC"
	sourceDef.SourceType = pkg.SourceTypeOlympusSpineAndPainPllc
