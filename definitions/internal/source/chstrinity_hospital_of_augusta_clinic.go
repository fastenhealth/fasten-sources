...
func GetSourceChstrinityHospitalOfAugustaClinic(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeChstrinityHospitalOfAugustaClinic]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "CHSTrinity Hospital of Augusta Clinic"
	sourceDef.SourceType = pkg.SourceTypeChstrinityHospitalOfAugustaClinic
