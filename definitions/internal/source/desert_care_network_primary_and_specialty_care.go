...
func GetSourceDesertCareNetworkPrimaryAndSpecialtyCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDesertCareNetworkPrimaryAndSpecialtyCare]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Desert Care Network Primary and Specialty Care"
	sourceDef.SourceType = pkg.SourceTypeDesertCareNetworkPrimaryAndSpecialtyCare
