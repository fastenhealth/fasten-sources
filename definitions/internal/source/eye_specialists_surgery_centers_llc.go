...
func GetSourceEyeSpecialistsSurgeryCentersLlc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEyeSpecialistsSurgeryCentersLlc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Eye Specialists Surgery Centers LLC"
	sourceDef.SourceType = pkg.SourceTypeEyeSpecialistsSurgeryCentersLlc
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.unitedhealthgroup.com/"
