...
func GetSourceTruhealthFamilyClinicPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTruhealthFamilyClinicPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "TRUHEALTH FAMILY CLINIC PLLC"
	sourceDef.SourceType = pkg.SourceTypeTruhealthFamilyClinicPllc
