...
func GetSourceSeanKossariMdAProfessionalCorp(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSeanKossariMdAProfessionalCorp]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sean Kossari MD A Professional Corp"
	sourceDef.SourceType = pkg.SourceTypeSeanKossariMdAProfessionalCorp
