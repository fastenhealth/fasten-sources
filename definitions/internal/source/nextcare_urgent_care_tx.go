...
func GetSourceNextcareUrgentCareTx(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeNextcareUrgentCareTx]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "NextCare Urgent Care TX"
	sourceDef.SourceType = pkg.SourceTypeNextcareUrgentCareTx
	sourceDef.BrandLogo = "nextcare-urgent-care-tx.jpg"
