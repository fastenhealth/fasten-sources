...
func GetSourceCommunityHealthCare(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	sourceDef.Aliases = []string{"HILLTOP DENAL", "LAKEWOOD DENTAL", "BETHEL LEARNING CLINIC", "HILLTOP REGIONAL HEALTH CENTER", "SPANAWAY CLINIC", "COMMUNITY HEALTH CARE PHARMACY - PARKLAND", "COMMUNITY HEALTH CARE PHARMACY - SPANAWAY", "COMMUNITY HEALTH CARE PHARMACY - KEY MEDICAL CENTER", "CLR DENTAL CLINIC"}
