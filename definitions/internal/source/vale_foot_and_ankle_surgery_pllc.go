...
func GetSourceValeFootAndAnkleSurgeryPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeValeFootAndAnkleSurgeryPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "VALE FOOT AND ANKLE SURGERY PLLC"
	sourceDef.SourceType = pkg.SourceTypeValeFootAndAnkleSurgeryPllc
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.valepodiatry.com"
