...
func GetSourceCatholicCharitiesOfCentralFl(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCatholicCharitiesOfCentralFl]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Catholic Charities of Central FL"
	sourceDef.SourceType = pkg.SourceTypeCatholicCharitiesOfCentralFl
