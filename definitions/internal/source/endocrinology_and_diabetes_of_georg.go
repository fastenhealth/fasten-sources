...
func GetSourceEndocrinologyAndDiabetesOfGeorg(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEndocrinologyAndDiabetesOfGeorg]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ENDOCRINOLOGY AND DIABETES OF GEORG"
	sourceDef.SourceType = pkg.SourceTypeEndocrinologyAndDiabetesOfGeorg
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.endogeorgia.com"
