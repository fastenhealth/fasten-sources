...
func GetSourceCompleteFootAndAnkleCareOfNor(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCompleteFootAndAnkleCareOfNor]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Complete Foot and Ankle Care of Nor"
	sourceDef.SourceType = pkg.SourceTypeCompleteFootAndAnkleCareOfNor
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://completefootandanklecare.com"
