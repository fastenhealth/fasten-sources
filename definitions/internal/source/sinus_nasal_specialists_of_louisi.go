...
func GetSourceSinusNasalSpecialistsOfLouisi(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSinusNasalSpecialistsOfLouisi]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Sinus  Nasal Specialists of Louisi"
	sourceDef.SourceType = pkg.SourceTypeSinusNasalSpecialistsOfLouisi
