...
func GetSourceLifebridgeGynecologyOfPikesville(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeLifebridgeGynecologyOfPikesville]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Lifebridge Gynecology of Pikesville"
	sourceDef.SourceType = pkg.SourceTypeLifebridgeGynecologyOfPikesville
