...
func GetSourceDrJonathanRalphDrAnilaWahid(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDrJonathanRalphDrAnilaWahid]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Dr Jonathan Ralph  Dr Anila Wahid"
	sourceDef.SourceType = pkg.SourceTypeDrJonathanRalphDrAnilaWahid
