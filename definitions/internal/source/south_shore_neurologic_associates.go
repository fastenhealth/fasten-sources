...
func GetSourceSouthShoreNeurologicAssociates(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSouthShoreNeurologicAssociates]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "South Shore Neurologic Associates"
	sourceDef.SourceType = pkg.SourceTypeSouthShoreNeurologicAssociates
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.southshoreneurologic.com/"
