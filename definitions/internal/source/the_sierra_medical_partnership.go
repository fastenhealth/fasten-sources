...
func GetSourceTheSierraMedicalPartnership(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheSierraMedicalPartnership]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Sierra Medical Partnership"
	sourceDef.SourceType = pkg.SourceTypeTheSierraMedicalPartnership
