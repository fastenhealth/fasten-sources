...
func GetSourceIkareMoodTraumaRecovery(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeIkareMoodTraumaRecovery]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "iKare Mood Trauma Recovery"
	sourceDef.SourceType = pkg.SourceTypeIkareMoodTraumaRecovery
