...
func GetSourceTitanOrthopaedicsOfMemphisPllc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTitanOrthopaedicsOfMemphisPllc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Titan Orthopaedics of Memphis PLLC"
	sourceDef.SourceType = pkg.SourceTypeTitanOrthopaedicsOfMemphisPllc
