...
func GetSourceBeachPhysiciansMedicalGroup(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeBeachPhysiciansMedicalGroup]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Beach Physicians Medical Group"
	sourceDef.SourceType = pkg.SourceTypeBeachPhysiciansMedicalGroup
	sourceDef.PatientAccessUrl = "https://www.beachphysicians.com/"
