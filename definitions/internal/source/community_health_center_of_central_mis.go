...
func GetSourceCommunityHealthCenterOfCentralMis(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCommunityHealthCenterOfCentralMis]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Community Health Center Of Central Mis"
	sourceDef.SourceType = pkg.SourceTypeCommunityHealthCenterOfCentralMis
	sourceDef.Hidden = true
	sourceDef.PatientAccessUrl = "https://www.chccmo.org/"
