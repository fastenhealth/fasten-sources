...
func GetSourceDanvilleSportsMedicineAndPrimar(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeDanvilleSportsMedicineAndPrimar]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Danville Sports Medicine and Primar"
	sourceDef.SourceType = pkg.SourceTypeDanvilleSportsMedicineAndPrimar
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.danvillesportsmedicineandprimarycare.com"
