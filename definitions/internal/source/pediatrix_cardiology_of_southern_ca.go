...
func GetSourcePediatrixCardiologyOfSouthernCa(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePediatrixCardiologyOfSouthernCa]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Pediatrix Cardiology Of Southern CA"
	sourceDef.SourceType = pkg.SourceTypePediatrixCardiologyOfSouthernCa
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.BrandLogo = "pediatrix-cardiology-of-southern-ca.jpg"
	sourceDef.PatientAccessUrl = "https://www.facebook.com/PediatrixCardiologySoCal/"
