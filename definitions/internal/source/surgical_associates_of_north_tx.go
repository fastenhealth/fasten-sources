...
func GetSourceSurgicalAssociatesOfNorthTx(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeSurgicalAssociatesOfNorthTx]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Surgical Associates of North TX"
	sourceDef.SourceType = pkg.SourceTypeSurgicalAssociatesOfNorthTx
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.surgicalassociatesofnorthtexas.com"
