...
func GetSourceStGeorgeEndoscopy(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeStGeorgeEndoscopy]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "St George Endoscopy"
	sourceDef.SourceType = pkg.SourceTypeStGeorgeEndoscopy
	sourceDef.PatientAccessUrl = "https://utahendocenter.com/"
