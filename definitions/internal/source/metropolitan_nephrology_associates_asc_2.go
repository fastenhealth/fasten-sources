...
func GetSourceMetropolitanNephrologyAssociatesAsc2(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMetropolitanNephrologyAssociatesAsc2]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Metropolitan Nephrology Associates ASC 2"
	sourceDef.SourceType = pkg.SourceTypeMetropolitanNephrologyAssociatesAsc2
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "https://www.mnakidney.com/"
