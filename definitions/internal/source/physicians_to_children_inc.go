...
func GetSourcePhysiciansToChildrenInc(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePhysiciansToChildrenInc]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Physicians To Children Inc"
	sourceDef.SourceType = pkg.SourceTypePhysiciansToChildrenInc
	sourceDef.PatientAccessUrl = "https://www.physicianstochildren.com/"
