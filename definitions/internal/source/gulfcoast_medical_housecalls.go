...
func GetSourceGulfcoastMedicalHousecalls(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeGulfcoastMedicalHousecalls]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Gulfcoast Medical Housecalls"
	sourceDef.SourceType = pkg.SourceTypeGulfcoastMedicalHousecalls
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://gulfcoastmedicalhousecalls.com/index.html"
