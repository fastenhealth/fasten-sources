...
func GetSourcePlanteEndcrnDbtsWllnssCntr(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePlanteEndcrnDbtsWllnssCntr]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Plante Endcrn Dbts Wllnss Cntr"
	sourceDef.SourceType = pkg.SourceTypePlanteEndcrnDbtsWllnssCntr
