...
func GetSourceIllinoisCollegeOfOptometry(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeIllinoisCollegeOfOptometry]; clientIdOk {
	...
	sourceDef.Category = []string{"390200000X", "332B00000X", "152W00000X"}
	sourceDef.Aliases = []string{"ILLINOIS EYE INSTITUTE"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1982082087", "1285612390"}}
