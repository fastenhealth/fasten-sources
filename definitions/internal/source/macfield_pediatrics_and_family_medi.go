...
func GetSourceMacfieldPediatricsAndFamilyMedi(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMacfieldPediatricsAndFamilyMedi]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Macfield Pediatrics and Family Medi"
	sourceDef.SourceType = pkg.SourceTypeMacfieldPediatricsAndFamilyMedi
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.macfieldmd.com"
