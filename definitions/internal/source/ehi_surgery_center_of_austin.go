...
func GetSourceEhiSurgeryCenterOfAustin(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEhiSurgeryCenterOfAustin]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "EHI Surgery Center of Austin"
	sourceDef.SourceType = pkg.SourceTypeEhiSurgeryCenterOfAustin
