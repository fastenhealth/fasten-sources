...
func GetSourceJorgeRLopezMd(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeJorgeRLopezMd]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Jorge R Lopez MD"
	sourceDef.SourceType = pkg.SourceTypeJorgeRLopezMd
	sourceDef.BrandLogo = "jorge-r-lopez-md.jpg"
	sourceDef.PatientAccessUrl = "http://www.jorgelopezmd.com/"
