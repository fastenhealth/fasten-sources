...
func GetSourceAlconaHealthCenter(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeAlconaHealthCenter]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Alcona Health Center"
	sourceDef.SourceType = pkg.SourceTypeAlconaHealthCenter
	sourceDef.PatientAccessUrl = "https://www.alconahealthcenters.org/"
