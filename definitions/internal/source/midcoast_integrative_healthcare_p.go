...
func GetSourceMidcoastIntegrativeHealthcareP(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeMidcoastIntegrativeHealthcareP]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "MIDCOAST INTEGRATIVE HEALTHCARE P"
	sourceDef.SourceType = pkg.SourceTypeMidcoastIntegrativeHealthcareP
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.jenniferlakisdo.com"
