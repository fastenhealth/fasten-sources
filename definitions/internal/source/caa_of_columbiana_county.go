...
func GetSourceCaaOfColumbianaCounty(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeCaaOfColumbianaCounty]; clientIdOk {
	...
	sourceDef.Aliases = []string{"Community Action Agency of Columbiana County"}
	sourceDef.PatientAccessUrl = "https://caaofcc.org/"
