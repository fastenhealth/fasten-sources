...
func GetSourceArthritisCenterOfNorthGeorgia(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeArthritisCenterOfNorthGeorgia]; clientIdOk {
	...
	sourceDef.Aliases = []string{"ARTHRITIS CENTER OF NORTH GEORGIA"}
	sourceDef.Identifiers = map[string][]string{"http://hl7.org/fhir/sid/us-npi": []string{"1629464805"}}
