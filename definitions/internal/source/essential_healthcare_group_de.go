...
func GetSourceEssentialHealthcareGroupDe(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeEssentialHealthcareGroupDe]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Essential Healthcare Group DE"
	sourceDef.SourceType = pkg.SourceTypeEssentialHealthcareGroupDe
