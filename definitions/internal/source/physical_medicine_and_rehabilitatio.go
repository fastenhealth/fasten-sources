...
func GetSourcePhysicalMedicineAndRehabilitatio(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypePhysicalMedicineAndRehabilitatio]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Physical Medicine and Rehabilitatio"
	sourceDef.SourceType = pkg.SourceTypePhysicalMedicineAndRehabilitatio
