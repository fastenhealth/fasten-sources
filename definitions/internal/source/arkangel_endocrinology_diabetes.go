...
func GetSourceArkangelEndocrinologyDiabetes(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeArkangelEndocrinologyDiabetes]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "ARKANGEL ENDOCRINOLOGY  DIABETES"
	sourceDef.SourceType = pkg.SourceTypeArkangelEndocrinologyDiabetes
	sourceDef.Category = []string{}
	sourceDef.Aliases = []string{}
	sourceDef.PatientAccessUrl = "http://www.annaboron.com"
