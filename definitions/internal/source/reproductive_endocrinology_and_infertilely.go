...
func GetSourceReproductiveEndocrinologyAndInfertilely(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeReproductiveEndocrinologyAndInfertilely]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "Reproductive Endocrinology and Infertilely"
	sourceDef.SourceType = pkg.SourceTypeReproductiveEndocrinologyAndInfertilely
