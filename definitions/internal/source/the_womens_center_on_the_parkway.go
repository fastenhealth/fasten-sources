...
func GetSourceTheWomensCenterOnTheParkway(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTheWomensCenterOnTheParkway]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeAthena))

	sourceDef.Display = "The Womens Center on the Parkway"
	sourceDef.SourceType = pkg.SourceTypeTheWomensCenterOnTheParkway
