...
func GetSourceTriCountyVascularCareOffice(env pkg.FastenLighthouseEnvType, clientIdLookup map[pkg.SourceType]string) (models.LighthouseSourceDefinition, error) {
	...
	if clientId, clientIdOk := clientIdLookup[pkg.SourceTypeTriCountyVascularCareOffice]; clientIdOk {
		sourceDef.ClientId = clientId
	}
	sourceDef.RedirectUri = pkg.GetCallbackEndpoint(string(pkg.SourceTypeNextgen))

	sourceDef.Display = "Tri County Vascular Care Office"
	sourceDef.SourceType = pkg.SourceTypeTriCountyVascularCareOffice
